...
# 58 "cyclone/tools/bison/lalr.cyc"
...
return 0;}
# 366
void Cyc_initialize_F (void){struct _fat_ptr _T0;int _T1;unsigned*_T2;unsigned _T3;unsigned _T4;struct _fat_ptr _T5;int _T6;struct _fat_ptr*_T7;unsigned _T8;unsigned _T9;struct _fat_ptr _TA;struct _fat_ptr _TB;int _TC;short*_TD;unsigned _TE;unsigned _TF;struct _fat_ptr _T10;int _T11;unsigned char*_T12;short*_T13;short _T14;struct _fat_ptr _T15;int _T16;unsigned char*_T17;struct Cyc_shifts_tag**_T18;struct Cyc_shifts_tag*_T19;unsigned _T1A;struct Cyc_shifts_tag*_T1B;short _T1C;struct _fat_ptr _T1D;struct Cyc_shifts_tag*_T1E;struct _fat_ptr _T1F;int _T20;unsigned char*_T21;short*_T22;short _T23;int _T24;unsigned char*_T25;short*_T26;short _T27;struct _fat_ptr _T28;int _T29;unsigned char*_T2A;unsigned*_T2B;int _T2C;unsigned _T2D;struct _fat_ptr _T2E;struct Cyc_shifts_tag*_T2F;struct _fat_ptr _T30;int _T31;unsigned char*_T32;short*_T33;short _T34;int _T35;unsigned char*_T36;short*_T37;short _T38;struct _fat_ptr _T39;int _T3A;unsigned char*_T3B;char*_T3C;char _T3D;int _T3E;struct _fat_ptr _T3F;int _T40;int _T41;unsigned char*_T42;short*_T43;int _T44;int _T45;struct _fat_ptr _T46;int _T47;short*_T48;unsigned _T49;unsigned _T4A;struct _fat_ptr _T4B;int _T4C;unsigned char*_T4D;struct _fat_ptr*_T4E;struct _fat_ptr _T4F;int _T50;unsigned char*_T51;short*_T52;struct _fat_ptr _T53;int _T54;unsigned char*_T55;short*_T56;struct _fat_ptr _T57;int _T58;unsigned char*_T59;short*_T5A;struct _fat_ptr*_T5B;int _T5C;struct _fat_ptr _T5D;int _T5E;unsigned char*_T5F;struct _fat_ptr*_T60;struct _fat_ptr _T61;unsigned char*_T62;unsigned _T63;struct _fat_ptr _T64;unsigned char*_T65;struct _fat_ptr*_T66;int _T67;
# 369
int i;
int j;
int k;
...
int nwords;
# 382
nwords= Cyc_ngotos * Cyc_tokensetsize;_T1= nwords;{unsigned _T68=(unsigned)_T1;_T3= _check_times(_T68,sizeof(unsigned));{unsigned*_T69=_cycalloc_atomic(_T3);{unsigned _T6A=_T68;unsigned _new2_cyclone;_new2_cyclone= 0;_TLA4: if(_new2_cyclone < _T6A)goto _TLA2;else{goto _TLA3;}_TLA2: _T4= _new2_cyclone;
_T69[_T4]= 0U;_new2_cyclone= _new2_cyclone + 1;goto _TLA4;_TLA3:;}_T2= (unsigned*)_T69;}_T0= _tag_fat(_T2,sizeof(unsigned),_T68);}Cyc_F= _T0;_T6= Cyc_ngotos;{unsigned _T68=(unsigned)_T6;_T8= _check_times(_T68,sizeof(struct _fat_ptr));{struct _fat_ptr*_T69=_cycalloc(_T8);{unsigned _T6A=_T68;unsigned _new2p_cyclone;_new2p_cyclone= 0;_TLA8: if(_new2p_cyclone < _T6A)goto _TLA6;else{goto _TLA7;}_TLA6: _T9= _new2p_cyclone;_TA= 
# 385
_tag_fat(0,0,0);_T69[_T9]= _TA;_new2p_cyclone= _new2p_cyclone + 1;goto _TLA8;_TLA7:;}_T7= (struct _fat_ptr*)_T69;}_T5= _tag_fat(_T7,sizeof(struct _fat_ptr),_T68);}reads= _T5;_TC= Cyc_ngotos + 1;{unsigned _T68=(unsigned)_TC;_TE= _check_times(_T68,sizeof(short));{short*_T69=_cycalloc_atomic(_TE);{unsigned _T6A=_T68;unsigned _new2_cyclone;_new2_cyclone= 0;_TLAC: if(_new2_cyclone < _T6A)goto _TLAA;else{goto _TLAB;}_TLAA: _TF= _new2_cyclone;
_T69[_TF]= 0;_new2_cyclone= _new2_cyclone + 1;goto _TLAC;_TLAB:;}_TD= (short*)_T69;}_TB= _tag_fat(_TD,sizeof(short),_T68);}edge= _TB;
nedges= 0;
# 389
rowp= Cyc_F;
...
if(symbol < Cyc_ntokens)goto _TLB7;goto _TLB5;_TLB7: _T28= rowp;_T29= symbol / 32;_T2A= _check_fat_subscript(_T28,sizeof(unsigned),_T29);_T2B= (unsigned*)_T2A;_T2C= symbol % 32;_T2D= 1U << _T2C;
# 404
*_T2B= *_T2B | _T2D;
# 399
...
# 409
_TLBA: _T2E= Cyc_accessing_symbol;_T2F= sp;_T30= _T2F->shifts;_T31= j;_T32= _check_fat_subscript(_T30,sizeof(short),_T31);_T33= (short*)_T32;_T34= *_T33;_T35= (int)_T34;_T36= _check_fat_subscript(_T2E,sizeof(short),_T35);_T37= (short*)_T36;_T38= *_T37;symbol= (int)_T38;_T39= Cyc_nullable;_T3A= symbol;_T3B= _check_fat_subscript(_T39,sizeof(char),_T3A);_T3C= (char*)_T3B;_T3D= *_T3C;_T3E= (int)_T3D;
if(!_T3E)goto _TLBD;_T3F= edge;_T40= nedges;
nedges= _T40 + 1;_T41= _T40;_T42= _check_fat_subscript(_T3F,sizeof(short),_T41);_T43= (short*)_T42;_T44= Cyc_map_goto(stateno,symbol);*_T43= (short)_T44;goto _TLBE;_TLBD: _TLBE:
# 407
 j= j + 1;goto _TLBC;_TLBB: _T45= nedges;
# 414
if(!_T45)goto _TLBF;_T47= nedges + 1;{unsigned _T68=(unsigned)_T47;_T49= _check_times(_T68,sizeof(short));{short*_T69=_cycalloc_atomic(_T49);{unsigned _T6A=_T68;unsigned _new2_cyclone;_new2_cyclone= 0;_TLC4: if(_new2_cyclone < _T6A)goto _TLC2;else{goto _TLC3;}_TLC2: _T4A= _new2_cyclone;
# 418
_T69[_T4A]= 0;_new2_cyclone= _new2_cyclone + 1;goto _TLC4;_TLC3:;}_T48= (short*)_T69;}_T46= _tag_fat(_T48,sizeof(short),_T68);}rp= _T46;_T4B= reads;_T4C= i;_T4D= _check_fat_subscript(_T4B,sizeof(struct _fat_ptr),_T4C);_T4E= (struct _fat_ptr*)_T4D;
*_T4E= rp;
# 421
j= 0;_TLC8: if(j < nedges)goto _TLC6;else{goto _TLC7;}
_TLC6: _T4F= rp;_T50= j;_T51= _check_fat_subscript(_T4F,sizeof(short),_T50);_T52= (short*)_T51;_T53= edge;_T54= j;_T55= _check_fat_subscript(_T53,sizeof(short),_T54);_T56= (short*)_T55;*_T52= *_T56;
# 421
j= j + 1;goto _TLC8;_TLC7: _T57= rp;_T58= nedges;_T59= _check_fat_subscript(_T57,sizeof(short),_T58);_T5A= (short*)_T59;
# 424
*_T5A= - 1;
nedges= 0;goto _TLC0;_TLBF: _TLC0: goto _TLB2;_TLB1: _TLB2: _T5B= & rowp;_T5C= Cyc_tokensetsize;
# 429
_fat_ptr_inplace_plus(_T5B,sizeof(unsigned),_T5C);
# 390
...
# 436
_TLCA: _T5D= reads;_T5E= i;_T5F= _check_fat_subscript(_T5D,sizeof(struct _fat_ptr),_T5E);_T60= (struct _fat_ptr*)_T5F;_T61= *_T60;_T62= _T61.curr;_T63= (unsigned)_T62;if(!_T63)goto _TLCD;_T64= reads;_T65= _T64.curr;_T66= (struct _fat_ptr*)_T65;_T67= i;
({__typeof__(_tag_fat(0,0,0))_T68=_tag_fat(0,0,0);_T66[_T67]= _T68;});goto _TLCE;_TLCD: _TLCE:
# 434
...
({__typeof__(_tag_fat(0,0,0))_TB4=_tag_fat(0,0,0);_TB2[_TB3]= _TB4;});goto _TL106;_TL105: _TL106:
# 529
...
# 642
_TL138: _T0= Cyc_includes;_T1= i;_T2= _check_fat_subscript(_T0,sizeof(struct _fat_ptr),_T1);_T3= (struct _fat_ptr*)_T2;_T4= *_T3;_T5= _T4.curr;_T6= (unsigned)_T5;if(!_T6)goto _TL13B;_T7= Cyc_includes;_T8= _T7.curr;_T9= (struct _fat_ptr*)_T8;_TA= i;({__typeof__(_tag_fat(0,0,0))_TB=_tag_fat(0,0,0);_T9[_TA]= _TB;});goto _TL13C;_TL13B: _TL13C:
# 640
