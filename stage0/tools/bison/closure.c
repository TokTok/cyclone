...
# 57 "cyclone/tools/bison/closure.cyc"
...
Cyc_set_fderives();}
# 100
void Cyc_set_fderives (void){struct _fat_ptr _T0;int _T1;unsigned*_T2;unsigned _T3;unsigned _T4;struct _fat_ptr _T5;int _T6;int _T7;struct _fat_ptr _T8;int _T9;struct _fat_ptr _TA;int _TB;int _TC;int _TD;struct _fat_ptr*_TE;struct _fat_ptr _TF;unsigned char*_T10;unsigned*_T11;unsigned _T12;unsigned _T13;unsigned _T14;int _T15;struct _fat_ptr _T16;int _T17;unsigned char*_T18;struct _fat_ptr*_T19;struct _fat_ptr*_T1A;struct _fat_ptr _T1B;unsigned char*_T1C;short*_T1D;short _T1E;int _T1F;struct _fat_ptr _T20;int _T21;unsigned char*_T22;unsigned*_T23;int _T24;unsigned _T25;int _T26;int _T27;struct _fat_ptr*_T28;struct _fat_ptr _T29;unsigned char*_T2A;unsigned*_T2B;struct _fat_ptr*_T2C;int _T2D;
# 103
...
# 110
int ruleno;
int i;_T1= Cyc_nvars * Cyc_rulesetsize;{unsigned _T2E=(unsigned)_T1;_T3= _check_times(_T2E,sizeof(unsigned));{unsigned*_T2F=_cycalloc_atomic(_T3);{unsigned _T30=_T2E;unsigned _new2_cyclone;_new2_cyclone= 0;_TLB: if(_new2_cyclone < _T30)goto _TL9;else{goto _TLA;}_TL9: _T4= _new2_cyclone;
# 113
_T2F[_T4]= 0U;_new2_cyclone= _new2_cyclone + 1;goto _TLB;_TLA:;}_T2= (unsigned*)_T2F;}_T0= _tag_fat(_T2,sizeof(unsigned),_T2E);}_T5= _T0;_T6= Cyc_ntokens * Cyc_rulesetsize;_T7= - _T6;Cyc_fderives= _fat_ptr_plus(_T5,sizeof(unsigned),_T7);
# 115
...
# 126
_TL11: _T12= cword;_T13= 1U << b;_T14= _T12 & _T13;_T15= (int)_T14;if(!_T15)goto _TL14;_T16= Cyc_derives;_T17= j;_T18= _check_fat_subscript(_T16,sizeof(struct _fat_ptr),_T17);_T19= (struct _fat_ptr*)_T18;
# 128
rp= *_T19;
_TL16: _T1A= & rp;_T1B= _fat_ptr_inplace_plus_post(_T1A,sizeof(short),1);_T1C= _check_fat_subscript(_T1B,sizeof(short),0U);_T1D= (short*)_T1C;_T1E= *_T1D;ruleno= (int)_T1E;_T1F= ruleno;if(_T1F > 0)goto _TL17;else{goto _TL18;}
# 131
_TL17: _T20= rrow;_T21= ruleno / 32;_T22= _check_fat_subscript(_T20,sizeof(unsigned),_T21);_T23= (unsigned*)_T22;_T24= ruleno % 32;_T25= 1U << _T24;*_T23= *_T23 | _T25;goto _TL16;_TL18: goto _TL15;_TL14: _TL15:
# 135
 b= b + 1;
if(b < 32)goto _TL19;_T26= j + 1;_T27= Cyc_nsyms;if(_T26 >= _T27)goto _TL19;_T28= & vrow;_T29= 
# 138
_fat_ptr_inplace_plus_post(_T28,sizeof(unsigned),1);_T2A= _check_fat_subscript(_T29,sizeof(unsigned),0U);_T2B= (unsigned*)_T2A;cword= *_T2B;
b= 0;goto _TL1A;_TL19: _TL1A:
# 124
 j= j + 1;goto _TL13;_TL12: _T2C= & rrow;_T2D= Cyc_rulesetsize;
# 143
_fat_ptr_inplace_plus(_T2C,sizeof(unsigned),_T2D);
# 119
...
# 171
rowsize= _T1 / 32;Cyc_varsetsize= rowsize;_T3= Cyc_nvars * rowsize;{unsigned _T28=(unsigned)_T3;_T5= _check_times(_T28,sizeof(unsigned));{unsigned*_T29=_cycalloc_atomic(_T5);{unsigned _T2A=_T28;unsigned _new2_cyclone;_new2_cyclone= 0;_TL1E: if(_new2_cyclone < _T2A)goto _TL1C;else{goto _TL1D;}_TL1C: _T6= _new2_cyclone;
# 173
_T29[_T6]= 0U;_new2_cyclone= _new2_cyclone + 1;goto _TL1E;_TL1D:;}_T4= (unsigned*)_T29;}_T2= _tag_fat(_T4,sizeof(unsigned),_T28);}Cyc_firsts= _T2;
# 175
row= Cyc_firsts;
...
# 260
_TL3E: _T49= word;_T4A= 1U << b;_T4B= _T49 & _T4A;_T4C= (int)_T4B;if(!_T4C)goto _TL41;_T4D= Cyc_rrhs;_T4E= ruleno;_T4F= _check_fat_subscript(_T4D,sizeof(short),_T4E);_T50= (short*)_T4F;_T51= *_T50;
# 262
itemno= (int)_T51;
_TL43: _T52= csp;_T53= _T52.curr;_T54= (short*)_T53;_T55= csend;_T56= _T55.curr;_T57= (short*)_T56;if(_T54 < _T57)goto _TL46;else{goto _TL45;}_TL46: _T58= csp;_T59= _check_fat_subscript(_T58,sizeof(short),0U);_T5A= (short*)_T59;_T5B= *_T5A;_T5C= (int)_T5B;_T5D= itemno;if(_T5C < _T5D)goto _TL44;else{goto _TL45;}
_TL44: _T5E= & Cyc_itemsetend;_T5F= _fat_ptr_inplace_plus_post(_T5E,sizeof(short),1);_T60= _check_fat_subscript(_T5F,sizeof(short),0U);_T61= (short*)_T60;_T62= & csp;_T63= _fat_ptr_inplace_plus_post(_T62,sizeof(short),1);_T64= _T63.curr;_T65= (short*)_T64;*_T61= *_T65;goto _TL43;_TL45: _T66= & Cyc_itemsetend;_T67= 
_fat_ptr_inplace_plus_post(_T66,sizeof(short),1);_T68= _check_fat_subscript(_T67,sizeof(short),0U);_T69= (short*)_T68;_T6A= itemno;*_T69= (short)_T6A;goto _TL42;_TL41: _TL42:
# 268
 ruleno= ruleno + 1;
# 258
b= b + 1;goto _TL40;_TL3F:;}_TL3C: goto _TL38;_TL3A:
# 273
 _TL47: _T6B= csp;_T6C= _T6B.curr;_T6D= (short*)_T6C;_T6E= csend;_T6F= _T6E.curr;_T70= (short*)_T6F;if(_T6D < _T70)goto _TL48;else{goto _TL49;}
_TL48: _T71= & Cyc_itemsetend;_T72= _fat_ptr_inplace_plus_post(_T71,sizeof(short),1);_T73= _check_fat_subscript(_T72,sizeof(short),0U);_T74= (short*)_T73;_T75= & csp;_T76= _fat_ptr_inplace_plus_post(_T75,sizeof(short),1);_T77= _check_fat_subscript(_T76,sizeof(short),0U);_T78= (short*)_T77;*_T74= *_T78;goto _TL47;_TL49:;}
# 282
