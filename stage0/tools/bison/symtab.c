...
# 54 "cyclone/tools/bison/symtab.h"
...
# 28 "cyclone/tools/bison/symtab.cyc"
...
_TA->link= *_TE;_TF= bp;
_TF->next= 0;_T10= bp;
({__typeof__(Cyc_copys(key))_T1E=Cyc_copys(key);_T10->tag= _T1E;});_T11= bp;
_T11->class= '\000';_T12= bp;
_T12->value= 0;_T13= bp;
({__typeof__(_tag_fat(0,0,0))_T1E=_tag_fat(0,0,0);_T13->type_name= _T1E;});_T14= bp;
_T14->prec= 0;_T15= bp;
