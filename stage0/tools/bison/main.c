...
# 129 "bazel-out/k8-fastbuild/bin/cyclone/library/std/libc/stdlib.h"
...
# 25 "cyclone/tools/bison/main.cyc"
...
# 41
int Cyc_main(int argc,struct _fat_ptr argv){struct _fat_ptr _T0;unsigned char*_T1;struct _fat_ptr*_T2;int _T3;int _T4;_T0= argv;_T1= _check_fat_subscript(_T0,sizeof(struct _fat_ptr),0);_T2= (struct _fat_ptr*)_T1;
...
# 141
_TLA:{struct Cyc_String_pa_PrintArg_struct _TE;_TE.tag= 0;_TE.f1= Cyc_infile;_T7= _TE;}{struct Cyc_String_pa_PrintArg_struct _TE=_T7;{struct Cyc_Int_pa_PrintArg_struct _TF;_TF.tag= 1;_T9= Cyc_lineno;_TF.f1= (unsigned long)_T9;_T8= _TF;}{struct Cyc_Int_pa_PrintArg_struct _TF=_T8;{struct Cyc_String_pa_PrintArg_struct _T10;_T10.tag= 0;_T10.f1= s;_TA= _T10;}{struct Cyc_String_pa_PrintArg_struct _T10=_TA;void*_T11[3];_T11[0]= & _TE;_T11[1]= & _TF;_T11[2]= & _T10;_TB= Cyc_stderr;_TC= _tag_fat("(\"%s\", line %d) error: %s\n",sizeof(char),27U);_TD= _tag_fat(_T11,sizeof(void*),3);Cyc_fprintf(_TB,_TC,_TD);}}}_TLB:
# 143
 Cyc_failure= 1;}
# 148
