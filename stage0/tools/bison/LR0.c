...
# 32 "cyclone/tools/bison/LR0.cyc"
...
# 114
_TL12: _T1F= Cyc_kernel_base;_T20= i;_T21= _check_fat_subscript(_T1F,sizeof(struct _fat_ptr),_T20);_T22= (struct _fat_ptr*)_T21;_T23= Cyc_kernel_items;_T24= count;({__typeof__(_fat_ptr_plus(_T23,sizeof(short),_T24))_T31=_fat_ptr_plus(_T23,sizeof(short),_T24);*_T22= _T31;});_T25= symbol_count;_T26= i;_T27= _check_fat_subscript(_T25,sizeof(short),_T26);_T28= (short*)_T27;_T29= *_T28;_T2A= (int)_T29;
count= count + _T2A;
# 112
...
_TL2B: _T0= Cyc_kernel_end;_T1= i;_T2= _check_fat_subscript(_T0,sizeof(struct _fat_ptr),_T1);_T3= (struct _fat_ptr*)_T2;({__typeof__(_tag_fat(0,0,0))_T2E=_tag_fat(0,0,0);*_T3= _T2E;});
# 209
...
# 338
_TL55: _T41= sp;({__typeof__(Cyc_new_state(symbol))_T49=Cyc_new_state(symbol);_T41->link= _T49;});sp= _T41->link;
...
_T5->nitems= 0;_T6= p;
({__typeof__(_tag_fat(0,0,0))_T7=_tag_fat(0,0,0);_T6->items= _T7;});
...
_TD2[_T53]= 0;_new2_cyclone= _new2_cyclone + 1;goto _TL97;_TL96:;}_T51= (short*)_TD2;}_T50= _T51;}({__typeof__(_tag_fat(_T50,sizeof(short),1U))_TD1=_tag_fat(_T50,sizeof(short),1U);_T4F->shifts= _TD1;});_T54= sp2;_T55= _T54->shifts;_T56= _T55.curr;_T57= (short*)_T56;_T58= Cyc_nstates;
...
_TD2[_T97]= 0;_new2_cyclone= _new2_cyclone + 1;goto _TLAB;_TLAA:;}_T95= (short*)_TD2;}_T94= _T95;}({__typeof__(_tag_fat(_T94,sizeof(short),1U))_TD1=_tag_fat(_T94,sizeof(short),1U);_T93->shifts= _TD1;});_T98= sp;
...
_TD2[_TA4]= 0;_new2_cyclone= _new2_cyclone + 1;goto _TLAF;_TLAE:;}_TA2= (short*)_TD2;}_TA1= _TA2;}({__typeof__(_tag_fat(_TA1,sizeof(short),1U))_TD1=_tag_fat(_TA1,sizeof(short),1U);_TA0->shifts= _TD1;});_TA5= sp;
_TA5->next= 0;_TA6= sp;
...
({__typeof__(_tag_fat(0,0,0))_TD1=_tag_fat(0,0,0);_TB4->items= _TD1;});_TB5= 
...
_TD2[_TBC]= 0;_new2_cyclone= _new2_cyclone + 1;goto _TLB3;_TLB2:;}_TBA= (short*)_TD2;}_TB9= _TBA;}({__typeof__(_tag_fat(_TB9,sizeof(short),1U))_TD1=_tag_fat(_TB9,sizeof(short),1U);_TB8->shifts= _TD1;});_TBD= sp;_TBE= Cyc_nstates;
...
({__typeof__(_tag_fat(0,0,0))_TD1=_tag_fat(0,0,0);_TCC->items= _TD1;});_TCD= statep;_TCE= Cyc_nstates;
...
({__typeof__(_tag_fat(0,0,0))_T1B=_tag_fat(0,0,0);_T4->items= _T1B;});_T5= statep;_T6= Cyc_nstates;
...
_T1C[_TF]= 0;_new2_cyclone= _new2_cyclone + 1;goto _TLB7;_TLB6:;}_TD= (short*)_T1C;}_TC= _TD;}({__typeof__(_tag_fat(_TC,sizeof(short),1U))_T1B=_tag_fat(_TC,sizeof(short),1U);_TB->shifts= _T1B;});_T10= sp;
