...
_TL15: _T2A= actions;_T2B= _T2A->hd;{struct _tuple5*_T4F=(struct _tuple5*)_T2B;struct Cyc_Syntax_Location*_T50;int _T51;{struct _tuple5 _T52=*_T4F;_T51= _T52.f0;_T50= _T52.f1;}{int num=_T51;struct Cyc_Syntax_Location*loc=_T50;{struct Cyc_Int_pa_PrintArg_struct _T52;_T52.tag= 1;_T2D= num;
