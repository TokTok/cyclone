#include <cyc_include.h>
 struct Cyc_Core_Opt{void*v;};struct Cyc___cycFILE;
...
# 157
extern int Cyc_printf(struct _fat_ptr,struct _fat_ptr);struct Cyc_List_List{void*hd;struct Cyc_List_List*tl;};
...
# 38 "./cyclone/library/std/position.h"
...
# 69
extern long Cyc_Hashtable_try_lookup(struct Cyc_Hashtable_Table*,void*,void**);struct Cyc_Dict_T;struct Cyc_Dict_Dict{int(*rel)(void*,void*);struct _RegionHandle*r;const struct Cyc_Dict_T*t;};extern char Cyc_Dict_Absent[7U];struct Cyc_Dict_Absent_exn_struct{char*tag;};
...
# 69 "cyclone/library/compiler/tcutil.h"
...
# 249
void*Cyc_Tcutil_any_bool(struct Cyc_List_List*);struct Cyc___cycFILE;
...
void*Cyc_Warn_impos(struct _fat_ptr,struct _fat_ptr);struct Cyc_Port_Edit{unsigned loc;struct _fat_ptr old_string;struct _fat_ptr new_string;};
# 90 "cyclone/library/compiler/port.cyc"
int Cyc_Port_cmp_edit(struct Cyc_Port_Edit*e1,struct Cyc_Port_Edit*e2){struct Cyc_Port_Edit*_T0;int _T1;struct Cyc_Port_Edit*_T2;int _T3;int _T4;_T0= e1;_T1= (int)_T0;_T2= e2;_T3= (int)_T2;_T4= _T1 - _T3;return _T4;}
static unsigned Cyc_Port_get_seg(struct Cyc_Port_Edit*e){struct Cyc_Port_Edit*_T0;unsigned _T1;_T0= e;_T1= _T0->loc;return _T1;}
int Cyc_Port_cmp_seg_t(unsigned loc1,unsigned loc2){unsigned _T0;int _T1;_T0= loc1 - loc2;_T1= (int)_T0;return _T1;}
int Cyc_Port_hash_seg_t(unsigned loc){unsigned _T0;int _T1;_T0= loc;_T1= (int)_T0;return _T1;}struct Cyc_Port_VarUsage{long address_taken;struct Cyc_Absyn_Exp*init;struct Cyc_List_List*usage_locs;};struct Cyc_Port_Cvar{int id;void**eq;struct Cyc_List_List*uppers;struct Cyc_List_List*lowers;};struct Cyc_Port_Cfield{void*qual;struct _fat_ptr*f;void*type;};struct Cyc_Port_Const_ct_Port_Ctype_struct{int tag;};struct Cyc_Port_Notconst_ct_Port_Ctype_struct{int tag;};struct Cyc_Port_Thin_ct_Port_Ctype_struct{int tag;};struct Cyc_Port_Fat_ct_Port_Ctype_struct{int tag;};struct Cyc_Port_Void_ct_Port_Ctype_struct{int tag;};struct Cyc_Port_Zero_ct_Port_Ctype_struct{int tag;};struct Cyc_Port_Arith_ct_Port_Ctype_struct{int tag;};struct Cyc_Port_Heap_ct_Port_Ctype_struct{int tag;};struct Cyc_Port_Zterm_ct_Port_Ctype_struct{int tag;};struct Cyc_Port_Nozterm_ct_Port_Ctype_struct{int tag;};struct Cyc_Port_RgnVar_ct_Port_Ctype_struct{int tag;struct _fat_ptr*f1;};struct Cyc_Port_Ptr_ct_Port_Ctype_struct{int tag;void*f1;void*f2;void*f3;void*f4;void*f5;};struct Cyc_Port_Array_ct_Port_Ctype_struct{int tag;void*f1;void*f2;void*f3;};struct _tuple13{struct Cyc_Absyn_Aggrdecl*f0;struct Cyc_List_List*f1;};struct Cyc_Port_KnownAggr_ct_Port_Ctype_struct{int tag;struct _tuple13*f1;};struct Cyc_Port_UnknownAggr_ct_Port_Ctype_struct{int tag;struct Cyc_List_List*f1;void**f2;};struct Cyc_Port_Fn_ct_Port_Ctype_struct{int tag;void*f1;struct Cyc_List_List*f2;};struct Cyc_Port_Var_ct_Port_Ctype_struct{int tag;struct Cyc_Port_Cvar*f1;};
# 147
...
# 187
({__typeof__(Cyc_Port_ctype2string(deep,elt))_T7B=Cyc_Port_ctype2string(deep,elt);_T7A.f1= _T7B;});_T1A= _T7A;}{struct Cyc_String_pa_PrintArg_struct _T7A=_T1A;{struct Cyc_String_pa_PrintArg_struct _T7B;_T7B.tag= 0;({__typeof__(Cyc_Port_ctype2string(deep,qual))_T7C=Cyc_Port_ctype2string(deep,qual);_T7B.f1= _T7C;});_T1B= _T7B;}{struct Cyc_String_pa_PrintArg_struct _T7B=_T1B;{struct Cyc_String_pa_PrintArg_struct _T7C;_T7C.tag= 0;
({__typeof__(Cyc_Port_ctype2string(deep,k))_T7D=Cyc_Port_ctype2string(deep,k);_T7C.f1= _T7D;});_T1C= _T7C;}{struct Cyc_String_pa_PrintArg_struct _T7C=_T1C;{struct Cyc_String_pa_PrintArg_struct _T7D;_T7D.tag= 0;({__typeof__(Cyc_Port_ctype2string(deep,rgn))_T7E=Cyc_Port_ctype2string(deep,rgn);_T7D.f1= _T7E;});_T1D= _T7D;}{struct Cyc_String_pa_PrintArg_struct _T7D=_T1D;{struct Cyc_String_pa_PrintArg_struct _T7E;_T7E.tag= 0;({__typeof__(Cyc_Port_ctype2string(deep,zt))_T7F=Cyc_Port_ctype2string(deep,zt);_T7E.f1= _T7F;});_T1E= _T7E;}{struct Cyc_String_pa_PrintArg_struct _T7E=_T1E;void*_T7F[5];_T7F[0]= & _T7A;_T7F[1]= & _T7B;_T7F[2]= & _T7C;_T7F[3]= & _T7D;_T7F[4]= & _T7E;_T1F= 
# 187
...
# 190
({__typeof__(Cyc_Port_ctype2string(deep,elt))_T7B=Cyc_Port_ctype2string(deep,elt);_T7A.f1= _T7B;});_T26= _T7A;}{struct Cyc_String_pa_PrintArg_struct _T7A=_T26;{struct Cyc_String_pa_PrintArg_struct _T7B;_T7B.tag= 0;({__typeof__(Cyc_Port_ctype2string(deep,qual))_T7C=Cyc_Port_ctype2string(deep,qual);_T7B.f1= _T7C;});_T27= _T7B;}{struct Cyc_String_pa_PrintArg_struct _T7B=_T27;{struct Cyc_String_pa_PrintArg_struct _T7C;_T7C.tag= 0;
({__typeof__(Cyc_Port_ctype2string(deep,zt))_T7D=Cyc_Port_ctype2string(deep,zt);_T7C.f1= _T7D;});_T28= _T7C;}{struct Cyc_String_pa_PrintArg_struct _T7C=_T28;void*_T7D[3];_T7D[0]= & _T7A;_T7D[1]= & _T7B;_T7D[2]= & _T7C;_T29= 
# 190
_tag_fat("array(%s,%s,%s)",sizeof(char),16U);_T2A= _tag_fat(_T7D,sizeof(void*),3);_T25= Cyc_aprintf(_T29,_T2A);}}}return _T25;}case 13: _T2B= t;{struct Cyc_Port_KnownAggr_ct_Port_Ctype_struct*_T7A=(struct Cyc_Port_KnownAggr_ct_Port_Ctype_struct*)_T2B;_T2C= _T7A->f1;{struct _tuple13 _T7B=*_T2C;_T79= _T7B.f0;_T78= _T7B.f1;}}{struct Cyc_Absyn_Aggrdecl*ad=_T79;struct Cyc_List_List*cfs=_T78;_T2E= ad;_T2F= _T2E->kind;_T30= (int)_T2F;
# 193
...
_TL5:{struct Cyc_String_pa_PrintArg_struct _T7A;_T7A.tag= 0;_T7A.f1= s;_T33= _T7A;}{struct Cyc_String_pa_PrintArg_struct _T7A=_T33;{struct Cyc_String_pa_PrintArg_struct _T7B;_T7B.tag= 0;_T35= ad;_T36= _T35->name;({__typeof__(Cyc_Absynpp_qvar2string(_T36))_T7C=Cyc_Absynpp_qvar2string(_T36);_T7B.f1= _T7C;});_T34= _T7B;}{struct Cyc_String_pa_PrintArg_struct _T7B=_T34;void*_T7C[2];_T7C[0]= & _T7A;_T7C[1]= & _T7B;_T37= _tag_fat("%s %s",sizeof(char),6U);_T38= _tag_fat(_T7C,sizeof(void*),2);_T32= Cyc_aprintf(_T37,_T38);}}return _T32;
# 197
_TL3:{struct Cyc_String_pa_PrintArg_struct _T7A;_T7A.tag= 0;_T7A.f1= s;_T3A= _T7A;}{struct Cyc_String_pa_PrintArg_struct _T7A=_T3A;{struct Cyc_String_pa_PrintArg_struct _T7B;_T7B.tag= 0;_T3C= ad;_T3D= _T3C->name;({__typeof__(Cyc_Absynpp_qvar2string(_T3D))_T7C=Cyc_Absynpp_qvar2string(_T3D);_T7B.f1= _T7C;});_T3B= _T7B;}{struct Cyc_String_pa_PrintArg_struct _T7B=_T3B;{struct Cyc_String_pa_PrintArg_struct _T7C;_T7C.tag= 0;({__typeof__(Cyc_Port_cfields2string(0,cfs))_T7D=Cyc_Port_cfields2string(0,cfs);_T7C.f1= _T7D;});_T3E= _T7C;}{struct Cyc_String_pa_PrintArg_struct _T7C=_T3E;void*_T7D[3];_T7D[0]= & _T7A;_T7D[1]= & _T7B;_T7D[2]= & _T7C;_T3F= _tag_fat("%s %s {%s}",sizeof(char),11U);_T40= _tag_fat(_T7D,sizeof(void*),3);_T39= Cyc_aprintf(_T3F,_T40);}}}return _T39;}}case 14: _T41= t;_T42= (struct Cyc_Port_UnknownAggr_ct_Port_Ctype_struct*)_T41;_T43= _T42->f2;if(_T43==0)goto _TL6;_T44= t;{struct Cyc_Port_UnknownAggr_ct_Port_Ctype_struct*_T7A=(struct Cyc_Port_UnknownAggr_ct_Port_Ctype_struct*)_T44;_T79= _T7A->f1;_T45= _T7A->f2;{void*_T7B=*_T45;_T78= _T7B;}}{struct Cyc_List_List*cfs=_T79;void*eq=_T78;_T46= 
# 199
...
# 201
({__typeof__(Cyc_Port_cfields2string(deep,cfs))_T7B=Cyc_Port_cfields2string(deep,cfs);_T7A.f1= _T7B;});_T49= _T7A;}{struct Cyc_String_pa_PrintArg_struct _T7A=_T49;void*_T7B[1];_T7B[0]= & _T7A;_T4A= _tag_fat("aggr {%s}",sizeof(char),10U);_T4B= _tag_fat(_T7B,sizeof(void*),1);_T48= Cyc_aprintf(_T4A,_T4B);}return _T48;}case 15: _T4C= t;{struct Cyc_Port_Fn_ct_Port_Ctype_struct*_T7A=(struct Cyc_Port_Fn_ct_Port_Ctype_struct*)_T4C;_T4D= _T7A->f1;_T79= (void*)_T4D;_T74= _T7A->f2;}{void*t=_T79;struct Cyc_List_List*ts=_T74;{struct Cyc_String_pa_PrintArg_struct _T7A;_T7A.tag= 0;
# 203
({__typeof__(Cyc_Port_ctypes2string(deep,ts))_T7B=Cyc_Port_ctypes2string(deep,ts);_T7A.f1= _T7B;});_T4F= _T7A;}{struct Cyc_String_pa_PrintArg_struct _T7A=_T4F;{struct Cyc_String_pa_PrintArg_struct _T7B;_T7B.tag= 0;({__typeof__(Cyc_Port_ctype2string(deep,t))_T7C=Cyc_Port_ctype2string(deep,t);_T7B.f1= _T7C;});_T50= _T7B;}{struct Cyc_String_pa_PrintArg_struct _T7B=_T50;void*_T7C[2];_T7C[0]= & _T7A;_T7C[1]= & _T7B;_T51= _tag_fat("fn(%s)->%s",sizeof(char),11U);_T52= _tag_fat(_T7C,sizeof(void*),2);_T4E= Cyc_aprintf(_T51,_T52);}}return _T4E;}default: _T53= t;{struct Cyc_Port_Var_ct_Port_Ctype_struct*_T7A=(struct Cyc_Port_Var_ct_Port_Ctype_struct*)_T53;_T73= _T7A->f1;}{struct Cyc_Port_Cvar*cv=_T73;_T54= cv;_T55= _T54->eq;_T56= (unsigned)_T55;
# 205
...
# 210
_TLA:{struct Cyc_String_pa_PrintArg_struct _T7A;_T7A.tag= 0;_T69= cv;_T6A= _T69->lowers;({__typeof__(Cyc_Port_ctypes2string(0,_T6A))_T7B=Cyc_Port_ctypes2string(0,_T6A);_T7A.f1= _T7B;});_T68= _T7A;}{struct Cyc_String_pa_PrintArg_struct _T7A=_T68;{struct Cyc_Int_pa_PrintArg_struct _T7B;_T7B.tag= 1;_T6C= cv;_T6D= _T6C->id;_T7B.f1= (unsigned long)_T6D;_T6B= _T7B;}{struct Cyc_Int_pa_PrintArg_struct _T7B=_T6B;{struct Cyc_String_pa_PrintArg_struct _T7C;_T7C.tag= 0;_T6F= cv;_T70= _T6F->uppers;
({__typeof__(Cyc_Port_ctypes2string(0,_T70))_T7D=Cyc_Port_ctypes2string(0,_T70);_T7C.f1= _T7D;});_T6E= _T7C;}{struct Cyc_String_pa_PrintArg_struct _T7C=_T6E;void*_T7D[3];_T7D[0]= & _T7A;_T7D[1]= & _T7B;_T7D[2]= & _T7C;_T71= 
# 210
_tag_fat("var([%s]<=%d<=[%s])",sizeof(char),20U);_T72= _tag_fat(_T7D,sizeof(void*),3);_T67= Cyc_aprintf(_T71,_T72);}}}return _T67;}};}
# 214
static struct _fat_ptr*Cyc_Port_ctype2stringptr(long deep,void*t){struct _fat_ptr*_T0;{struct _fat_ptr*_T1=_cycalloc(sizeof(struct _fat_ptr));({__typeof__(Cyc_Port_ctype2string(deep,t))_T2=Cyc_Port_ctype2string(deep,t);*_T1= _T2;});_T0= (struct _fat_ptr*)_T1;}return _T0;}
...
return _T6;}}}
# 226
static struct _fat_ptr*Cyc_Port_cfield2stringptr(long deep,struct Cyc_Port_Cfield*f){struct _fat_ptr _T0;struct Cyc_String_pa_PrintArg_struct _T1;long _T2;struct Cyc_Port_Cfield*_T3;void*_T4;struct Cyc_String_pa_PrintArg_struct _T5;struct Cyc_Port_Cfield*_T6;struct _fat_ptr*_T7;struct Cyc_String_pa_PrintArg_struct _T8;long _T9;struct Cyc_Port_Cfield*_TA;void*_TB;struct _fat_ptr _TC;struct _fat_ptr _TD;struct _fat_ptr*_TE;{struct Cyc_String_pa_PrintArg_struct _TF;_TF.tag= 0;_T2= deep;_T3= f;_T4= _T3->qual;
# 228
({__typeof__(Cyc_Port_ctype2string(_T2,_T4))_T10=Cyc_Port_ctype2string(_T2,_T4);_TF.f1= _T10;});_T1= _TF;}{struct Cyc_String_pa_PrintArg_struct _TF=_T1;{struct Cyc_String_pa_PrintArg_struct _T10;_T10.tag= 0;_T6= f;_T7= _T6->f;_T10.f1= *_T7;_T5= _T10;}{struct Cyc_String_pa_PrintArg_struct _T10=_T5;{struct Cyc_String_pa_PrintArg_struct _T11;_T11.tag= 0;_T9= deep;_TA= f;_TB= _TA->type;({__typeof__(Cyc_Port_ctype2string(_T9,_TB))_T12=Cyc_Port_ctype2string(_T9,_TB);_T11.f1= _T12;});_T8= _T11;}{struct Cyc_String_pa_PrintArg_struct _T11=_T8;void*_T12[3];_T12[0]= & _TF;_T12[1]= & _T10;_T12[2]= & _T11;_TC= _tag_fat("%s %s: %s",sizeof(char),10U);_TD= _tag_fat(_T12,sizeof(void*),3);_T0= Cyc_aprintf(_TC,_TD);}}}{
# 227
struct _fat_ptr s=_T0;{struct _fat_ptr*_TF=_cycalloc(sizeof(struct _fat_ptr));
# 229
*_TF= s;_TE= (struct _fat_ptr*)_TF;}return _TE;}}
# 231
static struct _fat_ptr Cyc_Port_ctypes2string(long deep,struct Cyc_List_List*ts){struct _fat_ptr _T0;struct Cyc_List_List*(*_T1)(struct _fat_ptr*(*)(long,void*),long,struct Cyc_List_List*);struct Cyc_List_List*(*_T2)(void*(*)(void*,void*),void*,struct Cyc_List_List*);long _T3;struct Cyc_List_List*_T4;struct Cyc_List_List*_T5;struct Cyc_List_List*_T6;struct _fat_ptr _T7;_T0= 
_tag_fat(",",sizeof(char),2U);_T2= Cyc_List_map_c;{struct Cyc_List_List*(*_T8)(struct _fat_ptr*(*)(long,void*),long,struct Cyc_List_List*)=(struct Cyc_List_List*(*)(struct _fat_ptr*(*)(long,void*),long,struct Cyc_List_List*))_T2;_T1= _T8;}_T3= deep;_T4= ts;_T5= _T1(Cyc_Port_ctype2stringptr,_T3,_T4);_T6= Cyc_Port_sep(_T0,_T5);_T7= Cyc_strconcat_l(_T6);return _T7;}
# 234
static struct _fat_ptr Cyc_Port_cfields2string(long deep,struct Cyc_List_List*fs){struct _fat_ptr _T0;struct Cyc_List_List*(*_T1)(struct _fat_ptr*(*)(long,struct Cyc_Port_Cfield*),long,struct Cyc_List_List*);struct Cyc_List_List*(*_T2)(void*(*)(void*,void*),void*,struct Cyc_List_List*);long _T3;struct Cyc_List_List*_T4;struct Cyc_List_List*_T5;struct Cyc_List_List*_T6;struct _fat_ptr _T7;_T0= 
_tag_fat(";",sizeof(char),2U);_T2= Cyc_List_map_c;{struct Cyc_List_List*(*_T8)(struct _fat_ptr*(*)(long,struct Cyc_Port_Cfield*),long,struct Cyc_List_List*)=(struct Cyc_List_List*(*)(struct _fat_ptr*(*)(long,struct Cyc_Port_Cfield*),long,struct Cyc_List_List*))_T2;_T1= _T8;}_T3= deep;_T4= fs;_T5= _T1(Cyc_Port_cfield2stringptr,_T3,_T4);_T6= Cyc_Port_sep(_T0,_T5);_T7= Cyc_strconcat_l(_T6);return _T7;}
# 240
...
static void*Cyc_Port_unknown_aggr_ct(struct Cyc_List_List*fs){struct Cyc_Port_UnknownAggr_ct_Port_Ctype_struct*_T0;void*_T1;{struct Cyc_Port_UnknownAggr_ct_Port_Ctype_struct*_T2=_cycalloc(sizeof(struct Cyc_Port_UnknownAggr_ct_Port_Ctype_struct));_T2->tag= 14;_T2->f1= fs;_T2->f2= 0;_T0= (struct Cyc_Port_UnknownAggr_ct_Port_Ctype_struct*)_T2;}_T1= (void*)_T0;return _T1;}
static void*Cyc_Port_known_aggr_ct(struct _tuple13*p){struct Cyc_Port_KnownAggr_ct_Port_Ctype_struct*_T0;void*_T1;{struct Cyc_Port_KnownAggr_ct_Port_Ctype_struct*_T2=_cycalloc(sizeof(struct Cyc_Port_KnownAggr_ct_Port_Ctype_struct));_T2->tag= 13;
...
# 268
static void*Cyc_Port_new_var(void*x){void*_T0;_T0= Cyc_Port_var();return _T0;}
...
if(_TF==_T10)goto _TL18;_T11= eqp;{void**_T33=_cycalloc(sizeof(void*));
*_T33= r;_T12= (void**)_T33;}*_T11= _T12;goto _TL19;_TL18: _TL19: _T13= r;
return _T13;}_TL16:
# 294
...
# 323
if(!_T29)goto _TL24;_T2A= eq;_T2B= *_T2A;_T2C= 
Cyc_Port_compress_ct(_T2B);return _T2C;
# 326
_TL24: _T2D= t;return _T2D;}default: _T2E= t;
# 329
return _T2E;};}struct _tuple14{void*f0;void*f1;};
# 335
static void*Cyc_Port_inst(struct Cyc_Dict_Dict*instenv,void*t){int*_T0;unsigned _T1;void*_T2;long(*_T3)(struct Cyc_Dict_Dict,struct _fat_ptr*);long(*_T4)(struct Cyc_Dict_Dict,void*);struct Cyc_Dict_Dict*_T5;struct Cyc_Dict_Dict _T6;struct _fat_ptr*_T7;long _T8;struct Cyc_Dict_Dict*_T9;struct Cyc_Dict_Dict(*_TA)(struct Cyc_Dict_Dict,struct _fat_ptr*,void*);struct Cyc_Dict_Dict(*_TB)(struct Cyc_Dict_Dict,void*,void*);struct Cyc_Dict_Dict*_TC;struct Cyc_Dict_Dict _TD;struct _fat_ptr*_TE;void*_TF;void*(*_T10)(struct Cyc_Dict_Dict,struct _fat_ptr*);void*(*_T11)(struct Cyc_Dict_Dict,void*);struct Cyc_Dict_Dict*_T12;struct Cyc_Dict_Dict _T13;struct _fat_ptr*_T14;void*_T15;void*_T16;void*_T17;void*_T18;void*_T19;void*_T1A;struct _tuple14 _T1B;void*_T1C;struct Cyc_Port_Ptr_ct_Port_Ctype_struct*_T1D;void*_T1E;void*_T1F;void*_T20;void*_T21;void*_T22;struct Cyc_Port_Array_ct_Port_Ctype_struct*_T23;void*_T24;void*_T25;struct Cyc_Port_Fn_ct_Port_Ctype_struct*_T26;struct Cyc_List_List*(*_T27)(void*(*)(struct Cyc_Dict_Dict*,void*),struct Cyc_Dict_Dict*,struct Cyc_List_List*);struct Cyc_List_List*(*_T28)(void*(*)(void*,void*),void*,struct Cyc_List_List*);struct Cyc_Dict_Dict*_T29;struct Cyc_List_List*_T2A;void*_T2B;
...
# 352
long(*_T33)(struct Cyc_Dict_Dict,struct _fat_ptr*)=(long(*)(struct Cyc_Dict_Dict,struct _fat_ptr*))_T4;_T3= _T33;}_T5= instenv;_T6= *_T5;_T7= n;_T8= _T3(_T6,_T7);if(_T8)goto _TL27;else{goto _TL29;}
_TL29: _T9= instenv;_TB= Cyc_Dict_insert;{struct Cyc_Dict_Dict(*_T33)(struct Cyc_Dict_Dict,struct _fat_ptr*,void*)=(struct Cyc_Dict_Dict(*)(struct Cyc_Dict_Dict,struct _fat_ptr*,void*))_TB;_TA= _T33;}_TC= instenv;_TD= *_TC;_TE= n;_TF= Cyc_Port_var();({__typeof__(_TA(_TD,_TE,_TF))_T33=_TA(_TD,_TE,_TF);*_T9= _T33;});goto _TL28;_TL27: _TL28: _T11= Cyc_Dict_lookup;{
void*(*_T33)(struct Cyc_Dict_Dict,struct _fat_ptr*)=(void*(*)(struct Cyc_Dict_Dict,struct _fat_ptr*))_T11;_T10= _T33;}_T12= instenv;_T13= *_T12;_T14= n;_T15= _T10(_T13,_T14);return _T15;}case 11:{struct Cyc_Port_Ptr_ct_Port_Ctype_struct*_T33=(struct Cyc_Port_Ptr_ct_Port_Ctype_struct*)_T2C;_T16= _T33->f1;_T32= (void*)_T16;_T17= _T33->f2;_T31= (void*)_T17;_T18= _T33->f3;_T30= (void*)_T18;_T19= _T33->f4;_T2F= (void*)_T19;_T1A= _T33->f5;_T2E= (void*)_T1A;}{void*t1=_T32;void*t2=_T31;void*t3=_T30;void*t4=_T2F;void*zt=_T2E;{struct _tuple14 _T33;
# 356
({__typeof__(Cyc_Port_inst(instenv,t1))_T34=Cyc_Port_inst(instenv,t1);_T33.f0= _T34;});({__typeof__(Cyc_Port_inst(instenv,t4))_T34=Cyc_Port_inst(instenv,t4);_T33.f1= _T34;});_T1B= _T33;}{struct _tuple14 _T33=_T1B;void*_T34;void*_T35;_T35= _T33.f0;_T34= _T33.f1;{void*nt1=_T35;void*nt4=_T34;
if(nt1!=t1)goto _TL2A;if(nt4!=t4)goto _TL2A;_T1C= t;
return _T1C;_TL2A:{struct Cyc_Port_Ptr_ct_Port_Ctype_struct*_T36=_cycalloc(sizeof(struct Cyc_Port_Ptr_ct_Port_Ctype_struct));_T36->tag= 11;
...
if(nt1!=t1)goto _TL2C;_T22= t;
return _T22;_TL2C:{struct Cyc_Port_Array_ct_Port_Ctype_struct*_T33=_cycalloc(sizeof(struct Cyc_Port_Array_ct_Port_Ctype_struct));_T33->tag= 12;
...
# 366
({__typeof__(Cyc_Port_inst(instenv,t1))_T34=Cyc_Port_inst(instenv,t1);_T33->f1= _T34;});_T28= Cyc_List_map_c;{struct Cyc_List_List*(*_T34)(void*(*)(struct Cyc_Dict_Dict*,void*),struct Cyc_Dict_Dict*,struct Cyc_List_List*)=(struct Cyc_List_List*(*)(void*(*)(struct Cyc_Dict_Dict*,void*),struct Cyc_Dict_Dict*,struct Cyc_List_List*))_T28;_T27= _T34;}_T29= instenv;_T2A= ts;({__typeof__(_T27(Cyc_Port_inst,_T29,_T2A))_T34=_T27(Cyc_Port_inst,_T29,_T2A);_T33->f2= _T34;});_T26= (struct Cyc_Port_Fn_ct_Port_Ctype_struct*)_T33;}_T2B= (void*)_T26;return _T2B;}};}
# 370
void*Cyc_Port_instantiate(void*t){struct Cyc_Dict_Dict*_T0;struct Cyc_Dict_Dict(*_T1)(int(*)(struct _fat_ptr*,struct _fat_ptr*));struct Cyc_Dict_Dict(*_T2)(int(*)(void*,void*));int(*_T3)(struct _fat_ptr*,struct _fat_ptr*);void*_T4;void*_T5;{struct Cyc_Dict_Dict*_T6=_cycalloc(sizeof(struct Cyc_Dict_Dict));_T2= Cyc_Dict_empty;{struct Cyc_Dict_Dict(*_T7)(int(*)(struct _fat_ptr*,struct _fat_ptr*))=(struct Cyc_Dict_Dict(*)(int(*)(struct _fat_ptr*,struct _fat_ptr*)))_T2;_T1= _T7;}_T3= Cyc_strptrcmp;({__typeof__(_T1(_T3))_T7=_T1(_T3);*_T6= _T7;});_T0= (struct Cyc_Dict_Dict*)_T6;}_T4= t;_T5= Cyc_Port_inst(_T0,_T4);return _T5;}
# 375
struct Cyc_List_List*Cyc_Port_filter_self(void*t,struct Cyc_List_List*ts){struct Cyc_List_List*_T0;unsigned _T1;struct Cyc_List_List*_T2;void*_T3;struct Cyc_List_List*_T4;long _T5;struct Cyc_List_List*_T6;void*_T7;struct Cyc_List_List*_T8;void*_T9;void*_TA;struct Cyc_List_List*_TB;struct Cyc_List_List*_TC;struct Cyc_List_List*_TD;struct Cyc_List_List*_TE;
long found=0;{
...
if(t!=t2)goto _TL32;
found= 1;goto _TL33;_TL32: _TL33:;}_T4= xs;
# 377
xs= _T4->tl;goto _TL31;_TL30:;}_T5= found;
# 382
if(_T5)goto _TL34;else{goto _TL36;}
_TL36: _T6= ts;return _T6;_TL34: {
...
return _TE;}}
# 395
void Cyc_Port_generalize(long is_rgn,void*t){void*_T0;int*_T1;unsigned _T2;void*_T3;struct Cyc_Port_Cvar*_T4;void*_T5;struct Cyc_Port_Cvar*_T6;struct Cyc_List_List*_T7;struct Cyc_Port_Cvar*_T8;void*_T9;struct Cyc_Port_Cvar*_TA;struct Cyc_List_List*_TB;long _TC;struct Cyc_Port_Cvar*_TD;struct Cyc_List_List*_TE;struct Cyc_Port_Cvar*_TF;struct Cyc_List_List*_T10;void*_T11;struct _fat_ptr*_T12;void*_T13;struct Cyc_Port_Cvar*_T14;struct Cyc_List_List*_T15;unsigned _T16;void*_T17;struct Cyc_Port_Cvar*_T18;struct Cyc_List_List*_T19;void*_T1A;void*_T1B;struct Cyc_Port_Cvar*_T1C;struct Cyc_List_List*_T1D;void*_T1E;void*_T1F;void*_T20;void*_T21;void*_T22;void*_T23;void*_T24;void*_T25;void*_T26;void*_T27;void*_T28;void*_T29;void*_T2A;void(*_T2B)(void(*)(long,void*),long,struct Cyc_List_List*);void(*_T2C)(void(*)(void*,void*),void*,struct Cyc_List_List*);struct Cyc_List_List*_T2D;
...
# 400
({__typeof__(Cyc_Port_filter_self(_T5,_T7))_T34=Cyc_Port_filter_self(_T5,_T7);_T4->uppers= _T34;});_T8= cv;_T9= t;_TA= cv;_TB= _TA->lowers;
({__typeof__(Cyc_Port_filter_self(_T9,_TB))_T34=Cyc_Port_filter_self(_T9,_TB);_T8->lowers= _T34;});_TC= is_rgn;
...
Cyc_Port_generalize(1,t4);goto _LL0;}case 12: _T25= t;{struct Cyc_Port_Array_ct_Port_Ctype_struct*_T34=(struct Cyc_Port_Array_ct_Port_Ctype_struct*)_T25;_T26= _T34->f1;_T33= (void*)_T26;_T27= _T34->f2;_T32= (void*)_T27;_T28= _T34->f3;_T31= (void*)_T28;}{void*t1=_T33;void*t2=_T32;void*t3=_T31;
# 440
Cyc_Port_generalize(0,t1);
Cyc_Port_generalize(0,t2);goto _LL0;}default: _T29= t;{struct Cyc_Port_Fn_ct_Port_Ctype_struct*_T34=(struct Cyc_Port_Fn_ct_Port_Ctype_struct*)_T29;_T2A= _T34->f1;_T33= (void*)_T2A;_T2E= _T34->f2;}{void*t1=_T33;struct Cyc_List_List*ts=_T2E;
# 444
Cyc_Port_generalize(0,t1);_T2C= Cyc_List_iter_c;{
void(*_T34)(void(*)(long,void*),long,struct Cyc_List_List*)=(void(*)(void(*)(long,void*),long,struct Cyc_List_List*))_T2C;_T2B= _T34;}_T2D= ts;_T2B(Cyc_Port_generalize,0,_T2D);goto _LL0;}}_LL0:;}}
# 452
static long Cyc_Port_occurs(void*v,void*t){void*_T0;int*_T1;unsigned _T2;void*_T3;void*_T4;void*_T5;void*_T6;void*_T7;void*_T8;int _T9;long _TA;long _TB;long _TC;long _TD;void*_TE;void*_TF;void*_T10;void*_T11;int _T12;long _T13;long _T14;void*_T15;void*_T16;long _T17;struct Cyc_List_List*_T18;unsigned _T19;void*_T1A;struct Cyc_List_List*_T1B;void*_T1C;long _T1D;struct Cyc_List_List*_T1E;void*_T1F;struct _tuple13*_T20;void*_T21;struct Cyc_List_List*_T22;unsigned _T23;void*_T24;struct Cyc_List_List*_T25;void*_T26;struct Cyc_Port_Cfield*_T27;void*_T28;long _T29;void*_T2A;struct Cyc_List_List*_T2B;void*_T2C;struct Cyc_Port_Cfield*_T2D;void*_T2E;long _T2F;struct Cyc_List_List*_T30;
t= Cyc_Port_compress_ct(t);
if(t!=v)goto _TL44;
return 1;_TL44: {struct Cyc_List_List*_T31;void*_T32;void*_T33;void*_T34;void*_T35;void*_T36;_T0= t;_T1= (int*)_T0;_T2= *_T1;switch(_T2){case 11: _T3= t;{struct Cyc_Port_Ptr_ct_Port_Ctype_struct*_T37=(struct Cyc_Port_Ptr_ct_Port_Ctype_struct*)_T3;_T4= _T37->f1;_T36= (void*)_T4;_T5= _T37->f2;_T35= (void*)_T5;_T6= _T37->f3;_T34= (void*)_T6;_T7= _T37->f4;_T33= (void*)_T7;_T8= _T37->f5;_T32= (void*)_T8;}{void*t1=_T36;void*t2=_T35;void*t3=_T34;void*t4=_T33;void*t5=_T32;_TA= 
# 458
Cyc_Port_occurs(v,t1);if(_TA)goto _TL49;else{goto _TL4C;}_TL4C: _TB= Cyc_Port_occurs(v,t2);if(_TB)goto _TL49;else{goto _TL4B;}_TL4B: _TC= Cyc_Port_occurs(v,t3);if(_TC)goto _TL49;else{goto _TL4A;}_TL4A: _TD= Cyc_Port_occurs(v,t4);if(_TD)goto _TL49;else{goto _TL47;}_TL49: _T9= 1;goto _TL48;_TL47: _T9= Cyc_Port_occurs(v,t5);_TL48: return _T9;}case 12: _TE= t;{struct Cyc_Port_Array_ct_Port_Ctype_struct*_T37=(struct Cyc_Port_Array_ct_Port_Ctype_struct*)_TE;_TF= _T37->f1;_T36= (void*)_TF;_T10= _T37->f2;_T35= (void*)_T10;_T11= _T37->f3;_T34= (void*)_T11;}{void*t1=_T36;void*t2=_T35;void*t3=_T34;_T13= 
# 460
...
# 462
Cyc_Port_occurs(v,t);if(!_T17)goto _TL51;
return 1;_TL51:
 _TL56: _T18= ts;_T19= (unsigned)_T18;if(_T19)goto _TL54;else{goto _TL55;}
_TL54: _T1A= v;_T1B= ts;_T1C= _T1B->hd;_T1D= Cyc_Port_occurs(_T1A,_T1C);if(!_T1D)goto _TL57;
return 1;_TL57: _T1E= ts;
# 464
ts= _T1E->tl;goto _TL56;_TL55:
# 467
 return 0;}case 13: _T1F= t;{struct Cyc_Port_KnownAggr_ct_Port_Ctype_struct*_T37=(struct Cyc_Port_KnownAggr_ct_Port_Ctype_struct*)_T1F;_T20= _T37->f1;{struct _tuple13 _T38=*_T20;_T31= _T38.f1;}}{struct Cyc_List_List*fs=_T31;
# 469
...
_TL5A: _T24= v;_T25= fs;_T26= _T25->hd;_T27= (struct Cyc_Port_Cfield*)_T26;_T28= _T27->qual;_T29= Cyc_Port_occurs(_T24,_T28);if(_T29)goto _TL5F;else{goto _TL60;}_TL60: _T2A= v;_T2B= fs;_T2C= _T2B->hd;_T2D= (struct Cyc_Port_Cfield*)_T2C;_T2E= _T2D->type;_T2F= Cyc_Port_occurs(_T2A,_T2E);if(_T2F)goto _TL5F;else{goto _TL5D;}
...
static struct Cyc_List_List*Cyc_Port_merge_fields(struct Cyc_List_List*,struct Cyc_List_List*,long);
# 490
static void Cyc_Port_unify_ct(void*t1,void*t2){struct _tuple14 _T0;void*_T1;int*_T2;int _T3;void*_T4;long _T5;void*_T6;struct Cyc_Port_Cvar*_T7;struct Cyc_List_List*_T8;struct Cyc_List_List*_T9;unsigned _TA;void*_TB;struct Cyc_List_List*_TC;void*_TD;long _TE;struct Cyc_Port_Unify_ct_exn_struct*_TF;struct Cyc_Port_Unify_ct_exn_struct*_T10;struct Cyc_List_List*_T11;void*_T12;struct Cyc_Port_Cvar*_T13;struct Cyc_List_List*_T14;struct Cyc_List_List*_T15;unsigned _T16;struct Cyc_List_List*_T17;void*_T18;void*_T19;long _T1A;struct Cyc_Port_Unify_ct_exn_struct*_T1B;struct Cyc_Port_Unify_ct_exn_struct*_T1C;struct Cyc_List_List*_T1D;struct Cyc_Port_Cvar*_T1E;void**_T1F;struct Cyc_Port_Unify_ct_exn_struct*_T20;struct Cyc_Port_Unify_ct_exn_struct*_T21;void*_T22;int*_T23;int _T24;void*_T25;void*_T26;int*_T27;unsigned _T28;void*_T29;int*_T2A;int _T2B;void*_T2C;void*_T2D;void*_T2E;void*_T2F;void*_T30;void*_T31;void*_T32;void*_T33;void*_T34;void*_T35;void*_T36;void*_T37;void*_T38;int*_T39;int _T3A;void*_T3B;struct _fat_ptr*_T3C;void*_T3D;struct _fat_ptr*_T3E;int _T3F;struct Cyc_Port_Unify_ct_exn_struct*_T40;struct Cyc_Port_Unify_ct_exn_struct*_T41;void*_T42;int*_T43;int _T44;void*_T45;void*_T46;void*_T47;void*_T48;void*_T49;void*_T4A;void*_T4B;void*_T4C;void*_T4D;int*_T4E;int _T4F;void*_T50;void*_T51;void*_T52;void*_T53;void*_T54;int*_T55;unsigned _T56;void*_T57;void*_T58;struct Cyc_Port_Unify_ct_exn_struct*_T59;struct Cyc_Port_Unify_ct_exn_struct*_T5A;void*_T5B;struct _tuple13*_T5C;void*_T5D;void*_T5E;struct Cyc_Port_UnknownAggr_ct_Port_Ctype_struct*_T5F;void***_T60;void***_T61;void**_T62;void*_T63;int*_T64;unsigned _T65;void*_T66;void*_T67;struct Cyc_Port_UnknownAggr_ct_Port_Ctype_struct*_T68;void***_T69;void*_T6A;void*_T6B;struct Cyc_Port_UnknownAggr_ct_Port_Ctype_struct*_T6C;void***_T6D;struct Cyc_List_List*_T6E;void***_T6F;void***_T70;void**_T71;void*_T72;void*_T73;struct Cyc_Port_UnknownAggr_ct_Port_Ctype_struct*_T74;void***_T75;void*_T76;struct _tuple13*_T77;void***_T78;void**_T79;struct Cyc_Port_Unify_ct_exn_struct*_T7A;struct Cyc_Port_Unify_ct_exn_struct*_T7B;
t1= Cyc_Port_compress_ct(t1);
t2= Cyc_Port_compress_ct(t2);
if(t1!=t2)goto _TL61;
return;_TL61:{struct _tuple14 _T7C;
_T7C.f0= t1;_T7C.f1= t2;_T0= _T7C;}{struct _tuple14 _T7C=_T0;struct Cyc_Absyn_Aggrdecl*_T7D;struct Cyc_List_List*_T7E;struct Cyc_List_List*_T7F;struct _fat_ptr _T80;struct _fat_ptr _T81;void*_T82;void*_T83;void*_T84;void*_T85;void*_T86;void*_T87;void*_T88;void*_T89;void*_T8A;void*_T8B;_T1= _T7C.f0;_T2= (int*)_T1;_T3= *_T2;if(_T3!=16)goto _TL63;_T4= _T7C.f0;{struct Cyc_Port_Var_ct_Port_Ctype_struct*_T8C=(struct Cyc_Port_Var_ct_Port_Ctype_struct*)_T4;_T8B= _T8C->f1;}{struct Cyc_Port_Cvar*v1=_T8B;_T5= 
# 497
...
_TL69: _TB= t2;_TC= us;_TD= _TC->hd;_TE= Cyc_Port_leq(_TB,_TD);if(_TE)goto _TL6C;else{goto _TL6E;}
_TL6E: _TF= & Cyc_Port_Unify_ct_val;_T10= (struct Cyc_Port_Unify_ct_exn_struct*)_TF;_throw(_T10);goto _TL6D;_TL6C: _TL6D: _T11= us;
# 500
...
_TL70: _T17= ls;_T18= _T17->hd;_T19= t2;_T1A= Cyc_Port_leq(_T18,_T19);if(_T1A)goto _TL73;else{goto _TL75;}
_TL75: _T1B= & Cyc_Port_Unify_ct_val;_T1C= (struct Cyc_Port_Unify_ct_exn_struct*)_T1B;_throw(_T1C);goto _TL74;_TL73: _TL74: _T1D= ls;
# 503
...
return;}_TL76: _T26= _T7C.f0;_T27= (int*)_T26;_T28= *_T27;switch(_T28){case 11: _T29= _T7C.f1;_T2A= (int*)_T29;_T2B= *_T2A;if(_T2B!=11)goto _TL79;_T2C= _T7C.f0;{struct Cyc_Port_Ptr_ct_Port_Ctype_struct*_T8C=(struct Cyc_Port_Ptr_ct_Port_Ctype_struct*)_T2C;_T2D= _T8C->f1;_T8B= (void*)_T2D;_T2E= _T8C->f2;_T8A= (void*)_T2E;_T2F= _T8C->f3;_T89= (void*)_T2F;_T30= _T8C->f4;_T88= (void*)_T30;_T31= _T8C->f5;_T87= (void*)_T31;}_T32= _T7C.f1;{struct Cyc_Port_Ptr_ct_Port_Ctype_struct*_T8C=(struct Cyc_Port_Ptr_ct_Port_Ctype_struct*)_T32;_T33= _T8C->f1;_T86= (void*)_T33;_T34= _T8C->f2;_T85= (void*)_T34;_T35= _T8C->f3;_T84= (void*)_T35;_T36= _T8C->f4;_T83= (void*)_T36;_T37= _T8C->f5;_T82= (void*)_T37;}{void*e1=_T8B;void*q1=_T8A;void*k1=_T89;void*r1=_T88;void*zt1=_T87;void*e2=_T86;void*q2=_T85;void*k2=_T84;void*r2=_T83;void*zt2=_T82;
# 514
...
Cyc_Port_unify_ct(q1,q2);
Cyc_Port_unify_ct(zt1,zt2);
return;}_TL7F: goto _LL15;case 15: _T4D= _T7C.f1;_T4E= (int*)_T4D;_T4F= *_T4E;if(_T4F!=15)goto _TL81;_T50= _T7C.f0;{struct Cyc_Port_Fn_ct_Port_Ctype_struct*_T8C=(struct Cyc_Port_Fn_ct_Port_Ctype_struct*)_T50;_T51= _T8C->f1;_T8B= (void*)_T51;_T8A= _T8C->f2;}_T52= _T7C.f1;{struct Cyc_Port_Fn_ct_Port_Ctype_struct*_T8C=(struct Cyc_Port_Fn_ct_Port_Ctype_struct*)_T52;_T53= _T8C->f1;_T89= (void*)_T53;_T7F= _T8C->f2;}{void*t1=_T8B;struct Cyc_List_List*ts1=_T8A;void*t2=_T89;struct Cyc_List_List*ts2=_T7F;
# 530
Cyc_Port_unify_ct(t1,t2);
Cyc_Port_unify_cts(ts1,ts2);
return;}_TL81: goto _LL15;case 13: _T54= _T7C.f1;_T55= (int*)_T54;_T56= *_T55;switch(_T56){case 13: _T57= _T7C.f0;{struct Cyc_Port_KnownAggr_ct_Port_Ctype_struct*_T8C=(struct Cyc_Port_KnownAggr_ct_Port_Ctype_struct*)_T57;_T8B= _T8C->f1;}_T58= _T7C.f1;{struct Cyc_Port_KnownAggr_ct_Port_Ctype_struct*_T8C=(struct Cyc_Port_KnownAggr_ct_Port_Ctype_struct*)_T58;_T8A= _T8C->f1;}{struct _tuple13*p1=_T8B;struct _tuple13*p2=_T8A;
# 534
if(p1!=p2)goto _TL84;
return;
# 537
_TL84: _T59= & Cyc_Port_Unify_ct_val;_T5A= (struct Cyc_Port_Unify_ct_exn_struct*)_T59;_throw(_T5A);;}case 14: _T5B= _T7C.f0;{struct Cyc_Port_KnownAggr_ct_Port_Ctype_struct*_T8C=(struct Cyc_Port_KnownAggr_ct_Port_Ctype_struct*)_T5B;_T5C= _T8C->f1;{struct _tuple13 _T8D=*_T5C;_T8B= _T8D.f0;_T7F= _T8D.f1;}}_T5D= _T7C.f1;{struct Cyc_Port_UnknownAggr_ct_Port_Ctype_struct*_T8C=(struct Cyc_Port_UnknownAggr_ct_Port_Ctype_struct*)_T5D;_T7E= _T8C->f1;_T5E= _T7C.f1;_T5F= (struct Cyc_Port_UnknownAggr_ct_Port_Ctype_struct*)_T5E;_T60= & _T5F->f2;_T8A= (void***)_T60;}{struct Cyc_Absyn_Aggrdecl*ad=_T8B;struct Cyc_List_List*fs2=_T7F;struct Cyc_List_List*fs1=_T7E;void***eq=_T8A;
# 547
...
# 565
static struct Cyc_List_List*Cyc_Port_merge_fields(struct Cyc_List_List*fs1,struct Cyc_List_List*fs2,long allow_f1_subset_f2){struct Cyc_List_List*_T0;unsigned _T1;struct Cyc_List_List*_T2;void*_T3;struct Cyc_List_List*_T4;unsigned _T5;struct Cyc_List_List*_T6;void*_T7;struct Cyc_Port_Cfield*_T8;struct _fat_ptr*_T9;struct Cyc_Port_Cfield*_TA;struct _fat_ptr*_TB;int _TC;struct Cyc_List_List*_TD;struct Cyc_Port_Cfield*_TE;void*_TF;struct Cyc_Port_Cfield*_T10;void*_T11;struct Cyc_Port_Cfield*_T12;void*_T13;struct Cyc_Port_Cfield*_T14;void*_T15;struct Cyc_List_List*_T16;long _T17;long _T18;struct Cyc_List_List*_T19;struct Cyc_Port_Unify_ct_exn_struct*_T1A;struct Cyc_Port_Unify_ct_exn_struct*_T1B;struct Cyc_List_List*_T1C;struct Cyc_List_List*_T1D;unsigned _T1E;struct Cyc_List_List*_T1F;void*_T20;struct Cyc_List_List*_T21;unsigned _T22;struct Cyc_List_List*_T23;void*_T24;struct Cyc_Port_Cfield*_T25;struct _fat_ptr*_T26;struct Cyc_Port_Cfield*_T27;struct _fat_ptr*_T28;int _T29;struct Cyc_List_List*_T2A;long _T2B;struct Cyc_List_List*_T2C;struct Cyc_List_List*_T2D;struct Cyc_List_List*_T2E;
...
Cyc_strptrcmp(_T26,_T28);if(!_T29)goto _TLA7;
found= 1;goto _TLA8;_TLA7: _TLA8:;}_T2A= xs2;
# 590
...
return _T2E;}
# 601
static long Cyc_Port_unifies(void*t1,void*t2){struct _handler_cons*_T0;int _T1;void*_T2;struct Cyc_Port_Unify_ct_exn_struct*_T3;char*_T4;char*_T5;{struct _handler_cons _T6;_T0= & _T6;_push_handler(_T0);{int _T7=0;_T1= setjmp(_T6.handler);if(!_T1)goto _TLAC;_T7= 1;goto _TLAD;_TLAC: _TLAD: if(_T7)goto _TLAE;else{goto _TLB0;}_TLB0:
# 607
...
# 615
return 1;}struct _tuple15{void*f0;void*f1;void*f2;void*f3;void*f4;};
# 621
static struct Cyc_List_List*Cyc_Port_insert_upper(void*v,void*t,struct Cyc_List_List**uppers){void*_T0;int*_T1;unsigned _T2;struct Cyc_List_List**_T3;struct Cyc_List_List**_T4;struct Cyc_List_List*_T5;struct Cyc_List_List**_T6;struct Cyc_List_List*_T7;struct Cyc_List_List**_T8;struct Cyc_List_List*_T9;unsigned _TA;struct Cyc_List_List*_TB;void*_TC;struct Cyc_List_List**_TD;struct Cyc_List_List*_TE;struct _tuple14 _TF;void*_T10;int*_T11;unsigned _T12;void*_T13;int*_T14;unsigned _T15;struct Cyc_List_List**_T16;struct Cyc_List_List*_T17;void*_T18;int*_T19;int _T1A;void*_T1B;void*_T1C;void*_T1D;void*_T1E;void*_T1F;void*_T20;void*_T21;void*_T22;void*_T23;void*_T24;void*_T25;void*_T26;struct _tuple15 _T27;struct Cyc_Port_Ptr_ct_Port_Ctype_struct*_T28;struct Cyc_Port_Ptr_ct_Port_Ctype_struct*_T29;struct Cyc_Port_Ptr_ct_Port_Ctype_struct*_T2A;struct Cyc_Port_Ptr_ct_Port_Ctype_struct*_T2B;struct Cyc_Port_Ptr_ct_Port_Ctype_struct*_T2C;struct Cyc_Port_Ptr_ct_Port_Ctype_struct*_T2D;struct Cyc_List_List*_T2E;struct Cyc_Port_Ptr_ct_Port_Ctype_struct*_T2F;void*_T30;struct Cyc_List_List**_T31;struct Cyc_List_List*_T32;struct Cyc_List_List*_T33;struct Cyc_List_List*_T34;struct Cyc_List_List**_T35;
...
# 653
if(t!=t2)goto _TLB8;_TD= uppers;_TE= *_TD;
return _TE;_TLB8:{struct _tuple14 _T36;
_T36.f0= t;_T36.f1= t2;_TF= _T36;}{struct _tuple14 _T36=_TF;void*_T37;void*_T38;void*_T39;void*_T3A;void*_T3B;void*_T3C;void*_T3D;void*_T3E;void*_T3F;void*_T40;_T10= _T36.f0;_T11= (int*)_T10;_T12= *_T11;switch(_T12){case 6: _T13= _T36.f1;_T14= (int*)_T13;_T15= *_T14;switch(_T15){case 11: goto _LL1F;case 5: _LL1F: goto _LL21;case 12: _LL21: _T16= uppers;_T17= *_T16;
# 662
return _T17;default: goto _LL24;};case 11: _T18= _T36.f1;_T19= (int*)_T18;_T1A= *_T19;if(_T1A!=11)goto _TLBC;_T1B= _T36.f0;{struct Cyc_Port_Ptr_ct_Port_Ctype_struct*_T41=(struct Cyc_Port_Ptr_ct_Port_Ctype_struct*)_T1B;_T1C= _T41->f1;_T40= (void*)_T1C;_T1D= _T41->f2;_T3F= (void*)_T1D;_T1E= _T41->f3;_T3E= (void*)_T1E;_T1F= _T41->f4;_T3D= (void*)_T1F;_T20= _T41->f5;_T3C= (void*)_T20;}_T21= _T36.f1;{struct Cyc_Port_Ptr_ct_Port_Ctype_struct*_T41=(struct Cyc_Port_Ptr_ct_Port_Ctype_struct*)_T21;_T22= _T41->f1;_T3B= (void*)_T22;_T23= _T41->f2;_T3A= (void*)_T23;_T24= _T41->f3;_T39= (void*)_T24;_T25= _T41->f4;_T38= (void*)_T25;_T26= _T41->f5;_T37= (void*)_T26;}{void*ta=_T40;void*qa=_T3F;void*ka=_T3E;void*ra=_T3D;void*za=_T3C;void*tb=_T3B;void*qb=_T3A;void*kb=_T39;void*rb=_T38;void*zb=_T37;{struct _tuple15 _T41;
# 667
({__typeof__(Cyc_Port_var())_T42=Cyc_Port_var();_T41.f0= _T42;});({__typeof__(Cyc_Port_var())_T42=Cyc_Port_var();_T41.f1= _T42;});({__typeof__(Cyc_Port_var())_T42=Cyc_Port_var();_T41.f2= _T42;});({__typeof__(Cyc_Port_var())_T42=Cyc_Port_var();_T41.f3= _T42;});({__typeof__(Cyc_Port_var())_T42=Cyc_Port_var();_T41.f4= _T42;});_T27= _T41;}{struct _tuple15 _T41=_T27;void*_T42;void*_T43;void*_T44;void*_T45;void*_T46;_T46= _T41.f0;_T45= _T41.f1;_T44= _T41.f2;_T43= _T41.f3;_T42= _T41.f4;{void*tc=_T46;void*qc=_T45;void*kc=_T44;void*rc=_T43;void*zc=_T42;
...
Cyc_Port_leq(rc,rb);
Cyc_Port_leq(zc,za);
Cyc_Port_leq(zc,zb);_T2E= us;_T2F= p;_T30= (void*)_T2F;
...
# 690
static struct Cyc_List_List*Cyc_Port_insert_lower(void*v,void*t,struct Cyc_List_List**lowers){void*_T0;int*_T1;unsigned _T2;struct Cyc_List_List**_T3;struct Cyc_List_List**_T4;struct Cyc_List_List*_T5;struct Cyc_List_List**_T6;struct Cyc_List_List*_T7;struct Cyc_List_List**_T8;struct Cyc_List_List*_T9;unsigned _TA;struct Cyc_List_List*_TB;void*_TC;struct Cyc_List_List**_TD;struct Cyc_List_List*_TE;struct _tuple14 _TF;void*_T10;int*_T11;int _T12;void*_T13;int*_T14;unsigned _T15;void*_T16;int*_T17;unsigned _T18;void*_T19;int*_T1A;unsigned _T1B;void*_T1C;void*_T1D;void*_T1E;void*_T1F;void*_T20;void*_T21;void*_T22;void*_T23;void*_T24;void*_T25;void*_T26;void*_T27;struct _tuple15 _T28;struct Cyc_Port_Ptr_ct_Port_Ctype_struct*_T29;struct Cyc_Port_Ptr_ct_Port_Ctype_struct*_T2A;struct Cyc_Port_Ptr_ct_Port_Ctype_struct*_T2B;struct Cyc_Port_Ptr_ct_Port_Ctype_struct*_T2C;struct Cyc_Port_Ptr_ct_Port_Ctype_struct*_T2D;struct Cyc_Port_Ptr_ct_Port_Ctype_struct*_T2E;struct Cyc_List_List*_T2F;struct Cyc_Port_Ptr_ct_Port_Ctype_struct*_T30;void*_T31;struct Cyc_List_List**_T32;struct Cyc_List_List*_T33;void*_T34;int*_T35;int _T36;struct Cyc_List_List**_T37;struct Cyc_List_List*_T38;struct Cyc_List_List*_T39;struct Cyc_List_List*_T3A;struct Cyc_List_List**_T3B;
...
Cyc_Port_leq(rb,rc);
Cyc_Port_leq(za,zc);
Cyc_Port_leq(zb,zc);_T2F= ls;_T30= p;_T31= (void*)_T30;
...
# 801
({__typeof__(Cyc_Port_filter_self(_T21,_T23))_T8E=Cyc_Port_filter_self(_T21,_T23);_T20->uppers= _T8E;});_T24= v2;_T25= t2;_T26= v2;_T27= _T26->lowers;
({__typeof__(Cyc_Port_filter_self(_T25,_T27))_T8E=Cyc_Port_filter_self(_T25,_T27);_T24->lowers= _T8E;});_T28= v1;_T29= t1;_T2A= t2;_T2B= v1;_T2C= & _T2B->uppers;
({__typeof__(Cyc_Port_insert_upper(_T29,_T2A,_T2C))_T8E=Cyc_Port_insert_upper(_T29,_T2A,_T2C);_T28->uppers= _T8E;});_T2D= v2;_T2E= t2;_T2F= t1;_T30= v2;_T31= & _T30->lowers;
({__typeof__(Cyc_Port_insert_lower(_T2E,_T2F,_T31))_T8E=Cyc_Port_insert_lower(_T2E,_T2F,_T31);_T2D->lowers= _T8E;});
...
# 807
({__typeof__(Cyc_Port_filter_self(_T34,_T36))_T8E=Cyc_Port_filter_self(_T34,_T36);_T33->uppers= _T8E;});_T37= v1;_T38= t1;_T39= t2;_T3A= v1;_T3B= & _T3A->uppers;
({__typeof__(Cyc_Port_insert_upper(_T38,_T39,_T3B))_T8E=Cyc_Port_insert_upper(_T38,_T39,_T3B);_T37->uppers= _T8E;});
return 1;}};case 4:
# 779
...
# 795
Cyc_Port_leq(t1,t2);if(!_T4F)goto _TLD7;_T50= Cyc_Port_leq(q1,q2);if(!_T50)goto _TLD7;_T51= Cyc_Port_unifies(k1,k2);if(!_T51)goto _TLD7;_T52= Cyc_Port_leq(r1,r2);if(!_T52)goto _TLD7;_T4E= Cyc_Port_leq(z1,z2);goto _TLD8;_TLD7: _T4E= 0;_TLD8: return _T4E;}case 16: goto _LL2D;default: goto _LL2F;};case 12: _T53= _T80.f1;_T54= (int*)_T53;_T55= *_T54;switch(_T55){case 6:
# 791
 return 1;case 4:
# 793
...
# 799
Cyc_Port_leq(t1,t2);if(!_T6B)goto _TLDC;_T6C= Cyc_Port_leq(q1,q2);if(!_T6C)goto _TLDC;_T6D= & Cyc_Port_Fat_ct_val;_T6E= (struct Cyc_Port_Fat_ct_Port_Ctype_struct*)_T6D;_T6F= (void*)_T6E;_T70= k2;_T71= Cyc_Port_unifies(_T6F,_T70);if(!_T71)goto _TLDC;_T6A= Cyc_Port_leq(z1,z2);goto _TLDD;_TLDC: _T6A= 0;_TLDD: return _T6A;}case 16: goto _LL2D;default: goto _LL2F;};default: _T72= _T80.f1;_T73= (int*)_T72;_T74= *_T73;if(_T74!=16)goto _TLDE;_LL2D: _T75= _T80.f1;{struct Cyc_Port_Var_ct_Port_Ctype_struct*_T8E=(struct Cyc_Port_Var_ct_Port_Ctype_struct*)_T75;_T81= _T8E->f1;}{struct Cyc_Port_Cvar*v2=_T81;_T76= v2;_T77= t2;_T78= v2;_T79= _T78->lowers;
# 811
({__typeof__(Cyc_Port_filter_self(_T77,_T79))_T8E=Cyc_Port_filter_self(_T77,_T79);_T76->lowers= _T8E;});_T7A= v2;_T7B= t2;_T7C= t1;_T7D= v2;_T7E= & _T7D->lowers;
({__typeof__(Cyc_Port_insert_lower(_T7B,_T7C,_T7E))_T8E=Cyc_Port_insert_lower(_T7B,_T7C,_T7E);_T7A->lowers= _T8E;});
return 1;}_TLDE: _LL2F: _T7F= 
# 815
Cyc_Port_unifies(t1,t2);return _T7F;};}}struct Cyc_Port_GlobalCenv{struct Cyc_Dict_Dict typedef_dict;struct Cyc_Dict_Dict struct_dict;struct Cyc_Dict_Dict union_dict;void*return_type;struct Cyc_List_List*qualifier_edits;struct Cyc_List_List*pointer_edits;struct Cyc_List_List*zeroterm_edits;struct Cyc_List_List*vardecl_locs;struct Cyc_Hashtable_Table*varusage_tab;struct Cyc_List_List*edits;long porting;};
# 846
...
struct Cyc_Port_GlobalCenv*g;g= _cycalloc(sizeof(struct Cyc_Port_GlobalCenv));_T0= g;_T2= Cyc_Dict_empty;{struct Cyc_Dict_Dict(*_T1A)(int(*)(struct _tuple0*,struct _tuple0*))=(struct Cyc_Dict_Dict(*)(int(*)(struct _tuple0*,struct _tuple0*)))_T2;_T1= _T1A;}_T3= Cyc_Absyn_qvar_cmp;({__typeof__(_T1(_T3))_T1A=_T1(_T3);_T0->typedef_dict= _T1A;});_T4= g;_T6= Cyc_Dict_empty;{
struct Cyc_Dict_Dict(*_T1A)(int(*)(struct _tuple0*,struct _tuple0*))=(struct Cyc_Dict_Dict(*)(int(*)(struct _tuple0*,struct _tuple0*)))_T6;_T5= _T1A;}_T7= Cyc_Absyn_qvar_cmp;({__typeof__(_T5(_T7))_T1A=_T5(_T7);_T4->struct_dict= _T1A;});_T8= g;_TA= Cyc_Dict_empty;{
struct Cyc_Dict_Dict(*_T1A)(int(*)(struct _tuple0*,struct _tuple0*))=(struct Cyc_Dict_Dict(*)(int(*)(struct _tuple0*,struct _tuple0*)))_TA;_T9= _T1A;}_TB= Cyc_Absyn_qvar_cmp;({__typeof__(_T9(_TB))_T1A=_T9(_TB);_T8->union_dict= _T1A;});_TC= g;
...
struct Cyc_Hashtable_Table*(*_T1A)(int,int(*)(unsigned,unsigned),int(*)(unsigned))=(struct Cyc_Hashtable_Table*(*)(int,int(*)(unsigned,unsigned),int(*)(unsigned)))_T12;_T11= _T1A;}({__typeof__(_T11(128,Cyc_Port_cmp_seg_t,Cyc_Port_hash_seg_t))_T1A=_T11(128,Cyc_Port_cmp_seg_t,Cyc_Port_hash_seg_t);_T10->varusage_tab= _T1A;});_T13= g;
_T13->edits= 0;_T14= g;
_T14->porting= 0;_T15= g;
({__typeof__(Cyc_Port_void_ct())_T1A=Cyc_Port_void_ct();_T15->return_type= _T1A;});{struct Cyc_Port_Cenv*_T1A=_cycalloc(sizeof(struct Cyc_Port_Cenv));
_T1A->gcenv= g;_T1A->cpos= 3U;_T18= Cyc_Dict_empty;{struct Cyc_Dict_Dict(*_T1B)(int(*)(struct _tuple0*,struct _tuple0*))=(struct Cyc_Dict_Dict(*)(int(*)(struct _tuple0*,struct _tuple0*)))_T18;_T17= _T1B;}_T19= Cyc_Absyn_qvar_cmp;({__typeof__(_T17(_T19))_T1B=_T17(_T19);_T1A->var_dict= _T1B;});_T16= (struct Cyc_Port_Cenv*)_T1A;}return _T16;}
# 877
static long Cyc_Port_in_fn_arg(struct Cyc_Port_Cenv*env){struct Cyc_Port_Cenv*_T0;enum Cyc_Port_CPos _T1;int _T2;int _T3;_T0= env;_T1= _T0->cpos;_T2= (int)_T1;_T3= _T2==1;return _T3;}
static long Cyc_Port_in_fn_res(struct Cyc_Port_Cenv*env){struct Cyc_Port_Cenv*_T0;enum Cyc_Port_CPos _T1;int _T2;int _T3;_T0= env;_T1= _T0->cpos;_T2= (int)_T1;_T3= _T2==0;return _T3;}
static long Cyc_Port_in_toplevel(struct Cyc_Port_Cenv*env){struct Cyc_Port_Cenv*_T0;enum Cyc_Port_CPos _T1;int _T2;int _T3;_T0= env;_T1= _T0->cpos;_T2= (int)_T1;_T3= _T2==3;return _T3;}
static void*Cyc_Port_lookup_return_type(struct Cyc_Port_Cenv*env){struct Cyc_Port_Cenv*_T0;struct Cyc_Port_GlobalCenv*_T1;void*_T2;_T0= env;_T1= _T0->gcenv;_T2= _T1->return_type;return _T2;}
static void*Cyc_Port_lookup_typedef(struct Cyc_Port_Cenv*env,struct _tuple0*n){struct _handler_cons*_T0;int _T1;struct _tuple14*(*_T2)(struct Cyc_Dict_Dict,struct _tuple0*);void*(*_T3)(struct Cyc_Dict_Dict,void*);struct Cyc_Port_Cenv*_T4;struct Cyc_Port_GlobalCenv*_T5;struct Cyc_Dict_Dict _T6;struct _tuple0*_T7;struct _tuple14*_T8;void*_T9;struct Cyc_Dict_Absent_exn_struct*_TA;char*_TB;char*_TC;void*_TD;struct _handler_cons _TE;_T0= & _TE;_push_handler(_T0);{int _TF=0;_T1= setjmp(_TE.handler);if(!_T1)goto _TLE0;_TF= 1;goto _TLE1;_TLE0: _TLE1: if(_TF)goto _TLE2;else{goto _TLE4;}_TLE4: _T3= Cyc_Dict_lookup;{
# 883
struct _tuple14*(*_T10)(struct Cyc_Dict_Dict,struct _tuple0*)=(struct _tuple14*(*)(struct Cyc_Dict_Dict,struct _tuple0*))_T3;_T2= _T10;}_T4= env;_T5= _T4->gcenv;_T6= _T5->typedef_dict;_T7= n;_T8= _T2(_T6,_T7);{struct _tuple14 _T10=*_T8;void*_T11;_T11= _T10.f0;{void*t=_T11;void*_T12=t;_npop_handler(0);return _T12;}}_pop_handler();goto _TLE3;_TLE2: _T9= Cyc_Core_get_exn_thrown();{void*_T10=(void*)_T9;void*_T11;_TA= (struct Cyc_Dict_Absent_exn_struct*)_T10;_TB= _TA->tag;_TC= Cyc_Dict_Absent;if(_TB!=_TC)goto _TLE5;_TD= Cyc_Absyn_sint_type;
# 890
return _TD;_TLE5: _T11= _T10;{void*exn=_T11;_rethrow(exn);};}_TLE3:;}}
# 895
static void*Cyc_Port_lookup_typedef_ctype(struct Cyc_Port_Cenv*env,struct _tuple0*n){struct _handler_cons*_T0;int _T1;struct _tuple14*(*_T2)(struct Cyc_Dict_Dict,struct _tuple0*);void*(*_T3)(struct Cyc_Dict_Dict,void*);struct Cyc_Port_Cenv*_T4;struct Cyc_Port_GlobalCenv*_T5;struct Cyc_Dict_Dict _T6;struct _tuple0*_T7;struct _tuple14*_T8;void*_T9;struct Cyc_Dict_Absent_exn_struct*_TA;char*_TB;char*_TC;void*_TD;struct _handler_cons _TE;_T0= & _TE;_push_handler(_T0);{int _TF=0;_T1= setjmp(_TE.handler);if(!_T1)goto _TLE7;_TF= 1;goto _TLE8;_TLE7: _TLE8: if(_TF)goto _TLE9;else{goto _TLEB;}_TLEB: _T3= Cyc_Dict_lookup;{
# 897
struct _tuple14*(*_T10)(struct Cyc_Dict_Dict,struct _tuple0*)=(struct _tuple14*(*)(struct Cyc_Dict_Dict,struct _tuple0*))_T3;_T2= _T10;}_T4= env;_T5= _T4->gcenv;_T6= _T5->typedef_dict;_T7= n;_T8= _T2(_T6,_T7);{struct _tuple14 _T10=*_T8;void*_T11;_T11= _T10.f1;{void*ct=_T11;void*_T12=ct;_npop_handler(0);return _T12;}}_pop_handler();goto _TLEA;_TLE9: _T9= Cyc_Core_get_exn_thrown();{void*_T10=(void*)_T9;void*_T11;_TA= (struct Cyc_Dict_Absent_exn_struct*)_T10;_TB= _TA->tag;_TC= Cyc_Dict_Absent;if(_TB!=_TC)goto _TLEC;_TD= 
# 904
Cyc_Port_var();return _TD;_TLEC: _T11= _T10;{void*exn=_T11;_rethrow(exn);};}_TLEA:;}}
# 910
static struct _tuple13*Cyc_Port_lookup_struct_decl(struct Cyc_Port_Cenv*env,struct _tuple0*n){struct _tuple13**(*_T0)(struct Cyc_Dict_Dict,struct _tuple0*);void**(*_T1)(struct Cyc_Dict_Dict,void*);struct Cyc_Port_Cenv*_T2;struct Cyc_Port_GlobalCenv*_T3;struct Cyc_Dict_Dict _T4;struct _tuple0*_T5;struct _tuple13**_T6;unsigned _T7;struct _tuple13**_T8;struct _tuple13*_T9;struct Cyc_Absyn_Aggrdecl*_TA;struct Cyc_Absyn_Aggrdecl*_TB;struct Cyc_Absyn_Aggrdecl*_TC;struct Cyc_Absyn_Aggrdecl*_TD;struct Cyc_Absyn_Aggrdecl*_TE;struct Cyc_Absyn_Aggrdecl*_TF;struct Cyc_Absyn_Aggrdecl*_T10;struct _tuple13*_T11;struct _tuple13*_T12;struct Cyc_Port_Cenv*_T13;struct Cyc_Port_GlobalCenv*_T14;struct Cyc_Dict_Dict(*_T15)(struct Cyc_Dict_Dict,struct _tuple0*,struct _tuple13*);struct Cyc_Dict_Dict(*_T16)(struct Cyc_Dict_Dict,void*,void*);struct Cyc_Port_Cenv*_T17;struct Cyc_Port_GlobalCenv*_T18;struct Cyc_Dict_Dict _T19;struct _tuple0*_T1A;struct _tuple13*_T1B;struct _tuple13*_T1C;_T1= Cyc_Dict_lookup_opt;{
struct _tuple13**(*_T1D)(struct Cyc_Dict_Dict,struct _tuple0*)=(struct _tuple13**(*)(struct Cyc_Dict_Dict,struct _tuple0*))_T1;_T0= _T1D;}_T2= env;_T3= _T2->gcenv;_T4= _T3->struct_dict;_T5= n;{struct _tuple13**popt=_T0(_T4,_T5);_T6= popt;_T7= (unsigned)_T6;
if(!_T7)goto _TLEE;_T8= popt;_T9= *_T8;
return _T9;
# 915
_TLEE: {struct Cyc_Absyn_Aggrdecl*ad;ad= _cycalloc(sizeof(struct Cyc_Absyn_Aggrdecl));_TA= ad;_TA->kind= 0U;_TB= ad;
_TB->sc= 2U;_TC= ad;
_TC->name= n;_TD= ad;
_TD->tvs= 0;_TE= ad;
_TE->impl= 0;_TF= ad;
_TF->attributes= 0;_T10= ad;
_T10->expected_mem_kind= 0;{
struct _tuple13*p;p= _cycalloc(sizeof(struct _tuple13));_T11= p;_T11->f0= ad;_T12= p;_T12->f1= 0;_T13= env;_T14= _T13->gcenv;_T16= Cyc_Dict_insert;{
struct Cyc_Dict_Dict(*_T1D)(struct Cyc_Dict_Dict,struct _tuple0*,struct _tuple13*)=(struct Cyc_Dict_Dict(*)(struct Cyc_Dict_Dict,struct _tuple0*,struct _tuple13*))_T16;_T15= _T1D;}_T17= env;_T18= _T17->gcenv;_T19= _T18->struct_dict;_T1A= n;_T1B= p;({__typeof__(_T15(_T19,_T1A,_T1B))_T1D=_T15(_T19,_T1A,_T1B);_T14->struct_dict= _T1D;});_T1C= p;
return _T1C;}}}}
# 930
static struct _tuple13*Cyc_Port_lookup_union_decl(struct Cyc_Port_Cenv*env,struct _tuple0*n){struct _tuple13**(*_T0)(struct Cyc_Dict_Dict,struct _tuple0*);void**(*_T1)(struct Cyc_Dict_Dict,void*);struct Cyc_Port_Cenv*_T2;struct Cyc_Port_GlobalCenv*_T3;struct Cyc_Dict_Dict _T4;struct _tuple0*_T5;struct _tuple13**_T6;unsigned _T7;struct _tuple13**_T8;struct _tuple13*_T9;struct Cyc_Absyn_Aggrdecl*_TA;struct Cyc_Absyn_Aggrdecl*_TB;struct Cyc_Absyn_Aggrdecl*_TC;struct Cyc_Absyn_Aggrdecl*_TD;struct Cyc_Absyn_Aggrdecl*_TE;struct Cyc_Absyn_Aggrdecl*_TF;struct Cyc_Absyn_Aggrdecl*_T10;struct _tuple13*_T11;struct _tuple13*_T12;struct Cyc_Port_Cenv*_T13;struct Cyc_Port_GlobalCenv*_T14;struct Cyc_Dict_Dict(*_T15)(struct Cyc_Dict_Dict,struct _tuple0*,struct _tuple13*);struct Cyc_Dict_Dict(*_T16)(struct Cyc_Dict_Dict,void*,void*);struct Cyc_Port_Cenv*_T17;struct Cyc_Port_GlobalCenv*_T18;struct Cyc_Dict_Dict _T19;struct _tuple0*_T1A;struct _tuple13*_T1B;struct _tuple13*_T1C;_T1= Cyc_Dict_lookup_opt;{
struct _tuple13**(*_T1D)(struct Cyc_Dict_Dict,struct _tuple0*)=(struct _tuple13**(*)(struct Cyc_Dict_Dict,struct _tuple0*))_T1;_T0= _T1D;}_T2= env;_T3= _T2->gcenv;_T4= _T3->union_dict;_T5= n;{struct _tuple13**popt=_T0(_T4,_T5);_T6= popt;_T7= (unsigned)_T6;
if(!_T7)goto _TLF0;_T8= popt;_T9= *_T8;
return _T9;
# 935
_TLF0: {struct Cyc_Absyn_Aggrdecl*ad;ad= _cycalloc(sizeof(struct Cyc_Absyn_Aggrdecl));_TA= ad;_TA->kind= 1U;_TB= ad;
_TB->sc= 2U;_TC= ad;
_TC->name= n;_TD= ad;
_TD->tvs= 0;_TE= ad;
_TE->impl= 0;_TF= ad;
...
_T10->expected_mem_kind= 0;{
struct _tuple13*p;p= _cycalloc(sizeof(struct _tuple13));_T11= p;_T11->f0= ad;_T12= p;_T12->f1= 0;_T13= env;_T14= _T13->gcenv;_T16= Cyc_Dict_insert;{
struct Cyc_Dict_Dict(*_T1D)(struct Cyc_Dict_Dict,struct _tuple0*,struct _tuple13*)=(struct Cyc_Dict_Dict(*)(struct Cyc_Dict_Dict,struct _tuple0*,struct _tuple13*))_T16;_T15= _T1D;}_T17= env;_T18= _T17->gcenv;_T19= _T18->union_dict;_T1A= n;_T1B= p;({__typeof__(_T15(_T19,_T1A,_T1B))_T1D=_T15(_T19,_T1A,_T1B);_T14->union_dict= _T1D;});_T1C= p;
return _T1C;}}}}struct _tuple16{struct _tuple14 f0;unsigned f1;};struct _tuple17{void*f0;struct _tuple14*f1;unsigned f2;};
# 949
static struct _tuple16 Cyc_Port_lookup_var(struct Cyc_Port_Cenv*env,struct _tuple0*x){struct _handler_cons*_T0;int _T1;struct _tuple17*(*_T2)(struct Cyc_Dict_Dict,struct _tuple0*);void*(*_T3)(struct Cyc_Dict_Dict,void*);struct Cyc_Port_Cenv*_T4;struct Cyc_Dict_Dict _T5;struct _tuple0*_T6;struct _tuple17*_T7;struct _tuple16 _T8;struct _tuple14*_T9;void*_TA;struct Cyc_Dict_Absent_exn_struct*_TB;char*_TC;char*_TD;struct _tuple16 _TE;struct _handler_cons _TF;_T0= & _TF;_push_handler(_T0);{int _T10=0;_T1= setjmp(_TF.handler);if(!_T1)goto _TLF2;_T10= 1;goto _TLF3;_TLF2: _TLF3: if(_T10)goto _TLF4;else{goto _TLF6;}_TLF6: _T3= Cyc_Dict_lookup;{
# 951
struct _tuple17*(*_T11)(struct Cyc_Dict_Dict,struct _tuple0*)=(struct _tuple17*(*)(struct Cyc_Dict_Dict,struct _tuple0*))_T3;_T2= _T11;}_T4= env;_T5= _T4->var_dict;_T6= x;_T7= _T2(_T5,_T6);{struct _tuple17 _T11=*_T7;unsigned _T12;struct _tuple14*_T13;_T13= _T11.f1;_T12= _T11.f2;{struct _tuple14*p=_T13;unsigned loc=_T12;{struct _tuple16 _T14;_T9= p;
_T14.f0= *_T9;_T14.f1= loc;_T8= _T14;}{struct _tuple16 _T14=_T8;_npop_handler(0);return _T14;}}}_pop_handler();goto _TLF5;_TLF4: _TA= Cyc_Core_get_exn_thrown();{void*_T11=(void*)_TA;void*_T12;_TB= (struct Cyc_Dict_Absent_exn_struct*)_T11;_TC= _TB->tag;_TD= Cyc_Dict_Absent;if(_TC!=_TD)goto _TLF7;{struct _tuple16 _T13;
# 958
({__typeof__(Cyc_Port_var())_T14=Cyc_Port_var();_T13.f0.f0= _T14;});({__typeof__(Cyc_Port_var())_T14=Cyc_Port_var();_T13.f0.f1= _T14;});_T13.f1= 0U;_TE= _T13;}return _TE;_TLF7: _T12= _T11;{void*exn=_T12;_rethrow(exn);};}_TLF5:;}}
# 961
static struct _tuple17*Cyc_Port_lookup_full_var(struct Cyc_Port_Cenv*env,struct _tuple0*x){struct _tuple17*(*_T0)(struct Cyc_Dict_Dict,struct _tuple0*);void*(*_T1)(struct Cyc_Dict_Dict,void*);struct Cyc_Port_Cenv*_T2;struct Cyc_Dict_Dict _T3;struct _tuple0*_T4;struct _tuple17*_T5;_T1= Cyc_Dict_lookup;{
struct _tuple17*(*_T6)(struct Cyc_Dict_Dict,struct _tuple0*)=(struct _tuple17*(*)(struct Cyc_Dict_Dict,struct _tuple0*))_T1;_T0= _T6;}_T2= env;_T3= _T2->var_dict;_T4= x;_T5= _T0(_T3,_T4);return _T5;}
# 965
static long Cyc_Port_declared_var(struct Cyc_Port_Cenv*env,struct _tuple0*x){long(*_T0)(struct Cyc_Dict_Dict,struct _tuple0*);long(*_T1)(struct Cyc_Dict_Dict,void*);struct Cyc_Port_Cenv*_T2;struct Cyc_Dict_Dict _T3;struct _tuple0*_T4;long _T5;_T1= Cyc_Dict_member;{long(*_T6)(struct Cyc_Dict_Dict,struct _tuple0*)=(long(*)(struct Cyc_Dict_Dict,struct _tuple0*))_T1;_T0= _T6;}_T2= env;_T3= _T2->var_dict;_T4= x;_T5= _T0(_T3,_T4);return _T5;}
# 967
static long Cyc_Port_isfn(struct Cyc_Port_Cenv*env,struct _tuple0*x){struct _handler_cons*_T0;int _T1;struct _tuple17*(*_T2)(struct Cyc_Dict_Dict,struct _tuple0*);void*(*_T3)(struct Cyc_Dict_Dict,void*);struct Cyc_Port_Cenv*_T4;struct Cyc_Dict_Dict _T5;struct _tuple0*_T6;struct _tuple17*_T7;void*_T8;int*_T9;unsigned _TA;void*_TB;void*_TC;struct Cyc_Dict_Absent_exn_struct*_TD;char*_TE;char*_TF;struct _handler_cons _T10;_T0= & _T10;_push_handler(_T0);{int _T11=0;_T1= setjmp(_T10.handler);if(!_T1)goto _TLF9;_T11= 1;goto _TLFA;_TLF9: _TLFA: if(_T11)goto _TLFB;else{goto _TLFD;}_TLFD: _T3= Cyc_Dict_lookup;{
# 969
struct _tuple17*(*_T12)(struct Cyc_Dict_Dict,struct _tuple0*)=(struct _tuple17*(*)(struct Cyc_Dict_Dict,struct _tuple0*))_T3;_T2= _T12;}_T4= env;_T5= _T4->var_dict;_T6= x;_T7= _T2(_T5,_T6);{struct _tuple17 _T12=*_T7;void*_T13;_T13= _T12.f0;{void*t=_T13;
...
# 973
t= Cyc_Port_lookup_typedef(env,n);goto LOOP;}case 6:  {long _T15=1;_npop_handler(0);return _T15;}default:  {long _T15=0;_npop_handler(0);return _T15;}};}}}_pop_handler();goto _TLFC;_TLFB: _TC= Cyc_Core_get_exn_thrown();{void*_T12=(void*)_TC;void*_T13;_TD= (struct Cyc_Dict_Absent_exn_struct*)_T12;_TE= _TD->tag;_TF= Cyc_Dict_Absent;if(_TE!=_TF)goto _TLFF;
# 985
return 0;_TLFF: _T13= _T12;{void*exn=_T13;_rethrow(exn);};}_TLFC:;}}
# 989
static long Cyc_Port_isarray(struct Cyc_Port_Cenv*env,struct _tuple0*x){struct _handler_cons*_T0;int _T1;struct _tuple17*(*_T2)(struct Cyc_Dict_Dict,struct _tuple0*);void*(*_T3)(struct Cyc_Dict_Dict,void*);struct Cyc_Port_Cenv*_T4;struct Cyc_Dict_Dict _T5;struct _tuple0*_T6;struct _tuple17*_T7;void*_T8;int*_T9;unsigned _TA;void*_TB;void*_TC;struct Cyc_Dict_Absent_exn_struct*_TD;char*_TE;char*_TF;struct _handler_cons _T10;_T0= & _T10;_push_handler(_T0);{int _T11=0;_T1= setjmp(_T10.handler);if(!_T1)goto _TL101;_T11= 1;goto _TL102;_TL101: _TL102: if(_T11)goto _TL103;else{goto _TL105;}_TL105: _T3= Cyc_Dict_lookup;{
# 991
struct _tuple17*(*_T12)(struct Cyc_Dict_Dict,struct _tuple0*)=(struct _tuple17*(*)(struct Cyc_Dict_Dict,struct _tuple0*))_T3;_T2= _T12;}_T4= env;_T5= _T4->var_dict;_T6= x;_T7= _T2(_T5,_T6);{struct _tuple17 _T12=*_T7;void*_T13;_T13= _T12.f0;{void*t=_T13;
LOOP: {struct _tuple0*_T14;_T8= t;_T9= (int*)_T8;_TA= *_T9;switch(_TA){case 8: _TB= t;{struct Cyc_Absyn_TypedefType_Absyn_Type_struct*_T15=(struct Cyc_Absyn_TypedefType_Absyn_Type_struct*)_TB;_T14= _T15->f1;}{struct _tuple0*n=_T14;
# 995
t= Cyc_Port_lookup_typedef(env,n);goto LOOP;}case 5:  {long _T15=1;_npop_handler(0);return _T15;}default:  {long _T15=0;_npop_handler(0);return _T15;}};}}}_pop_handler();goto _TL104;_TL103: _TC= Cyc_Core_get_exn_thrown();{void*_T12=(void*)_TC;void*_T13;_TD= (struct Cyc_Dict_Absent_exn_struct*)_T12;_TE= _TD->tag;_TF= Cyc_Dict_Absent;if(_TE!=_TF)goto _TL107;
# 1007
...
# 1018
static void Cyc_Port_add_return_type(struct Cyc_Port_Cenv*env,void*t){struct Cyc_Port_Cenv*_T0;struct Cyc_Port_GlobalCenv*_T1;_T0= env;_T1= _T0->gcenv;_T1->return_type= t;}
# 1021
static struct Cyc_Port_Cenv*Cyc_Port_add_var(struct Cyc_Port_Cenv*env,struct _tuple0*x,void*t,void*qual,void*ctype,unsigned loc){struct Cyc_Port_Cenv*_T0;struct Cyc_Port_Cenv*_T1;struct Cyc_Dict_Dict(*_T2)(struct Cyc_Dict_Dict,struct _tuple0*,struct _tuple17*);struct Cyc_Dict_Dict(*_T3)(struct Cyc_Dict_Dict,void*,void*);struct Cyc_Port_Cenv*_T4;struct Cyc_Dict_Dict _T5;struct _tuple0*_T6;struct _tuple17*_T7;struct _tuple14*_T8;struct Cyc_Port_Cenv*_T9;{struct Cyc_Port_Cenv*_TA=_cycalloc(sizeof(struct Cyc_Port_Cenv));_T1= env;
_TA->gcenv= _T1->gcenv;_T3= Cyc_Dict_insert;{struct Cyc_Dict_Dict(*_TB)(struct Cyc_Dict_Dict,struct _tuple0*,struct _tuple17*)=(struct Cyc_Dict_Dict(*)(struct Cyc_Dict_Dict,struct _tuple0*,struct _tuple17*))_T3;_T2= _TB;}_T4= env;_T5= _T4->var_dict;_T6= x;{struct _tuple17*_TB=_cycalloc(sizeof(struct _tuple17));_TB->f0= t;{struct _tuple14*_TC=_cycalloc(sizeof(struct _tuple14));_TC->f0= qual;_TC->f1= ctype;_T8= (struct _tuple14*)_TC;}_TB->f1= _T8;_TB->f2= loc;_T7= (struct _tuple17*)_TB;}({__typeof__(_T2(_T5,_T6,_T7))_TB=_T2(_T5,_T6,_T7);_TA->var_dict= _TB;});_T9= env;
_TA->cpos= _T9->cpos;_T0= (struct Cyc_Port_Cenv*)_TA;}
# 1022
return _T0;}
# 1027
static void Cyc_Port_add_typedef(struct Cyc_Port_Cenv*env,struct _tuple0*n,void*t,void*ct){struct Cyc_Port_Cenv*_T0;struct Cyc_Port_GlobalCenv*_T1;struct Cyc_Dict_Dict(*_T2)(struct Cyc_Dict_Dict,struct _tuple0*,struct _tuple14*);struct Cyc_Dict_Dict(*_T3)(struct Cyc_Dict_Dict,void*,void*);struct Cyc_Port_Cenv*_T4;struct Cyc_Port_GlobalCenv*_T5;struct Cyc_Dict_Dict _T6;struct _tuple0*_T7;struct _tuple14*_T8;_T0= env;_T1= _T0->gcenv;_T3= Cyc_Dict_insert;{
struct Cyc_Dict_Dict(*_T9)(struct Cyc_Dict_Dict,struct _tuple0*,struct _tuple14*)=(struct Cyc_Dict_Dict(*)(struct Cyc_Dict_Dict,struct _tuple0*,struct _tuple14*))_T3;_T2= _T9;}_T4= env;_T5= _T4->gcenv;_T6= _T5->typedef_dict;_T7= n;{struct _tuple14*_T9=_cycalloc(sizeof(struct _tuple14));_T9->f0= t;_T9->f1= ct;_T8= (struct _tuple14*)_T9;}({__typeof__(_T2(_T6,_T7,_T8))_T9=_T2(_T6,_T7,_T8);_T1->typedef_dict= _T9;});}struct _tuple18{struct _tuple0*f0;unsigned f1;void*f2;};
# 1030
static void Cyc_Port_register_localvar_decl(struct Cyc_Port_Cenv*env,struct _tuple0*x,unsigned loc,void*type,struct Cyc_Absyn_Exp*init){struct Cyc_Port_Cenv*_T0;struct Cyc_Port_GlobalCenv*_T1;struct Cyc_List_List*_T2;struct _tuple18*_T3;struct Cyc_Port_Cenv*_T4;struct Cyc_Port_GlobalCenv*_T5;void(*_T6)(struct Cyc_Hashtable_Table*,unsigned,struct Cyc_Port_VarUsage*);void(*_T7)(struct Cyc_Hashtable_Table*,void*,void*);struct Cyc_Port_Cenv*_T8;struct Cyc_Port_GlobalCenv*_T9;struct Cyc_Hashtable_Table*_TA;unsigned _TB;struct Cyc_Port_VarUsage*_TC;_T0= env;_T1= _T0->gcenv;{struct Cyc_List_List*_TD=_cycalloc(sizeof(struct Cyc_List_List));{struct _tuple18*_TE=_cycalloc(sizeof(struct _tuple18));
_TE->f0= x;_TE->f1= loc;_TE->f2= type;_T3= (struct _tuple18*)_TE;}_TD->hd= _T3;_T4= env;_T5= _T4->gcenv;_TD->tl= _T5->vardecl_locs;_T2= (struct Cyc_List_List*)_TD;}_T1->vardecl_locs= _T2;_T7= Cyc_Hashtable_insert;{
...
# 1034
static void Cyc_Port_register_localvar_usage(struct Cyc_Port_Cenv*env,unsigned declloc,unsigned useloc,long takeaddress){long(*_T0)(struct Cyc_Hashtable_Table*,unsigned,struct Cyc_Port_VarUsage**);long(*_T1)(struct Cyc_Hashtable_Table*,void*,void**);struct Cyc_Port_Cenv*_T2;struct Cyc_Port_GlobalCenv*_T3;struct Cyc_Hashtable_Table*_T4;unsigned _T5;struct Cyc_Port_VarUsage**_T6;long _T7;long _T8;struct Cyc_Port_VarUsage*_T9;struct Cyc_Port_VarUsage*_TA;struct Cyc_Port_VarUsage*_TB;struct Cyc_List_List*_TC;unsigned _TD;
struct Cyc_Port_VarUsage*varusage=0;_T1= Cyc_Hashtable_try_lookup;{
long(*_TE)(struct Cyc_Hashtable_Table*,unsigned,struct Cyc_Port_VarUsage**)=(long(*)(struct Cyc_Hashtable_Table*,unsigned,struct Cyc_Port_VarUsage**))_T1;_T0= _TE;}_T2= env;_T3= _T2->gcenv;_T4= _T3->varusage_tab;_T5= declloc;_T6= & varusage;_T7= _T0(_T4,_T5,_T6);if(!_T7)goto _TL109;_T8= takeaddress;
if(!_T8)goto _TL10B;_T9= 
_check_null(varusage);_T9->address_taken= 1;goto _TL10C;_TL10B: _TL10C: _TA= 
...
_TE->hd= (void*)_TD;_TE->tl= l;_TC= (struct Cyc_List_List*)_TE;}_TB->usage_locs= _TC;}goto _TL10A;_TL109: _TL10A:;}struct _tuple19{void*f0;void*f1;unsigned f2;};
# 1046
static void Cyc_Port_register_const_cvar(struct Cyc_Port_Cenv*env,void*new_qual,void*orig_qual,unsigned loc){struct Cyc_Port_Cenv*_T0;struct Cyc_Port_GlobalCenv*_T1;struct Cyc_List_List*_T2;struct _tuple19*_T3;struct Cyc_Port_Cenv*_T4;struct Cyc_Port_GlobalCenv*_T5;_T0= env;_T1= _T0->gcenv;{struct Cyc_List_List*_T6=_cycalloc(sizeof(struct Cyc_List_List));{struct _tuple19*_T7=_cycalloc(sizeof(struct _tuple19));
# 1048
_T7->f0= new_qual;_T7->f1= orig_qual;_T7->f2= loc;_T3= (struct _tuple19*)_T7;}_T6->hd= _T3;_T4= env;_T5= _T4->gcenv;_T6->tl= _T5->qualifier_edits;_T2= (struct Cyc_List_List*)_T6;}
# 1047
_T1->qualifier_edits= _T2;}
# 1053
static void Cyc_Port_register_ptr_cvars(struct Cyc_Port_Cenv*env,void*new_ptr,void*orig_ptr,unsigned loc){struct Cyc_Port_Cenv*_T0;struct Cyc_Port_GlobalCenv*_T1;struct Cyc_List_List*_T2;struct _tuple19*_T3;struct Cyc_Port_Cenv*_T4;struct Cyc_Port_GlobalCenv*_T5;_T0= env;_T1= _T0->gcenv;{struct Cyc_List_List*_T6=_cycalloc(sizeof(struct Cyc_List_List));{struct _tuple19*_T7=_cycalloc(sizeof(struct _tuple19));
_T7->f0= new_ptr;_T7->f1= orig_ptr;_T7->f2= loc;_T3= (struct _tuple19*)_T7;}_T6->hd= _T3;_T4= env;_T5= _T4->gcenv;_T6->tl= _T5->pointer_edits;_T2= (struct Cyc_List_List*)_T6;}_T1->pointer_edits= _T2;}
# 1057
static void Cyc_Port_register_zeroterm_cvars(struct Cyc_Port_Cenv*env,void*new_zt,void*orig_zt,unsigned loc){struct Cyc_Port_Cenv*_T0;struct Cyc_Port_GlobalCenv*_T1;struct Cyc_List_List*_T2;struct _tuple19*_T3;struct Cyc_Port_Cenv*_T4;struct Cyc_Port_GlobalCenv*_T5;_T0= env;_T1= _T0->gcenv;{struct Cyc_List_List*_T6=_cycalloc(sizeof(struct Cyc_List_List));{struct _tuple19*_T7=_cycalloc(sizeof(struct _tuple19));
_T7->f0= new_zt;_T7->f1= orig_zt;_T7->f2= loc;_T3= (struct _tuple19*)_T7;}_T6->hd= _T3;_T4= env;_T5= _T4->gcenv;_T6->tl= _T5->zeroterm_edits;_T2= (struct Cyc_List_List*)_T6;}_T1->zeroterm_edits= _T2;}
# 1063
...
struct _tuple8*arg1;arg1= _cycalloc(sizeof(struct _tuple8));_T0= arg1;_T0->f0= 0;_T1= arg1;({__typeof__(Cyc_Absyn_empty_tqual(0U))_T12=Cyc_Absyn_empty_tqual(0U);_T1->f1= _T12;});_T2= arg1;_T2->f2= Cyc_Absyn_sint_type;{
struct _tuple8*arg2;arg2= _cycalloc(sizeof(struct _tuple8));_T3= arg2;
_T3->f0= 0;_T4= arg2;({__typeof__(Cyc_Absyn_empty_tqual(0U))_T12=Cyc_Absyn_empty_tqual(0U);_T4->f1= _T12;});_T5= arg2;_T6= 
...
# 1067
({__typeof__(Cyc_Absyn_fatptr_type(_T8,_T9,_TA,_TB,_TC,_TD))_T12=Cyc_Absyn_fatptr_type(_T8,_T9,_TA,_TB,_TC,_TD);_T5->f2= _T12;});{struct Cyc_Absyn_FnType_Absyn_Type_struct*_T12=_cycalloc(sizeof(struct Cyc_Absyn_FnType_Absyn_Type_struct));_T12->tag= 6;
# 1069
_T12->f1.tvars= 0;
_T12->f1.effect= 0;
({__typeof__(Cyc_Absyn_empty_tqual(0U))_T13=Cyc_Absyn_empty_tqual(0U);_T12->f1.ret_tqual= _T13;});
_T12->f1.ret_type= Cyc_Absyn_sint_type;{struct _tuple8*_T13[2];
_T13[0]= arg1;_T13[1]= arg2;_T10= _tag_fat(_T13,sizeof(struct _tuple8*),2);_TF= Cyc_List_list(_T10);}_T12->f1.args= _TF;
_T12->f1.c_varargs= 0;
...
_T12->f1.effconstr= 0;_TE= (struct Cyc_Absyn_FnType_Absyn_Type_struct*)_T12;}_T11= (void*)_TE;
# 1069
return _T11;}}
# 1091
...
# 1097
({__typeof__(Cyc_Absyn_Loc_n())_TA=Cyc_Absyn_Loc_n();_T9->f0= _TA;});{struct _fat_ptr*_TA=_cycalloc(sizeof(struct _fat_ptr));({__typeof__(_tag_fat("main",sizeof(char),5U))_TB=_tag_fat("main",sizeof(char),5U);*_TA= _TB;});_T2= (struct _fat_ptr*)_TA;}_T9->f1= _T2;_T1= (struct _tuple0*)_T9;}_T3= Cyc_Port_main_type();_T4= Cyc_Port_const_ct();_T5= e;_T6= Cyc_Port_main_type();_T7= Cyc_Port_type_to_ctype(_T5,_T6);e= Cyc_Port_add_var(_T0,_T1,_T3,_T4,_T7,0U);_T8= e;
# 1099
return _T8;}
# 1105
static void Cyc_Port_region_counts(struct Cyc_Dict_Dict*cts,void*t){int*_T0;unsigned _T1;long(*_T2)(struct Cyc_Dict_Dict,struct _fat_ptr*);long(*_T3)(struct Cyc_Dict_Dict,void*);struct Cyc_Dict_Dict*_T4;struct Cyc_Dict_Dict _T5;struct _fat_ptr*_T6;long _T7;struct Cyc_Dict_Dict*_T8;struct Cyc_Dict_Dict(*_T9)(struct Cyc_Dict_Dict,struct _fat_ptr*,int*);struct Cyc_Dict_Dict(*_TA)(struct Cyc_Dict_Dict,void*,void*);struct Cyc_Dict_Dict*_TB;struct Cyc_Dict_Dict _TC;struct _fat_ptr*_TD;int*_TE;int*(*_TF)(struct Cyc_Dict_Dict,struct _fat_ptr*);void*(*_T10)(struct Cyc_Dict_Dict,void*);struct Cyc_Dict_Dict*_T11;struct Cyc_Dict_Dict _T12;struct _fat_ptr*_T13;int*_T14;int*_T15;int _T16;void*_T17;void*_T18;void*_T19;void*_T1A;void*_T1B;void*_T1C;void*_T1D;void*_T1E;void*_T1F;struct Cyc_List_List*_T20;unsigned _T21;struct Cyc_Dict_Dict*_T22;struct Cyc_List_List*_T23;void*_T24;struct Cyc_List_List*_T25;
...
# 1122
long(*_T2D)(struct Cyc_Dict_Dict,struct _fat_ptr*)=(long(*)(struct Cyc_Dict_Dict,struct _fat_ptr*))_T3;_T2= _T2D;}_T4= cts;_T5= *_T4;_T6= n;_T7= _T2(_T5,_T6);if(_T7)goto _TL10E;else{goto _TL110;}
_TL110: _T8= cts;_TA= Cyc_Dict_insert;{struct Cyc_Dict_Dict(*_T2D)(struct Cyc_Dict_Dict,struct _fat_ptr*,int*)=(struct Cyc_Dict_Dict(*)(struct Cyc_Dict_Dict,struct _fat_ptr*,int*))_TA;_T9= _T2D;}_TB= cts;_TC= *_TB;_TD= n;{int*_T2D=_cycalloc_atomic(sizeof(int));*_T2D= 0;_TE= (int*)_T2D;}({__typeof__(_T9(_TC,_TD,_TE))_T2D=_T9(_TC,_TD,_TE);*_T8= _T2D;});goto _TL10F;_TL10E: _TL10F: _T10= Cyc_Dict_lookup;{
...
# 1180
_T38->loc= loc;({__typeof__(_tag_fat("`H ",sizeof(char),4U))_T39=_tag_fat("`H ",sizeof(char),4U);_T38->old_string= _T39;});({__typeof__(_tag_fat("",sizeof(char),1U))_T39=_tag_fat("",sizeof(char),1U);_T38->new_string= _T39;});_T17= (struct Cyc_Port_Edit*)_T38;}_T37->hd= _T17;_T18= env;_T19= _T18->gcenv;_T37->tl= _T19->edits;_T16= (struct Cyc_List_List*)_T37;}_T15->edits= _T16;goto _LL0;}}_TL116: goto _LL7;case 5: _T1A= _T2F.f1;_T1B= (int*)_T1A;_T1C= *_T1B;if(_T1C!=12)goto _TL11A;_T1D= _T2F.f0;{struct Cyc_Absyn_ArrayType_Absyn_Type_struct*_T37=(struct Cyc_Absyn_ArrayType_Absyn_Type_struct*)_T1D;_T1E= _T37->f1;_T36= _T1E.elt_type;}_T1F= _T2F.f1;{struct Cyc_Port_Array_ct_Port_Ctype_struct*_T37=(struct Cyc_Port_Array_ct_Port_Ctype_struct*)_T1F;_T20= _T37->f1;_T35= (void*)_T20;}{void*et=_T36;void*ec=_T35;
# 1184
...
# 1360
({__typeof__(Cyc_Absyn_Loc_n())_TD1=Cyc_Absyn_Loc_n();(*_T19).f0= _TD1;});{
struct _tuple13*p=Cyc_Port_lookup_struct_decl(env,n);_T1A= 
...
# 1364
({__typeof__(Cyc_Absyn_Loc_n())_TD1=Cyc_Absyn_Loc_n();(*_T1E).f0= _TD1;});{
struct _tuple13*p=Cyc_Port_lookup_union_decl(env,n);_T1F= 
...
# 1371
struct _tuple13*p=Cyc_Port_lookup_struct_decl(_T24,_T26);_T27= 
Cyc_Port_known_aggr_ct(p);return _T27;}_TL12E: _T28= env;_T29= ad;_T2A= _T29->name;{
# 1374
struct _tuple13*p=Cyc_Port_lookup_union_decl(_T28,_T2A);_T2B= 
...
_TL131: _T31= fs;_T32= _T31->hd;_T33= (struct Cyc_Absyn_Enumfield*)_T32;_T34= _T33->name;({__typeof__(Cyc_Absyn_Loc_n())_TCF=Cyc_Absyn_Loc_n();(*_T34).f0= _TCF;});_T35= env;_T36= fs;_T37= _T36->hd;_T38= (struct Cyc_Absyn_Enumfield*)_T37;_T39= _T38->name;_T3A= Cyc_Absyn_sint_type;_T3B= 
...
# 1275
if(!_T74)goto _TL149;_T75= cqv;_T76= 
Cyc_Port_const_ct();Cyc_Port_unify_ct(_T75,_T76);goto _TL14A;_TL149: _TL14A: {
# 1281
...
# 1286
if(!_T7C)goto _TL14D;_T7D= cbv;_T7E= 
Cyc_Port_fat_ct();Cyc_Port_unify_ct(_T7D,_T7E);goto _TL14E;_TL14D: _TL14E: {
...
({__typeof__(Cyc_Port_type_to_ctype(env_arg,t))_TD3=Cyc_Port_type_to_ctype(env_arg,t);_TD2->hd= _TD3;});_TD2->tl= cargs;_TBF= (struct Cyc_List_List*)_TD2;}cargs= _TBF;}}_TC0= args;
# 1352
...
# 1393
static void*Cyc_Port_gen_primop(struct Cyc_Port_Cenv*env,enum Cyc_Absyn_Primop p,struct Cyc_List_List*args){struct Cyc_List_List*_T0;void*_T1;struct Cyc_List_List*_T2;enum Cyc_Absyn_Primop _T3;int _T4;struct Cyc_List_List*_T5;void*_T6;void*_T7;void*_T8;void*_T9;void*_TA;void*_TB;void*_TC;void*_TD;long _TE;void*_TF;void*_T10;void*_T11;void*_T12;void*_T13;void*_T14;void*_T15;void*_T16;void*_T17;void*_T18;long _T19;void*_T1A;void*_T1B;void*_T1C;void*_T1D;void*_T1E;void*_T1F;void*_T20;void*_T21;void*_T22;void*_T23;void*_T24;struct Cyc_List_List*_T25;void*_T26;void*_T27;void*_T28;void*_T29;void*_T2A;void*_T2B;void*_T2C;void*_T2D;long _T2E;void*_T2F;void*_T30;void*_T31;void*_T32;void*_T33;void*_T34;void*_T35;long _T36;void*_T37;void*_T38;void*_T39;void*_T3A;void*_T3B;void*_T3C;void*_T3D;void*_T3E;void*_T3F;void*_T40;void*_T41;struct Cyc_List_List*_T42;void*_T43;void*_T44;void*_T45;void*_T46;void*_T47;void*_T48;int(*_T49)(struct _fat_ptr,struct _fat_ptr);void*(*_T4A)(struct _fat_ptr,struct _fat_ptr);struct _fat_ptr _T4B;struct _fat_ptr _T4C;_T0= 
...
# 1470
static struct _tuple14 Cyc_Port_gen_lhs(struct Cyc_Port_Cenv*env,struct Cyc_Absyn_Exp*e,long takeaddress){struct Cyc_Absyn_Exp*_T0;int*_T1;unsigned _T2;void*_T3;struct _tuple0*_T4;struct Cyc_Port_Cenv*_T5;unsigned _T6;struct Cyc_Absyn_Exp*_T7;unsigned _T8;long _T9;struct _tuple14 _TA;void*_TB;void*_TC;void*_TD;void*_TE;void*_TF;void*_T10;void*_T11;struct _tuple14 _T12;void*_T13;void*_T14;void*_T15;void*_T16;void*_T17;void*_T18;void*_T19;struct _tuple14 _T1A;void*_T1B;struct Cyc_List_List*_T1C;struct Cyc_Port_Cfield*_T1D;struct _fat_ptr _T1E;void*_T1F;struct _tuple14 _T20;void*_T21;struct Cyc_List_List*_T22;struct Cyc_Port_Cfield*_T23;struct _fat_ptr _T24;void*_T25;void*_T26;void*_T27;void*_T28;void*_T29;void*_T2A;struct _tuple14 _T2B;int(*_T2C)(struct _fat_ptr,struct _fat_ptr);void*(*_T2D)(struct _fat_ptr,struct _fat_ptr);struct _fat_ptr _T2E;struct Cyc_String_pa_PrintArg_struct _T2F;struct _fat_ptr _T30;struct _fat_ptr _T31;struct _fat_ptr _T32;_T0= e;{
...
({__typeof__(Cyc_Absyn_Loc_n())_T38=Cyc_Absyn_Loc_n();(*_T4).f0= _T38;});{
struct _tuple16 _T38=Cyc_Port_lookup_var(env,x);unsigned _T39;struct _tuple14 _T3A;_T3A= _T38.f0;_T39= _T38.f1;{struct _tuple14 p=_T3A;unsigned loc=_T39;_T5= env;_T6= loc;_T7= e;_T8= _T7->loc;_T9= takeaddress;
...
Cyc_Port_leq(t1,p);{struct _tuple14 _T38;
...
Cyc_Port_gen_exp(0,env,e1);_T19= p;Cyc_Port_leq(_T18,_T19);{struct _tuple14 _T38;
...
_T39->qual= q;_T39->f= f;_T39->type= v;_T1D= (struct Cyc_Port_Cfield*)_T39;}_T38[0]= _T1D;_T1E= _tag_fat(_T38,sizeof(struct Cyc_Port_Cfield*),1);_T1C= Cyc_List_list(_T1E);}_T1F= Cyc_Port_unknown_aggr_ct(_T1C);Cyc_Port_leq(_T1B,_T1F);{struct _tuple14 _T38;
...
_T39->qual= q;_T39->f= f;_T39->type= v;_T23= (struct Cyc_Port_Cfield*)_T39;}_T38[0]= _T23;_T24= _tag_fat(_T38,sizeof(struct Cyc_Port_Cfield*),1);_T22= Cyc_List_list(_T24);}_T25= Cyc_Port_unknown_aggr_ct(_T22);_T26= Cyc_Port_var();_T27= Cyc_Port_var();_T28= Cyc_Port_var();_T29= Cyc_Port_var();_T2A= Cyc_Port_ptr_ct(_T25,_T26,_T27,_T28,_T29);Cyc_Port_leq(_T21,_T2A);{struct _tuple14 _T38;
_T38.f0= q;_T38.f1= v;_T2B= _T38;}return _T2B;}default: _T2D= Cyc_Warn_impos;{
# 1505
int(*_T38)(struct _fat_ptr,struct _fat_ptr)=(int(*)(struct _fat_ptr,struct _fat_ptr))_T2D;_T2C= _T38;}{struct Cyc_String_pa_PrintArg_struct _T38;_T38.tag= 0;({__typeof__(Cyc_Absynpp_exp2string(e))_T39=Cyc_Absynpp_exp2string(e);_T38.f1= _T39;});_T2F= _T38;}{struct Cyc_String_pa_PrintArg_struct _T38=_T2F;void*_T39[1];_T39[0]= & _T38;_T30= _tag_fat("gen_lhs: %s",sizeof(char),12U);_T31= _tag_fat(_T39,sizeof(void*),1);_T2E= Cyc_aprintf(_T30,_T31);}_T32= _tag_fat(0U,sizeof(void*),0);_T2C(_T2E,_T32);};}}
# 1510
static void*Cyc_Port_gen_exp_false(struct Cyc_Port_Cenv*env,struct Cyc_Absyn_Exp*e){void*_T0;_T0= Cyc_Port_gen_exp(0,env,e);return _T0;}
static void*Cyc_Port_gen_exp(long takeaddress,struct Cyc_Port_Cenv*env,struct Cyc_Absyn_Exp*e){struct Cyc_Absyn_Exp*_T0;int*_T1;unsigned _T2;struct Cyc_Absyn_Const_e_Absyn_Raw_exp_struct*_T3;union Cyc_Absyn_Cnst _T4;struct _union_Cnst_Wstring_c _T5;unsigned _T6;void*_T7;struct Cyc_Absyn_Const_e_Absyn_Raw_exp_struct*_T8;union Cyc_Absyn_Cnst _T9;struct _union_Cnst_Int_c _TA;struct _tuple5 _TB;int _TC;void*_TD;void*_TE;void*_TF;void*_T10;void*_T11;void*_T12;void*_T13;void*_T14;void*_T15;void*_T16;void*_T17;void*_T18;void*_T19;void*_T1A;void*_T1B;void*_T1C;struct _tuple0*_T1D;struct _tuple14 _T1E;long _T1F;void*_T20;void*_T21;void*_T22;void*_T23;void*_T24;void*_T25;long _T26;void*_T27;void*_T28;void*_T29;void*_T2A;void*_T2B;void*_T2C;struct Cyc_Port_Cenv*_T2D;unsigned _T2E;struct Cyc_Absyn_Exp*_T2F;unsigned _T30;long _T31;void*_T32;struct Cyc_Port_Cenv*_T33;enum Cyc_Absyn_Primop _T34;struct Cyc_List_List*(*_T35)(void*(*)(struct Cyc_Port_Cenv*,struct Cyc_Absyn_Exp*),struct Cyc_Port_Cenv*,struct Cyc_List_List*);struct Cyc_List_List*(*_T36)(void*(*)(void*,void*),void*,struct Cyc_List_List*);struct Cyc_Port_Cenv*_T37;struct Cyc_List_List*_T38;struct Cyc_List_List*_T39;void*_T3A;void*_T3B;void*_T3C;struct Cyc_Absyn_PrimopOpt*_T3D;unsigned _T3E;struct Cyc_List_List _T3F;struct Cyc_List_List _T40;struct Cyc_List_List*_T41;struct Cyc_Port_Cenv*_T42;struct Cyc_Absyn_PrimopOpt*_T43;enum Cyc_Absyn_Primop _T44;struct Cyc_List_List*_T45;struct Cyc_List_List*_T46;void*_T47;void*_T48;void*_T49;void*_T4A;void*_T4B;void*_T4C;void*_T4D;void*_T4E;void*_T4F;void*_T50;void*_T51;void*_T52;void*_T53;void*_T54;void*_T55;void*_T56;void*_T57;void*_T58;void*_T59;void*_T5A;void*_T5B;void*_T5C;void*_T5D;void*_T5E;void*_T5F;void*_T60;void*_T61;struct Cyc_List_List*(*_T62)(void*(*)(struct Cyc_Port_Cenv*,struct Cyc_Absyn_Exp*),struct Cyc_Port_Cenv*,struct Cyc_List_List*);struct Cyc_List_List*(*_T63)(void*(*)(void*,void*),void*,struct Cyc_List_List*);struct Cyc_Port_Cenv*_T64;struct Cyc_List_List*_T65;struct Cyc_List_List*_T66;void*_T67;void*_T68;void*_T69;void*_T6A;void*_T6B;void*_T6C;void*_T6D;struct Cyc_List_List*_T6E;void*_T6F;struct Cyc_List_List*_T70;void*_T71;struct Cyc_List_List*_T72;struct Cyc_List_List*_T73;void*_T74;void*_T75;void*_T76;void*_T77;void*_T78;void*_T79;void*_T7A;void*_T7B;void*_T7C;void*_T7D;void*_T7E;void*_T7F;void*_T80;void*_T81;void*_T82;void*_T83;void*_T84;void*_T85;void*_T86;void*_T87;void*_T88;void*_T89;void*_T8A;void*_T8B;void*_T8C;void*_T8D;void*_T8E;void*_T8F;void*_T90;void*_T91;struct Cyc_List_List*_T92;struct Cyc_Port_Cfield*_T93;struct _fat_ptr _T94;void*_T95;void*_T96;void*_T97;struct Cyc_List_List*_T98;struct Cyc_Port_Cfield*_T99;struct _fat_ptr _T9A;void*_T9B;void*_T9C;void*_T9D;void*_T9E;void*_T9F;void*_TA0;void*_TA1;struct Cyc_Absyn_MallocInfo _TA2;struct Cyc_Absyn_MallocInfo _TA3;void*_TA4;void*_TA5;void*_TA6;void**_TA7;unsigned _TA8;struct Cyc_Port_Cenv*_TA9;void**_TAA;void*_TAB;void*_TAC;void*_TAD;void*_TAE;void*_TAF;void*_TB0;void*_TB1;int(*_TB2)(struct _fat_ptr,struct _fat_ptr);void*(*_TB3)(struct _fat_ptr,struct _fat_ptr);struct _fat_ptr _TB4;struct _fat_ptr _TB5;int(*_TB6)(struct _fat_ptr,struct _fat_ptr);void*(*_TB7)(struct _fat_ptr,struct _fat_ptr);struct _fat_ptr _TB8;struct _fat_ptr _TB9;int(*_TBA)(struct _fat_ptr,struct _fat_ptr);void*(*_TBB)(struct _fat_ptr,struct _fat_ptr);struct _fat_ptr _TBC;struct _fat_ptr _TBD;int(*_TBE)(struct _fat_ptr,struct _fat_ptr);void*(*_TBF)(struct _fat_ptr,struct _fat_ptr);struct _fat_ptr _TC0;struct _fat_ptr _TC1;int(*_TC2)(struct _fat_ptr,struct _fat_ptr);void*(*_TC3)(struct _fat_ptr,struct _fat_ptr);struct _fat_ptr _TC4;struct _fat_ptr _TC5;int(*_TC6)(struct _fat_ptr,struct _fat_ptr);void*(*_TC7)(struct _fat_ptr,struct _fat_ptr);struct _fat_ptr _TC8;struct _fat_ptr _TC9;int(*_TCA)(struct _fat_ptr,struct _fat_ptr);void*(*_TCB)(struct _fat_ptr,struct _fat_ptr);struct _fat_ptr _TCC;struct _fat_ptr _TCD;int(*_TCE)(struct _fat_ptr,struct _fat_ptr);void*(*_TCF)(struct _fat_ptr,struct _fat_ptr);struct _fat_ptr _TD0;struct _fat_ptr _TD1;int(*_TD2)(struct _fat_ptr,struct _fat_ptr);void*(*_TD3)(struct _fat_ptr,struct _fat_ptr);struct _fat_ptr _TD4;struct _fat_ptr _TD5;int(*_TD6)(struct _fat_ptr,struct _fat_ptr);void*(*_TD7)(struct _fat_ptr,struct _fat_ptr);struct _fat_ptr _TD8;struct _fat_ptr _TD9;int(*_TDA)(struct _fat_ptr,struct _fat_ptr);void*(*_TDB)(struct _fat_ptr,struct _fat_ptr);struct _fat_ptr _TDC;struct _fat_ptr _TDD;int(*_TDE)(struct _fat_ptr,struct _fat_ptr);void*(*_TDF)(struct _fat_ptr,struct _fat_ptr);struct _fat_ptr _TE0;struct _fat_ptr _TE1;int(*_TE2)(struct _fat_ptr,struct _fat_ptr);void*(*_TE3)(struct _fat_ptr,struct _fat_ptr);struct _fat_ptr _TE4;struct _fat_ptr _TE5;int(*_TE6)(struct _fat_ptr,struct _fat_ptr);void*(*_TE7)(struct _fat_ptr,struct _fat_ptr);struct _fat_ptr _TE8;struct _fat_ptr _TE9;int(*_TEA)(struct _fat_ptr,struct _fat_ptr);void*(*_TEB)(struct _fat_ptr,struct _fat_ptr);struct _fat_ptr _TEC;struct _fat_ptr _TED;int(*_TEE)(struct _fat_ptr,struct _fat_ptr);void*(*_TEF)(struct _fat_ptr,struct _fat_ptr);struct _fat_ptr _TF0;struct _fat_ptr _TF1;int(*_TF2)(struct _fat_ptr,struct _fat_ptr);void*(*_TF3)(struct _fat_ptr,struct _fat_ptr);struct _fat_ptr _TF4;struct _fat_ptr _TF5;int(*_TF6)(struct _fat_ptr,struct _fat_ptr);void*(*_TF7)(struct _fat_ptr,struct _fat_ptr);struct _fat_ptr _TF8;struct _fat_ptr _TF9;int(*_TFA)(struct _fat_ptr,struct _fat_ptr);void*(*_TFB)(struct _fat_ptr,struct _fat_ptr);struct _fat_ptr _TFC;struct _fat_ptr _TFD;_T0= e;{
void*_TFE=_T0->r;struct Cyc_Absyn_Stmt*_TFF;void**_T100;struct _fat_ptr*_T101;struct Cyc_List_List*_T102;struct Cyc_Absyn_Exp*_T103;enum Cyc_Absyn_Incrementor _T104;struct Cyc_Absyn_Exp*_T105;struct Cyc_Absyn_PrimopOpt*_T106;enum Cyc_Absyn_Primop _T107;void*_T108;_T1= (int*)_TFE;_T2= *_T1;switch(_T2){case 0: _T3= (struct Cyc_Absyn_Const_e_Absyn_Raw_exp_struct*)_TFE;_T4= _T3->f1;_T5= _T4.Wstring_c;_T6= _T5.tag;switch(_T6){case 2: goto _LL4;case 3: _LL4: goto _LL6;case 4: _LL6: goto _LL8;case 6: _LL8: goto _LLA;case 7: _LLA: goto _LLC;case 8: _LL16: _T7= 
# 1524
Cyc_Port_arith_ct();return _T7;case 5: _T8= (struct Cyc_Absyn_Const_e_Absyn_Raw_exp_struct*)_TFE;_T9= _T8->f1;_TA= _T9.Int_c;_TB= _TA.val;_TC= _TB.f1;if(_TC!=0)goto _TL17D;_TD= 
# 1526
Cyc_Port_zero_ct();return _TD;_TL17D: _TE= 
# 1528
Cyc_Port_arith_ct();return _TE;case 9: _TF= 
# 1530
Cyc_Port_arith_ct();_T10= Cyc_Port_const_ct();_T11= Cyc_Port_fat_ct();_T12= Cyc_Port_heap_ct();_T13= Cyc_Port_zterm_ct();_T14= Cyc_Port_ptr_ct(_TF,_T10,_T11,_T12,_T13);return _T14;case 10: _T15= 
# 1532
...
# 1534
Cyc_Port_zero_ct();return _T1B;};case 17: _LLC: goto _LLE;case 18: _LLE: goto _LL10;case 19: _LL10: goto _LL12;case 31: _LL12: goto _LL14;case 32: _LL14: goto _LL16;case 1:{struct Cyc_Absyn_Var_e_Absyn_Raw_exp_struct*_T109=(struct Cyc_Absyn_Var_e_Absyn_Raw_exp_struct*)_TFE;_T1C= _T109->f1;_T108= (void*)_T1C;}{void*b=_T108;
# 1536
struct _tuple0*x=Cyc_Absyn_binding2qvar(b);_T1D= x;
({__typeof__(Cyc_Absyn_Loc_n())_T109=Cyc_Absyn_Loc_n();(*_T1D).f0= _T109;});{
struct _tuple16 _T109=Cyc_Port_lookup_var(env,x);unsigned _T10A;struct _tuple14 _T10B;_T10B= _T109.f0;_T10A= _T109.f1;{struct _tuple14 p=_T10B;unsigned loc=_T10A;void*_T10C;_T1E= p;_T10C= _T1E.f1;{void*t=_T10C;_T1F= 
# 1540
Cyc_Port_isfn(env,x);if(!_T1F)goto _TL17F;
t= Cyc_Port_instantiate(t);_T20= t;_T21= 
Cyc_Port_var();_T22= Cyc_Port_var();_T23= Cyc_Port_heap_ct();_T24= 
Cyc_Port_nozterm_ct();_T25= 
# 1542
Cyc_Port_ptr_ct(_T20,_T21,_T22,_T23,_T24);return _T25;
# 1544
...
return _T32;}}}}case 3:{struct Cyc_Absyn_Primop_e_Absyn_Raw_exp_struct*_T109=(struct Cyc_Absyn_Primop_e_Absyn_Raw_exp_struct*)_TFE;_T107= _T109->f1;_T108= _T109->f2;}{enum Cyc_Absyn_Primop p=_T107;struct Cyc_List_List*es=_T108;_T33= env;_T34= p;_T36= Cyc_List_map_c;{
# 1557
struct Cyc_List_List*(*_T109)(void*(*)(struct Cyc_Port_Cenv*,struct Cyc_Absyn_Exp*),struct Cyc_Port_Cenv*,struct Cyc_List_List*)=(struct Cyc_List_List*(*)(void*(*)(struct Cyc_Port_Cenv*,struct Cyc_Absyn_Exp*),struct Cyc_Port_Cenv*,struct Cyc_List_List*))_T36;_T35= _T109;}_T37= env;_T38= es;_T39= _T35(Cyc_Port_gen_exp_false,_T37,_T38);_T3A= Cyc_Port_gen_primop(_T33,_T34,_T39);return _T3A;}case 4:{struct Cyc_Absyn_AssignOp_e_Absyn_Raw_exp_struct*_T109=(struct Cyc_Absyn_AssignOp_e_Absyn_Raw_exp_struct*)_TFE;_T108= _T109->f1;_T106= _T109->f2;_T105= _T109->f3;}{struct Cyc_Absyn_Exp*e1=_T108;struct Cyc_Absyn_PrimopOpt*popt=_T106;struct Cyc_Absyn_Exp*e2=_T105;
# 1559
struct _tuple14 _T109=Cyc_Port_gen_lhs(env,e1,0);void*_T10A;void*_T10B;_T10B= _T109.f0;_T10A= _T109.f1;{void*q=_T10B;void*t1=_T10A;_T3B= q;_T3C= 
Cyc_Port_notconst_ct();Cyc_Port_unifies(_T3B,_T3C);{
void*t2=Cyc_Port_gen_exp(0,env,e2);_T3D= popt;_T3E= (unsigned)_T3D;
if(!_T3E)goto _TL183;{struct Cyc_List_List _T10C;
# 1564
_T10C.hd= t2;_T10C.tl= 0;_T3F= _T10C;}{
# 1563
struct Cyc_List_List x2=_T3F;{struct Cyc_List_List _T10C;
# 1567
_T10C.hd= t1;_T41= & x2;_T10C.tl= (struct Cyc_List_List*)_T41;_T40= _T10C;}{
# 1566
struct Cyc_List_List x1=_T40;_T42= env;_T43= popt;_T44= _T43->v;_T45= & x1;_T46= (struct Cyc_List_List*)_T45;{
# 1569
void*t3=Cyc_Port_gen_primop(_T42,_T44,_T46);
Cyc_Port_leq(t3,t1);_T47= t1;
return _T47;}}}
# 1573
_TL183: Cyc_Port_leq(t2,t1);_T48= t1;
return _T48;}}}case 5:{struct Cyc_Absyn_Increment_e_Absyn_Raw_exp_struct*_T109=(struct Cyc_Absyn_Increment_e_Absyn_Raw_exp_struct*)_TFE;_T108= _T109->f1;_T104= _T109->f2;}{struct Cyc_Absyn_Exp*e1=_T108;enum Cyc_Absyn_Incrementor inc=_T104;
# 1577
struct _tuple14 _T109=Cyc_Port_gen_lhs(env,e1,0);void*_T10A;void*_T10B;_T10B= _T109.f0;_T10A= _T109.f1;{void*q=_T10B;void*t=_T10A;_T49= q;_T4A= 
Cyc_Port_notconst_ct();Cyc_Port_unifies(_T49,_T4A);_T4B= t;_T4C= 
# 1580
Cyc_Port_var();_T4D= Cyc_Port_var();_T4E= Cyc_Port_fat_ct();_T4F= Cyc_Port_var();_T50= Cyc_Port_var();_T51= Cyc_Port_ptr_ct(_T4C,_T4D,_T4E,_T4F,_T50);Cyc_Port_leq(_T4B,_T51);_T52= t;_T53= 
Cyc_Port_arith_ct();Cyc_Port_leq(_T52,_T53);_T54= t;
return _T54;}}case 6:{struct Cyc_Absyn_Conditional_e_Absyn_Raw_exp_struct*_T109=(struct Cyc_Absyn_Conditional_e_Absyn_Raw_exp_struct*)_TFE;_T108= _T109->f1;_T105= _T109->f2;_T103= _T109->f3;}{struct Cyc_Absyn_Exp*e1=_T108;struct Cyc_Absyn_Exp*e2=_T105;struct Cyc_Absyn_Exp*e3=_T103;
# 1584
void*v=Cyc_Port_var();_T55= 
Cyc_Port_gen_exp(0,env,e1);_T56= Cyc_Port_arith_ct();Cyc_Port_leq(_T55,_T56);_T57= 
Cyc_Port_gen_exp(0,env,e2);_T58= v;Cyc_Port_leq(_T57,_T58);_T59= 
Cyc_Port_gen_exp(0,env,e3);_T5A= v;Cyc_Port_leq(_T59,_T5A);_T5B= v;
return _T5B;}case 7:{struct Cyc_Absyn_And_e_Absyn_Raw_exp_struct*_T109=(struct Cyc_Absyn_And_e_Absyn_Raw_exp_struct*)_TFE;_T108= _T109->f1;_T105= _T109->f2;}{struct Cyc_Absyn_Exp*e1=_T108;struct Cyc_Absyn_Exp*e2=_T105;_T108= e1;_T105= e2;goto _LL2E;}case 8:{struct Cyc_Absyn_Or_e_Absyn_Raw_exp_struct*_T109=(struct Cyc_Absyn_Or_e_Absyn_Raw_exp_struct*)_TFE;_T108= _T109->f1;_T105= _T109->f2;}_LL2E: {struct Cyc_Absyn_Exp*e1=_T108;struct Cyc_Absyn_Exp*e2=_T105;_T5C= 
# 1592
Cyc_Port_gen_exp(0,env,e1);_T5D= Cyc_Port_arith_ct();Cyc_Port_leq(_T5C,_T5D);_T5E= 
Cyc_Port_gen_exp(0,env,e2);_T5F= Cyc_Port_arith_ct();Cyc_Port_leq(_T5E,_T5F);_T60= 
Cyc_Port_arith_ct();return _T60;}case 9:{struct Cyc_Absyn_SeqExp_e_Absyn_Raw_exp_struct*_T109=(struct Cyc_Absyn_SeqExp_e_Absyn_Raw_exp_struct*)_TFE;_T108= _T109->f1;_T105= _T109->f2;}{struct Cyc_Absyn_Exp*e1=_T108;struct Cyc_Absyn_Exp*e2=_T105;
# 1596
Cyc_Port_gen_exp(0,env,e1);_T61= 
Cyc_Port_gen_exp(0,env,e2);return _T61;}case 10:{struct Cyc_Absyn_FnCall_e_Absyn_Raw_exp_struct*_T109=(struct Cyc_Absyn_FnCall_e_Absyn_Raw_exp_struct*)_TFE;_T108= _T109->f1;_T102= _T109->f2;}{struct Cyc_Absyn_Exp*e1=_T108;struct Cyc_List_List*es=_T102;
# 1599
void*v=Cyc_Port_var();
void*t1=Cyc_Port_gen_exp(0,env,e1);_T63= Cyc_List_map_c;{
struct Cyc_List_List*(*_T109)(void*(*)(struct Cyc_Port_Cenv*,struct Cyc_Absyn_Exp*),struct Cyc_Port_Cenv*,struct Cyc_List_List*)=(struct Cyc_List_List*(*)(void*(*)(struct Cyc_Port_Cenv*,struct Cyc_Absyn_Exp*),struct Cyc_Port_Cenv*,struct Cyc_List_List*))_T63;_T62= _T109;}_T64= env;_T65= es;{struct Cyc_List_List*ts=_T62(Cyc_Port_gen_exp_false,_T64,_T65);_T66= ts;{
struct Cyc_List_List*vs=Cyc_List_map(Cyc_Port_new_var,_T66);_T67= t1;_T68= 
Cyc_Port_fn_ct(v,vs);_T69= Cyc_Port_var();_T6A= Cyc_Port_var();_T6B= Cyc_Port_var();_T6C= Cyc_Port_nozterm_ct();_T6D= Cyc_Port_ptr_ct(_T68,_T69,_T6A,_T6B,_T6C);Cyc_Port_unifies(_T67,_T6D);
_TL188: if(ts!=0)goto _TL186;else{goto _TL187;}
_TL186: _T6E= ts;_T6F= _T6E->hd;_T70= _check_null(vs);_T71= _T70->hd;Cyc_Port_leq(_T6F,_T71);_T72= ts;
# 1604
ts= _T72->tl;_T73= vs;vs= _T73->tl;goto _TL188;_TL187: _T74= v;
# 1606
return _T74;}}}case 40:{struct Cyc_Absyn_Extension_e_Absyn_Raw_exp_struct*_T109=(struct Cyc_Absyn_Extension_e_Absyn_Raw_exp_struct*)_TFE;_T108= _T109->f1;}{struct Cyc_Absyn_Exp*e1=_T108;_T75= 
# 1608
Cyc_Port_gen_exp(0,env,e1);return _T75;}case 12:{struct Cyc_Absyn_NoInstantiate_e_Absyn_Raw_exp_struct*_T109=(struct Cyc_Absyn_NoInstantiate_e_Absyn_Raw_exp_struct*)_TFE;_T108= _T109->f1;}{struct Cyc_Absyn_Exp*e1=_T108;_T76= 
# 1610
Cyc_Port_gen_exp(0,env,e1);return _T76;}case 14:{struct Cyc_Absyn_Cast_e_Absyn_Raw_exp_struct*_T109=(struct Cyc_Absyn_Cast_e_Absyn_Raw_exp_struct*)_TFE;_T77= _T109->f1;_T108= (void*)_T77;_T105= _T109->f2;}{void*t=_T108;struct Cyc_Absyn_Exp*e1=_T105;
# 1612
void*t1=Cyc_Port_type_to_ctype(env,t);
void*t2=Cyc_Port_gen_exp(0,env,e1);
Cyc_Port_leq(t1,t2);_T78= t2;
return _T78;}case 15:{struct Cyc_Absyn_Address_e_Absyn_Raw_exp_struct*_T109=(struct Cyc_Absyn_Address_e_Absyn_Raw_exp_struct*)_TFE;_T105= _T109->f1;}{struct Cyc_Absyn_Exp*e1=_T105;
# 1617
struct _tuple14 _T109=Cyc_Port_gen_lhs(env,e1,1);void*_T10A;void*_T10B;_T10B= _T109.f0;_T10A= _T109.f1;{void*q=_T10B;void*t=_T10A;_T79= t;_T7A= q;_T7B= 
Cyc_Port_var();_T7C= Cyc_Port_var();_T7D= Cyc_Port_var();_T7E= Cyc_Port_ptr_ct(_T79,_T7A,_T7B,_T7C,_T7D);return _T7E;}}case 23:{struct Cyc_Absyn_Subscript_e_Absyn_Raw_exp_struct*_T109=(struct Cyc_Absyn_Subscript_e_Absyn_Raw_exp_struct*)_TFE;_T105= _T109->f1;_T103= _T109->f2;}{struct Cyc_Absyn_Exp*e1=_T105;struct Cyc_Absyn_Exp*e2=_T103;
# 1620
void*v=Cyc_Port_var();_T7F= 
Cyc_Port_gen_exp(0,env,e2);_T80= Cyc_Port_arith_ct();Cyc_Port_leq(_T7F,_T80);{
void*t=Cyc_Port_gen_exp(0,env,e1);_T81= t;_T82= v;_T83= 
Cyc_Port_var();_T84= Cyc_Port_fat_ct();_T85= Cyc_Port_var();_T86= Cyc_Port_var();_T87= Cyc_Port_ptr_ct(_T82,_T83,_T84,_T85,_T86);Cyc_Port_leq(_T81,_T87);_T88= v;
return _T88;}}case 20:{struct Cyc_Absyn_Deref_e_Absyn_Raw_exp_struct*_T109=(struct Cyc_Absyn_Deref_e_Absyn_Raw_exp_struct*)_TFE;_T105= _T109->f1;}{struct Cyc_Absyn_Exp*e1=_T105;
# 1626
void*v=Cyc_Port_var();_T89= 
Cyc_Port_gen_exp(0,env,e1);_T8A= v;_T8B= Cyc_Port_var();_T8C= Cyc_Port_var();_T8D= Cyc_Port_var();_T8E= Cyc_Port_var();_T8F= Cyc_Port_ptr_ct(_T8A,_T8B,_T8C,_T8D,_T8E);Cyc_Port_leq(_T89,_T8F);_T90= v;
return _T90;}case 21:{struct Cyc_Absyn_AggrMember_e_Absyn_Raw_exp_struct*_T109=(struct Cyc_Absyn_AggrMember_e_Absyn_Raw_exp_struct*)_TFE;_T105= _T109->f1;_T101= _T109->f2;}{struct Cyc_Absyn_Exp*e1=_T105;struct _fat_ptr*f=_T101;
# 1630
void*v=Cyc_Port_var();
void*t=Cyc_Port_gen_exp(takeaddress,env,e1);_T91= t;{struct Cyc_Port_Cfield*_T109[1];{struct Cyc_Port_Cfield*_T10A=_cycalloc(sizeof(struct Cyc_Port_Cfield));
({__typeof__(Cyc_Port_var())_T10B=Cyc_Port_var();_T10A->qual= _T10B;});_T10A->f= f;_T10A->type= v;_T93= (struct Cyc_Port_Cfield*)_T10A;}_T109[0]= _T93;_T94= _tag_fat(_T109,sizeof(struct Cyc_Port_Cfield*),1);_T92= Cyc_List_list(_T94);}_T95= Cyc_Port_unknown_aggr_ct(_T92);Cyc_Port_leq(_T91,_T95);_T96= v;
return _T96;}case 22:{struct Cyc_Absyn_AggrArrow_e_Absyn_Raw_exp_struct*_T109=(struct Cyc_Absyn_AggrArrow_e_Absyn_Raw_exp_struct*)_TFE;_T105= _T109->f1;_T101= _T109->f2;}{struct Cyc_Absyn_Exp*e1=_T105;struct _fat_ptr*f=_T101;
# 1635
void*v=Cyc_Port_var();
void*t=Cyc_Port_gen_exp(0,env,e1);_T97= 
Cyc_Port_gen_exp(0,env,e1);{struct Cyc_Port_Cfield*_T109[1];{struct Cyc_Port_Cfield*_T10A=_cycalloc(sizeof(struct Cyc_Port_Cfield));
({__typeof__(Cyc_Port_var())_T10B=Cyc_Port_var();_T10A->qual= _T10B;});_T10A->f= f;_T10A->type= v;_T99= (struct Cyc_Port_Cfield*)_T10A;}_T109[0]= _T99;_T9A= _tag_fat(_T109,sizeof(struct Cyc_Port_Cfield*),1);_T98= Cyc_List_list(_T9A);}_T9B= Cyc_Port_unknown_aggr_ct(_T98);_T9C= Cyc_Port_var();_T9D= Cyc_Port_var();_T9E= Cyc_Port_var();_T9F= Cyc_Port_var();_TA0= Cyc_Port_ptr_ct(_T9B,_T9C,_T9D,_T9E,_T9F);
# 1637
Cyc_Port_leq(_T97,_TA0);_TA1= v;
# 1639
return _TA1;}case 33:{struct Cyc_Absyn_Malloc_e_Absyn_Raw_exp_struct*_T109=(struct Cyc_Absyn_Malloc_e_Absyn_Raw_exp_struct*)_TFE;_TA2= _T109->f1;_T100= _TA2.elt_type;_TA3= _T109->f1;_T105= _TA3.num_elts;}{void**topt=_T100;struct Cyc_Absyn_Exp*e1=_T105;_TA4= 
# 1641
Cyc_Port_gen_exp(0,env,e1);_TA5= Cyc_Port_arith_ct();Cyc_Port_leq(_TA4,_TA5);_TA7= topt;_TA8= (unsigned)_TA7;
if(!_TA8)goto _TL189;_TA9= env;_TAA= topt;_TAB= *_TAA;_TA6= Cyc_Port_type_to_ctype(_TA9,_TAB);goto _TL18A;_TL189: _TA6= Cyc_Port_var();_TL18A: {void*t=_TA6;_TAC= t;_TAD= 
Cyc_Port_var();_TAE= Cyc_Port_fat_ct();_TAF= Cyc_Port_heap_ct();_TB0= Cyc_Port_var();_TB1= Cyc_Port_ptr_ct(_TAC,_TAD,_TAE,_TAF,_TB0);return _TB1;}}case 41: _TB3= Cyc_Warn_impos;{
# 1645
int(*_T109)(struct _fat_ptr,struct _fat_ptr)=(int(*)(struct _fat_ptr,struct _fat_ptr))_TB3;_TB2= _T109;}_TB4= _tag_fat("@assert",sizeof(char),8U);_TB5= _tag_fat(0U,sizeof(void*),0);_TB2(_TB4,_TB5);case 42: _TB7= Cyc_Warn_impos;{
# 1647
int(*_T109)(struct _fat_ptr,struct _fat_ptr)=(int(*)(struct _fat_ptr,struct _fat_ptr))_TB7;_TB6= _T109;}_TB8= _tag_fat("@assert_false",sizeof(char),14U);_TB9= _tag_fat(0U,sizeof(void*),0);_TB6(_TB8,_TB9);case 11: _TBB= Cyc_Warn_impos;{
# 1649
int(*_T109)(struct _fat_ptr,struct _fat_ptr)=(int(*)(struct _fat_ptr,struct _fat_ptr))_TBB;_TBA= _T109;}_TBC= _tag_fat("throw",sizeof(char),6U);_TBD= _tag_fat(0U,sizeof(void*),0);_TBA(_TBC,_TBD);case 13: _TBF= Cyc_Warn_impos;{
# 1651
int(*_T109)(struct _fat_ptr,struct _fat_ptr)=(int(*)(struct _fat_ptr,struct _fat_ptr))_TBF;_TBE= _T109;}_TC0= _tag_fat("instantiate",sizeof(char),12U);_TC1= _tag_fat(0U,sizeof(void*),0);_TBE(_TC0,_TC1);case 2: _TC3= Cyc_Warn_impos;{
# 1653
int(*_T109)(struct _fat_ptr,struct _fat_ptr)=(int(*)(struct _fat_ptr,struct _fat_ptr))_TC3;_TC2= _T109;}_TC4= _tag_fat("Pragma_e",sizeof(char),9U);_TC5= _tag_fat(0U,sizeof(void*),0);_TC2(_TC4,_TC5);case 34:{struct Cyc_Absyn_Swap_e_Absyn_Raw_exp_struct*_T109=(struct Cyc_Absyn_Swap_e_Absyn_Raw_exp_struct*)_TFE;_T105= _T109->f1;_T103= _T109->f2;}{struct Cyc_Absyn_Exp*e1=_T105;struct Cyc_Absyn_Exp*e2=_T103;_TC7= Cyc_Warn_impos;{
# 1655
int(*_T109)(struct _fat_ptr,struct _fat_ptr)=(int(*)(struct _fat_ptr,struct _fat_ptr))_TC7;_TC6= _T109;}_TC8= _tag_fat("Swap_e",sizeof(char),7U);_TC9= _tag_fat(0U,sizeof(void*),0);_TC6(_TC8,_TC9);}case 16: _TCB= Cyc_Warn_impos;{
# 1657
int(*_T109)(struct _fat_ptr,struct _fat_ptr)=(int(*)(struct _fat_ptr,struct _fat_ptr))_TCB;_TCA= _T109;}_TCC= _tag_fat("New_e",sizeof(char),6U);_TCD= _tag_fat(0U,sizeof(void*),0);_TCA(_TCC,_TCD);case 24: _TCF= Cyc_Warn_impos;{
# 1659
int(*_T109)(struct _fat_ptr,struct _fat_ptr)=(int(*)(struct _fat_ptr,struct _fat_ptr))_TCF;_TCE= _T109;}_TD0= _tag_fat("CompoundLit_e",sizeof(char),14U);_TD1= _tag_fat(0U,sizeof(void*),0);_TCE(_TD0,_TD1);case 25: _TD3= Cyc_Warn_impos;{
# 1661
int(*_T109)(struct _fat_ptr,struct _fat_ptr)=(int(*)(struct _fat_ptr,struct _fat_ptr))_TD3;_TD2= _T109;}_TD4= _tag_fat("Array_e",sizeof(char),8U);_TD5= _tag_fat(0U,sizeof(void*),0);_TD2(_TD4,_TD5);case 26: _TD7= Cyc_Warn_impos;{
# 1663
int(*_T109)(struct _fat_ptr,struct _fat_ptr)=(int(*)(struct _fat_ptr,struct _fat_ptr))_TD7;_TD6= _T109;}_TD8= _tag_fat("Comprehension_e",sizeof(char),16U);_TD9= _tag_fat(0U,sizeof(void*),0);_TD6(_TD8,_TD9);case 27: _TDB= Cyc_Warn_impos;{
# 1665
int(*_T109)(struct _fat_ptr,struct _fat_ptr)=(int(*)(struct _fat_ptr,struct _fat_ptr))_TDB;_TDA= _T109;}_TDC= _tag_fat("ComprehensionNoinit_e",sizeof(char),22U);_TDD= _tag_fat(0U,sizeof(void*),0);_TDA(_TDC,_TDD);case 28: _TDF= Cyc_Warn_impos;{
# 1667
int(*_T109)(struct _fat_ptr,struct _fat_ptr)=(int(*)(struct _fat_ptr,struct _fat_ptr))_TDF;_TDE= _T109;}_TE0= _tag_fat("Aggregate_e",sizeof(char),12U);_TE1= _tag_fat(0U,sizeof(void*),0);_TDE(_TE0,_TE1);case 29: _TE3= Cyc_Warn_impos;{
# 1669
int(*_T109)(struct _fat_ptr,struct _fat_ptr)=(int(*)(struct _fat_ptr,struct _fat_ptr))_TE3;_TE2= _T109;}_TE4= _tag_fat("AnonStruct_e",sizeof(char),13U);_TE5= _tag_fat(0U,sizeof(void*),0);_TE2(_TE4,_TE5);case 30: _TE7= Cyc_Warn_impos;{
# 1671
int(*_T109)(struct _fat_ptr,struct _fat_ptr)=(int(*)(struct _fat_ptr,struct _fat_ptr))_TE7;_TE6= _T109;}_TE8= _tag_fat("Datatype_e",sizeof(char),11U);_TE9= _tag_fat(0U,sizeof(void*),0);_TE6(_TE8,_TE9);case 35: _TEB= Cyc_Warn_impos;{
# 1673
int(*_T109)(struct _fat_ptr,struct _fat_ptr)=(int(*)(struct _fat_ptr,struct _fat_ptr))_TEB;_TEA= _T109;}_TEC= _tag_fat("UnresolvedMem_e",sizeof(char),16U);_TED= _tag_fat(0U,sizeof(void*),0);_TEA(_TEC,_TED);case 36:{struct Cyc_Absyn_StmtExp_e_Absyn_Raw_exp_struct*_T109=(struct Cyc_Absyn_StmtExp_e_Absyn_Raw_exp_struct*)_TFE;_TFF= _T109->f1;}{struct Cyc_Absyn_Stmt*s=_TFF;_TEF= Cyc_Warn_impos;{
# 1675
int(*_T109)(struct _fat_ptr,struct _fat_ptr)=(int(*)(struct _fat_ptr,struct _fat_ptr))_TEF;_TEE= _T109;}_TF0= _tag_fat("StmtExp_e",sizeof(char),10U);_TF1= _tag_fat(0U,sizeof(void*),0);_TEE(_TF0,_TF1);}case 38: _TF3= Cyc_Warn_impos;{
# 1677
int(*_T109)(struct _fat_ptr,struct _fat_ptr)=(int(*)(struct _fat_ptr,struct _fat_ptr))_TF3;_TF2= _T109;}_TF4= _tag_fat("Valueof_e",sizeof(char),10U);_TF5= _tag_fat(0U,sizeof(void*),0);_TF2(_TF4,_TF5);case 39: _TF7= Cyc_Warn_impos;{
# 1679
int(*_T109)(struct _fat_ptr,struct _fat_ptr)=(int(*)(struct _fat_ptr,struct _fat_ptr))_TF7;_TF6= _T109;}_TF8= _tag_fat("Asm_e",sizeof(char),6U);_TF9= _tag_fat(0U,sizeof(void*),0);_TF6(_TF8,_TF9);default: _TFB= Cyc_Warn_impos;{
# 1681
int(*_T109)(struct _fat_ptr,struct _fat_ptr)=(int(*)(struct _fat_ptr,struct _fat_ptr))_TFB;_TFA= _T109;}_TFC= _tag_fat("Tagcheck_e",sizeof(char),11U);_TFD= _tag_fat(0U,sizeof(void*),0);_TFA(_TFC,_TFD);};}}
# 1686
...
return;}case 2:{struct Cyc_Absyn_Seq_s_Absyn_Raw_stmt_struct*_T28=(struct Cyc_Absyn_Seq_s_Absyn_Raw_stmt_struct*)_T20;_T26= _T28->f1;_T25= _T28->f2;}{struct Cyc_Absyn_Stmt*s1=_T26;struct Cyc_Absyn_Stmt*s2=_T25;
# 1694
Cyc_Port_gen_stmt(env,s1);
Cyc_Port_gen_stmt(env,s2);
return;}case 3:{struct Cyc_Absyn_Return_s_Absyn_Raw_stmt_struct*_T28=(struct Cyc_Absyn_Return_s_Absyn_Raw_stmt_struct*)_T20;_T27= _T28->f1;}{struct Cyc_Absyn_Exp*eopt=_T27;
# 1698
...
Cyc_Port_gen_stmt(env,s);
return;}case 13:{struct Cyc_Absyn_Label_s_Absyn_Raw_stmt_struct*_T28=(struct Cyc_Absyn_Label_s_Absyn_Raw_stmt_struct*)_T20;_T26= _T28->f2;}{struct Cyc_Absyn_Stmt*s=_T26;
# 1732
Cyc_Port_gen_stmt(env,s);
return;}case 14:{struct Cyc_Absyn_Do_s_Absyn_Raw_stmt_struct*_T28=(struct Cyc_Absyn_Do_s_Absyn_Raw_stmt_struct*)_T20;_T26= _T28->f1;_T19= _T28->f2;_T27= _T19.f0;}{struct Cyc_Absyn_Stmt*s=_T26;struct Cyc_Absyn_Exp*e=_T27;
# 1735
...
# 1754
({__typeof__(Cyc_Absyn_Loc_n())_T6A=Cyc_Absyn_Loc_n();(*_T7).f0= _T6A;});
...
_TL195: _TC= dles;_TD= _TC->hd;_TE= (struct _tuple20*)_TD;{struct _tuple20 _T6A=*_TE;struct Cyc_Absyn_Exp*_T6B;struct Cyc_List_List*_T6C;_T6C= _T6A.f0;_T6B= _T6A.f1;{struct Cyc_List_List*d=_T6C;struct Cyc_Absyn_Exp*e=_T6B;_TF= d;_T10= (unsigned)_TF;
if(!_T10)goto _TL198;_T12= Cyc_Warn_impos;{
int(*_T6D)(struct _fat_ptr,struct _fat_ptr)=(int(*)(struct _fat_ptr,struct _fat_ptr))_T12;_T11= _T6D;}_T13= _tag_fat("designators in initializers",sizeof(char),28U);_T14= _tag_fat(0U,sizeof(void*),0);_T11(_T13,_T14);goto _TL199;_TL198: _TL199: {
...
# 1771
({__typeof__(Cyc_Absyn_Loc_n())_T6A=Cyc_Absyn_Loc_n();(*_T30).f0= _T6A;});_T31= 
Cyc_Port_lookup_struct_decl(env,n);{struct _tuple13 _T6A=*_T31;struct Cyc_Absyn_Aggrdecl*_T6B;_T6B= _T6A.f0;{struct Cyc_Absyn_Aggrdecl*ad=_T6B;
...
_TL1A3: _T3E= dles;_T3F= _T3E->hd;_T40= (struct _tuple20*)_T3F;{struct _tuple20 _T6A=*_T40;struct Cyc_Absyn_Exp*_T6B;struct Cyc_List_List*_T6C;_T6C= _T6A.f0;_T6B= _T6A.f1;{struct Cyc_List_List*d=_T6C;struct Cyc_Absyn_Exp*e=_T6B;_T41= d;_T42= (unsigned)_T41;
if(!_T42)goto _TL1A6;_T44= Cyc_Warn_impos;{
int(*_T6D)(struct _fat_ptr,struct _fat_ptr)=(int(*)(struct _fat_ptr,struct _fat_ptr))_T44;_T43= _T6D;}_T45= _tag_fat("designators in initializers",sizeof(char),28U);_T46= _tag_fat(0U,sizeof(void*),0);_T43(_T45,_T46);goto _TL1A7;_TL1A6: _TL1A7: _T47= 
...
# 1795
({__typeof__(Cyc_Absyn_Loc_n())_T66=Cyc_Absyn_Loc_n();(*_T5C).f0= _T66;});
...
# 1809
static struct Cyc_Port_Cenv*Cyc_Port_gen_localdecl(struct Cyc_Port_Cenv*env,struct Cyc_Absyn_Decl*d,long fromglobal){struct Cyc_Absyn_Decl*_T0;int*_T1;int _T2;long _T3;struct Cyc_Port_Cenv*_T4;struct Cyc_Absyn_Vardecl*_T5;struct _tuple0*_T6;struct Cyc_Absyn_Vardecl*_T7;unsigned _T8;struct Cyc_Absyn_Vardecl*_T9;void*_TA;struct Cyc_Absyn_Vardecl*_TB;struct Cyc_Absyn_Exp*_TC;struct Cyc_Port_Cenv*_TD;struct Cyc_Port_GlobalCenv*_TE;long _TF;struct Cyc_Port_Cenv*_T10;void*_T11;void*_T12;struct Cyc_Absyn_Vardecl*_T13;struct Cyc_Absyn_Tqual _T14;long _T15;struct Cyc_Absyn_Vardecl*_T16;struct Cyc_Absyn_Tqual _T17;unsigned _T18;void*_T19;struct Cyc_Absyn_Vardecl*_T1A;struct Cyc_Absyn_Tqual _T1B;long _T1C;struct Cyc_Absyn_Vardecl*_T1D;struct _tuple0*_T1E;struct Cyc_Port_Cenv*_T1F;struct Cyc_Absyn_Vardecl*_T20;struct _tuple0*_T21;struct Cyc_Absyn_Vardecl*_T22;void*_T23;void*_T24;void*_T25;struct Cyc_Absyn_Vardecl*_T26;unsigned _T27;void*_T28;struct Cyc_Port_Cenv*_T29;struct Cyc_Absyn_Vardecl*_T2A;void*_T2B;void*_T2C;struct Cyc_Absyn_Vardecl*_T2D;struct Cyc_Absyn_Exp*_T2E;unsigned _T2F;struct Cyc_Absyn_Vardecl*_T30;struct Cyc_Port_Cenv*_T31;struct Cyc_Absyn_Vardecl*_T32;void*_T33;struct Cyc_Absyn_Exp*_T34;struct Cyc_Port_Cenv*_T35;int(*_T36)(struct _fat_ptr,struct _fat_ptr);void*(*_T37)(struct _fat_ptr,struct _fat_ptr);struct _fat_ptr _T38;struct _fat_ptr _T39;_T0= d;{
...
# 1812
if(_T3)goto _TL1AC;else{goto _TL1AE;}
_TL1AE: _T4= env;_T5= vd;_T6= _T5->name;_T7= vd;_T8= _T7->varloc;_T9= vd;_TA= _T9->type;_TB= vd;_TC= _TB->initializer;Cyc_Port_register_localvar_decl(_T4,_T6,_T8,_TA,_TC);goto _TL1AD;_TL1AC: _TL1AD: {
# 1815
void*t=Cyc_Port_var();
void*q;_TD= env;_TE= _TD->gcenv;_TF= _TE->porting;
if(!_TF)goto _TL1AF;
q= Cyc_Port_var();_T10= env;_T11= q;_T13= vd;_T14= _T13->tq;_T15= _T14.print_const;
if(!_T15)goto _TL1B1;_T12= Cyc_Port_const_ct();goto _TL1B2;_TL1B1: _T12= Cyc_Port_notconst_ct();_TL1B2: _T16= vd;_T17= _T16->tq;_T18= _T17.loc;Cyc_Port_register_const_cvar(_T10,_T11,_T12,_T18);goto _TL1B0;
# 1826
...
# 1828
({__typeof__(Cyc_Absyn_Loc_n())_T3C=Cyc_Absyn_Loc_n();(*_T1E).f0= _T3C;});_T1F= env;_T20= vd;_T21= _T20->name;_T22= vd;_T23= _T22->type;_T24= q;_T25= t;_T26= vd;_T27= _T26->varloc;
...
# 1858
({__typeof__(Cyc_Absyn_Loc_n())_T107=Cyc_Absyn_Loc_n();(*_TA).f0= _T107;});_TB= env;_TC= vd;_TD= _TC->name;_TE= 
# 1862
Cyc_Port_declared_var(_TB,_TD);if(!_TE)goto _TL1B8;_TF= env;_T10= vd;_T11= _T10->name;{
struct _tuple16 _T107=Cyc_Port_lookup_var(_TF,_T11);unsigned _T108;struct _tuple14 _T109;_T109= _T107.f0;_T108= _T107.f1;{struct _tuple14 p=_T109;unsigned loc=_T108;void*_T10A;void*_T10B;_T12= p;_T10B= _T12.f0;_T13= p;_T10A= _T13.f1;{void*q=_T10B;void*t=_T10A;
# 1865
...
if(!_T20)goto _TL1BD;_T1D= Cyc_Port_const_ct();goto _TL1BE;_TL1BD: _T1D= Cyc_Port_notconst_ct();_TL1BE: _T21= vd;_T22= _T21->tq;_T23= _T22.loc;Cyc_Port_register_const_cvar(_T1B,_T1C,_T1D,_T23);goto _TL1BB;
# 1875
...
# 1891
({__typeof__(Cyc_Absyn_Loc_n())_T107=Cyc_Absyn_Loc_n();(*_T3A).f0= _T107;});{
struct _tuple17*predeclared=0;_T3B= env;_T3C= fd;_T3D= _T3C->name;_T3E= 
# 1894
...
struct Cyc_Absyn_FnType_Absyn_Type_struct*fntype;fntype= _cycalloc(sizeof(struct Cyc_Absyn_FnType_Absyn_Type_struct));_T49= fntype;_T49->tag= 6;_T4A= fntype;_T4A->f1.tvars= 0;_T4B= fntype;_T4B->f1.effect= 0;_T4C= fntype;({__typeof__(Cyc_Absyn_empty_tqual(0U))_T107=Cyc_Absyn_empty_tqual(0U);_T4C->f1.ret_tqual= _T107;});_T4D= fntype;_T4D->f1.ret_type= rettype;_T4E= fntype;_T4E->f1.args= targs;_T4F= fntype;_T4F->f1.c_varargs= 0;_T50= fntype;_T50->f1.cyc_varargs= 0;_T51= fntype;
_T51->f1.qual_bnd= 0;_T52= fntype;_T52->f1.attributes= 0;_T53= fntype;_T53->f1.checks_clause= 0;_T54= fntype;_T54->f1.checks_assn= 0;_T55= fntype;_T55->f1.requires_clause= 0;_T56= fntype;_T56->f1.requires_assn= 0;_T57= fntype;_T57->f1.ensures_clause= 0;_T58= fntype;
_T58->f1.ensures_assn= 0;_T59= fntype;_T59->f1.throws_clause= 0;_T5A= fntype;_T5A->f1.throws_assn= 0;_T5B= fntype;_T5B->f1.return_value= 0;_T5C= fntype;_T5C->f1.arg_vardecls= 0;_T5D= fntype;_T5D->f1.effconstr= 0;{
# 1905
...
# 1924
_TL1C9: _T6E= tq;_T6F= _T6E.print_const;if(!_T6F)goto _TL1CD;_T6D= Cyc_Port_const_ct();goto _TL1CE;_TL1CD: _T6D= Cyc_Port_notconst_ct();_TL1CE: tqv= _T6D;_TL1CA:{struct Cyc_List_List*_T10B=_cycalloc(sizeof(struct Cyc_List_List));{struct _tuple21*_T10C=_cycalloc(sizeof(struct _tuple21));
# 1926
_T10C->f0= x;_T10C->f1= t;_T10C->f2= tqv;_T10C->f3= ct;_T71= (struct _tuple21*)_T10C;}_T10B->hd= _T71;_T10B->tl= c_args;_T70= (struct Cyc_List_List*)_T10B;}c_args= _T70;{struct Cyc_List_List*_T10B=_cycalloc(sizeof(struct Cyc_List_List));
...
# 1935
({__typeof__(Cyc_Absyn_Loc_n())_T107=Cyc_Absyn_Loc_n();(*_T75).f0= _T107;});_T76= fn_env;_T77= fd;_T78= _T77->name;_T79= fntype;_T7A= (void*)_T79;_T7B= 
...
_TL1D0: _T7F= xs;_T80= _T7F->hd;_T81= (struct _tuple21*)_T80;{struct _tuple21 _T107=*_T81;void*_T108;void*_T109;void*_T10A;struct _fat_ptr*_T10B;_T10B= _T107.f0;_T10A= _T107.f1;_T109= _T107.f2;_T108= _T107.f3;{struct _fat_ptr*x=_T10B;void*t=_T10A;void*q=_T109;void*ct=_T108;_T82= fn_env;{struct _tuple0*_T10C=_cycalloc(sizeof(struct _tuple0));
({__typeof__(Cyc_Absyn_Loc_n())_T10D=Cyc_Absyn_Loc_n();_T10C->f0= _T10D;});({__typeof__(_check_null(x))_T10D=_check_null(x);_T10C->f1= _T10D;});_T83= (struct _tuple0*)_T10C;}_T84= t;_T85= q;_T86= ct;fn_env= Cyc_Port_add_var(_T82,_T83,_T84,_T85,_T86,0U);}}_T87= xs;
# 1938
...
# 1967
struct _tuple17 _T107=*_T9F;void*_T108;void*_T109;void*_T10A;_T10A= _T107.f0;_TA0= _T107.f1;{struct _tuple14 _T10B=*_TA0;_T109= _T10B.f0;_T108= _T10B.f1;}{void*orig_type=_T10A;void*q2=_T109;void*t2=_T108;_TA1= q2;_TA2= 
...
({__typeof__(Cyc_Absyn_Loc_n())_T107=Cyc_Absyn_Loc_n();(*_TA9).f0= _T107;});_TAA= env;_TAB= td;_TAC= _TAB->name;_TAD= t;_TAE= ct;
...
({__typeof__(Cyc_Absyn_Loc_n())_T107=Cyc_Absyn_Loc_n();(*_TB2).f0= _T107;});{
...
if(!_TC7)goto _TL1DF;_TC4= Cyc_Port_const_ct();goto _TL1E0;_TL1DF: _TC4= Cyc_Port_notconst_ct();_TL1E0: _TC8= f;_TC9= _TC8->tq;_TCA= _TC9.loc;Cyc_Port_register_const_cvar(_TC2,_TC3,_TC4,_TCA);goto _TL1DE;
# 2017
...
# 2038
({__typeof__(Cyc_Absyn_Loc_n())_T107=Cyc_Absyn_Loc_n();(*_TE0).f0= _T107;});_TE1= ed;_TE2= _TE1->fields;_TE3= (unsigned)_TE2;
# 2040
...
_TL1EA: _TE9= fs;_TEA= _TE9->hd;_TEB= (struct Cyc_Absyn_Enumfield*)_TEA;_TEC= _TEB->name;({__typeof__(Cyc_Absyn_Loc_n())_T107=Cyc_Absyn_Loc_n();(*_TEC).f0= _T107;});_TED= env;_TEE= fs;_TEF= _TEE->hd;_TF0= (struct Cyc_Absyn_Enumfield*)_TEF;_TF1= _TF0->name;_TF2= ed;_TF3= _TF2->name;_TF4= ed;_TF5= 
Cyc_Absyn_enum_type(_TF3,_TF4);_TF6= Cyc_Port_const_ct();_TF7= Cyc_Port_arith_ct();env= Cyc_Port_add_var(_TED,_TF1,_TF5,_TF6,_TF7,0U);_TF8= fs;
# 2041
...
# 2050
_tag_fat("Warning: Cyclone declaration found in code to be ported -- skipping.",sizeof(char),69U);_TFF= _tag_fat(0U,sizeof(void*),0);
# 2048
Cyc_fprintf(_TFD,_TFE,_TFF);goto _TL1EE;_TL1ED: _TL1EE: _T100= env;
# 2051
return _T100;};}}
# 2056
...
return _T7;}
# 2062
static struct Cyc_List_List*Cyc_Port_gen_edits(struct Cyc_List_List*ds){struct Cyc_Port_Cenv*_T0;struct Cyc_List_List*_T1;struct Cyc_Port_Cenv*_T2;struct Cyc_Port_GlobalCenv*_T3;struct Cyc_Port_Cenv*_T4;struct Cyc_Port_GlobalCenv*_T5;struct Cyc_Port_Cenv*_T6;struct Cyc_Port_GlobalCenv*_T7;struct Cyc_Port_Cenv*_T8;struct Cyc_Port_GlobalCenv*_T9;struct Cyc_Port_Cenv*_TA;struct Cyc_Port_GlobalCenv*_TB;struct Cyc_List_List*_TC;unsigned _TD;struct Cyc_List_List*_TE;void*_TF;struct _tuple19*_T10;struct Cyc_List_List*_T11;struct Cyc_List_List*_T12;unsigned _T13;struct Cyc_List_List*_T14;void*_T15;struct _tuple19*_T16;struct Cyc_List_List*_T17;struct Cyc_List_List*_T18;unsigned _T19;struct Cyc_List_List*_T1A;void*_T1B;struct _tuple19*_T1C;struct Cyc_List_List*_T1D;struct Cyc_List_List*_T1E;unsigned _T1F;struct Cyc_List_List*_T20;void*_T21;struct _tuple19*_T22;long _T23;unsigned _T24;int _T25;int*_T26;unsigned _T27;struct Cyc_List_List*_T28;struct Cyc_Port_Edit*_T29;struct Cyc_List_List*_T2A;struct Cyc_Port_Edit*_T2B;struct Cyc_List_List*_T2C;struct Cyc_List_List*_T2D;unsigned _T2E;struct Cyc_List_List*_T2F;void*_T30;struct _tuple19*_T31;long _T32;unsigned _T33;int _T34;int*_T35;unsigned _T36;struct Cyc_List_List*_T37;struct Cyc_Port_Edit*_T38;struct Cyc_List_List*_T39;struct Cyc_Port_Edit*_T3A;struct Cyc_List_List*_T3B;struct Cyc_List_List*_T3C;unsigned _T3D;struct Cyc_List_List*_T3E;void*_T3F;struct _tuple19*_T40;long _T41;unsigned _T42;int _T43;int*_T44;unsigned _T45;struct Cyc_List_List*_T46;struct Cyc_Port_Edit*_T47;struct Cyc_List_List*_T48;struct Cyc_Port_Edit*_T49;struct Cyc_List_List*_T4A;struct Cyc_List_List*(*_T4B)(int(*)(struct Cyc_Port_Edit*,struct Cyc_Port_Edit*),struct Cyc_List_List*);struct Cyc_List_List*(*_T4C)(int(*)(void*,void*),struct Cyc_List_List*);struct Cyc_List_List*_T4D;struct Cyc_List_List*_T4E;unsigned _T4F;struct Cyc_List_List*_T50;void*_T51;struct Cyc_Port_Edit*_T52;unsigned _T53;struct Cyc_List_List*_T54;struct Cyc_List_List*_T55;_T0= 
# 2064
...
_TL1F4: _TE= ps;_TF= _TE->hd;_T10= (struct _tuple19*)_TF;{struct _tuple19 _T56=*_T10;unsigned _T57;void*_T58;void*_T59;_T59= _T56.f0;_T58= _T56.f1;_T57= _T56.f2;{void*new_ctype=_T59;void*orig_ctype=_T58;unsigned loc=_T57;
...
_TL1F8: _T14= cs;_T15= _T14->hd;_T16= (struct _tuple19*)_T15;{struct _tuple19 _T56=*_T16;unsigned _T57;void*_T58;void*_T59;_T59= _T56.f0;_T58= _T56.f1;_T57= _T56.f2;{void*new_qual=_T59;void*old_qual=_T58;unsigned loc=_T57;
...
_TL1FC: _T1A= zs;_T1B= _T1A->hd;_T1C= (struct _tuple19*)_T1B;{struct _tuple19 _T56=*_T1C;unsigned _T57;void*_T58;void*_T59;_T59= _T56.f0;_T58= _T56.f1;_T57= _T56.f2;{void*new_zt=_T59;void*old_zt=_T58;unsigned loc=_T57;
...
_TL200: _T20= ptrs;_T21= _T20->hd;_T22= (struct _tuple19*)_T21;{struct _tuple19 _T56=*_T22;unsigned _T57;void*_T58;void*_T59;_T59= _T56.f0;_T58= _T56.f1;_T57= _T56.f2;{void*new_ctype=_T59;void*orig_ctype=_T58;unsigned loc=_T57;_T23= 
...
# 2115
_T5C->loc= loc;({__typeof__(_tag_fat("?",sizeof(char),2U))_T5D=_tag_fat("?",sizeof(char),2U);_T5C->old_string= _T5D;});({__typeof__(_tag_fat("*",sizeof(char),2U))_T5D=_tag_fat("*",sizeof(char),2U);_T5C->new_string= _T5D;});_T29= (struct Cyc_Port_Edit*)_T5C;}_T5B->hd= _T29;_T5B->tl= edits;_T28= (struct Cyc_List_List*)_T5B;}edits= _T28;goto _LLC;case 3:{struct Cyc_List_List*_T5B=_cycalloc(sizeof(struct Cyc_List_List));{struct Cyc_Port_Edit*_T5C=_cycalloc(sizeof(struct Cyc_Port_Edit));
# 2118
_T5C->loc= loc;({__typeof__(_tag_fat("",sizeof(char),1U))_T5D=_tag_fat("",sizeof(char),1U);_T5C->old_string= _T5D;});({__typeof__(_tag_fat("@fat ",sizeof(char),6U))_T5D=_tag_fat("@fat ",sizeof(char),6U);_T5C->new_string= _T5D;});_T2B= (struct Cyc_Port_Edit*)_T5C;}_T5B->hd= _T2B;_T5B->tl= edits;_T2A= (struct Cyc_List_List*)_T5B;}edits= _T2A;goto _LLC;default: goto _LLC;}_LLC:;}goto _TL204;_TL203: _TL204:;}}_T2C= ptrs;
# 2110
ptrs= _T2C->tl;goto _TL202;_TL201:
# 2126
 _TL20A: _T2D= consts;_T2E= (unsigned)_T2D;if(_T2E)goto _TL208;else{goto _TL209;}
_TL208: _T2F= consts;_T30= _T2F->hd;_T31= (struct _tuple19*)_T30;{struct _tuple19 _T56=*_T31;unsigned _T57;void*_T58;void*_T59;_T59= _T56.f0;_T58= _T56.f1;_T57= _T56.f2;{void*new_qual=_T59;void*old_qual=_T58;unsigned loc=_T57;_T32= 
...
# 2131
_T5C->loc= loc;({__typeof__(_tag_fat("const ",sizeof(char),7U))_T5D=_tag_fat("const ",sizeof(char),7U);_T5C->old_string= _T5D;});({__typeof__(_tag_fat("",sizeof(char),1U))_T5D=_tag_fat("",sizeof(char),1U);_T5C->new_string= _T5D;});_T38= (struct Cyc_Port_Edit*)_T5C;}_T5B->hd= _T38;_T5B->tl= edits;_T37= (struct Cyc_List_List*)_T5B;}edits= _T37;goto _LL16;case 0:{struct Cyc_List_List*_T5B=_cycalloc(sizeof(struct Cyc_List_List));{struct Cyc_Port_Edit*_T5C=_cycalloc(sizeof(struct Cyc_Port_Edit));
# 2134
_T5C->loc= loc;({__typeof__(_tag_fat("",sizeof(char),1U))_T5D=_tag_fat("",sizeof(char),1U);_T5C->old_string= _T5D;});({__typeof__(_tag_fat("const ",sizeof(char),7U))_T5D=_tag_fat("const ",sizeof(char),7U);_T5C->new_string= _T5D;});_T3A= (struct Cyc_Port_Edit*)_T5C;}_T5B->hd= _T3A;_T5B->tl= edits;_T39= (struct Cyc_List_List*)_T5B;}edits= _T39;goto _LL16;default: goto _LL16;}_LL16:;}goto _TL20C;_TL20B: _TL20C:;}}_T3B= consts;
# 2126
consts= _T3B->tl;goto _TL20A;_TL209:
# 2142
 _TL212: _T3C= zts;_T3D= (unsigned)_T3C;if(_T3D)goto _TL210;else{goto _TL211;}
_TL210: _T3E= zts;_T3F= _T3E->hd;_T40= (struct _tuple19*)_T3F;{struct _tuple19 _T56=*_T40;unsigned _T57;void*_T58;void*_T59;_T59= _T56.f0;_T58= _T56.f1;_T57= _T56.f2;{void*new_zt=_T59;void*old_zt=_T58;unsigned loc=_T57;_T41= 
...
# 2147
_T5C->loc= loc;({__typeof__(_tag_fat("@nozeroterm ",sizeof(char),13U))_T5D=_tag_fat("@nozeroterm ",sizeof(char),13U);_T5C->old_string= _T5D;});({__typeof__(_tag_fat("",sizeof(char),1U))_T5D=_tag_fat("",sizeof(char),1U);_T5C->new_string= _T5D;});_T47= (struct Cyc_Port_Edit*)_T5C;}_T5B->hd= _T47;_T5B->tl= edits;_T46= (struct Cyc_List_List*)_T5B;}edits= _T46;goto _LL20;case 9:{struct Cyc_List_List*_T5B=_cycalloc(sizeof(struct Cyc_List_List));{struct Cyc_Port_Edit*_T5C=_cycalloc(sizeof(struct Cyc_Port_Edit));
# 2150
_T5C->loc= loc;({__typeof__(_tag_fat("@zeroterm ",sizeof(char),11U))_T5D=_tag_fat("@zeroterm ",sizeof(char),11U);_T5C->old_string= _T5D;});({__typeof__(_tag_fat("",sizeof(char),1U))_T5D=_tag_fat("",sizeof(char),1U);_T5C->new_string= _T5D;});_T49= (struct Cyc_Port_Edit*)_T5C;}_T5B->hd= _T49;_T5B->tl= edits;_T48= (struct Cyc_List_List*)_T5B;}edits= _T48;goto _LL20;default: goto _LL20;}_LL20:;}goto _TL214;_TL213: _TL214:;}}_T4A= zts;
# 2142
