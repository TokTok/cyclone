#include <cyc_include.h>
 struct Cyc_Core_Opt{void*v;};extern char Cyc_Core_Not_found[10U];struct Cyc_Core_Not_found_exn_struct{char*tag;};struct Cyc___cycFILE;
...
# 100
struct _fat_ptr Cyc_Absynpp_effconstr2string(struct Cyc_List_List*);struct Cyc_Dict_T;struct Cyc_Dict_Dict{int(*rel)(void*,void*);struct _RegionHandle*r;const struct Cyc_Dict_T*t;};
...
# 88 "cyclone/library/compiler/tcenv.h"
enum Cyc_Tcenv_NewStatus{Cyc_Tcenv_NoneNew =0U,Cyc_Tcenv_InNew =1U,Cyc_Tcenv_InNewAggr =2U};
# 155
extern void*Cyc_Tcenv_glob_curr_rgn;
# 30 "cyclone/library/compiler/currgn.h"
...
# 92 "cyclone/library/compiler/kinds.h"
struct Cyc_Core_Opt Cyc_Kinds_tvar_kind_opt(struct Cyc_Absyn_Tvar*);
# 128 "cyclone/library/compiler/tcutil.h"
int Cyc_Tcutil_typecmp(void*,void*);
# 144
long Cyc_Tcutil_subset_effect(long,void*,void*);
# 146
long Cyc_Tcutil_check_eff_in_cap(unsigned,long,void*,struct Cyc_List_List*,void*);
# 148
long Cyc_Tcutil_satisfies_effect_constraints(unsigned,struct Cyc_List_List*,struct Cyc_List_List*);
# 167
...
extern struct _fat_ptr Cyc_aprintf(struct _fat_ptr,struct _fat_ptr);
# 161
extern int Cyc_fprintf(struct Cyc___cycFILE*,struct _fat_ptr,struct _fat_ptr);struct Cyc_Warn_String_Warn_Warg_struct{int tag;struct _fat_ptr f1;};struct Cyc_Warn_Typ_Warn_Warg_struct{int tag;void*f1;};
# 79 "cyclone/library/compiler/warn.h"
void Cyc_Warn_err2(unsigned,struct _fat_ptr);char Cyc_Tcenv_Env_error[10U]="Env_error";
# 53 "cyclone/library/compiler/tcenv.cyc"
struct Cyc_Tcenv_Env_error_exn_struct Cyc_Tcenv_Env_error_val={Cyc_Tcenv_Env_error};
# 55
void*Cyc_Tcenv_env_err(struct _fat_ptr msg){struct Cyc_Tcenv_Env_error_exn_struct*_T0;struct Cyc_Tcenv_Env_error_exn_struct*_T1;_T0= & Cyc_Tcenv_Env_error_val;_T1= (struct Cyc_Tcenv_Env_error_exn_struct*)_T0;_throw(_T1);}struct _tuple13{struct Cyc_Absyn_Switch_clause*f0;struct Cyc_List_List*f1;struct Cyc_List_List*f2;};struct Cyc_Tcenv_SharedFenv{void*return_typ;struct Cyc_List_List*delayed_effect_checks;struct Cyc_List_List*delayed_constraint_checks;};struct Cyc_Tcenv_FenvFlags{enum Cyc_Tcenv_NewStatus in_new;long in_notreadctxt: 1;long in_lhs: 1;long abstract_ok: 1;long in_stmt_exp: 1;};struct Cyc_Tcenv_InitialConstraint_Tcenv_StoreConstraintEnv_struct{int tag;struct Cyc_List_List*f1;};struct Cyc_Tcenv_LastConstraint_Tcenv_StoreConstraintEnv_struct{int tag;void*f1;};struct Cyc_Tcenv_Fenv{struct Cyc_Tcenv_SharedFenv*shared;struct Cyc_List_List*type_vars;struct Cyc_List_List*aquals_bounds;const struct _tuple13*ctrl_env;void*capability;void*curr_rgn;void*curr_lifo_rgn;struct Cyc_Tcenv_FenvFlags flags;void*lastconstraint;struct Cyc_List_List*effconstr;};
# 135
...
# 137
struct Cyc_Tcenv_Genv*ae;ae= _cycalloc(sizeof(struct Cyc_Tcenv_Genv));_T0= ae;_T2= Cyc_Dict_empty;{struct Cyc_Dict_Dict(*_T1C)(int(*)(struct _tuple0*,struct _tuple0*))=(struct Cyc_Dict_Dict(*)(int(*)(struct _tuple0*,struct _tuple0*)))_T2;_T1= _T1C;}_T3= Cyc_Absyn_qvar_cmp;({__typeof__(_T1(_T3))_T1C=_T1(_T3);_T0->aggrdecls= _T1C;});_T4= ae;_T6= Cyc_Dict_empty;{
struct Cyc_Dict_Dict(*_T1C)(int(*)(struct _tuple0*,struct _tuple0*))=(struct Cyc_Dict_Dict(*)(int(*)(struct _tuple0*,struct _tuple0*)))_T6;_T5= _T1C;}_T7= Cyc_Absyn_qvar_cmp;({__typeof__(_T5(_T7))_T1C=_T5(_T7);_T4->datatypedecls= _T1C;});_T8= ae;_TA= Cyc_Dict_empty;{
struct Cyc_Dict_Dict(*_T1C)(int(*)(struct _tuple0*,struct _tuple0*))=(struct Cyc_Dict_Dict(*)(int(*)(struct _tuple0*,struct _tuple0*)))_TA;_T9= _T1C;}_TB= Cyc_Absyn_qvar_cmp;({__typeof__(_T9(_TB))_T1C=_T9(_TB);_T8->enumdecls= _T1C;});_TC= ae;_TE= Cyc_Dict_empty;{
struct Cyc_Dict_Dict(*_T1C)(int(*)(struct _tuple0*,struct _tuple0*))=(struct Cyc_Dict_Dict(*)(int(*)(struct _tuple0*,struct _tuple0*)))_TE;_TD= _T1C;}_TF= Cyc_Absyn_qvar_cmp;({__typeof__(_TD(_TF))_T1C=_TD(_TF);_TC->typedefs= _T1C;});_T10= ae;_T12= Cyc_Dict_empty;{
struct Cyc_Dict_Dict(*_T1C)(int(*)(struct _tuple0*,struct _tuple0*))=(struct Cyc_Dict_Dict(*)(int(*)(struct _tuple0*,struct _tuple0*)))_T12;_T11= _T1C;}_T13= Cyc_Absyn_qvar_cmp;({__typeof__(_T11(_T13))_T1C=_T11(_T13);_T10->ordinaries= _T1C;});_T14= ae;_T16= Cyc_Dict_insert;{
struct Cyc_Dict_Dict(*_T1C)(struct Cyc_Dict_Dict,struct _tuple0*,struct Cyc_Absyn_Datatypedecl**)=(struct Cyc_Dict_Dict(*)(struct Cyc_Dict_Dict,struct _tuple0*,struct Cyc_Absyn_Datatypedecl**))_T16;_T15= _T1C;}_T17= ae;_T18= _T17->datatypedecls;_T19= Cyc_Absyn_exn_name;{struct Cyc_Absyn_Datatypedecl**_T1C=_cycalloc(sizeof(struct Cyc_Absyn_Datatypedecl*));({__typeof__(Cyc_Absyn_exn_tud())_T1D=Cyc_Absyn_exn_tud();*_T1C= _T1D;});_T1A= (struct Cyc_Absyn_Datatypedecl**)_T1C;}({__typeof__(_T15(_T18,_T19,_T1A))_T1C=_T15(_T18,_T19,_T1A);_T14->datatypedecls= _T1C;});{struct Cyc_Tcenv_Tenv*_T1C=_cycalloc(sizeof(struct Cyc_Tcenv_Tenv));
_T1C->ns= 0;_T1C->ae= ae;_T1C->le= 0;_T1C->allow_valueof= 0;_T1C->in_extern_c_include= 0;_T1C->in_tempest= 0;_T1C->tempest_generalize= 0;_T1C->in_extern_c_inc_repeat= 0;_T1B= (struct Cyc_Tcenv_Tenv*)_T1C;}return _T1B;}struct _tuple14{void*f0;long f1;};
# 145
void*Cyc_Tcenv_lookup_ordinary_global(struct Cyc_Tcenv_Tenv*te,unsigned loc,struct _tuple0*q,long is_use){struct _tuple14*(*_T0)(struct Cyc_Dict_Dict,struct _tuple0*);void*(*_T1)(struct Cyc_Dict_Dict,void*);struct Cyc_Tcenv_Tenv*_T2;struct Cyc_Tcenv_Genv*_T3;struct Cyc_Dict_Dict _T4;struct _tuple0*_T5;long _T6;struct _tuple14*_T7;struct _tuple14*_T8;struct _tuple14 _T9;void*_TA;_T1= Cyc_Dict_lookup;{
struct _tuple14*(*_TB)(struct Cyc_Dict_Dict,struct _tuple0*)=(struct _tuple14*(*)(struct Cyc_Dict_Dict,struct _tuple0*))_T1;_T0= _TB;}_T2= te;_T3= _T2->ae;_T4= _T3->ordinaries;_T5= q;{struct _tuple14*ans=_T0(_T4,_T5);_T6= is_use;
...
struct Cyc_Absyn_Datatypedecl**(*_T9)(struct Cyc_Dict_Dict,struct _tuple0*)=(struct Cyc_Absyn_Datatypedecl**(*)(struct Cyc_Dict_Dict,struct _tuple0*))_T3;_T2= _T9;}_T4= te;_T5= _T4->ae;_T6= _T5->datatypedecls;_T7= q;({__typeof__(_T2(_T6,_T7))_T9=_T2(_T6,_T7);*_T8= _T9;});_T0= (struct Cyc_Absyn_Datatypedecl***)_T8;}return _T0;}
# 160
...
if(le!=0)goto _TL2;{
int(*_T3)(struct _fat_ptr)=(int(*)(struct _fat_ptr))Cyc_Tcenv_env_err;_T1= _T3;}_T1(err_msg);goto _TL3;_TL2: _TL3: _T2= le;
return _T2;}}
# 175
...
if(_T1!=0)goto _TL4;{
int(*_T8)(struct _fat_ptr)=(int(*)(struct _fat_ptr))Cyc_Tcenv_env_err;_T2= _T8;}_T3= _tag_fat("put_fenv",sizeof(char),9U);_T2(_T3);goto _TL5;_TL4: _TL5: {
...
return _T3;}
# 188
void*Cyc_Tcenv_return_typ(struct Cyc_Tcenv_Tenv*te){struct Cyc_Tcenv_Tenv*_T0;struct _fat_ptr _T1;struct Cyc_Tcenv_Fenv*_T2;struct Cyc_Tcenv_SharedFenv*_T3;void*_T4;_T0= te;_T1= _tag_fat("return_typ",sizeof(char),11U);_T2= Cyc_Tcenv_get_fenv(_T0,_T1);_T3= _T2->shared;_T4= _T3->return_typ;return _T4;}
# 190
...
if(_T2!=0)goto _TL6;
return 0;_TL6: _T3= le;_T4= _T3->type_vars;
return _T4;}}
# 196
...
({__typeof__(Cyc_Tcenv_lookup_type_vars(te))_T2=Cyc_Tcenv_lookup_type_vars(te);_T1->v= _T2;});_T0= (struct Cyc_Core_Opt*)_T1;}return _T0;}
# 200
...
struct Cyc_Tcenv_Fenv*le=_T0->le;
if(le!=0)goto _TL8;_T1= 
Cyc_Tcenv_put_emptyfenv(te);return _T1;_TL8: {
...
struct Cyc_Tcenv_Fenv*le=_T0->le;
if(le!=0)goto _TLA;
return 0U;_TLA: _T1= le;_T2= _T1->flags;_T3= _T2.in_new;
return _T3;}}
# 223
long Cyc_Tcenv_abstract_val_ok(struct Cyc_Tcenv_Tenv*te){struct Cyc_Tcenv_Tenv*_T0;struct Cyc_Tcenv_Fenv*_T1;struct Cyc_Tcenv_FenvFlags _T2;long _T3;_T0= te;{
struct Cyc_Tcenv_Fenv*le=_T0->le;
if(le!=0)goto _TLC;
return 0;_TLC: _T1= le;_T2= _T1->flags;_T3= _T2.abstract_ok;
return _T3;}}
# 229
...
struct Cyc_Tcenv_Fenv*le=_T0->le;
if(le!=0)goto _TLE;_T1= 
Cyc_Tcenv_put_emptyfenv(te);return _T1;_TLE: {
struct Cyc_Tcenv_Fenv*ans;ans= _cycalloc(sizeof(struct Cyc_Tcenv_Fenv));_T2= ans;_T3= le;*_T2= *_T3;_T4= ans;
...
struct Cyc_Tcenv_Fenv*le=_T0->le;
if(le!=0)goto _TL10;_T1= 
Cyc_Tcenv_put_emptyfenv(te);return _T1;_TL10: {
struct Cyc_Tcenv_Fenv*ans;ans= _cycalloc(sizeof(struct Cyc_Tcenv_Fenv));_T2= ans;_T3= le;*_T2= *_T3;_T4= ans;
...
struct Cyc_Tcenv_Fenv*le=_T0->le;
if(le!=0)goto _TL12;_T1= 
Cyc_Tcenv_put_emptyfenv(te);return _T1;_TL12: {
struct Cyc_Tcenv_Fenv*ans;ans= _cycalloc(sizeof(struct Cyc_Tcenv_Fenv));_T2= ans;_T3= le;*_T2= *_T3;_T4= ans;
...
struct Cyc_Tcenv_Fenv*le=_T0->le;
if(le!=0)goto _TL14;_T1= 
Cyc_Tcenv_put_emptyfenv(te);return _T1;_TL14: {
struct Cyc_Tcenv_Fenv*ans;ans= _cycalloc(sizeof(struct Cyc_Tcenv_Fenv));_T2= ans;_T3= le;*_T2= *_T3;_T4= ans;
_T4->flags.in_notreadctxt= 0;_T5= 
Cyc_Tcenv_put_fenv(te,ans);return _T5;}}}
# 261
long Cyc_Tcenv_in_notreadctxt(struct Cyc_Tcenv_Tenv*te){struct Cyc_Tcenv_Tenv*_T0;struct Cyc_Tcenv_Fenv*_T1;struct Cyc_Tcenv_FenvFlags _T2;long _T3;_T0= te;{
struct Cyc_Tcenv_Fenv*le=_T0->le;
if(le!=0)goto _TL16;
return 0;_TL16: _T1= le;_T2= _T1->flags;_T3= _T2.in_notreadctxt;
return _T3;}}
# 267
...
struct Cyc_Tcenv_Fenv*le=_T0->le;
if(le!=0)goto _TL18;_T1= 
Cyc_Tcenv_put_emptyfenv(te);return _T1;_TL18: {
struct Cyc_Tcenv_Fenv*ans;ans= _cycalloc(sizeof(struct Cyc_Tcenv_Fenv));_T2= ans;_T3= le;*_T2= *_T3;_T4= ans;
...
struct Cyc_Tcenv_Fenv*le=_T0->le;
if(le!=0)goto _TL1A;_T1= 
Cyc_Tcenv_put_emptyfenv(te);return _T1;_TL1A: {
struct Cyc_Tcenv_Fenv*ans;ans= _cycalloc(sizeof(struct Cyc_Tcenv_Fenv));_T2= ans;_T3= le;*_T2= *_T3;_T4= ans;
_T4->flags.in_lhs= 0;_T5= 
Cyc_Tcenv_put_fenv(te,ans);return _T5;}}}
# 283
long Cyc_Tcenv_in_lhs(struct Cyc_Tcenv_Tenv*te){struct Cyc_Tcenv_Tenv*_T0;struct Cyc_Tcenv_Fenv*_T1;struct Cyc_Tcenv_FenvFlags _T2;long _T3;_T0= te;{
struct Cyc_Tcenv_Fenv*le=_T0->le;
if(le!=0)goto _TL1C;
return 0;_TL1C: _T1= le;_T2= _T1->flags;_T3= _T2.in_lhs;
return _T3;}}
# 289
...
struct Cyc_Tcenv_Fenv*le=_T0->le;
if(le!=0)goto _TL1E;_T1= 
Cyc_Tcenv_put_emptyfenv(te);return _T1;_TL1E: {
struct Cyc_Tcenv_Fenv*ans;ans= _cycalloc(sizeof(struct Cyc_Tcenv_Fenv));_T2= ans;_T3= le;*_T2= *_T3;_T4= ans;
_T4->flags.in_stmt_exp= 1;_T5= 
Cyc_Tcenv_put_fenv(te,ans);return _T5;}}}
# 297
long Cyc_Tcenv_in_stmt_exp(struct Cyc_Tcenv_Tenv*te){struct Cyc_Tcenv_Tenv*_T0;struct Cyc_Tcenv_Fenv*_T1;struct Cyc_Tcenv_FenvFlags _T2;long _T3;_T0= te;{
struct Cyc_Tcenv_Fenv*le=_T0->le;
if(le!=0)goto _TL20;
return 0;_TL20: _T1= le;_T2= _T1->flags;_T3= _T2.in_stmt_exp;
return _T3;}}
# 305
const struct _tuple13*const Cyc_Tcenv_process_fallthru(struct Cyc_Tcenv_Tenv*te,struct Cyc_Absyn_Stmt*s,struct Cyc_Absyn_Switch_clause***clauseopt){struct Cyc_Tcenv_Tenv*_T0;struct _fat_ptr _T1;struct Cyc_Tcenv_Fenv*_T2;struct Cyc_Absyn_Switch_clause***_T3;struct Cyc_Absyn_Switch_clause**_T4;const struct _tuple13*_T5;struct _tuple13 _T6;const struct _tuple13*_T7;_T0= te;_T1= 
# 307
_tag_fat("process_fallthru",sizeof(char),17U);_T2= Cyc_Tcenv_get_fenv(_T0,_T1);{const struct _tuple13*ans=_T2->ctrl_env;
...
return _T7;}}
# 313
struct Cyc_Tcenv_Tenv*Cyc_Tcenv_set_fallthru(struct Cyc_Tcenv_Tenv*te,struct Cyc_List_List*new_tvs,struct Cyc_List_List*vds,struct Cyc_Absyn_Switch_clause*clause){struct Cyc_List_List*_T0;struct Cyc_List_List*_T1;void*_T2;struct Cyc_Absyn_Vardecl*_T3;struct Cyc_List_List*_T4;struct _tuple13*_T5;struct _tuple13*_T6;struct _tuple13*_T7;struct Cyc_Tcenv_Fenv*_T8;struct Cyc_Tcenv_Tenv*_T9;struct _fat_ptr _TA;struct Cyc_Tcenv_Fenv*_TB;struct Cyc_Tcenv_Fenv*_TC;struct Cyc_Tcenv_Tenv*_TD;
# 315
...
# 318
struct _tuple13*new_ctrl_env;new_ctrl_env= _cycalloc(sizeof(struct _tuple13));_T5= new_ctrl_env;_T5->f0= clause;_T6= new_ctrl_env;_T6->f1= new_tvs;_T7= new_ctrl_env;({__typeof__(Cyc_List_imp_rev(ft_typ))_TE=Cyc_List_imp_rev(ft_typ);_T7->f2= _TE;});{
...
_T2B->hd= rgn;{struct Cyc_List_List*_T2C=_cycalloc(sizeof(struct Cyc_List_List));_T7= ans;_T2C->hd= _T7->capability;_T2C->tl= 0;_T6= (struct Cyc_List_List*)_T2C;}_T2B->tl= _T6;_T5= (struct Cyc_List_List*)_T2B;}({__typeof__(Cyc_Absyn_join_eff(_T5))_T2B=Cyc_Absyn_join_eff(_T5);_T4->capability= _T2B;});_T8= lifo;
# 359
...
# 367
_T2D->f1= rgn;({__typeof__(Cyc_Absyn_join_eff(l))_T2E=Cyc_Absyn_join_eff(l);_T2D->f2= _T2E;});_TE= (struct Cyc_Absyn_DisjointConstraint_Absyn_EffConstraint_struct*)_T2D;}dj= (void*)_TE;_TF= ans;{struct Cyc_Tcenv_LastConstraint_Tcenv_StoreConstraintEnv_struct*_T2D=_cycalloc(sizeof(struct Cyc_Tcenv_LastConstraint_Tcenv_StoreConstraintEnv_struct));_T2D->tag= 1;
...
# 373
_T30->f1= rgn;{struct Cyc_List_List*_T31=_cycalloc(sizeof(struct Cyc_List_List));_T31->hd= e;_T31->tl= l;_T23= (struct Cyc_List_List*)_T31;}({__typeof__(Cyc_Absyn_join_eff(_T23))_T31=Cyc_Absyn_join_eff(_T23);_T30->f2= _T31;});_T22= (struct Cyc_Absyn_DisjointConstraint_Absyn_EffConstraint_struct*)_T30;}dj= (void*)_T22;_T24= c;
...
# 381
_T2C->f1= rgn;_T27= (struct Cyc_Absyn_SingleConstraint_Absyn_EffConstraint_struct*)_T2C;}_T2B->hd= (void*)_T27;{struct Cyc_List_List*_T2C=_cycalloc(sizeof(struct Cyc_List_List));({__typeof__(_check_null(dj))_T2D=_check_null(dj);_T2C->hd= _T2D;});_T29= ans;_T2C->tl= _T29->effconstr;_T28= (struct Cyc_List_List*)_T2C;}_T2B->tl= _T28;_T26= (struct Cyc_List_List*)_T2B;}_T25->effconstr= _T26;}goto _TL33;_TL32: _TL33: goto _TL31;_TL30: _TL31: _T2A= 
# 384
...
# 393
_T14->hd= (void*)_TE;{struct Cyc_List_List*_T15=_cycalloc(sizeof(struct Cyc_List_List));_T10= ans;_T15->hd= _T10->capability;_T15->tl= 0;_TF= (struct Cyc_List_List*)_T15;}_T14->tl= _TF;_TD= (struct Cyc_List_List*)_T14;}({__typeof__(Cyc_Absyn_join_eff(_TD))_T14=Cyc_Absyn_join_eff(_TD);_TC->capability= _T14;});_T11= ans;_T12= block_typ;
...
({__typeof__(Cyc_List_append(_T6,_T7))_T9=Cyc_List_append(_T6,_T7);_T4->effconstr= _T9;});_T8= 
...
struct Cyc_Tcenv_Fenv*le=_T0->le;
if(le!=0)goto _TL3D;
Cyc_Tcenv_glob_curr_rgn= Cyc_Absyn_heap_rgn_type;_T1= Cyc_Absyn_heap_rgn_type;
return _T1;_TL3D: _T2= le;
# 419
Cyc_Tcenv_glob_curr_rgn= _T2->curr_rgn;_T3= le;_T4= _T3->curr_rgn;
return _T4;}}
# 422
...
struct Cyc_Tcenv_Fenv*le=_T0->le;
if(le!=0)goto _TL3F;_T1= Cyc_Absyn_heap_rgn_type;
return _T1;_TL3F: _T2= le;_T3= _T2->curr_lifo_rgn;
return _T3;}}
# 429
...
struct Cyc_Tcenv_Fenv*le=_T0->le;
if(le!=0)goto _TL41;
return 0;_TL41: _T1= le;_T2= _T1->effconstr;
return _T2;}}
# 435
...
struct Cyc_Tcenv_Fenv*le=_T0->le;
if(le!=0)goto _TL43;
return 0;_TL43: _T1= le;_T2= _T1->aquals_bounds;
return _T2;}}struct _tuple15{void*f0;void*f1;};
# 441
...
_TL46: _T0= i;_T1= _T0->hd;{struct _tuple15*_T8=(struct _tuple15*)_T1;void*_T9;void*_TA;{struct _tuple15 _TB=*_T8;_TA= _TB.f0;_T9= _TB.f1;}{void*tv=_TA;void*b=_T9;{struct Cyc_String_pa_PrintArg_struct _TB;_TB.tag= 0;
({__typeof__(Cyc_Absynpp_typ2string(tv))_TC=Cyc_Absynpp_typ2string(tv);_TB.f1= _TC;});_T2= _TB;}{struct Cyc_String_pa_PrintArg_struct _TB=_T2;{struct Cyc_String_pa_PrintArg_struct _TC;_TC.tag= 0;({__typeof__(Cyc_Absynpp_typ2string(b))_TD=Cyc_Absynpp_typ2string(b);_TC.f1= _TD;});_T3= _TC;}{struct Cyc_String_pa_PrintArg_struct _TC=_T3;void*_TD[2];_TD[0]= & _TB;_TD[1]= & _TC;_T4= Cyc_stderr;_T5= _tag_fat(" (%s, %s) ",sizeof(char),11U);_T6= _tag_fat(_TD,sizeof(void*),2);Cyc_fprintf(_T4,_T5,_T6);}}}}_T7= i;
# 442
i= _T7->tl;goto _TL48;_TL47:;}
# 447
struct Cyc_Tcenv_Tenv*Cyc_Tcenv_add_aquals_bound(struct Cyc_Tcenv_Tenv*te,void*aq,void*bnd){struct Cyc_Tcenv_Fenv*_T0;struct Cyc_Tcenv_Tenv*_T1;struct _fat_ptr _T2;struct Cyc_Tcenv_Fenv*_T3;struct Cyc_Tcenv_Fenv*_T4;struct _handler_cons*_T5;int _T6;int(*_T7)(void*,void*);struct Cyc_List_List*_T8;void*_T9;void*_TA;struct Cyc_Core_Not_found_exn_struct*_TB;char*_TC;char*_TD;struct Cyc_Tcenv_Fenv*_TE;struct Cyc_List_List*_TF;struct _tuple15*_T10;struct Cyc_Tcenv_Tenv*_T11;
...
# 451
void*found=Cyc_List_assoc_cmp(_T7,_T8,_T9);struct Cyc_Tcenv_Tenv*_T14=te;_npop_handler(0);return _T14;}_pop_handler();goto _TL4C;_TL4B: _TA= Cyc_Core_get_exn_thrown();{void*_T14=(void*)_TA;void*_T15;_TB= (struct Cyc_Core_Not_found_exn_struct*)_T14;_TC= _TB->tag;_TD= Cyc_Core_Not_found;if(_TC!=_TD)goto _TL4E;goto _LL0;_TL4E: _T15= _T14;{void*exn=_T15;_rethrow(exn);}_LL0:;}_TL4C:;}}_TE= ans;{struct Cyc_List_List*_T12=_cycalloc(sizeof(struct Cyc_List_List));{struct _tuple15*_T13=_cycalloc(sizeof(struct _tuple15));
# 457
_T13->f0= aq;_T13->f1= bnd;_T10= (struct _tuple15*)_T13;}_T12->hd= _T10;_T12->tl= aqb;_TF= (struct Cyc_List_List*)_T12;}_TE->aquals_bounds= _TF;_T11= 
Cyc_Tcenv_put_fenv(te,ans);return _T11;}}
# 464
void Cyc_Tcenv_check_effect_accessible_nodelay(struct Cyc_Tcenv_Tenv*te,unsigned loc,void*rgn){struct Cyc_Tcenv_Tenv*_T0;long _T1;struct Cyc_Tcenv_Tenv*_T2;struct _fat_ptr _T3;void*_T4;struct Cyc_Tcenv_Fenv*_T5;void*_T6;long _T7;void*_T8;struct Cyc_Tcenv_Fenv*_T9;void*_TA;long _TB;unsigned _TC;void*_TD;struct Cyc_Tcenv_Fenv*_TE;struct Cyc_List_List*_TF;struct Cyc_Tcenv_Fenv*_T10;void*_T11;long _T12;unsigned _T13;void*_T14;struct Cyc_Tcenv_Fenv*_T15;struct Cyc_List_List*_T16;struct Cyc_Tcenv_Fenv*_T17;void*_T18;long _T19;struct Cyc_Warn_String_Warn_Warg_struct _T1A;struct Cyc_Warn_Typ_Warn_Warg_struct _T1B;unsigned _T1C;struct _fat_ptr _T1D;_T0= te;_T1= _T0->allow_valueof;
# 466
if(!_T1)goto _TL50;
return;_TL50: _T2= te;_T3= 
...
Cyc_Tcutil_subset_effect(0,_T4,_T6);if(_T7)goto _TL54;else{goto _TL55;}_TL55: _T8= rgn;_T9= fe;_TA= _T9->capability;_TB= Cyc_Tcutil_subset_effect(1,_T8,_TA);if(_TB)goto _TL54;else{goto _TL52;}
...
# 480
({__typeof__(_tag_fat("Expression accesses unavailable region ",sizeof(char),40U))_T1F=_tag_fat("Expression accesses unavailable region ",sizeof(char),40U);_T1E.f1= _T1F;});_T1A= _T1E;}{struct Cyc_Warn_String_Warn_Warg_struct _T1E=_T1A;{struct Cyc_Warn_Typ_Warn_Warg_struct _T1F;_T1F.tag= 2;_T1F.f1= rgn;_T1B= _T1F;}{struct Cyc_Warn_Typ_Warn_Warg_struct _T1F=_T1B;void*_T20[2];_T20[0]= & _T1E;_T20[1]= & _T1F;_T1C= loc;_T1D= _tag_fat(_T20,sizeof(void*),2);Cyc_Warn_err2(_T1C,_T1D);}}}}struct _tuple16{void*f0;void*f1;struct Cyc_List_List*f2;unsigned f3;};
# 485
void Cyc_Tcenv_check_effect_accessible(struct Cyc_Tcenv_Tenv*te,unsigned loc,void*eff){struct Cyc_Tcenv_Tenv*_T0;long _T1;struct Cyc_Tcenv_Tenv*_T2;struct _fat_ptr _T3;long _T4;long _T5;struct Cyc_Tcenv_SharedFenv*_T6;struct Cyc_List_List*_T7;struct _tuple16*_T8;struct Cyc_Tcenv_SharedFenv*_T9;_T0= te;_T1= _T0->allow_valueof;
# 487
if(!_T1)goto _TL5A;
return;_TL5A: _T2= te;_T3= 
# 490
...
return;_TL5E: _T6= shared;{struct Cyc_List_List*_TE=_cycalloc(sizeof(struct Cyc_List_List));{struct _tuple16*_TF=_cycalloc(sizeof(struct _tuple16));
# 496
_TF->f0= capability;_TF->f1= eff;_TF->f2= effc;_TF->f3= loc;_T8= (struct _tuple16*)_TF;}_TE->hd= _T8;_T9= shared;_TE->tl= _T9->delayed_effect_checks;_T7= (struct Cyc_List_List*)_TE;}
# 495
_T6->delayed_effect_checks= _T7;}}}
# 498
void Cyc_Tcenv_check_delayed_effects(struct Cyc_Tcenv_Tenv*te){struct Cyc_Tcenv_Tenv*_T0;struct _fat_ptr _T1;struct Cyc_Tcenv_Fenv*_T2;struct Cyc_Tcenv_SharedFenv*_T3;struct Cyc_List_List*_T4;void*_T5;long _T6;long _T7;struct Cyc_Warn_String_Warn_Warg_struct _T8;struct Cyc_Warn_Typ_Warn_Warg_struct _T9;struct Cyc_Warn_String_Warn_Warg_struct _TA;struct Cyc_Warn_Typ_Warn_Warg_struct _TB;unsigned _TC;struct _fat_ptr _TD;struct Cyc_List_List*_TE;_T0= te;_T1= 
_tag_fat("check_delayed_constraints",sizeof(char),26U);_T2= Cyc_Tcenv_get_fenv(_T0,_T1);_T3= _T2->shared;{struct Cyc_List_List*checks=_T3->delayed_effect_checks;
_TL63: if(checks!=0)goto _TL61;else{goto _TL62;}
_TL61: _T4= checks;_T5= _T4->hd;{struct _tuple16*_TF=(struct _tuple16*)_T5;unsigned _T10;struct Cyc_List_List*_T11;void*_T12;void*_T13;{struct _tuple16 _T14=*_TF;_T13= _T14.f0;_T12= _T14.f1;_T11= _T14.f2;_T10= _T14.f3;}{void*capability=_T13;void*eff=_T12;struct Cyc_List_List*constr=_T11;unsigned loc=_T10;_T6= 
...
# 506
({__typeof__(_tag_fat("Capability \n",sizeof(char),13U))_T15=_tag_fat("Capability \n",sizeof(char),13U);_T14.f1= _T15;});_T8= _T14;}{struct Cyc_Warn_String_Warn_Warg_struct _T14=_T8;{struct Cyc_Warn_Typ_Warn_Warg_struct _T15;_T15.tag= 2;_T15.f1= capability;_T9= _T15;}{struct Cyc_Warn_Typ_Warn_Warg_struct _T15=_T9;{struct Cyc_Warn_String_Warn_Warg_struct _T16;_T16.tag= 0;({__typeof__(_tag_fat("\ndoes not cover function's effect\n",sizeof(char),35U))_T17=_tag_fat("\ndoes not cover function's effect\n",sizeof(char),35U);_T16.f1= _T17;});_TA= _T16;}{struct Cyc_Warn_String_Warn_Warg_struct _T16=_TA;{struct Cyc_Warn_Typ_Warn_Warg_struct _T17;_T17.tag= 2;_T17.f1= eff;_TB= _T17;}{struct Cyc_Warn_Typ_Warn_Warg_struct _T17=_TB;void*_T18[4];_T18[0]= & _T14;_T18[1]= & _T15;_T18[2]= & _T16;_T18[3]= & _T17;_TC= loc;_TD= _tag_fat(_T18,sizeof(void*),4);Cyc_Warn_err2(_TC,_TD);}}}}}}_TL60: _TE= checks;
# 500
checks= _TE->tl;goto _TL63;_TL62:;}}struct _tuple17{struct Cyc_List_List*f0;struct Cyc_List_List*f1;unsigned f2;};
# 510
void Cyc_Tcenv_check_effect_constraints(struct Cyc_Tcenv_Tenv*te,unsigned loc,struct Cyc_List_List*ec){struct Cyc_Tcenv_Tenv*_T0;struct Cyc_Tcenv_Fenv*_T1;long _T2;struct Cyc_Warn_String_Warn_Warg_struct _T3;unsigned _T4;struct _fat_ptr _T5;struct Cyc_Tcenv_Tenv*_T6;struct Cyc_Tcenv_Fenv*_T7;long _T8;struct Cyc_Tcenv_SharedFenv*_T9;struct Cyc_List_List*_TA;struct _tuple17*_TB;struct Cyc_Tcenv_SharedFenv*_TC;_T0= te;_T1= _T0->le;
if(_T1!=0)goto _TL68;_T2= 
Cyc_Tcutil_satisfies_effect_constraints(loc,ec,0);if(_T2)goto _TL6A;else{goto _TL6C;}
_TL6C:{struct Cyc_Warn_String_Warn_Warg_struct _TD;_TD.tag= 0;({__typeof__(_tag_fat("the effect constraints are not satisfied here",sizeof(char),46U))_TE=_tag_fat("the effect constraints are not satisfied here",sizeof(char),46U);_TD.f1= _TE;});_T3= _TD;}{struct Cyc_Warn_String_Warn_Warg_struct _TD=_T3;void*_TE[1];_TE[0]= & _TD;_T4= loc;_T5= _tag_fat(_TE,sizeof(void*),1);Cyc_Warn_err2(_T4,_T5);}goto _TL6B;_TL6A: _TL6B:
# 515
...
_TL6F: _T9= shared;{struct Cyc_List_List*_T10=_cycalloc(sizeof(struct Cyc_List_List));{struct _tuple17*_T11=_cycalloc(sizeof(struct _tuple17));
_T11->f0= ec;_T11->f1= env_ec;_T11->f2= loc;_TB= (struct _tuple17*)_T11;}_T10->hd= _TB;_TC= shared;_T10->tl= _TC->delayed_constraint_checks;_TA= (struct Cyc_List_List*)_T10;}
# 519
_T9->delayed_constraint_checks= _TA;goto _TL6E;_TL6D: _TL6E:;}}}
# 524
void Cyc_Tcenv_check_delayed_constraints(struct Cyc_Tcenv_Tenv*te){struct Cyc_Tcenv_Tenv*_T0;struct _fat_ptr _T1;struct Cyc_Tcenv_Fenv*_T2;struct Cyc_Tcenv_SharedFenv*_T3;struct Cyc_List_List*_T4;void*_T5;long _T6;struct Cyc_Warn_String_Warn_Warg_struct _T7;unsigned _T8;struct _fat_ptr _T9;struct Cyc_List_List*_TA;_T0= te;_T1= 
_tag_fat("check_delayed_constraints",sizeof(char),26U);_T2= Cyc_Tcenv_get_fenv(_T0,_T1);_T3= _T2->shared;{struct Cyc_List_List*checks=_T3->delayed_constraint_checks;
_TL73: if(checks!=0)goto _TL71;else{goto _TL72;}
_TL71: _T4= checks;_T5= _T4->hd;{struct _tuple17*_TB=(struct _tuple17*)_T5;unsigned _TC;struct Cyc_List_List*_TD;struct Cyc_List_List*_TE;{struct _tuple17 _TF=*_TB;_TE= _TF.f0;_TD= _TF.f1;_TC= _TF.f2;}{struct Cyc_List_List*ec=_TE;struct Cyc_List_List*env_ec=_TD;unsigned loc=_TC;_T6= 
Cyc_Tcutil_satisfies_effect_constraints(loc,ec,env_ec);if(_T6)goto _TL74;else{goto _TL76;}
_TL76:{struct Cyc_Warn_String_Warn_Warg_struct _TF;_TF.tag= 0;({__typeof__(_tag_fat("the effect constraints are not satisfied here",sizeof(char),46U))_T10=_tag_fat("the effect constraints are not satisfied here",sizeof(char),46U);_TF.f1= _T10;});_T7= _TF;}{struct Cyc_Warn_String_Warn_Warg_struct _TF=_T7;void*_T10[1];_T10[0]= & _TF;_T8= loc;_T9= _tag_fat(_T10,sizeof(void*),1);Cyc_Warn_err2(_T8,_T9);}goto _TL75;_TL74: _TL75:;}}_TA= checks;
# 526
...
# 535
_T1->return_typ= ret;_T1->delayed_effect_checks= 0;_T1->delayed_constraint_checks= 0;_T0= (struct Cyc_Tcenv_SharedFenv*)_T1;}
# 534
return _T0;}
# 538
...
({__typeof__(Cyc_Absyn_var_type(_TA))_T2F=Cyc_Absyn_var_type(_TA);_T2E->hd= _T2F;});_T2E->tl= es;_T7= (struct Cyc_List_List*)_T2E;}es= _T7;goto _TL7C;_TL7B: _TL7C:;}}_TB= tvs;
# 540
...
# 556
_T2C->f1= es;_T2A= (struct Cyc_Tcenv_InitialConstraint_Tcenv_StoreConstraintEnv_struct*)_T2C;}_T2B= (void*)_T2A;return _T2B;}struct _tuple18{struct Cyc_List_List*f0;void*f1;void*f2;};
# 559
struct Cyc_Tcenv_Fenv*Cyc_Tcenv_new_fenv(unsigned loc,struct Cyc_Absyn_Fndecl*fd){struct Cyc_Absyn_Tvar*_T0;struct _fat_ptr*_T1;struct _fat_ptr _T2;struct Cyc_String_pa_PrintArg_struct _T3;struct Cyc_Absyn_Fndecl*_T4;struct _tuple0*_T5;struct _tuple0 _T6;struct _fat_ptr*_T7;struct _fat_ptr _T8;struct _fat_ptr _T9;struct Cyc_Absyn_Tvar*_TA;struct Cyc_Absyn_Tvar*_TB;struct Cyc_Absyn_Eq_kb_Absyn_KindBound_struct*_TC;struct Cyc_Absyn_Eq_kb_Absyn_KindBound_struct*_TD;struct Cyc_Absyn_Tvar*_TE;struct _tuple18 _TF;struct Cyc_List_List*_T10;struct Cyc_Absyn_Fndecl*_T11;struct Cyc_Absyn_FnInfo _T12;struct Cyc_List_List*_T13;struct Cyc_List_List*_T14;struct Cyc_Absyn_Fndecl*_T15;struct Cyc_Absyn_FnInfo _T16;void*_T17;struct Cyc_Absyn_Fndecl*_T18;struct Cyc_Absyn_FnInfo _T19;struct Cyc_List_List*_T1A;struct Cyc_List_List*_T1B;struct Cyc_Absyn_VarType_Absyn_Type_struct*_T1C;struct Cyc_Absyn_Fndecl*_T1D;struct Cyc_Core_Opt*_T1E;struct Cyc_Core_Opt*_T1F;void*_T20;struct Cyc_List_List*_T21;void*_T22;struct Cyc_Absyn_Vardecl*_T23;struct Cyc_List_List*_T24;struct Cyc_Absyn_Fndecl*_T25;struct Cyc_Absyn_FnInfo _T26;struct Cyc_Absyn_VarargInfo*_T27;struct Cyc_Absyn_Fndecl*_T28;struct Cyc_Absyn_FnInfo _T29;struct Cyc_Absyn_VarargInfo*_T2A;struct Cyc_Absyn_Fndecl*_T2B;struct Cyc_Core_Opt*_T2C;struct Cyc_Core_Opt*_T2D;void*_T2E;struct Cyc_List_List*_T2F;void*_T30;struct Cyc_Absyn_Vardecl*_T31;struct _tuple0*_T32;struct _tuple0 _T33;struct _fat_ptr*_T34;struct _fat_ptr*_T35;int _T36;struct Cyc_Absyn_Vardecl*_T37;struct Cyc_List_List*_T38;struct Cyc_Tcenv_Fenv*_T39;struct Cyc_List_List*_T3A;struct Cyc_List_List*_T3B;struct Cyc_Absyn_Fndecl*_T3C;struct Cyc_Absyn_FnInfo _T3D;
struct Cyc_Absyn_Tvar*rgn0;rgn0= _cycalloc(sizeof(struct Cyc_Absyn_Tvar));_T0= rgn0;{struct _fat_ptr*_T3E=_cycalloc(sizeof(struct _fat_ptr));{struct Cyc_String_pa_PrintArg_struct _T3F;_T3F.tag= 0;_T4= fd;_T5= _T4->name;_T6= *_T5;_T7= _T6.f1;_T3F.f1= *_T7;_T3= _T3F;}{struct Cyc_String_pa_PrintArg_struct _T3F=_T3;void*_T40[1];_T40[0]= & _T3F;_T8= _tag_fat("`%s",sizeof(char),4U);_T9= _tag_fat(_T40,sizeof(void*),1);_T2= Cyc_aprintf(_T8,_T9);}*_T3E= _T2;_T1= (struct _fat_ptr*)_T3E;}_T0->name= _T1;_TA= rgn0;({__typeof__(Cyc_Tcutil_new_tvar_id())_T3E=Cyc_Tcutil_new_tvar_id();_TA->identity= _T3E;});_TB= rgn0;_TC= & Cyc_Tcenv_eff_kb;_TD= (struct Cyc_Absyn_Eq_kb_Absyn_KindBound_struct*)_TC;_TB->kind= (void*)_TD;_TE= rgn0;
_TE->aquals_bound= 0;{struct _tuple18 _T3E;{struct Cyc_List_List*_T3F=_cycalloc(sizeof(struct Cyc_List_List));
# 564
({__typeof__(Cyc_CurRgn_curr_rgn_tvar())_T40=Cyc_CurRgn_curr_rgn_tvar();_T3F->hd= _T40;});_T11= fd;_T12= _T11->i;_T3F->tl= _T12.tvars;_T10= (struct Cyc_List_List*)_T3F;}_T3E.f0= _T10;{struct Cyc_List_List*_T3F=_cycalloc(sizeof(struct Cyc_List_List));
({__typeof__(Cyc_CurRgn_curr_rgn_type())_T40=Cyc_CurRgn_curr_rgn_type();_T3F->hd= _T40;});{struct Cyc_List_List*_T40=_cycalloc(sizeof(struct Cyc_List_List));_T15= fd;_T16= _T15->i;_T17= _T16.effect;({__typeof__(_check_null(_T17))_T41=_check_null(_T17);_T40->hd= _T41;});_T40->tl= 0;_T14= (struct Cyc_List_List*)_T40;}_T3F->tl= _T14;_T13= (struct Cyc_List_List*)_T3F;}({__typeof__(Cyc_Absyn_join_eff(_T13))_T3F=Cyc_Absyn_join_eff(_T13);_T3E.f1= _T3F;});_T18= fd;_T19= _T18->i;
_T3E.f2= _T19.ret_type;_TF= _T3E;}{
# 563
struct _tuple18 _T3E=_TF;void*_T3F;void*_T40;struct Cyc_List_List*_T41;_T41= _T3E.f0;_T40= _T3E.f1;_T3F= _T3E.f2;{struct Cyc_List_List*tvs1=_T41;void*cap=_T40;void*ret_t=_T3F;
# 567
...
struct Cyc_Absyn_VarargInfo _T42=*_T2A;long _T43;void*_T44;struct Cyc_Absyn_Tqual _T45;struct _fat_ptr*_T46;_T46= _T42.name;_T45= _T42.tq;_T44= _T42.type;_T43= _T42.inject;{struct _fat_ptr*n=_T46;struct Cyc_Absyn_Tqual tq=_T45;void*t=_T44;long i=_T43;_T2B= fd;_T2C= _T2B->param_vardecls;_T2D= 
# 577
...
({__typeof__(Cyc_Absyn_fatptr_type(t,param_rgn,Cyc_Absyn_al_qual_type,tq,Cyc_Absyn_false_type,Cyc_Absyn_false_type))_T47=Cyc_Absyn_fatptr_type(t,param_rgn,Cyc_Absyn_al_qual_type,tq,Cyc_Absyn_false_type,Cyc_Absyn_false_type);_T37->type= _T47;});goto _TL8F;_TL91:;}_T38= vds;
# 577
vds= _T38->tl;goto _TL90;_TL8F:;}}}goto _TL8C;_TL8B: _TL8C:{struct Cyc_Tcenv_Fenv*_T42=_cycalloc(sizeof(struct Cyc_Tcenv_Fenv));
# 586
({__typeof__(Cyc_Tcenv_new_shared_fenv(ret_t))_T43=Cyc_Tcenv_new_shared_fenv(ret_t);_T42->shared= _T43;});
_T42->type_vars= tvs;
# 589
({__typeof__(Cyc_Tcutil_get_aquals_bounds(fd))_T43=Cyc_Tcutil_get_aquals_bounds(fd);_T42->aquals_bounds= _T43;});
_T42->ctrl_env= 0;{struct Cyc_List_List*_T43=_cycalloc(sizeof(struct Cyc_List_List));
_T43->hd= param_rgn;{struct Cyc_List_List*_T44=_cycalloc(sizeof(struct Cyc_List_List));_T44->hd= cap;_T44->tl= 0;_T3B= (struct Cyc_List_List*)_T44;}_T43->tl= _T3B;_T3A= (struct Cyc_List_List*)_T43;}({__typeof__(Cyc_Absyn_join_eff(_T3A))_T43=Cyc_Absyn_join_eff(_T3A);_T42->capability= _T43;});
_T42->curr_rgn= param_rgn;
({__typeof__(Cyc_CurRgn_curr_rgn_type())_T43=Cyc_CurRgn_curr_rgn_type();_T42->curr_lifo_rgn= _T43;});
...
_T46.f1= *_T8;_T4= _T46;}{struct Cyc_String_pa_PrintArg_struct _T46=_T4;void*_T47[1];_T47[0]= & _T46;_T9= _tag_fat("`%s",sizeof(char),4U);_TA= _tag_fat(_T47,sizeof(void*),1);_T3= Cyc_aprintf(_T9,_TA);}*_T45= _T3;_T2= (struct _fat_ptr*)_T45;}_T1->name= _T2;_TB= rgn0;({__typeof__(Cyc_Tcutil_new_tvar_id())_T45=Cyc_Tcutil_new_tvar_id();_TB->identity= _T45;});_TC= rgn0;_TD= & Cyc_Tcenv_eff_kb;_TE= (struct Cyc_Absyn_Eq_kb_Absyn_KindBound_struct*)_TD;_TC->kind= (void*)_TE;_TF= rgn0;_TF->aquals_bound= 0;{
struct Cyc_List_List*tvs;tvs= _cycalloc(sizeof(struct Cyc_List_List));_T10= tvs;_T10->hd= rgn0;_T11= tvs;_T12= fd;_T13= _T12->i;_T14= _T13.tvars;_T15= type_vars;({__typeof__(Cyc_List_append(_T14,_T15))_T45=Cyc_List_append(_T14,_T15);_T11->tl= _T45;});
Cyc_Tcutil_check_unique_tvars(loc,tvs);{
...
struct Cyc_Absyn_VarargInfo _T45=*_T24;long _T46;void*_T47;struct Cyc_Absyn_Tqual _T48;struct _fat_ptr*_T49;_T49= _T45.name;_T48= _T45.tq;_T47= _T45.type;_T46= _T45.inject;{struct _fat_ptr*n=_T49;struct Cyc_Absyn_Tqual tq=_T48;void*t=_T47;long i=_T46;_T25= fd;_T26= _T25->param_vardecls;_T27= 
# 618
...
({__typeof__(Cyc_Absyn_fatptr_type(t,param_rgn,Cyc_Absyn_al_qual_type,tq,Cyc_Absyn_false_type,Cyc_Absyn_false_type))_T4A=Cyc_Absyn_fatptr_type(t,param_rgn,Cyc_Absyn_al_qual_type,tq,Cyc_Absyn_false_type,Cyc_Absyn_false_type);_T31->type= _T4A;});goto _TL9B;_TL9D:;}_T32= vds;
# 618
...
# 626
({__typeof__(Cyc_Tcenv_new_shared_fenv(_T36))_T46=Cyc_Tcenv_new_shared_fenv(_T36);_T45->shared= _T46;});
_T45->type_vars= tvs;
# 629
_T45->aquals_bounds= aqb;
_T45->ctrl_env= 0;{struct Cyc_List_List*_T46=_cycalloc(sizeof(struct Cyc_List_List));
_T46->hd= param_rgn;{struct Cyc_List_List*_T47=_cycalloc(sizeof(struct Cyc_List_List));_T39= fd;_T3A= _T39->i;_T3B= _T3A.effect;({__typeof__(_check_null(_T3B))_T48=_check_null(_T3B);_T47->hd= _T48;});_T47->tl= 0;_T38= (struct Cyc_List_List*)_T47;}_T46->tl= _T38;_T37= (struct Cyc_List_List*)_T46;}({__typeof__(Cyc_Absyn_join_eff(_T37))_T46=Cyc_Absyn_join_eff(_T37);_T45->capability= _T46;});
_T45->curr_rgn= param_rgn;
({__typeof__(Cyc_CurRgn_curr_rgn_type())_T46=Cyc_CurRgn_curr_rgn_type();_T45->curr_lifo_rgn= _T46;});
...
({__typeof__(Cyc_List_append(_T3E,_T3F))_T46=Cyc_List_append(_T3E,_T3F);_T45->effconstr= _T46;});_T33= (struct Cyc_Tcenv_Fenv*)_T45;}
# 626
return _T33;}}}}}
# 639
...
struct Cyc_Absyn_Tvar*rgn0;rgn0= _cycalloc(sizeof(struct Cyc_Absyn_Tvar));_T0= rgn0;{struct _fat_ptr*_TD=_cycalloc(sizeof(struct _fat_ptr));({__typeof__(_tag_fat("bogus",sizeof(char),6U))_TE=_tag_fat("bogus",sizeof(char),6U);*_TD= _TE;});_T1= (struct _fat_ptr*)_TD;}_T0->name= _T1;_T2= rgn0;({__typeof__(Cyc_Tcutil_new_tvar_id())_TD=Cyc_Tcutil_new_tvar_id();_T2->identity= _TD;});_T3= rgn0;_T4= & Cyc_Tcenv_eff_kb;_T5= (struct Cyc_Absyn_Eq_kb_Absyn_KindBound_struct*)_T4;_T3->kind= (void*)_T5;_T6= rgn0;_T6->aquals_bound= 0;{
...
({__typeof__(Cyc_Tcenv_new_shared_fenv(ret_type))_TE=Cyc_Tcenv_new_shared_fenv(ret_type);_TD->shared= _TE;});
_TD->type_vars= tvs;
# 647
_TD->aquals_bounds= 0;
_TD->ctrl_env= 0;{struct Cyc_List_List*_TE=_cycalloc(sizeof(struct Cyc_List_List));
_TE->hd= param_rgn;_TE->tl= 0;_TB= (struct Cyc_List_List*)_TE;}({__typeof__(Cyc_Absyn_join_eff(_TB))_TE=Cyc_Absyn_join_eff(_TB);_TD->capability= _TE;});
_TD->curr_rgn= param_rgn;
({__typeof__(Cyc_CurRgn_curr_rgn_type())_TE=Cyc_CurRgn_curr_rgn_type();_TD->curr_lifo_rgn= _TE;});
...
({__typeof__(Cyc_Dict_copy(_TA))_T21=Cyc_Dict_copy(_TA);_T7->aggrdecls= _T21;});_TB= ans;_TC= _TB->ae;_TD= te;_TE= _TD->ae;_TF= _TE->enumdecls;
({__typeof__(Cyc_Dict_copy(_TF))_T21=Cyc_Dict_copy(_TF);_TC->enumdecls= _T21;});_T10= ans;_T11= _T10->ae;_T12= te;_T13= _T12->ae;_T14= _T13->datatypedecls;
({__typeof__(Cyc_Dict_copy(_T14))_T21=Cyc_Dict_copy(_T14);_T11->datatypedecls= _T21;});_T15= ans;_T16= _T15->ae;_T17= te;_T18= _T17->ae;_T19= _T18->typedefs;
({__typeof__(Cyc_Dict_copy(_T19))_T21=Cyc_Dict_copy(_T19);_T16->typedefs= _T21;});_T1A= ans;_T1B= _T1A->ae;_T1C= te;_T1D= _T1C->ae;_T1E= _T1D->ordinaries;
({__typeof__(Cyc_Dict_copy(_T1E))_T21=Cyc_Dict_copy(_T1E);_T1B->ordinaries= _T21;});_T1F= ans;
_T1F->le= 0;_T20= ans;
return _T20;}
# 669
...
_TLA0: _T0= c;_T1= _T0->hd;{struct _tuple17*_T8=(struct _tuple17*)_T1;struct Cyc_List_List*_T9;struct Cyc_List_List*_TA;{struct _tuple17 _TB=*_T8;_TA= _TB.f0;_T9= _TB.f1;}{struct Cyc_List_List*ec1=_TA;struct Cyc_List_List*env=_T9;{struct Cyc_String_pa_PrintArg_struct _TB;_TB.tag= 0;
({__typeof__(Cyc_Absynpp_effconstr2string(ec1))_TC=Cyc_Absynpp_effconstr2string(ec1);_TB.f1= _TC;});_T2= _TB;}{struct Cyc_String_pa_PrintArg_struct _TB=_T2;{struct Cyc_String_pa_PrintArg_struct _TC;_TC.tag= 0;({__typeof__(Cyc_Absynpp_effconstr2string(env))_TD=Cyc_Absynpp_effconstr2string(env);_TC.f1= _TD;});_T3= _TC;}{struct Cyc_String_pa_PrintArg_struct _TC=_T3;void*_TD[2];_TD[0]= & _TB;_TD[1]= & _TC;_T4= Cyc_stderr;_T5= _tag_fat(" (%s , %s)\n",sizeof(char),12U);_T6= _tag_fat(_TD,sizeof(void*),2);Cyc_fprintf(_T4,_T5,_T6);}}}}_T7= c;
# 670
