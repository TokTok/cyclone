...
# 1355
void Cyc_Absyn_visit_stmt(long(*)(void*,struct Cyc_Absyn_Exp*),long(*)(void*,struct Cyc_Absyn_Stmt*),void*,struct Cyc_Absyn_Stmt*);struct Cyc___cycFILE;struct Cyc_String_pa_PrintArg_struct{int tag;struct _fat_ptr f1;};
# 100 "./cyclone/library/std/cycboot.h"
extern int Cyc_fprintf(struct Cyc___cycFILE*,struct _fat_ptr,struct _fat_ptr);struct Cyc_Dict_T;struct Cyc_Dict_Dict{int(*rel)(void*,void*);struct _RegionHandle*r;const struct Cyc_Dict_T*t;};struct Cyc_Set_Set;
# 50 "./cyclone/library/std/set.h"
extern struct Cyc_Set_Set*Cyc_Set_empty(int(*)(void*,void*));
# 64
extern struct Cyc_Set_Set*Cyc_Set_insert(struct Cyc_Set_Set*,void*);
# 46 "./cyclone/library/std/graph.h"
...
# 71 "cyclone/library/compiler/absynpp.h"
...
# 53 "cyclone/library/compiler/callgraph.cyc"
...
return 0;}}}
# 81
static long Cyc_Callgraph_visit_cg_f2(struct _tuple11*env,struct Cyc_Absyn_Stmt*s){return 1;}
# 83
static struct Cyc_Set_Set*Cyc_Callgraph_cg_stmt(struct Cyc_Hashtable_Table*fds,struct Cyc_Absyn_Stmt*e,struct Cyc_Set_Set*s){struct _tuple11 _T0;void(*_T1)(long(*)(struct _tuple11*,struct Cyc_Absyn_Exp*),long(*)(struct _tuple11*,struct Cyc_Absyn_Stmt*),struct _tuple11*,struct Cyc_Absyn_Stmt*);void(*_T2)(long(*)(void*,struct Cyc_Absyn_Exp*),long(*)(void*,struct Cyc_Absyn_Stmt*),void*,struct Cyc_Absyn_Stmt*);struct _tuple11*_T3;struct Cyc_Absyn_Stmt*_T4;struct _tuple11 _T5;struct Cyc_Set_Set*_T6;{struct _tuple11 _T7;
_T7.f0= fds;_T7.f1= s;_T0= _T7;}{struct _tuple11 env=_T0;_T2= Cyc_Absyn_visit_stmt;{
# 86
void(*_T7)(long(*)(struct _tuple11*,struct Cyc_Absyn_Exp*),long(*)(struct _tuple11*,struct Cyc_Absyn_Stmt*),struct _tuple11*,struct Cyc_Absyn_Stmt*)=(void(*)(long(*)(struct _tuple11*,struct Cyc_Absyn_Exp*),long(*)(struct _tuple11*,struct Cyc_Absyn_Stmt*),struct _tuple11*,struct Cyc_Absyn_Stmt*))_T2;_T1= _T7;}_T3= & env;_T4= e;_T1(Cyc_Callgraph_visit_cg_f1,Cyc_Callgraph_visit_cg_f2,_T3,_T4);{struct Cyc_Set_Set*_T7;_T5= env;_T7= _T5.f1;{struct Cyc_Set_Set*s=_T7;_T6= s;
# 88
return _T6;}}}}
# 91
static int Cyc_Callgraph_fndecl_cmp(struct Cyc_Absyn_Fndecl*fd1,struct Cyc_Absyn_Fndecl*fd2){struct Cyc_Absyn_Fndecl*_T0;struct _tuple0*_T1;struct Cyc_Absyn_Fndecl*_T2;struct _tuple0*_T3;int _T4;_T0= fd1;_T1= _T0->name;_T2= fd2;_T3= _T2->name;_T4= Cyc_Absyn_qvar_cmp(_T1,_T3);return _T4;}
# 93
...
({__typeof__(Cyc_Absynpp_qvar2string(_T2))_T7=Cyc_Absynpp_qvar2string(_T2);_T6.f1= _T7;});_T0= _T6;}{struct Cyc_String_pa_PrintArg_struct _T6=_T0;void*_T7[1];_T7[0]= & _T6;_T3= f;_T4= _tag_fat("%s ",sizeof(char),4U);_T5= _tag_fat(_T7,sizeof(void*),1);Cyc_fprintf(_T3,_T4,_T5);}}
# 147
