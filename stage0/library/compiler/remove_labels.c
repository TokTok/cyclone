...
_TL7: _TA= label_iter;_TB= _TA->hd;_TC= (struct _fat_ptr*)_TB;_TD= label;_TE= Cyc_strptrcmp(_TC,_TD);if(_TE!=0)goto _TLA;
label_used= 1;goto _TLB;_TLA: _TLB: _TF= label_iter;
...
# 54
static long Cyc_RemoveLabels_visit_label_f1(struct Cyc_RemoveLabels_LabelBin*lb,struct Cyc_Absyn_Exp*e){return 1;}
static long Cyc_RemoveLabels_visit_label_f2(struct Cyc_RemoveLabels_LabelBin*lb,struct Cyc_Absyn_Stmt*s){struct Cyc_Absyn_Stmt*_T0;int*_T1;unsigned _T2;struct Cyc_RemoveLabels_LabelBin*_T3;struct Cyc_List_List*_T4;struct Cyc_RemoveLabels_LabelBin*_T5;struct Cyc_RemoveLabels_LabelBin*_T6;struct Cyc_List_List*_T7;struct Cyc_RemoveLabels_LabelBin*_T8;_T0= s;{
...
# 58
_TB->hd= vt;_T5= lb;_TB->tl= _T5->label_gotos;_T4= (struct Cyc_List_List*)_TB;}_T3->label_gotos= _T4;
return 1;}case 13: _T6= lb;{struct Cyc_List_List*_TB=_cycalloc(sizeof(struct Cyc_List_List));
# 61
_TB->hd= s;_T8= lb;_TB->tl= _T8->label_stmts;_T7= (struct Cyc_List_List*)_TB;}_T6->label_stmts= _T7;
return 1;default:
# 64
 return 1;};}}
# 67
static void Cyc_RemoveLabels_anal_decl(struct Cyc_List_List*tds){struct Cyc_List_List*_T0;void*_T1;struct Cyc_Absyn_Decl*_T2;int*_T3;unsigned _T4;struct Cyc_RemoveLabels_LabelBin*_T5;struct Cyc_RemoveLabels_LabelBin*_T6;void(*_T7)(long(*)(struct Cyc_RemoveLabels_LabelBin*,struct Cyc_Absyn_Exp*),long(*)(struct Cyc_RemoveLabels_LabelBin*,struct Cyc_Absyn_Stmt*),struct Cyc_RemoveLabels_LabelBin*,struct Cyc_Absyn_Stmt*);void(*_T8)(long(*)(void*,struct Cyc_Absyn_Exp*),long(*)(void*,struct Cyc_Absyn_Stmt*),void*,struct Cyc_Absyn_Stmt*);struct Cyc_RemoveLabels_LabelBin*_T9;struct Cyc_Absyn_Fndecl*_TA;struct Cyc_Absyn_Stmt*_TB;struct Cyc_List_List*_TC;
...
void(*_T11)(long(*)(struct Cyc_RemoveLabels_LabelBin*,struct Cyc_Absyn_Exp*),long(*)(struct Cyc_RemoveLabels_LabelBin*,struct Cyc_Absyn_Stmt*),struct Cyc_RemoveLabels_LabelBin*,struct Cyc_Absyn_Stmt*)=(void(*)(long(*)(struct Cyc_RemoveLabels_LabelBin*,struct Cyc_Absyn_Exp*),long(*)(struct Cyc_RemoveLabels_LabelBin*,struct Cyc_Absyn_Stmt*),struct Cyc_RemoveLabels_LabelBin*,struct Cyc_Absyn_Stmt*))_T8;_T7= _T11;}_T9= lb;_TA= fndt;_TB= _TA->body;_T7(Cyc_RemoveLabels_visit_label_f1,Cyc_RemoveLabels_visit_label_f2,_T9,_TB);
