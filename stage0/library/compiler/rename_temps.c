...
void Cyc_Absyn_visit_exp(long(*)(void*,struct Cyc_Absyn_Exp*),long(*)(void*,struct Cyc_Absyn_Stmt*),void*,struct Cyc_Absyn_Exp*);struct Cyc___cycFILE;
...
struct _fat_ptr Cyc_Absynpp_exp2string(struct Cyc_Absyn_Exp*);struct Cyc_Dict_T;struct Cyc_Dict_Dict{int(*rel)(void*,void*);struct _RegionHandle*r;const struct Cyc_Dict_T*t;};
# 62 "./cyclone/library/std/dict.h"
extern struct Cyc_Dict_Dict Cyc_Dict_empty(int(*)(void*,void*));
# 87
extern struct Cyc_Dict_Dict Cyc_Dict_insert(struct Cyc_Dict_Dict,void*,void*);
# 108
extern void*Cyc_Dict_lookup(struct Cyc_Dict_Dict,void*);struct Cyc___cycFILE;
# 98 "bazel-out/k8-fastbuild/bin/cyclone/library/std/libc/stdio.h"
extern struct Cyc___cycFILE*Cyc_stderr;
# 127
extern struct _fat_ptr Cyc_aprintf(struct _fat_ptr,struct _fat_ptr);
# 161
extern int Cyc_fprintf(struct Cyc___cycFILE*,struct _fat_ptr,struct _fat_ptr);struct Cyc_Warn_String_Warn_Warg_struct{int tag;struct _fat_ptr f1;};
...
# 36 "cyclone/library/compiler/rename_temps.cyc"
static long Cyc_RenameTemps_is_temp_var(struct _tuple0*qv){struct _tuple0*_T0;struct _tuple0 _T1;struct _fat_ptr*_T2;int _T3;struct _fat_ptr _T4;unsigned _T5;struct _fat_ptr _T6;unsigned char*_T7;const char*_T8;const char*_T9;char _TA;int _TB;struct _fat_ptr _TC;unsigned char*_TD;const char*_TE;char _TF;int _T10;struct _fat_ptr _T11;unsigned char*_T12;const char*_T13;char _T14;int _T15;struct _fat_ptr _T16;unsigned char*_T17;const char*_T18;char _T19;int _T1A;_T0= qv;_T1= *_T0;_T2= _T1.f1;{
struct _fat_ptr v=*_T2;_T4= v;_T5= 
_get_fat_size(_T4,sizeof(char));if(_T5 <= 4U)goto _TL0;_T6= v;_T7= _T6.curr;_T8= (const char*)_T7;_T9= _check_null(_T8);_TA= _T9[0];_TB= (int)_TA;if(_TB!=95)goto _TL0;_TC= v;_TD= _TC.curr;_TE= (const char*)_TD;_TF= _TE[1];_T10= (int)_TF;if(_T10!=116)goto _TL0;_T11= v;_T12= _T11.curr;_T13= (const char*)_T12;_T14= _T13[2];_T15= (int)_T14;if(_T15!=109)goto _TL0;_T16= v;_T17= _T16.curr;_T18= (const char*)_T17;_T19= _T18[3];_T1A= (int)_T19;_T3= _T1A==112;goto _TL1;_TL0: _T3= 0;_TL1: return _T3;}}
# 40
...
static long Cyc_RenameTemps_rename_visit_f1(struct Cyc_RenameTemps_Env*env,struct Cyc_Absyn_Exp*e){struct Cyc_Absyn_Exp*_T0;int*_T1;int _T2;struct Cyc_Absyn_Var_e_Absyn_Raw_exp_struct*_T3;void**_T4;void**_T5;void*_T6;long _T7;struct _handler_cons*_T8;int _T9;void**_TA;void*(*_TB)(struct Cyc_Dict_Dict,struct _tuple0*);void*(*_TC)(struct Cyc_Dict_Dict,void*);struct Cyc_RenameTemps_Env*_TD;struct Cyc_Dict_Dict _TE;struct _tuple0*_TF;void*_T10;struct Cyc_String_pa_PrintArg_struct _T11;struct Cyc___cycFILE*_T12;struct _fat_ptr _T13;struct _fat_ptr _T14;_T0= e;{
...
struct Cyc_Dict_Dict(*_T38)(struct Cyc_Dict_Dict,struct _tuple0*,void*)=(struct Cyc_Dict_Dict(*)(struct Cyc_Dict_Dict,struct _tuple0*,void*))_TF;_TE= _T38;}_T10= env;_T11= _T10->d;_T12= vd;_T13= _T12->name;_T14= v;({__typeof__(_TE(_T11,_T13,_T14))_T38=_TE(_T11,_T13,_T14);_TD->d= _T38;});_T15= vd;{
struct Cyc_Absyn_Vardecl vd2=*_T15;
({__typeof__(Cyc_Absyn_binding2qvar(v))_T38=Cyc_Absyn_binding2qvar(v);vd2.name= _T38;});_T16= d;{struct Cyc_Absyn_Var_d_Absyn_Raw_decl_struct*_T38=_cycalloc(sizeof(struct Cyc_Absyn_Var_d_Absyn_Raw_decl_struct));_T38->tag= 0;{struct Cyc_Absyn_Vardecl*_T39=_cycalloc(sizeof(struct Cyc_Absyn_Vardecl));
...
# 100
({__typeof__(_tag_fat("RenameTemps: local decl not a var or function",sizeof(char),46U))_T39=_tag_fat("RenameTemps: local decl not a var or function",sizeof(char),46U);_T38.f1= _T39;});_T22= _T38;}{struct Cyc_Warn_String_Warn_Warg_struct _T38=_T22;void*_T39[1];_T39[0]= & _T38;_T24= Cyc_Warn_impos2;{int(*_T3A)(struct _fat_ptr)=(int(*)(struct _fat_ptr))_T24;_T23= _T3A;}_T25= _tag_fat(_T39,sizeof(void*),1);_T23(_T25);}}_LL7:;}_T26= s1;{
# 102
...
# 104
d= d2;
s1= s2;goto _TL10;}_TL18: _T2A= Cyc_Absyn_visit_stmt;{
# 108
void(*_T38)(long(*)(struct Cyc_RenameTemps_Env*,struct Cyc_Absyn_Exp*),long(*)(struct Cyc_RenameTemps_Env*,struct Cyc_Absyn_Stmt*),struct Cyc_RenameTemps_Env*,struct Cyc_Absyn_Stmt*)=(void(*)(long(*)(struct Cyc_RenameTemps_Env*,struct Cyc_Absyn_Exp*),long(*)(struct Cyc_RenameTemps_Env*,struct Cyc_Absyn_Stmt*),struct Cyc_RenameTemps_Env*,struct Cyc_Absyn_Stmt*))_T2A;_T29= _T38;}_T2B= env;_T2C= s1;_T29(Cyc_RenameTemps_rename_visit_f1,Cyc_RenameTemps_rename_visit_f2,_T2B,_T2C);_T2D= env;
*_T2D= old_env;
...
struct Cyc_Dict_Dict(*_T2B)(struct Cyc_Dict_Dict,struct _tuple0*,void*)=(struct Cyc_Dict_Dict(*)(struct Cyc_Dict_Dict,struct _tuple0*,void*))_TF;_TE= _T2B;}_T10= env;_T11= _T10.d;_T12= vd;_T13= _T12->name;_T14= v;({__typeof__(_TE(_T11,_T13,_T14))_T2B=_TE(_T11,_T13,_T14);env.d= _T2B;});_T15= vd;{
struct Cyc_Absyn_Vardecl vd2=*_T15;
({__typeof__(Cyc_Absyn_binding2qvar(v))_T2B=Cyc_Absyn_binding2qvar(v);vd2.name= _T2B;});_T16= tds2;_T17= _T16->hd;_T18= (struct Cyc_Absyn_Decl*)_T17;{struct Cyc_Absyn_Var_d_Absyn_Raw_decl_struct*_T2B=_cycalloc(sizeof(struct Cyc_Absyn_Var_d_Absyn_Raw_decl_struct));_T2B->tag= 0;{struct Cyc_Absyn_Vardecl*_T2C=_cycalloc(sizeof(struct Cyc_Absyn_Vardecl));
