...
# 33 "cyclone/library/compiler/kinds.cyc"
...
# 65 "cyclone/library/compiler/kinds.cyc"
...
# 131 "cyclone/library/compiler/kinds.cyc"
...
# 156
({__typeof__(_tag_fat("kind_to_opt: bad kind ",sizeof(char),23U))_T3C=_tag_fat("kind_to_opt: bad kind ",sizeof(char),23U);_T3B.f1= _T3C;});_T15= _T3B;}{struct Cyc_Warn_String_Warn_Warg_struct _T3B=_T15;{struct Cyc_Warn_Kind_Warn_Warg_struct _T3C;_T3C.tag= 9;_T3C.f1= kh;_T16= _T3C;}{struct Cyc_Warn_Kind_Warn_Warg_struct _T3C=_T16;void*_T3D[2];_T3D[0]= & _T3B;_T3D[1]= & _T3C;_T18= Cyc_Warn_impos2;{int(*_T3E)(struct _fat_ptr)=(int(*)(struct _fat_ptr))_T18;_T17= _T3E;}_T19= _tag_fat(_T3D,sizeof(void*),2);_T17(_T19);}}}goto _TL1;
# 159
...
# 188
({__typeof__(_tag_fat("kind_to_opt: bad kind ",sizeof(char),23U))_T3C=_tag_fat("kind_to_opt: bad kind ",sizeof(char),23U);_T3B.f1= _T3C;});_T34= _T3B;}{struct Cyc_Warn_String_Warn_Warg_struct _T3B=_T34;{struct Cyc_Warn_Kind_Warn_Warg_struct _T3C;_T3C.tag= 9;_T3C.f1= kh;_T35= _T3C;}{struct Cyc_Warn_Kind_Warn_Warg_struct _T3C=_T35;void*_T3D[2];_T3D[0]= & _T3B;_T3D[1]= & _T3C;_T37= Cyc_Warn_impos2;{int(*_T3E)(struct _fat_ptr)=(int(*)(struct _fat_ptr))_T37;_T36= _T3E;}_T38= _tag_fat(_T3D,sizeof(void*),2);_T36(_T38);}}}_TL1:;}}
# 193
void*Cyc_Kinds_kind_to_bound(struct Cyc_Absyn_Kind*k){struct Cyc_Absyn_Eq_kb_Absyn_KindBound_struct*_T0;void*_T1;{struct Cyc_Absyn_Eq_kb_Absyn_KindBound_struct*_T2=_cycalloc(sizeof(struct Cyc_Absyn_Eq_kb_Absyn_KindBound_struct));_T2->tag= 0;_T2->f1= k;_T0= (struct Cyc_Absyn_Eq_kb_Absyn_KindBound_struct*)_T2;}_T1= (void*)_T0;return _T1;}
# 195
struct Cyc_Core_Opt*Cyc_Kinds_kind_to_bound_opt(struct Cyc_Absyn_Kind*k){struct Cyc_Core_Opt*_T0;{struct Cyc_Core_Opt*_T1=_cycalloc(sizeof(struct Cyc_Core_Opt));({__typeof__(Cyc_Kinds_kind_to_bound(k))_T2=Cyc_Kinds_kind_to_bound(k);_T1->v= _T2;});_T0= (struct Cyc_Core_Opt*)_T1;}return _T0;}
# 198
...
# 208
_tag_fat("Region kind ::R is deprecated; use effect kind ::E instead",sizeof(char),59U);_TF= _tag_fat(0U,sizeof(void*),0);Cyc_Warn_warn(_TD,_TE,_TF);_T10= & Cyc_Kinds_ek;_T11= (struct Cyc_Absyn_Kind*)_T10;
return _T11;case 69: _T12= & Cyc_Kinds_ek;_T13= (struct Cyc_Absyn_Kind*)_T12;
# 211
...
({__typeof__(_tag_fat("Usage of deprecated kind: ",sizeof(char),27U))_T5F=_tag_fat("Usage of deprecated kind: ",sizeof(char),27U);_T5E.f1= _T5F;});_T19= _T5E;}{struct Cyc_Warn_String_Warn_Warg_struct _T5E=_T19;{struct Cyc_Warn_String_Warn_Warg_struct _T5F;_T5F.tag= 0;_T5F.f1= s;_T1A= _T5F;}{struct Cyc_Warn_String_Warn_Warg_struct _T5F=_T1A;void*_T60[2];_T60[0]= & _T5E;_T60[1]= & _T5F;_T1B= loc;_T1C= _tag_fat(_T60,sizeof(void*),2);Cyc_Warn_warn2(_T1B,_T1C);}}_T1D= s;_T1E= _T1D.curr;_T1F= (const char*)_T1E;_T20= _T1F[1];_T21= (int)_T20;
...
# 263
({__typeof__(_tag_fat("bad kind: ",sizeof(char),11U))_T5E=_tag_fat("bad kind: ",sizeof(char),11U);_T5D.f1= _T5E;});_T54= _T5D;}{struct Cyc_Warn_String_Warn_Warg_struct _T5D=_T54;{struct Cyc_Warn_String_Warn_Warg_struct _T5E;_T5E.tag= 0;_T5E.f1= s;_T55= _T5E;}{struct Cyc_Warn_String_Warn_Warg_struct _T5E=_T55;{struct Cyc_Warn_String_Warn_Warg_struct _T5F;_T5F.tag= 0;({__typeof__(_tag_fat(" strlen=",sizeof(char),9U))_T60=_tag_fat(" strlen=",sizeof(char),9U);_T5F.f1= _T60;});_T56= _T5F;}{struct Cyc_Warn_String_Warn_Warg_struct _T5F=_T56;{struct Cyc_Warn_Int_Warn_Warg_struct _T60;_T60.tag= 12;_T58= Cyc_strlen(s);_T60.f1= (int)_T58;_T57= _T60;}{struct Cyc_Warn_Int_Warn_Warg_struct _T60=_T57;void*_T61[4];_T61[0]= & _T5D;_T61[1]= & _T5E;_T61[2]= & _T5F;_T61[3]= & _T60;_T59= loc;_T5A= _tag_fat(_T61,sizeof(void*),4);Cyc_Warn_err2(_T59,_T5A);}}}}_T5B= & Cyc_Kinds_bk;_T5C= (struct Cyc_Absyn_Kind*)_T5B;
return _T5C;}
# 267
...
# 323
({__typeof__(_tag_fat("Bad kind",sizeof(char),9U))_T25=_tag_fat("Bad kind",sizeof(char),9U);_T24.f1= _T25;});_T1E= _T24;}{struct Cyc_Warn_String_Warn_Warg_struct _T24=_T1E;void*_T25[1];_T25[0]= & _T24;_T20= Cyc_Warn_impos2;{int(*_T26)(struct _fat_ptr)=(int(*)(struct _fat_ptr))_T20;_T1F= _T26;}_T21= _tag_fat(_T25,sizeof(void*),1);_T1F(_T21);}}_TL1A:;}}
# 328
...
# 338
({__typeof__(Cyc_Kinds_compress_kb(_T18))_T1C=Cyc_Kinds_compress_kb(_T18);*_T16= _T1C;});_T19= k2;_T1A= *_T19;
return _T1A;}};}
# 343
...
# 350
({__typeof__(Cyc_Kinds_kind_to_bound(k))_TF=Cyc_Kinds_kind_to_bound(k);_TE->v= _TF;});_T9= (struct Cyc_Core_Opt*)_TE;}*_T8= _T9;_TA= k;
return _TA;}};}
# 358
...
# 413
_TB->f1= 0;_TB->f2= def;_T7= (struct Cyc_Absyn_Less_kb_Absyn_KindBound_struct*)_TB;}_T6->kind= (void*)_T7;_T8= def;
return _T8;};}}
# 418
...
# 425
_T9.v= 0;_T6= _T9;}return _T6;};}}struct _tuple14{struct Cyc_Absyn_Tvar*f0;void*f1;};
# 429
struct _tuple14 Cyc_Kinds_swap_kind(void*t,void*kb){int*_T0;int _T1;struct Cyc_Absyn_Tvar*_T2;struct Cyc_Absyn_Tvar*_T3;struct _tuple14 _T4;struct Cyc_Warn_String_Warn_Warg_struct _T5;struct Cyc_Warn_Typ_Warn_Warg_struct _T6;int(*_T7)(struct _fat_ptr);void*(*_T8)(struct _fat_ptr);struct _fat_ptr _T9;
...
_T3->kind= kb;{struct _tuple14 _TC;
_TC.f0= tv;_TC.f1= oldkb;_T4= _TC;}return _T4;}}_TL2F:{struct Cyc_Warn_String_Warn_Warg_struct _TC;_TC.tag= 0;
# 436
({__typeof__(_tag_fat("swap_kind: cannot update the kind of ",sizeof(char),38U))_TD=_tag_fat("swap_kind: cannot update the kind of ",sizeof(char),38U);_TC.f1= _TD;});_T5= _TC;}{struct Cyc_Warn_String_Warn_Warg_struct _TC=_T5;{struct Cyc_Warn_Typ_Warn_Warg_struct _TD;_TD.tag= 2;_TD.f1= t;_T6= _TD;}{struct Cyc_Warn_Typ_Warn_Warg_struct _TD=_T6;void*_TE[2];_TE[0]= & _TC;_TE[1]= & _TD;_T8= Cyc_Warn_impos2;{int(*_TF)(struct _fat_ptr)=(int(*)(struct _fat_ptr))_T8;_T7= _TF;}_T9= _tag_fat(_TE,sizeof(void*),2);_T7(_T9);}};}
# 440
long Cyc_Kinds_kind_eq(struct Cyc_Absyn_Kind*k1,struct Cyc_Absyn_Kind*k2){int _T0;int _T1;struct Cyc_Absyn_Kind*_T2;enum Cyc_Absyn_KindQual _T3;int _T4;struct Cyc_Absyn_Kind*_T5;enum Cyc_Absyn_KindQual _T6;int _T7;struct Cyc_Absyn_Kind*_T8;enum Cyc_Absyn_AliasHint _T9;int _TA;struct Cyc_Absyn_Kind*_TB;enum Cyc_Absyn_AliasHint _TC;int _TD;
if(k1!=k2)goto _TL31;_T0= 1;goto _TL32;_TL31: _T2= k1;_T3= _T2->kind;_T4= (int)_T3;_T5= k2;_T6= _T5->kind;_T7= (int)_T6;if(_T4!=_T7)goto _TL33;_T8= k1;_T9= _T8->aliashint;_TA= (int)_T9;_TB= k2;_TC= _TB->aliashint;_TD= (int)_TC;_T1= _TA==_TD;goto _TL34;_TL33: _T1= 0;_TL34: _T0= _T1;_TL32: return _T0;}struct _tuple15{void*f0;void*f1;};
# 447
long Cyc_Kinds_constrain_kinds(void*c1,void*c2){struct _tuple15 _T0;void*_T1;int*_T2;int _T3;void*_T4;int*_T5;unsigned _T6;void*_T7;void*_T8;int _T9;void*_TA;void*_TB;void*_TC;struct Cyc_Absyn_Less_kb_Absyn_KindBound_struct*_TD;struct Cyc_Core_Opt**_TE;long _TF;struct Cyc_Core_Opt**_T10;struct Cyc_Core_Opt*_T11;void*_T12;int*_T13;int _T14;void*_T15;void*_T16;struct Cyc_Absyn_Unknown_kb_Absyn_KindBound_struct*_T17;struct Cyc_Core_Opt**_T18;struct Cyc_Core_Opt**_T19;struct Cyc_Core_Opt*_T1A;void*_T1B;int*_T1C;int _T1D;void*_T1E;void*_T1F;struct Cyc_Absyn_Unknown_kb_Absyn_KindBound_struct*_T20;struct Cyc_Core_Opt**_T21;struct Cyc_Core_Opt**_T22;struct Cyc_Core_Opt*_T23;void*_T24;int*_T25;int _T26;void*_T27;void*_T28;struct Cyc_Absyn_Less_kb_Absyn_KindBound_struct*_T29;struct Cyc_Core_Opt**_T2A;void*_T2B;long _T2C;struct Cyc_Core_Opt**_T2D;struct Cyc_Core_Opt*_T2E;void*_T2F;void*_T30;struct Cyc_Absyn_Less_kb_Absyn_KindBound_struct*_T31;struct Cyc_Core_Opt**_T32;void*_T33;void*_T34;struct Cyc_Absyn_Less_kb_Absyn_KindBound_struct*_T35;struct Cyc_Core_Opt**_T36;long _T37;struct Cyc_Core_Opt**_T38;struct Cyc_Core_Opt*_T39;long _T3A;struct Cyc_Core_Opt**_T3B;struct Cyc_Core_Opt*_T3C;
c1= Cyc_Kinds_compress_kb(c1);
c2= Cyc_Kinds_compress_kb(c2);
# 451
if(c1!=c2)goto _TL35;
return 1;_TL35:{struct _tuple15 _T3D;
# 454
_T3D.f0= c1;_T3D.f1= c2;_T0= _T3D;}{struct _tuple15 _T3D=_T0;struct Cyc_Absyn_Kind*_T3E;struct Cyc_Absyn_Kind*_T3F;void*_T40;void*_T41;_T1= _T3D.f0;_T2= (int*)_T1;_T3= *_T2;if(_T3!=0)goto _TL37;_T4= _T3D.f1;_T5= (int*)_T4;_T6= *_T5;switch(_T6){case 0: _T7= _T3D.f0;{struct Cyc_Absyn_Eq_kb_Absyn_KindBound_struct*_T42=(struct Cyc_Absyn_Eq_kb_Absyn_KindBound_struct*)_T7;_T41= _T42->f1;}_T8= _T3D.f1;{struct Cyc_Absyn_Eq_kb_Absyn_KindBound_struct*_T42=(struct Cyc_Absyn_Eq_kb_Absyn_KindBound_struct*)_T8;_T40= _T42->f1;}{struct Cyc_Absyn_Kind*k1=_T41;struct Cyc_Absyn_Kind*k2=_T40;_T9= k1==k2;
# 456
...
# 459
_T42->v= c1;_T1A= (struct Cyc_Core_Opt*)_T42;}*_T19= _T1A;
return 1;}_TL3D: _T1B= _T3D.f0;_T1C= (int*)_T1B;_T1D= *_T1C;if(_T1D!=1)goto _TL3F;_T1E= _T3D.f0;{struct Cyc_Absyn_Unknown_kb_Absyn_KindBound_struct*_T42=(struct Cyc_Absyn_Unknown_kb_Absyn_KindBound_struct*)_T1E;_T1F= _T3D.f0;_T20= (struct Cyc_Absyn_Unknown_kb_Absyn_KindBound_struct*)_T1F;_T21= & _T20->f1;_T41= (struct Cyc_Core_Opt**)_T21;}{struct Cyc_Core_Opt**f=_T41;_T22= f;{struct Cyc_Core_Opt*_T42=_cycalloc(sizeof(struct Cyc_Core_Opt));
# 462
_T42->v= c2;_T23= (struct Cyc_Core_Opt*)_T42;}*_T22= _T23;
return 1;}_TL3F: _T24= _T3D.f1;_T25= (int*)_T24;_T26= *_T25;if(_T26!=0)goto _TL41;_T27= _T3D.f0;{struct Cyc_Absyn_Less_kb_Absyn_KindBound_struct*_T42=(struct Cyc_Absyn_Less_kb_Absyn_KindBound_struct*)_T27;_T28= _T3D.f0;_T29= (struct Cyc_Absyn_Less_kb_Absyn_KindBound_struct*)_T28;_T2A= & _T29->f1;_T41= (struct Cyc_Core_Opt**)_T2A;_T3F= _T42->f2;}_T2B= _T3D.f1;{struct Cyc_Absyn_Eq_kb_Absyn_KindBound_struct*_T42=(struct Cyc_Absyn_Eq_kb_Absyn_KindBound_struct*)_T2B;_T40= _T42->f1;}{struct Cyc_Core_Opt**f=_T41;struct Cyc_Absyn_Kind*k1=_T3F;struct Cyc_Absyn_Kind*k2=_T40;_T2C= 
# 466
...
({__typeof__(_tag_fat("Inconsistent qualifier bounds",sizeof(char),30U))_T1A=_tag_fat("Inconsistent qualifier bounds",sizeof(char),30U);_T19.f1= _T1A;});_T9= _T19;}{struct Cyc_Warn_String_Warn_Warg_struct _T19=_T9;void*_T1A[1];_T1A[0]= & _T19;_TA= loc;_TB= _tag_fat(_T1A,sizeof(void*),1);Cyc_Warn_err2(_TA,_TB);}goto _LL5;case Cyc_Absyn_UniqueHint:
# 502
...
({__typeof__(_tag_fat("Inconsistent qualifier bounds",sizeof(char),30U))_T1A=_tag_fat("Inconsistent qualifier bounds",sizeof(char),30U);_T19.f1= _T1A;});_TD= _T19;}{struct Cyc_Warn_String_Warn_Warg_struct _T19=_TD;void*_T1A[1];_T1A[0]= & _T19;_TE= loc;_TF= _tag_fat(_T1A,sizeof(void*),1);Cyc_Warn_err2(_TE,_TF);}goto _LL5;case Cyc_Absyn_RefcntHint:
# 507
...
({__typeof__(_tag_fat("Inconsistent qualifier bounds",sizeof(char),30U))_T1A=_tag_fat("Inconsistent qualifier bounds",sizeof(char),30U);_T19.f1= _T1A;});_T11= _T19;}{struct Cyc_Warn_String_Warn_Warg_struct _T19=_T11;void*_T1A[1];_T1A[0]= & _T19;_T12= loc;_T13= _tag_fat(_T1A,sizeof(void*),1);Cyc_Warn_err2(_T12,_T13);}goto _LL5;default:{struct Cyc_Warn_String_Warn_Warg_struct _T19;_T19.tag= 0;
# 512
({__typeof__(_tag_fat("Inconsistent qualifier bounds",sizeof(char),30U))_T1A=_tag_fat("Inconsistent qualifier bounds",sizeof(char),30U);_T19.f1= _T1A;});_T14= _T19;}{struct Cyc_Warn_String_Warn_Warg_struct _T19=_T14;void*_T1A[1];_T1A[0]= & _T19;_T15= loc;_T16= _tag_fat(_T1A,sizeof(void*),1);Cyc_Warn_err2(_T15,_T16);}}_LL5: goto _LL0;}_TL4A: goto _LL0;_LL0:;}_T17= aq;
# 518
return _T17;}
