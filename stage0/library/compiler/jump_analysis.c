...
# 90
static int Cyc_JumpAnalysis_hash_ptr(void*s){void*_T0;int _T1;_T0= s;_T1= (int)_T0;return _T1;}
# 92
static struct Cyc_Hashtable_Table*Cyc_JumpAnalysis_make_ptr_table (void){int(*_T0)(void*,void*);struct Cyc_Hashtable_Table*_T1;_T0= Cyc_Core_ptrcmp;_T1= Cyc_Hashtable_create(33,_T0,Cyc_JumpAnalysis_hash_ptr);return _T1;}
# 94
...
# 110
static void Cyc_JumpAnalysis_anal_stmt_exp(struct Cyc_JumpAnalysis_StmtEnv*env,struct Cyc_Absyn_Stmt*s){struct Cyc_Absyn_Stmt*_T0;struct Cyc_JumpAnalysis_StmtEnv*_T1;struct Cyc_JumpAnalysis_StmtEnv _T2;struct Cyc_JumpAnalysis_StmtEnv _T3;struct Cyc_Absyn_Stmt*_T4;_T0= s;_T1= env;_T2= *_T1;_T3= Cyc_JumpAnalysis_add_encloser(_T0,_T2);_T4= s;Cyc_JumpAnalysis_anal_stmt(_T3,_T4);}
# 112
static void Cyc_JumpAnalysis_anal_exp(struct Cyc_JumpAnalysis_StmtEnv env,struct Cyc_Absyn_Exp*e){void(*_T0)(struct Cyc_Absyn_Exp*,struct Cyc_JumpAnalysis_StmtEnv*,void(*)(struct Cyc_JumpAnalysis_StmtEnv*,struct Cyc_Absyn_Stmt*),long);void(*_T1)(struct Cyc_Absyn_Exp*,void*,void(*)(void*,struct Cyc_Absyn_Stmt*),long);struct Cyc_Absyn_Exp*_T2;struct Cyc_JumpAnalysis_StmtEnv*_T3;struct Cyc_JumpAnalysis_StmtEnv*_T4;_T1= Cyc_Absyn_do_nested_statement;{
# 114
void(*_T5)(struct Cyc_Absyn_Exp*,struct Cyc_JumpAnalysis_StmtEnv*,void(*)(struct Cyc_JumpAnalysis_StmtEnv*,struct Cyc_Absyn_Stmt*),long)=(void(*)(struct Cyc_Absyn_Exp*,struct Cyc_JumpAnalysis_StmtEnv*,void(*)(struct Cyc_JumpAnalysis_StmtEnv*,struct Cyc_Absyn_Stmt*),long))_T1;_T0= _T5;}_T2= e;_T3= & env;_T4= (struct Cyc_JumpAnalysis_StmtEnv*)_T3;_T0(_T2,_T4,Cyc_JumpAnalysis_anal_stmt_exp,0);}
# 117
static void Cyc_JumpAnalysis_anal_scs(struct Cyc_JumpAnalysis_StmtEnv env,struct Cyc_List_List*scs){struct Cyc_JumpAnalysis_StmtEnv _T0;struct Cyc_JumpAnalysis_CaseEnd_j_JumpAnalysis_Jumpee_struct*_T1;struct Cyc_JumpAnalysis_CaseEnd_j_JumpAnalysis_Jumpee_struct*_T2;struct Cyc_List_List*_T3;void*_T4;struct Cyc_Absyn_Switch_clause*_T5;struct Cyc_Absyn_Switch_clause*_T6;struct Cyc_Core_Opt*_T7;long _T8;struct Cyc_Absyn_Switch_clause*_T9;struct Cyc_Absyn_Stmt*_TA;struct Cyc_JumpAnalysis_StmtEnv _TB;struct Cyc_JumpAnalysis_StmtEnv _TC;struct Cyc_Absyn_Switch_clause*_TD;struct Cyc_Absyn_Stmt*_TE;struct Cyc_List_List*_TF;_T0= env;
# 120
...
# 157
if(eopt==0)goto _TLD;
Cyc_JumpAnalysis_anal_exp(env,eopt);goto _TLE;_TLD: _TLE: _TC= env;_TD= _TC.fenv;{struct Cyc_List_List*_T8D=_cycalloc(sizeof(struct Cyc_List_List));{struct _tuple14*_T8E=_cycalloc(sizeof(struct _tuple14));
_T8E->f0= s;_T10= & Cyc_JumpAnalysis_Return_j_val;_T11= (struct Cyc_JumpAnalysis_Return_j_JumpAnalysis_Jumpee_struct*)_T10;_T8E->f1= (void*)_T11;_TF= (struct _tuple14*)_T8E;}_T8D->hd= _TF;_T12= env;_T13= _T12.fenv;_T8D->tl= _T13->jumpers;_TE= (struct Cyc_List_List*)_T8D;}_TD->jumpers= _TE;goto _LL0;}case 5:{struct Cyc_Absyn_While_s_Absyn_Raw_stmt_struct*_T8D=(struct Cyc_Absyn_While_s_Absyn_Raw_stmt_struct*)_T82;_T14= _T8D->f1;_T8C= _T14.f0;_T15= _T8D->f1;_T8B= _T15.f1;_T8A= _T8D->f2;}{struct Cyc_Absyn_Exp*e=_T8C;struct Cyc_Absyn_Stmt*cont_s=_T8B;struct Cyc_Absyn_Stmt*s=_T8A;_T17= Cyc_Hashtable_insert;{
# 163
...
Cyc_JumpAnalysis_anal_stmt(env_body,s);
Cyc_JumpAnalysis_anal_exp(env,e);goto _LL0;}}case 6: _T45= env;_T46= _T45.fenv;{struct Cyc_List_List*_T8D=_cycalloc(sizeof(struct Cyc_List_List));{struct _tuple14*_T8E=_cycalloc(sizeof(struct _tuple14));
# 195
_T8E->f0= s;_T49= env;_T8E->f1= _T49.break_stmt;_T48= (struct _tuple14*)_T8E;}_T8D->hd= _T48;_T4A= env;_T4B= _T4A.fenv;_T8D->tl= _T4B->jumpers;_T47= (struct Cyc_List_List*)_T8D;}_T46->jumpers= _T47;goto _LL0;case 7: _T4C= env;_T4D= _T4C.fenv;{struct Cyc_List_List*_T8D=_cycalloc(sizeof(struct Cyc_List_List));{struct _tuple14*_T8E=_cycalloc(sizeof(struct _tuple14));
# 198
_T8E->f0= s;_T50= env;_T8E->f1= _T50.continue_stmt;_T4F= (struct _tuple14*)_T8E;}_T8D->hd= _T4F;_T51= env;_T52= _T51.fenv;_T8D->tl= _T52->jumpers;_T4E= (struct Cyc_List_List*)_T8D;}_T4D->jumpers= _T4E;goto _LL0;case 8:{struct Cyc_Absyn_Goto_s_Absyn_Raw_stmt_struct*_T8D=(struct Cyc_Absyn_Goto_s_Absyn_Raw_stmt_struct*)_T82;_T86= _T8D->f1;}{struct _fat_ptr*lab=_T86;_T53= env;_T54= _T53.fenv;{struct Cyc_List_List*_T8D=_cycalloc(sizeof(struct Cyc_List_List));{struct _tuple14*_T8E=_cycalloc(sizeof(struct _tuple14));
# 201
_T8E->f0= s;{struct Cyc_JumpAnalysis_Lab_j_JumpAnalysis_Jumpee_struct*_T8F=_cycalloc(sizeof(struct Cyc_JumpAnalysis_Lab_j_JumpAnalysis_Jumpee_struct));_T8F->tag= 6;_T8F->f1= lab;_T57= (struct Cyc_JumpAnalysis_Lab_j_JumpAnalysis_Jumpee_struct*)_T8F;}_T8E->f1= (void*)_T57;_T56= (struct _tuple14*)_T8E;}_T8D->hd= _T56;_T58= env;_T59= _T58.fenv;_T8D->tl= _T59->jumpers;_T55= (struct Cyc_List_List*)_T8D;}_T54->jumpers= _T55;goto _LL0;}case 13:{struct Cyc_Absyn_Label_s_Absyn_Raw_stmt_struct*_T8D=(struct Cyc_Absyn_Label_s_Absyn_Raw_stmt_struct*)_T82;_T86= _T8D->f1;_T8B= _T8D->f2;}{struct _fat_ptr*lab=_T86;struct Cyc_Absyn_Stmt*s1=_T8B;{struct _handler_cons _T8D;_T5A= & _T8D;_push_handler(_T5A);{int _T8E=0;_T5B= setjmp(_T8D.handler);if(!_T5B)goto _TLF;_T8E= 1;goto _TL10;_TLF: _TL10: if(_T8E)goto _TL11;else{goto _TL13;}_TL13: _T5D= Cyc_Hashtable_lookup;{
# 206
...
({__typeof__(_tag_fat("repated label",sizeof(char),14U))_T90=_tag_fat("repated label",sizeof(char),14U);_T8F.f1= _T90;});_T62= _T8F;}{struct Cyc_Warn_String_Warn_Warg_struct _T8F=_T62;void*_T90[1];_T90[0]= & _T8F;_T63= s;_T64= _T63->loc;_T65= _tag_fat(_T90,sizeof(void*),1);Cyc_Warn_err2(_T64,_T65);}_pop_handler();goto _TL12;_TL11: _T66= Cyc_Core_get_exn_thrown();{void*_T8F=(void*)_T66;void*_T90;_T67= (struct Cyc_Core_Not_found_exn_struct*)_T8F;_T68= _T67->tag;_T69= Cyc_Core_Not_found;if(_T68!=_T69)goto _TL14;goto _LL21;_TL14: _T90= _T8F;{void*exn=_T90;_rethrow(exn);}_LL21:;}_TL12:;}}_T6B= Cyc_Hashtable_insert;{
# 212
...
# 218
Cyc_JumpAnalysis_anal_exps(env,es);_T71= env;_T72= _T71.fenv;{struct Cyc_List_List*_T8D=_cycalloc(sizeof(struct Cyc_List_List));{struct _tuple14*_T8E=_cycalloc(sizeof(struct _tuple14));
_T8E->f0= s;{struct Cyc_JumpAnalysis_Fallthru_j_JumpAnalysis_Jumpee_struct*_T8F=_cycalloc(sizeof(struct Cyc_JumpAnalysis_Fallthru_j_JumpAnalysis_Jumpee_struct));_T8F->tag= 4;_T76= _check_null(clauseopt);_T8F->f1= *_T76;_T75= (struct Cyc_JumpAnalysis_Fallthru_j_JumpAnalysis_Jumpee_struct*)_T8F;}_T8E->f1= (void*)_T75;_T74= (struct _tuple14*)_T8E;}_T8D->hd= _T74;_T77= env;_T78= _T77.fenv;_T8D->tl= _T78->jumpers;_T73= (struct Cyc_List_List*)_T8D;}_T72->jumpers= _T73;goto _LL0;}case 10:{struct Cyc_Absyn_Switch_s_Absyn_Raw_stmt_struct*_T8D=(struct Cyc_Absyn_Switch_s_Absyn_Raw_stmt_struct*)_T82;_T8C= _T8D->f1;_T85= _T8D->f2;}{struct Cyc_Absyn_Exp*e=_T8C;struct Cyc_List_List*scs=_T85;
# 222
Cyc_JumpAnalysis_anal_exp(env,e);
...
# 250
if(eo==0)goto _TL1C;
Cyc_JumpAnalysis_anal_exp(env,eo);goto _TL1D;_TL1C: _TL1D: goto _LL26;}case 1:{struct Cyc_Absyn_Fn_d_Absyn_Raw_decl_struct*_T90=(struct Cyc_Absyn_Fn_d_Absyn_Raw_decl_struct*)_T8D;_T8E= _T90->f1;}{struct Cyc_Absyn_Fndecl*fd=_T8E;_T7E= env;_T7F= _T7E.fenv;_T80= _T7F->tables;_T81= fd;
# 254
...
_T7F.save_env.try_depth= 0;_T7F.save_env.pat_var_depth= 0;_T7F.save_env.enclosers= 0;_T4= _T7F;}{
# 285
...
_TL1F: _T10= jumpers;_T11= _T10->hd;{struct _tuple14*_T7F=(struct _tuple14*)_T11;void*_T80;struct Cyc_Absyn_Stmt*_T81;{struct _tuple14 _T82=*_T7F;_T81= _T82.f0;_T80= _T82.f1;}{struct Cyc_Absyn_Stmt*src_stmt=_T81;void*dest=_T80;_T13= Cyc_Hashtable_lookup;{
# 302
...
# 305
({__typeof__(_tag_fat("jump has no target",sizeof(char),19U))_T8A=_tag_fat("jump has no target",sizeof(char),19U);_T89.f1= _T8A;});_T17= _T89;}{struct Cyc_Warn_String_Warn_Warg_struct _T89=_T17;void*_T8A[1];_T8A[0]= & _T89;_T18= src_stmt;_T19= _T18->loc;_T1A= _tag_fat(_T8A,sizeof(void*),1);Cyc_Warn_err2(_T19,_T1A);}goto _LL6;case 1:{struct Cyc_Warn_String_Warn_Warg_struct _T89;_T89.tag= 0;
# 308
({__typeof__(_tag_fat("break causes outer switch to implicitly fallthru",sizeof(char),49U))_T8A=_tag_fat("break causes outer switch to implicitly fallthru",sizeof(char),49U);_T89.f1= _T8A;});_T1B= _T89;}{struct Cyc_Warn_String_Warn_Warg_struct _T89=_T1B;void*_T8A[1];_T8A[0]= & _T89;_T1C= src_stmt;_T1D= _T1C->loc;_T1E= _tag_fat(_T8A,sizeof(void*),1);Cyc_Warn_err2(_T1D,_T1E);}goto _LL6;case 2: _T20= Cyc_Hashtable_insert;{
# 311
...
# 323
({__typeof__(_tag_fat("label ",sizeof(char),7U))_T8E=_tag_fat("label ",sizeof(char),7U);_T8D.f1= _T8E;});_T31= _T8D;}{struct Cyc_Warn_String_Warn_Warg_struct _T8D=_T31;{struct Cyc_Warn_String_Warn_Warg_struct _T8E;_T8E.tag= 0;_T33= lab;_T8E.f1= *_T33;_T32= _T8E;}{struct Cyc_Warn_String_Warn_Warg_struct _T8E=_T32;{struct Cyc_Warn_String_Warn_Warg_struct _T8F;_T8F.tag= 0;({__typeof__(_tag_fat(" undefined",sizeof(char),11U))_T90=_tag_fat(" undefined",sizeof(char),11U);_T8F.f1= _T90;});_T34= _T8F;}{struct Cyc_Warn_String_Warn_Warg_struct _T8F=_T34;void*_T90[3];_T90[0]= & _T8D;_T90[1]= & _T8E;_T90[2]= & _T8F;_T35= src_stmt;_T36= _T35->loc;_T37= _tag_fat(_T90,sizeof(void*),3);Cyc_Warn_err2(_T36,_T37);}}}goto L;_TL28: _T8C= _T8B;{void*exn=_T8C;_rethrow(exn);};}_TL26:;}}_T39= Cyc_Hashtable_lookup;{
# 326
struct Cyc_JumpAnalysis_SaveEnv*(*_T89)(struct Cyc_Hashtable_Table*,struct Cyc_Absyn_Stmt*)=(struct Cyc_JumpAnalysis_SaveEnv*(*)(struct Cyc_Hashtable_Table*,struct Cyc_Absyn_Stmt*))_T39;_T38= _T89;}{struct Cyc_JumpAnalysis_SaveEnv*_T89=_T38(stmt_info,dest_stmt);struct Cyc_List_List*_T8A;{struct Cyc_JumpAnalysis_SaveEnv _T8B=*_T89;_T8A= _T8B.enclosers;}{struct Cyc_List_List*dest_enclose=_T8A;
...
({__typeof__(_tag_fat("goto enters local scope or exception handler",sizeof(char),45U))_T8C=_tag_fat("goto enters local scope or exception handler",sizeof(char),45U);_T8B.f1= _T8C;});_T41= _T8B;}{struct Cyc_Warn_String_Warn_Warg_struct _T8B=_T41;void*_T8C[1];_T8C[0]= & _T8B;_T42= src_stmt;_T43= _T42->loc;_T44= _tag_fat(_T8C,sizeof(void*),1);Cyc_Warn_err2(_T43,_T44);}goto _LL6;_TL32:;}goto _TL2B;_TL2A: _TL2B: _T87= dest_stmt;goto _LL12;}}}case 3: _T45= dest;{struct Cyc_JumpAnalysis_Stmt_j_JumpAnalysis_Jumpee_struct*_T89=(struct Cyc_JumpAnalysis_Stmt_j_JumpAnalysis_Jumpee_struct*)_T45;_T87= _T89->f1;}_LL12: {struct Cyc_Absyn_Stmt*dest_stmt=_T87;_T47= Cyc_Hashtable_lookup;{
# 341
...
# 360
L: _T6E= Cyc_Hashtable_insert;{
void(*_T7F)(struct Cyc_Hashtable_Table*,struct Cyc_Absyn_Fndecl*,struct Cyc_Hashtable_Table*)=(void(*)(struct Cyc_Hashtable_Table*,struct Cyc_Absyn_Fndecl*,struct Cyc_Hashtable_Table*))_T6E;_T6D= _T7F;}_T6F= tables;_T70= _T6F->pop_tables;_T71= fd;_T72= pop_table;_T6D(_T70,_T71,_T72);_T74= Cyc_Hashtable_insert;{
...
struct Cyc_JumpAnalysis_Jump_Anal_Result*tables;tables= _cycalloc(sizeof(struct Cyc_JumpAnalysis_Jump_Anal_Result));_T0= tables;({__typeof__(Cyc_JumpAnalysis_make_ptr_table())_T4=Cyc_JumpAnalysis_make_ptr_table();_T0->pop_tables= _T4;});_T1= tables;
({__typeof__(Cyc_JumpAnalysis_make_ptr_table())_T4=Cyc_JumpAnalysis_make_ptr_table();_T1->succ_tables= _T4;});_T2= tables;
({__typeof__(Cyc_JumpAnalysis_make_ptr_table())_T4=Cyc_JumpAnalysis_make_ptr_table();_T2->pat_pop_tables= _T4;});
# 404
