...
# 42 "cyclone/library/compiler/tcutil.h"
...
# 50 "cyclone/library/compiler/remove_aggregates.cyc"
static struct Cyc_Absyn_Exp*Cyc_RemoveAggrs_deep_copy(struct Cyc_Absyn_Exp*e){struct Cyc_Absyn_Exp*_T0;_T0= Cyc_Tcutil_deep_copy_exp(1,e);return _T0;}
# 54
...
# 78
static struct Cyc_RemoveAggrs_Env Cyc_RemoveAggrs_no_init(struct Cyc_RemoveAggrs_Env env){struct Cyc_RemoveAggrs_Env _T0;struct Cyc_RemoveAggrs_Env _T1;enum Cyc_RemoveAggrs_ExpContext _T2;int _T3;_T1= env;_T2= _T1.ctxt;_T3= (int)_T2;if(_T3!=0)goto _TL2;_T0= Cyc_RemoveAggrs_other_env;goto _TL3;_TL2: _T0= env;_TL3: return _T0;}
# 80
...
({__typeof__(_tag_fat("remove_aggrs_exp -- unexpected array or comprehension: ",sizeof(char),56U))_TA=_tag_fat("remove_aggrs_exp -- unexpected array or comprehension: ",sizeof(char),56U);_T9.f1= _TA;});_T2= _T9;}{struct Cyc_Warn_String_Warn_Warg_struct _T9=_T2;{struct Cyc_Warn_Exp_Warn_Warg_struct _TA;_TA.tag= 4;_TA.f1= e;_T3= _TA;}{struct Cyc_Warn_Exp_Warn_Warg_struct _TA=_T3;void*_TB[2];_TB[0]= & _T9;_TB[1]= & _TA;_T5= Cyc_Warn_impos2;{int(*_TC)(struct _fat_ptr)=(int(*)(struct _fat_ptr))_T5;_T4= _TC;}_T6= _tag_fat(_TB,sizeof(void*),2);_T4(_T6);}}goto _TL5;_TL4: _TL5:;}}
# 93
static long Cyc_RemoveAggrs_can_use_initializer(struct Cyc_Absyn_Exp*e,void*t){int _T0;struct Cyc_Absyn_Exp*_T1;void*_T2;unsigned _T3;struct Cyc_Absyn_Exp*_T4;void*_T5;long _T6;struct Cyc_Absyn_Exp*_T7;void*_T8;void*_T9;void*_TA;int _TB;_T1= e;_T2= _T1->topt;_T3= (unsigned)_T2;
...
_T18->topt= Cyc_Absyn_char_type;{struct Cyc_List_List*_T160=_cycalloc(sizeof(struct Cyc_List_List));{struct _tuple13*_T161=_cycalloc(sizeof(struct _tuple13));
_T161->f0= 0;_T161->f1= c;_T1A= (struct _tuple13*)_T161;}_T160->hd= _T1A;_T160->tl= dles;_T19= (struct Cyc_List_List*)_T160;}dles= _T19;}
# 108
...
Cyc_Absyn_assign_exp(_T30,_T31,0U);_T33= env;_T34= _T33.dest;_T35= _T34->topt;_T36= _check_null(_T35);_T37= Cyc_Absyn_set_type(_T32,_T36);_T38= e1;_T39= Cyc_Absyn_seq_exp(_T37,_T38,0U);_T2E->r= _T39->r;_T3A= e;_T3B= e1;
# 136
_T3A->topt= _T3B->topt;
...
# 146
Cyc_Absyn_cast_exp(_T43,_T44,0,1U,0U);_T46= e;_T47= _T46->topt;_T48= _check_null(_T47);
# 145
body_exp= 
Cyc_Absyn_set_type(_T45,_T48);goto _TL17;_TL16: _TL17: _T49= xvar;_T4A= typ;_T4B= mexp;_T4C= 
# 148
...
if(_T58==2)goto _TL18;_T59= env;_T5A= _T59.ctxt;_T5B= (int)_T5A;_T55= _T5B!=1;goto _TL19;_TL18: _T55= 0;_TL19: {long do_stmt_exp=_T55;
...
({__typeof__(Cyc_Toc_temp_var())_T161=Cyc_Toc_temp_var();*_T160= _T161;});_T63= (struct _tuple0**)_T160;}v= _T63;_T64= v;_T65= *_T64;_T66= 
...
_TL21: _T6F= dles2;_T70= _T6F->hd;{struct _tuple13*_T160=(struct _tuple13*)_T70;struct Cyc_Absyn_Exp*_T161;struct Cyc_List_List*_T162;{struct _tuple13 _T163=*_T160;_T162= _T163.f0;_T161= _T163.f1;}{struct Cyc_List_List*ds=_T162;struct Cyc_Absyn_Exp*field_exp=_T161;
struct _fat_ptr*f=Cyc_Absyn_designatorlist_to_fieldname(ds);_T71= 
Cyc_RemoveAggrs_deep_copy(dest);_T72= f;_T73= Cyc_RemoveAggrs_member_exp(_T71,_T72,0U);_T74= field_exp;_T75= _T74->topt;_T76= _check_null(_T75);{struct Cyc_Absyn_Exp*field_dest=Cyc_Absyn_set_type(_T73,_T76);{struct Cyc_RemoveAggrs_Env _T163;
...
int(*_T160)(struct _fat_ptr,struct _fat_ptr)=(int(*)(struct _fat_ptr,struct _fat_ptr))_T7B;_T7A= _T160;}_T7C= _tag_fat("zero-field aggregate",sizeof(char),21U);_T7D= _tag_fat(0U,sizeof(void*),0);_T7A(_T7C,_T7D);goto _TL25;_TL24: _TL25: _T7E= dles;_T7F= _T7E->hd;_T80= (struct _tuple13*)_T7F;_T81= *_T80;{
# 183
struct Cyc_Absyn_Exp*init_e=_T81.f1;_T82= dles;
dles= _T82->tl;_TL29: if(dles!=0)goto _TL27;else{goto _TL28;}
_TL27: _T83= dles;_T84= _T83->hd;_T85= (struct _tuple13*)_T84;_T86= *_T85;{struct Cyc_Absyn_Exp*e2=_T86.f1;_T87= e2;_T88= _T87->topt;
if(_T88!=0)goto _TL2A;{struct Cyc_Warn_String_Warn_Warg_struct _T160;_T160.tag= 0;
({__typeof__(_tag_fat("expression ",sizeof(char),12U))_T161=_tag_fat("expression ",sizeof(char),12U);_T160.f1= _T161;});_T89= _T160;}{struct Cyc_Warn_String_Warn_Warg_struct _T160=_T89;{struct Cyc_Warn_Exp_Warn_Warg_struct _T161;_T161.tag= 4;_T161.f1= e2;_T8A= _T161;}{struct Cyc_Warn_Exp_Warn_Warg_struct _T161=_T8A;{struct Cyc_Warn_String_Warn_Warg_struct _T162;_T162.tag= 0;({__typeof__(_tag_fat(" missing type!",sizeof(char),15U))_T163=_tag_fat(" missing type!",sizeof(char),15U);_T162.f1= _T163;});_T8B= _T162;}{struct Cyc_Warn_String_Warn_Warg_struct _T162=_T8B;void*_T163[3];_T163[0]= & _T160;_T163[1]= & _T161;_T163[2]= & _T162;_T8D= Cyc_Warn_impos2;{int(*_T164)(struct _fat_ptr)=(int(*)(struct _fat_ptr))_T8D;_T8C= _T164;}_T8E= _tag_fat(_T163,sizeof(void*),3);_T8C(_T8E);}}}goto _TL2B;_TL2A: _TL2B: _T8F= 
...
Cyc_Absyn_exp_stmt(init_e,0U);_T9A= Cyc_Absyn_exp_stmt(dest,0U);_T9B= Cyc_Absyn_seq_stmt(_T99,_T9A,0U);_T9C= 
# 191
...
# 232
_TL35: _TB8= dles2;_TB9= _TB8->hd;{struct _tuple13*_T160=(struct _tuple13*)_TB9;struct Cyc_Absyn_Exp*_T161;{struct _tuple13 _T162=*_T160;_T161= _T162.f1;}{struct Cyc_Absyn_Exp*field_exp=_T161;_TBA= 
# 234
Cyc_RemoveAggrs_deep_copy(dest);_TBB= Cyc_Absyn_signed_int_exp(i,0U);_TBC= Cyc_Absyn_sint_type;_TBD= Cyc_Absyn_set_type(_TBB,_TBC);_TBE= Cyc_Absyn_subscript_exp(_TBA,_TBD,0U);_TBF= dest_type;{
# 233
struct Cyc_Absyn_Exp*fielddest=
Cyc_Absyn_set_type(_TBE,_TBF);{struct Cyc_RemoveAggrs_Env _T162;
# 236
_T162.ctxt= 2U;_T162.dest= fielddest;_TC0= _T162;}_TC1= field_exp;Cyc_RemoveAggrs_remove_aggrs_exp(_TC0,_TC1);}}}_TC2= dles2;
# 229
dles2= _TC2->tl;i= i + 1;goto _TL37;_TL36:;}_TC3= dles;_TC4= _TC3->hd;_TC5= (struct _tuple13*)_TC4;_TC6= *_TC5;{
# 238
struct Cyc_Absyn_Exp*init_e=_TC6.f1;_TC7= dles;
dles= _TC7->tl;_TL3B: if(dles!=0)goto _TL39;else{goto _TL3A;}
_TL39: _TC8= dles;_TC9= _TC8->hd;_TCA= (struct _tuple13*)_TC9;_TCB= *_TCA;{struct Cyc_Absyn_Exp*e2=_TCB.f1;_TCC= 
...
# 263
Cyc_Absyn_var_exp(i,0U);_TE2= Cyc_Absyn_uint_type;_TE3= Cyc_Absyn_set_type(_TE1,_TE2);_TE4= Cyc_Absyn_var_exp(max,0U);_TE5= Cyc_Absyn_uint_type;_TE6= Cyc_Absyn_set_type(_TE4,_TE5);{
# 262
struct Cyc_Absyn_Exp*eb=
Cyc_Absyn_lt_exp(_TE3,_TE6,0U);_TE7= 
...
_T160.ctxt= 2U;({__typeof__(Cyc_RemoveAggrs_deep_copy(lval))_T161=Cyc_RemoveAggrs_deep_copy(lval);_T160.dest= _T161;});_TFC= _T160;}_TFD= body;Cyc_RemoveAggrs_remove_aggrs_exp(_TFC,_TFD);_TFE= ea;_TFF= eb;_T100= ec;_T101= 
...
# 286
Cyc_RemoveAggrs_deep_copy(_T104);_T106= Cyc_Absyn_var_exp(max,0U);_T107= Cyc_Absyn_sint_type;_T108= Cyc_Absyn_set_type(_T106,_T107);_T109= Cyc_Absyn_subscript_exp(_T105,_T108,0U);_T10A= 
...
# 306
({__typeof__(_tag_fat("remove-aggrs: no-init-comp in bad position",sizeof(char),43U))_T162=_tag_fat("remove-aggrs: no-init-comp in bad position",sizeof(char),43U);_T161.f1= _T162;});_T11D= _T161;}{struct Cyc_Warn_String_Warn_Warg_struct _T161=_T11D;void*_T162[1];_T162[0]= & _T161;_T11F= Cyc_Warn_impos2;{int(*_T163)(struct _fat_ptr)=(int(*)(struct _fat_ptr))_T11F;_T11E= _T163;}_T120= _tag_fat(_T162,sizeof(void*),1);_T11E(_T120);}goto _TL43;_TL42: goto _LL60;_TL43: _LL60:;}_T121= e;_T122= bd;
# 311
...
_T160.ctxt= _T128.ctxt;_T129= env;_T12A= _T129.dest;if(_T12A!=0)goto _TL44;_T160.dest= 0;goto _TL45;_TL44: _T12B= env;_T12C= _T12B.dest;({__typeof__(Cyc_RemoveAggrs_deep_copy(_T12C))_T161=Cyc_RemoveAggrs_deep_copy(_T12C);_T160.dest= _T161;});_TL45: _T127= _T160;}{struct Cyc_RemoveAggrs_Env env3=_T127;_T12D= 
...
# 375
({__typeof__(_tag_fat("bad exp after translation to C: ",sizeof(char),33U))_T161=_tag_fat("bad exp after translation to C: ",sizeof(char),33U);_T160.f1= _T161;});_T136= _T160;}{struct Cyc_Warn_String_Warn_Warg_struct _T160=_T136;{struct Cyc_Warn_Exp_Warn_Warg_struct _T161;_T161.tag= 4;_T161.f1= e;_T137= _T161;}{struct Cyc_Warn_Exp_Warn_Warg_struct _T161=_T137;void*_T162[2];_T162[0]= & _T160;_T162[1]= & _T161;_T139= Cyc_Warn_impos2;{int(*_T163)(struct _fat_ptr)=(int(*)(struct _fat_ptr))_T139;_T138= _T163;}_T13A= _tag_fat(_T162,sizeof(void*),2);_T138(_T13A);}}}_LL0:;}_T13B= env;_T13C= _T13B.ctxt;_T13D= (int)_T13C;
# 377
...
_TL51: _T149= e;_T14A= env;_T14B= _T14A.dest;_T14C= 
_check_null(_T14B);_T14D= Cyc_Absyn_deref_exp(_T14C,0U);_T14E= e;_T14F= _T14E->topt;_T150= _check_null(_T14F);_T151= Cyc_Absyn_set_type(_T14D,_T150);_T152= Cyc_RemoveAggrs_deep_copy(e);_T153= Cyc_Absyn_assign_exp(_T151,_T152,0U);
# 380
_T149->r= _T153->r;goto _TL50;_TL4F: _TL50:{struct Cyc_RemoveAggrs_Result _T155;
# 383
...
# 400
if(_T8!=0)goto _TL55;
return 0;_TL55: _T9= vd;_TA= _T9->initializer;
# 409
...
_T2D.ctxt= 0U;_T2D.dest= var_exp;_TF= _T2D;}_T10= vd;_T11= _T10->initializer;_T12= _check_null(_T11);{struct Cyc_RemoveAggrs_Result _T2D=Cyc_RemoveAggrs_remove_aggrs_exp(_TF,_T12);enum Cyc_RemoveAggrs_ExpResult _T2E;_T2E= _T2D.res;{enum Cyc_RemoveAggrs_ExpResult r=_T2E;_T13= r;_T14= (int)_T13;
...
return 0;}default: _T24= Cyc_Warn_impos;{
# 423
...
# 426
 return 1;_TL53:;}}
# 429
static void Cyc_RemoveAggrs_remove_aggrs_stmt(struct Cyc_Absyn_Stmt*s){void(*_T0)(long(*)(int,struct Cyc_Absyn_Exp*),long(*)(int,struct Cyc_Absyn_Stmt*),int,struct Cyc_Absyn_Stmt*);void(*_T1)(long(*)(void*,struct Cyc_Absyn_Exp*),long(*)(void*,struct Cyc_Absyn_Stmt*),void*,struct Cyc_Absyn_Stmt*);struct Cyc_Absyn_Stmt*_T2;_T1= Cyc_Absyn_visit_stmt;{
void(*_T3)(long(*)(int,struct Cyc_Absyn_Exp*),long(*)(int,struct Cyc_Absyn_Stmt*),int,struct Cyc_Absyn_Stmt*)=(void(*)(long(*)(int,struct Cyc_Absyn_Exp*),long(*)(int,struct Cyc_Absyn_Stmt*),int,struct Cyc_Absyn_Stmt*))_T1;_T0= _T3;}_T2= s;_T0(Cyc_RemoveAggrs_remove_aggrs_stmt_f1,Cyc_RemoveAggrs_remove_aggrs_stmt_f2,0,_T2);}
# 433
