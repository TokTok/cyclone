...
# 125 "cyclone/library/std/core.h"
...
# 31 "cyclone/library/std/core.cyc"
...
if(o!=0)goto _TL0;_T0= 0;goto _TL1;_TL0: _T2= Cyc_Core_unique_qual;{struct Cyc_Core_Opt*_T5=_aqual_malloc(_T2,sizeof(struct Cyc_Core_Opt));_T3= o;_T4= _T3->v;({__typeof__(f(_T4))_T6=f(_T4);_T5->v= _T6;});_T1= (struct Cyc_Core_Opt*)_T5;}_T0= _T1;_TL1: return _T0;}
# 40
...
return _T0;}
# 52
long Cyc_Core_true_f(void*x){return 1;}
long Cyc_Core_false_f(void*x){return 0;}
# 55
...
return _T0;}
# 64
int Cyc_Core_ptrcmp(void*a,void*b){int _T0;_T0= Cyc_Core_nptrcmp(a,b);return _T0;}struct _tuple0{void*f0;void*f1;};
# 66
...
if(_get_arr_size_curr < _get_arr_size_base || _get_arr_size_curr >= arr.last_plus_one)return 0;else{return(_get_arr_size_curr - _get_arr_size_base)/ elt_sz;}}
