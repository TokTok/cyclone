...
# 250 "cyclone/library/std/cycboot.h"
extern int Cyc_getw(struct Cyc___cycFILE*);struct Cyc_Iter_Iter{void*env;long(*next)(void*,void*);};struct Cyc_List_List{void*hd;struct Cyc_List_List*tl;};
# 64 "cyclone/library/std/list.h"
extern int Cyc_List_length(struct Cyc_List_List*);struct Cyc_Dict_T;struct Cyc_Dict_Dict{int(*rel)(void*,void*);struct _RegionHandle*r;const struct Cyc_Dict_T*t;};extern char Cyc_Dict_Present[8U];struct Cyc_Dict_Present_exn_struct{char*tag;};extern char Cyc_Dict_Absent[7U];struct Cyc_Dict_Absent_exn_struct{char*tag;};char Cyc_Dict_Absent[7U]="Absent";char Cyc_Dict_Present[8U]="Present";
# 27 "cyclone/library/std/dict.cyc"
...
# 60
long Cyc_Dict_is_empty(struct Cyc_Dict_Dict d){struct Cyc_Dict_Dict _T0;const struct Cyc_Dict_T*_T1;int _T2;_T0= d;_T1= _T0.t;_T2= _T1==0;return _T2;}
# 62
long Cyc_Dict_member(struct Cyc_Dict_Dict d,void*key){struct Cyc_Dict_Dict _T0;struct Cyc_Dict_Dict _T1;void*_T2;const struct Cyc_Dict_T*_T3;struct _tuple0 _T4;void*_T5;const struct Cyc_Dict_T*_T6;const struct Cyc_Dict_T*_T7;_T0= d;{
...
if(i >= 0)goto _TL3;_T6= t;
t= _T6->left;goto _TL4;
_TL3: if(i <= 0)goto _TL5;_T7= t;
t= _T7->right;goto _TL6;
# 72
...
if(i >= 0)goto _TLA;_T6= t;
t= _T6->left;goto _TLB;
_TLA: if(i <= 0)goto _TLC;_T7= t;
t= _T7->right;goto _TLD;
# 87
...
if(i >= 0)goto _TL11;_T5= t;
t= _T5->left;goto _TL12;
_TL11: if(i <= 0)goto _TL13;_T6= t;
t= _T6->right;goto _TL14;
# 101
...
if(i >= 0)goto _TL18;_T6= t;
t= _T6->left;goto _TL19;
_TL18: if(i <= 0)goto _TL1A;_T7= t;
t= _T7->right;goto _TL1B;
# 116
_TL1A: _T8= t;_T9= & _T8->key_val.f1;return _T9;_TL1B: _TL19:;}goto _TL15;_TL17:
# 118
 return 0;}}}
# 121
long Cyc_Dict_lookup_bool(struct Cyc_Dict_Dict d,void*key,void**ans_place){struct Cyc_Dict_Dict _T0;struct Cyc_Dict_Dict _T1;void*_T2;const struct Cyc_Dict_T*_T3;struct _tuple0 _T4;void*_T5;const struct Cyc_Dict_T*_T6;const struct Cyc_Dict_T*_T7;void**_T8;const struct Cyc_Dict_T*_T9;struct _tuple0 _TA;_T0= d;{
int(*rel)(void*,void*)=_T0.rel;_T1= d;{
const struct Cyc_Dict_T*t=_T1.t;
_TL1C: if(t!=0)goto _TL1D;else{goto _TL1E;}
_TL1D: _T2= key;_T3= t;_T4= _T3->key_val;_T5= _T4.f0;{int i=rel(_T2,_T5);
if(i >= 0)goto _TL1F;_T6= t;
t= _T6->left;goto _TL20;
_TL1F: if(i <= 0)goto _TL21;_T7= t;
t= _T7->right;goto _TL22;
# 131
...
# 160
int i=rel(_T4,_T6);
if(i >= 0)goto _TL97;_T7= r;{struct _tuple1 _T1B;
_T1B.f0= color;_T9= r;_TA= rel;_TB= key_val;_TC= a;({__typeof__(Cyc_Dict_ins(_T9,_TA,_TB,_TC))_T1C=Cyc_Dict_ins(_T9,_TA,_TB,_TC);_T1B.f1= _T1C;});_T1B.f2= b;_T1B.f3= y;_T8= _T1B;}_TD= Cyc_Dict_balance(_T7,_T8);return _TD;_TL97:
 if(i <= 0)goto _TL99;_TE= r;{struct _tuple1 _T1B;
_T1B.f0= color;_T1B.f1= a;_T10= r;_T11= rel;_T12= key_val;_T13= b;({__typeof__(Cyc_Dict_ins(_T10,_T11,_T12,_T13))_T1C=Cyc_Dict_ins(_T10,_T11,_T12,_T13);_T1B.f2= _T1C;});_T1B.f3= y;_TF= _T1B;}_T14= Cyc_Dict_balance(_TE,_TF);return _T14;_TL99: _T16= r;{struct Cyc_Dict_T*_T1B=_region_malloc(_T16,0U,sizeof(struct Cyc_Dict_T));
...
# 177
struct Cyc_Dict_Dict Cyc_Dict_insert_new(struct Cyc_Dict_Dict d,void*key,void*data){long _T0;struct Cyc_Dict_Absent_exn_struct*_T1;struct Cyc_Dict_Absent_exn_struct*_T2;struct Cyc_Dict_Dict _T3;_T0= 
...
# 191
if(left==0)goto _TLA1;_T5= f;_T6= left;_T7= accum;
accum= Cyc_Dict_fold_tree(_T5,_T6,_T7);goto _TLA2;_TLA1: _TLA2:
 accum= f(key,val,accum);
if(right==0)goto _TLA3;_T8= f;_T9= right;_TA= accum;
accum= Cyc_Dict_fold_tree(_T8,_T9,_TA);goto _TLA4;_TLA3: _TLA4: _TB= accum;
return _TB;}}
# 199
...
# 225
if(left==0)goto _TLAD;_T5= f;_T6= left;
Cyc_Dict_app_tree(_T5,_T6);goto _TLAE;_TLAD: _TLAE:
 f(key,val);
if(right==0)goto _TLAF;_T7= f;_T8= right;
Cyc_Dict_app_tree(_T7,_T8);goto _TLB0;_TLAF: _TLB0:;}}
# 232
...
# 240
if(left==0)goto _TLB3;_T5= f;_T6= env;_T7= left;
Cyc_Dict_app_tree_c(_T5,_T6,_T7);goto _TLB4;_TLB3: _TLB4:
 f(env,key,val);
if(right==0)goto _TLB5;_T8= f;_T9= env;_TA= right;
Cyc_Dict_app_tree_c(_T8,_T9,_TA);goto _TLB6;_TLB5: _TLB6:;}}
# 247
...
# 255
if(left==0)goto _TLB9;_T5= f;_T6= left;
Cyc_Dict_iter_tree(_T5,_T6);goto _TLBA;_TLB9: _TLBA:
 f(key,val);
if(right==0)goto _TLBB;_T7= f;_T8= right;
Cyc_Dict_iter_tree(_T7,_T8);goto _TLBC;_TLBB: _TLBC:;}}
# 262
...
# 270
if(left==0)goto _TLBF;_T5= f;_T6= env;_T7= left;
Cyc_Dict_iter_tree_c(_T5,_T6,_T7);goto _TLC0;_TLBF: _TLC0:
 f(env,key,val);
if(right==0)goto _TLC1;_T8= f;_T9= env;_TA= right;
Cyc_Dict_iter_tree_c(_T8,_T9,_TA);goto _TLC2;_TLC1: _TLC2:;}}
# 277
...
# 283
static void Cyc_Dict_count_elem(int*cnt,void*a,void*b){int*_T0;int*_T1;int _T2;_T0= cnt;_T1= cnt;_T2= *_T1;*_T0= _T2 + 1;}
...
_T5.rel= _T1.rel;_T5.r= r2;_T2= r2;_T3= d;_T4= _T3.t;({__typeof__(Cyc_Dict_copy_tree(_T2,_T4))_T6=Cyc_Dict_copy_tree(_T2,_T4);_T5.t= _T6;});_T0= _T5;}return _T0;}
# 340
struct Cyc_Dict_Dict Cyc_Dict_copy(struct Cyc_Dict_Dict d){struct Cyc_Dict_Dict _T0;_T0= Cyc_Dict_rcopy(Cyc_Core_heap_region,d);return _T0;}
# 342
...
_T8.rel= _T4.rel;_T8.r= r;_T5= r;_T6= f;_T7= t;({__typeof__(Cyc_Dict_map_tree(_T5,_T6,_T7))_T9=Cyc_Dict_map_tree(_T5,_T6,_T7);_T8.t= _T9;});_T3= _T8;}return _T3;}}
# 357
struct Cyc_Dict_Dict Cyc_Dict_map(void*(*f)(void*),struct Cyc_Dict_Dict d){struct _RegionHandle*_T0;void*(*_T1)(void*);struct Cyc_Dict_Dict _T2;struct Cyc_Dict_Dict _T3;_T0= Cyc_Core_heap_region;_T1= f;_T2= d;_T3= Cyc_Dict_rmap(_T0,_T1,_T2);return _T3;}
# 359
...
_T9.rel= _T4.rel;_T9.r= r;_T5= r;_T6= f;_T7= env;_T8= t;({__typeof__(Cyc_Dict_map_tree_c(_T5,_T6,_T7,_T8))_TA=Cyc_Dict_map_tree_c(_T5,_T6,_T7,_T8);_T9.t= _TA;});_T3= _T9;}return _T3;}}
# 377
...
# 387
static long Cyc_Dict_forall_tree_c(long(*f)(void*,void*,void*),void*env,const struct Cyc_Dict_T*t){const struct Cyc_Dict_T*_T0;struct _tuple0 _T1;void*_T2;struct _tuple0 _T3;void*_T4;int _T5;long(*_T6)(void*,void*,void*);void*_T7;const struct Cyc_Dict_T*_T8;long _T9;long _TA;int _TB;long(*_TC)(void*,void*,void*);void*_TD;const struct Cyc_Dict_T*_TE;void*_TF;void*_T10;const struct Cyc_Dict_T*_T11;const struct Cyc_Dict_T*_T12;_T0= t;{struct Cyc_Dict_T _T13=*_T0;_T12= _T13.left;_T11= _T13.right;_T1= _T13.key_val;_T2= _T1.f0;_T10= (void*)_T2;_T3= _T13.key_val;_T4= _T3.f1;_TF= (void*)_T4;}{const struct Cyc_Dict_T*left=_T12;const struct Cyc_Dict_T*right=_T11;void*key=_T10;void*val=_TF;
# 389
if(left==0)goto _TLD7;else{goto _TLD8;}_TLD8: _T6= f;_T7= env;_T8= left;_T9= Cyc_Dict_forall_tree_c(_T6,_T7,_T8);if(_T9)goto _TLD7;else{goto _TLD5;}_TLD7: _TA= f(env,key,val);if(!_TA)goto _TLD5;
...
# 389
 return _T5;}}
# 393
long Cyc_Dict_forall_c(long(*f)(void*,void*,void*),void*env,struct Cyc_Dict_Dict d){struct Cyc_Dict_Dict _T0;long(*_T1)(void*,void*,void*);void*_T2;const struct Cyc_Dict_T*_T3;long _T4;_T0= d;{
const struct Cyc_Dict_T*t=_T0.t;
if(t!=0)goto _TLDB;
return 1;_TLDB: _T1= f;_T2= env;_T3= t;_T4= 
Cyc_Dict_forall_tree_c(_T1,_T2,_T3);return _T4;}}struct _tuple5{long(*f0)(void*,void*,void*);struct Cyc_Dict_Dict f1;};
# 400
static long Cyc_Dict_forall_intersect_f(struct _tuple5*env,void*a,void*b){struct _tuple5*_T0;long _T1;void*_T2;void*_T3;void*_T4;long _T5;struct Cyc_Dict_Dict _T6;long(*_T7)(void*,void*,void*);_T0= env;{struct _tuple5 _T8=*_T0;_T7= _T8.f0;_T6= _T8.f1;}{long(*f)(void*,void*,void*)=_T7;struct Cyc_Dict_Dict d2=_T6;_T1= 
# 402
Cyc_Dict_member(d2,a);if(!_T1)goto _TLDD;_T2= a;_T3= b;_T4= 
Cyc_Dict_lookup(d2,a);_T5= f(_T2,_T3,_T4);return _T5;_TLDD:
 return 1;}}
# 408
long Cyc_Dict_forall_intersect(long(*f)(void*,void*,void*),struct Cyc_Dict_Dict d1,struct Cyc_Dict_Dict d2){struct _tuple5 _T0;long(*_T1)(long(*)(struct _tuple5*,void*,void*),struct _tuple5*,struct Cyc_Dict_Dict);struct _tuple5*_T2;struct _tuple5*_T3;struct Cyc_Dict_Dict _T4;long _T5;{struct _tuple5 _T6;
_T6.f0= f;_T6.f1= d2;_T0= _T6;}{struct _tuple5 env=_T0;{
long(*_T6)(long(*)(struct _tuple5*,void*,void*),struct _tuple5*,struct Cyc_Dict_Dict)=(long(*)(long(*)(struct _tuple5*,void*,void*),struct _tuple5*,struct Cyc_Dict_Dict))Cyc_Dict_forall_c;_T1= _T6;}_T2= & env;_T3= (struct _tuple5*)_T2;_T4= d1;_T5= _T1(Cyc_Dict_forall_intersect_f,_T3,_T4);return _T5;}}struct _tuple6{void*(*f0)(void*,void*,void*,void*);void*f1;};
# 413
static struct Cyc_Dict_Dict*Cyc_Dict_union_f(struct _tuple6*env,void*a,void*b,struct Cyc_Dict_Dict*d1){struct Cyc_Dict_Dict*_T0;struct Cyc_Dict_Dict _T1;void*_T2;long _T3;struct Cyc_Dict_Dict*_T4;struct Cyc_Dict_Dict _T5;void*_T6;struct _tuple6*_T7;struct _tuple6 _T8;void*(*_T9)(void*,void*,void*,void*);struct _tuple6*_TA;struct _tuple6 _TB;void*_TC;void*_TD;void*_TE;void*_TF;struct Cyc_Dict_Dict*_T10;struct Cyc_Dict_Dict*_T11;struct Cyc_Dict_Dict _T12;void*_T13;void*_T14;struct Cyc_Dict_Dict*_T15;struct Cyc_Dict_Dict*_T16;struct Cyc_Dict_Dict*_T17;struct Cyc_Dict_Dict _T18;void*_T19;void*_T1A;struct Cyc_Dict_Dict*_T1B;_T0= d1;_T1= *_T0;_T2= a;_T3= 
# 415
...
({__typeof__(Cyc_Dict_insert(_T12,_T13,_T14))_T1C=Cyc_Dict_insert(_T12,_T13,_T14);*_T10= _T1C;});goto _TLE2;_TLE1: _TLE2: _T15= d1;
return _T15;}}_TLDF: _T16= d1;_T17= d1;_T18= *_T17;_T19= a;_T1A= b;
# 423
({__typeof__(Cyc_Dict_insert(_T18,_T19,_T1A))_T1C=Cyc_Dict_insert(_T18,_T19,_T1A);*_T16= _T1C;});_T1B= d1;
return _T1B;}
# 427
...
# 429
if(_T2!=_T5)goto _TLE3;_T6= d1;
return _T6;_TLE3: _T7= d1;_T8= _T7.t;
if(_T8!=0)goto _TLE5;_T9= d2;
return _T9;_TLE5: _TA= d2;_TB= _TA.t;
if(_TB!=0)goto _TLE7;_TC= d1;
return _TC;_TLE7:{struct _tuple6 _T14;
...
return _T13;}}
# 440
struct Cyc_Dict_Dict Cyc_Dict_intersect_c(void*(*f)(void*,void*,void*,void*),void*env,struct Cyc_Dict_Dict d1,struct Cyc_Dict_Dict d2){struct Cyc_Dict_Dict _T0;struct Cyc_Dict_Dict _T1;struct Cyc_Dict_Dict _T2;const struct Cyc_Dict_T*_T3;int _T4;const struct Cyc_Dict_T*_T5;int _T6;struct Cyc_Dict_Dict _T7;const struct Cyc_Dict_T**_T8;const struct Cyc_Dict_T**_T9;struct _RegionHandle*_TA;unsigned _TB;unsigned _TC;int _TD;int _TE;struct _fat_ptr _TF;int _T10;int _T11;unsigned char*_T12;const struct Cyc_Dict_T**_T13;struct _tuple0 _T14;void*_T15;struct _tuple0 _T16;void*_T17;int _T18;unsigned _T19;struct _fat_ptr _T1A;unsigned _T1B;struct _fat_ptr _T1C;struct _fat_ptr _T1D;unsigned _T1E;const struct Cyc_Dict_T**_T1F;struct _RegionHandle*_T20;unsigned _T21;unsigned _T22;struct _fat_ptr _T23;unsigned _T24;unsigned _T25;struct _fat_ptr _T26;unsigned char*_T27;const struct Cyc_Dict_T**_T28;unsigned _T29;int _T2A;unsigned _T2B;struct _fat_ptr _T2C;int _T2D;unsigned char*_T2E;const struct Cyc_Dict_T**_T2F;struct _fat_ptr _T30;int _T31;unsigned char*_T32;const struct Cyc_Dict_T**_T33;long _T34;struct Cyc_Dict_Dict _T35;struct _RegionHandle*_T36;struct Cyc_Dict_Dict _T37;int(*_T38)(void*,void*);struct _tuple0 _T39;void*_T3A;void*_T3B;void*_T3C;void*_T3D;const struct Cyc_Dict_T*_T3E;struct Cyc_Dict_Dict _T3F;struct Cyc_Dict_Dict _T40;struct Cyc_Dict_Dict _T41;_T0= d2;{
# 442
const struct Cyc_Dict_T*t2=_T0.t;
if(t2!=0)goto _TLE9;_T1= d2;
return _T1;_TLE9: _T2= d1;_T3= _T2.t;_T4= (int)_T3;_T5= t2;_T6= (int)_T5;
if(_T4!=_T6)goto _TLEB;_T7= d2;
return _T7;_TLEB: {
const struct Cyc_Dict_T*ans_tree=0;struct _RegionHandle _T42=_new_region(0U,"temp");struct _RegionHandle*temp=& _T42;_push_region(temp);{unsigned _T43=16U;_TA= temp;_TB= _check_times(_T43,sizeof(const struct Cyc_Dict_T*));{const struct Cyc_Dict_T**_T44=_region_malloc(_TA,0U,_TB);{unsigned _T45=_T43;unsigned i;i= 0;_TLF0: if(i < _T45)goto _TLEE;else{goto _TLEF;}_TLEE: _TC= i;
# 451
_T44[_TC]= t2;i= i + 1;goto _TLF0;_TLEF:;}_T9= (const struct Cyc_Dict_T**)_T44;}_T8= _T9;}{struct _fat_ptr queue=_tag_fat(_T8,sizeof(const struct Cyc_Dict_T*),16U);
int ind=0;
_TLF1: _TD= ind;_TE= - 1;if(_TD!=_TE)goto _TLF2;else{goto _TLF3;}
_TLF2: _TF= queue;_T10= ind;ind= _T10 + -1;_T11= _T10;_T12= _check_fat_subscript(_TF,sizeof(const struct Cyc_Dict_T*),_T11);_T13= (const struct Cyc_Dict_T**)_T12;{const struct Cyc_Dict_T*_T43=*_T13;void*_T44;void*_T45;const struct Cyc_Dict_T*_T46;const struct Cyc_Dict_T*_T47;{struct Cyc_Dict_T _T48=*_T43;_T47= _T48.left;_T46= _T48.right;_T14= _T48.key_val;_T15= _T14.f0;_T45= (void*)_T15;_T16= _T48.key_val;_T17= _T16.f1;_T44= (void*)_T17;}{const struct Cyc_Dict_T*l=_T47;const struct Cyc_Dict_T*r=_T46;void*k=_T45;void*v=_T44;_T18= ind + 2;_T19= (unsigned)_T18;_T1A= queue;_T1B= 
_get_fat_size(_T1A,sizeof(const struct Cyc_Dict_T*));if(_T19 < _T1B)goto _TLF4;_T1D= queue;_T1E= 
_get_fat_size(_T1D,sizeof(const struct Cyc_Dict_T*));{unsigned _T48=_T1E * 2U;_T20= temp;_T21= _check_times(_T48,sizeof(const struct Cyc_Dict_T*));{const struct Cyc_Dict_T**_T49=_region_malloc(_T20,0U,_T21);{unsigned _T4A=_T48;unsigned i;i= 0;_TLF9: if(i < _T4A)goto _TLF7;else{goto _TLF8;}_TLF7: _T22= i;_T23= queue;_T24= _get_fat_size(_T23,sizeof(const struct Cyc_Dict_T*));if(_T22 >= _T24)goto _TLFA;_T25= i;_T26= queue;_T27= _T26.curr;_T28= (const struct Cyc_Dict_T**)_T27;_T29= i;_T2A= (int)_T29;_T49[_T25]= _T28[_T2A];goto _TLFB;_TLFA: _T2B= i;_T49[_T2B]= t2;_TLFB: i= i + 1;goto _TLF9;_TLF8:;}_T1F= (const struct Cyc_Dict_T**)_T49;}_T1C= _tag_fat(_T1F,sizeof(const struct Cyc_Dict_T*),_T48);}queue= _T1C;goto _TLF5;_TLF4: _TLF5:
 if(l==0)goto _TLFC;_T2C= queue;
ind= ind + 1;_T2D= ind;_T2E= _check_fat_subscript(_T2C,sizeof(const struct Cyc_Dict_T*),_T2D);_T2F= (const struct Cyc_Dict_T**)_T2E;*_T2F= l;goto _TLFD;_TLFC: _TLFD:
 if(r==0)goto _TLFE;_T30= queue;
ind= ind + 1;_T31= ind;_T32= _check_fat_subscript(_T30,sizeof(const struct Cyc_Dict_T*),_T31);_T33= (const struct Cyc_Dict_T**)_T32;*_T33= r;goto _TLFF;_TLFE: _TLFF: _T34= 
Cyc_Dict_member(d1,k);if(!_T34)goto _TL100;_T35= d2;_T36= _T35.r;_T37= d2;_T38= _T37.rel;{struct _tuple0 _T48;
_T48.f0= k;_T3A= env;_T3B= k;_T3C= Cyc_Dict_lookup(d1,k);_T3D= v;({__typeof__(f(_T3A,_T3B,_T3C,_T3D))_T49=f(_T3A,_T3B,_T3C,_T3D);_T48.f1= _T49;});_T39= _T48;}_T3E= ans_tree;ans_tree= Cyc_Dict_ins(_T36,_T38,_T39,_T3E);goto _TL101;_TL100: _TL101:;}}goto _TLF1;_TLF3:;}{struct Cyc_Dict_Dict _T43;_T40= d2;
# 465
_T43.rel= _T40.rel;_T41= d2;_T43.r= _T41.r;_T43.t= ans_tree;_T3F= _T43;}{struct Cyc_Dict_Dict _T43=_T3F;_npop_handler(0);return _T43;}_pop_region();}}}
# 468
static void*Cyc_Dict_intersect_f(void*(*f)(void*,void*,void*),void*a,void*b1,void*b2){void*_T0;_T0= f(a,b1,b2);return _T0;}
# 470
...
# 482
struct Cyc_List_List*Cyc_Dict_to_list(struct Cyc_Dict_Dict d){struct Cyc_List_List*_T0;_T0= Cyc_Dict_rto_list(Cyc_Core_heap_region,d);return _T0;}struct _tuple7{long(*f0)(void*,void*);struct _RegionHandle*f1;};
# 484
static struct Cyc_Dict_Dict*Cyc_Dict_filter_f(struct _tuple7*env,void*x,void*y,struct Cyc_Dict_Dict*acc){struct _tuple7*_T0;long _T1;struct Cyc_Dict_Dict*_T2;struct Cyc_Dict_Dict*_T3;struct Cyc_Dict_Dict _T4;void*_T5;void*_T6;struct Cyc_Dict_Dict*_T7;struct _RegionHandle*_T8;long(*_T9)(void*,void*);_T0= env;{struct _tuple7 _TA=*_T0;_T9= _TA.f0;_T8= _TA.f1;}{long(*f)(void*,void*)=_T9;struct _RegionHandle*r=_T8;_T1= 
# 487
f(x,y);if(!_T1)goto _TL102;_T2= acc;_T3= acc;_T4= *_T3;_T5= x;_T6= y;
({__typeof__(Cyc_Dict_insert(_T4,_T5,_T6))_TA=Cyc_Dict_insert(_T4,_T5,_T6);*_T2= _TA;});goto _TL103;_TL102: _TL103: _T7= acc;
# 490
return _T7;}}
# 493
struct Cyc_Dict_Dict Cyc_Dict_rfilter(struct _RegionHandle*r2,long(*f)(void*,void*),struct Cyc_Dict_Dict d){struct _tuple7 _T0;struct _RegionHandle*_T1;struct Cyc_Dict_Dict _T2;int(*_T3)(void*,void*);struct Cyc_Dict_Dict*(*_T4)(struct Cyc_Dict_Dict*(*)(struct _tuple7*,void*,void*,struct Cyc_Dict_Dict*),struct _tuple7*,struct Cyc_Dict_Dict,struct Cyc_Dict_Dict*);struct _tuple7*_T5;struct Cyc_Dict_Dict _T6;struct Cyc_Dict_Dict*_T7;struct Cyc_Dict_Dict*_T8;struct Cyc_Dict_Dict*_T9;struct Cyc_Dict_Dict _TA;{struct _tuple7 _TB;
...
# 504
struct Cyc_Dict_Dict Cyc_Dict_filter(long(*f)(void*,void*),struct Cyc_Dict_Dict d){struct _RegionHandle*_T0;long(*_T1)(void*,void*);struct Cyc_Dict_Dict _T2;struct Cyc_Dict_Dict _T3;_T0= Cyc_Core_heap_region;_T1= f;_T2= d;_T3= Cyc_Dict_rfilter(_T0,_T1,_T2);return _T3;}struct _tuple8{long(*f0)(void*,void*,void*);void*f1;struct _RegionHandle*f2;};
# 506
static struct Cyc_Dict_Dict*Cyc_Dict_filter_c_f(struct _tuple8*env,void*x,void*y,struct Cyc_Dict_Dict*acc){struct _tuple8*_T0;void*_T1;long _T2;struct Cyc_Dict_Dict*_T3;struct Cyc_Dict_Dict*_T4;struct Cyc_Dict_Dict _T5;void*_T6;void*_T7;struct Cyc_Dict_Dict*_T8;struct _RegionHandle*_T9;void*_TA;long(*_TB)(void*,void*,void*);_T0= env;{struct _tuple8 _TC=*_T0;_TB= _TC.f0;_T1= _TC.f1;_TA= (void*)_T1;_T9= _TC.f2;}{long(*f)(void*,void*,void*)=_TB;void*f_env=_TA;struct _RegionHandle*r2=_T9;_T2= 
# 509
f(f_env,x,y);if(!_T2)goto _TL104;_T3= acc;_T4= acc;_T5= *_T4;_T6= x;_T7= y;
({__typeof__(Cyc_Dict_insert(_T5,_T6,_T7))_TC=Cyc_Dict_insert(_T5,_T6,_T7);*_T3= _TC;});goto _TL105;_TL104: _TL105: _T8= acc;
return _T8;}}
# 514
struct Cyc_Dict_Dict Cyc_Dict_rfilter_c(struct _RegionHandle*r2,long(*f)(void*,void*,void*),void*f_env,struct Cyc_Dict_Dict d){struct _tuple8 _T0;struct _RegionHandle*_T1;struct Cyc_Dict_Dict _T2;int(*_T3)(void*,void*);struct Cyc_Dict_Dict*(*_T4)(struct Cyc_Dict_Dict*(*)(struct _tuple8*,void*,void*,struct Cyc_Dict_Dict*),struct _tuple8*,struct Cyc_Dict_Dict,struct Cyc_Dict_Dict*);struct _tuple8*_T5;struct Cyc_Dict_Dict _T6;struct Cyc_Dict_Dict*_T7;struct Cyc_Dict_Dict*_T8;struct Cyc_Dict_Dict*_T9;struct Cyc_Dict_Dict _TA;{struct _tuple8 _TB;
# 516
...
# 520
struct Cyc_Dict_Dict Cyc_Dict_filter_c(long(*f)(void*,void*,void*),void*f_env,struct Cyc_Dict_Dict d){struct _RegionHandle*_T0;long(*_T1)(void*,void*,void*);void*_T2;struct Cyc_Dict_Dict _T3;struct Cyc_Dict_Dict _T4;_T0= Cyc_Core_heap_region;_T1= f;_T2= f_env;_T3= d;_T4= 
# 522
Cyc_Dict_rfilter_c(_T0,_T1,_T2,_T3);return _T4;}
# 525
static long Cyc_Dict_difference_f(struct Cyc_Dict_Dict*d,void*x,void*y){struct Cyc_Dict_Dict*_T0;struct Cyc_Dict_Dict _T1;void*_T2;long _T3;int _T4;_T0= d;_T1= *_T0;_T2= x;_T3= Cyc_Dict_member(_T1,_T2);_T4= !_T3;return _T4;}
# 527
struct Cyc_Dict_Dict Cyc_Dict_rdifference(struct _RegionHandle*r2,struct Cyc_Dict_Dict d1,struct Cyc_Dict_Dict d2){struct Cyc_Dict_Dict(*_T0)(struct _RegionHandle*,long(*)(struct Cyc_Dict_Dict*,void*,void*),struct Cyc_Dict_Dict*,struct Cyc_Dict_Dict);struct _RegionHandle*_T1;struct Cyc_Dict_Dict*_T2;struct Cyc_Dict_Dict*_T3;struct Cyc_Dict_Dict _T4;struct Cyc_Dict_Dict _T5;{
struct Cyc_Dict_Dict(*_T6)(struct _RegionHandle*,long(*)(struct Cyc_Dict_Dict*,void*,void*),struct Cyc_Dict_Dict*,struct Cyc_Dict_Dict)=(struct Cyc_Dict_Dict(*)(struct _RegionHandle*,long(*)(struct Cyc_Dict_Dict*,void*,void*),struct Cyc_Dict_Dict*,struct Cyc_Dict_Dict))Cyc_Dict_rfilter_c;_T0= _T6;}_T1= r2;_T2= & d2;_T3= (struct Cyc_Dict_Dict*)_T2;_T4= d1;_T5= _T0(_T1,Cyc_Dict_difference_f,_T3,_T4);return _T5;}
# 530
...
# 534
static long Cyc_Dict_delete_f(struct _tuple9*env,void*x,void*y){struct _tuple9*_T0;void*_T1;int _T2;int _T3;void*_T4;int(*_T5)(void*,void*);_T0= env;{struct _tuple9 _T6=*_T0;_T5= _T6.f0;_T1= _T6.f1;_T4= (void*)_T1;}{int(*rel)(void*,void*)=_T5;void*x0=_T4;_T2= 
# 536
rel(x0,x);_T3= _T2!=0;return _T3;}}
# 539
struct Cyc_Dict_Dict Cyc_Dict_rdelete(struct _RegionHandle*r2,struct Cyc_Dict_Dict d,void*x){long _T0;struct Cyc_Dict_Dict _T1;struct _tuple9 _T2;struct Cyc_Dict_Dict _T3;struct Cyc_Dict_Dict(*_T4)(struct _RegionHandle*,long(*)(struct _tuple9*,void*,void*),struct _tuple9*,struct Cyc_Dict_Dict);struct _RegionHandle*_T5;struct _tuple9*_T6;struct Cyc_Dict_Dict _T7;struct Cyc_Dict_Dict _T8;_T0= 
Cyc_Dict_member(d,x);if(_T0)goto _TL106;else{goto _TL108;}
_TL108: _T1= Cyc_Dict_rcopy(r2,d);return _T1;_TL106:{struct _tuple9 _T9;_T3= d;
_T9.f0= _T3.rel;_T9.f1= x;_T2= _T9;}{struct _tuple9 env=_T2;{
struct Cyc_Dict_Dict(*_T9)(struct _RegionHandle*,long(*)(struct _tuple9*,void*,void*),struct _tuple9*,struct Cyc_Dict_Dict)=(struct Cyc_Dict_Dict(*)(struct _RegionHandle*,long(*)(struct _tuple9*,void*,void*),struct _tuple9*,struct Cyc_Dict_Dict))Cyc_Dict_rfilter_c;_T4= _T9;}_T5= r2;_T6= & env;_T7= d;_T8= _T4(_T5,Cyc_Dict_delete_f,_T6,_T7);return _T8;}}
# 546
struct Cyc_Dict_Dict Cyc_Dict_rdelete_same(struct Cyc_Dict_Dict d,void*x){long _T0;struct Cyc_Dict_Dict _T1;struct _tuple9 _T2;struct Cyc_Dict_Dict _T3;struct Cyc_Dict_Dict(*_T4)(struct _RegionHandle*,long(*)(struct _tuple9*,void*,void*),struct _tuple9*,struct Cyc_Dict_Dict);struct Cyc_Dict_Dict _T5;struct _RegionHandle*_T6;struct _tuple9*_T7;struct Cyc_Dict_Dict _T8;struct Cyc_Dict_Dict _T9;_T0= 
Cyc_Dict_member(d,x);if(_T0)goto _TL109;else{goto _TL10B;}
_TL10B: _T1= d;return _T1;_TL109:{struct _tuple9 _TA;_T3= d;
_TA.f0= _T3.rel;_TA.f1= x;_T2= _TA;}{struct _tuple9 env=_T2;{
struct Cyc_Dict_Dict(*_TA)(struct _RegionHandle*,long(*)(struct _tuple9*,void*,void*),struct _tuple9*,struct Cyc_Dict_Dict)=(struct Cyc_Dict_Dict(*)(struct _RegionHandle*,long(*)(struct _tuple9*,void*,void*),struct _tuple9*,struct Cyc_Dict_Dict))Cyc_Dict_rfilter_c;_T4= _TA;}_T5= d;_T6= _T5.r;_T7= & env;_T8= d;_T9= _T4(_T6,Cyc_Dict_delete_f,_T7,_T8);return _T9;}}
# 553
struct Cyc_Dict_Dict Cyc_Dict_delete(struct Cyc_Dict_Dict d,void*x){struct Cyc_Dict_Dict _T0;_T0= Cyc_Dict_rdelete(Cyc_Core_heap_region,d,x);return _T0;}struct _tuple10{struct _fat_ptr f0;int f1;};
# 555
long Cyc_Dict_iter_f(struct _tuple10*stk,struct _tuple0*dest){struct _tuple10*_T0;struct _tuple10*_T1;int*_T2;int*_T3;int _T4;int _T5;struct _fat_ptr _T6;int _T7;unsigned char*_T8;const struct Cyc_Dict_T**_T9;struct _tuple0*_TA;const struct Cyc_Dict_T*_TB;const struct Cyc_Dict_T*_TC;const struct Cyc_Dict_T*_TD;unsigned _TE;struct _fat_ptr _TF;unsigned char*_T10;const struct Cyc_Dict_T**_T11;int _T12;const struct Cyc_Dict_T*_T13;const struct Cyc_Dict_T*_T14;const struct Cyc_Dict_T*_T15;unsigned _T16;struct _fat_ptr _T17;int _T18;unsigned char*_T19;const struct Cyc_Dict_T**_T1A;const struct Cyc_Dict_T*_T1B;int*_T1C;void*_T1D;struct _fat_ptr _T1E;_T0= stk;{struct _tuple10 _T1F=*_T0;_T1E= _T1F.f0;_T1= stk;_T2= & _T1->f1;_T1D= (int*)_T2;}{struct _fat_ptr stack=_T1E;int*indp=(int*)_T1D;_T3= indp;{
# 559
...
# 583
t= _T2.t;_T4= 2 * half_max_size;{unsigned _TE=(unsigned)_T4;_T6= rgn;_T7= _check_times(_TE,sizeof(const struct Cyc_Dict_T*));{const struct Cyc_Dict_T**_TF=_region_malloc(_T6,0U,_T7);{unsigned _T10=_TE;unsigned i;i= 0;_TL118: if(i < _T10)goto _TL116;else{goto _TL117;}_TL116: _T8= i;
# 585
_TF[_T8]= t;i= i + 1;goto _TL118;_TL117:;}_T5= (const struct Cyc_Dict_T**)_TF;}_T3= 
# 584
_tag_fat(_T5,sizeof(const struct Cyc_Dict_T*),_TE);}{struct _fat_ptr stack=_T3;{struct Cyc_Iter_Iter _TE;_TB= rgn;{struct _tuple10*_TF=_region_malloc(_TB,0U,sizeof(struct _tuple10));
# 588
_TF->f0= stack;_TC= t;_TD= (unsigned)_TC;if(!_TD)goto _TL119;_TF->f1= 0;goto _TL11A;_TL119: _TF->f1= - 1;_TL11A: _TA= (struct _tuple10*)_TF;}_TE.env= _TA;_TE.next= Cyc_Dict_iter_f;_T9= _TE;}
# 587
return _T9;}}}
# 596
...
# 604
({__typeof__(_tag_fat("Dict::marshal: Write failure",sizeof(char),29U))_T13=_tag_fat("Dict::marshal: Write failure",sizeof(char),29U);_T12->f1= _T13;});_T0= (struct Cyc_Core_Failure_exn_struct*)_T12;}_T1= (void*)_T0;_throw(_T1);
# 606
...
({__typeof__(_tag_fat("Dict::unmarshal: list length is -1",sizeof(char),35U))_T7=_tag_fat("Dict::unmarshal: list length is -1",sizeof(char),35U);_T6->f1= _T7;});_T3= (struct Cyc_Core_Failure_exn_struct*)_T6;}_T4= (void*)_T3;_throw(_T4);goto _TL11F;_TL11E: _TL11F:{
