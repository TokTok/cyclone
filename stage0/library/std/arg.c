#include <cyc_include.h>
 extern char Cyc_Core_Not_found[10U];struct Cyc_Core_Not_found_exn_struct{char*tag;};struct Cyc_List_List{void*hd;struct Cyc_List_List*tl;};extern char Cyc_Arg_Bad[4U];struct Cyc_Arg_Bad_exn_struct{char*tag;struct _fat_ptr f1;};struct Cyc_Arg_Unit_spec_Arg_Spec_struct{int tag;void(*f1)(void);};struct Cyc_Arg_Flag_spec_Arg_Spec_struct{int tag;void(*f1)(struct _fat_ptr);};struct Cyc_Arg_FlagString_spec_Arg_Spec_struct{int tag;void(*f1)(struct _fat_ptr,struct _fat_ptr);};struct Cyc_Arg_Set_spec_Arg_Spec_struct{int tag;long*f1;};struct Cyc_Arg_Clear_spec_Arg_Spec_struct{int tag;long*f1;};struct Cyc_Arg_String_spec_Arg_Spec_struct{int tag;void(*f1)(struct _fat_ptr);};struct Cyc_Arg_Int_spec_Arg_Spec_struct{int tag;void(*f1)(int);};struct Cyc_Arg_Rest_spec_Arg_Spec_struct{int tag;void(*f1)(struct _fat_ptr);};
# 69 "cyclone/library/std/arg.h"
extern int Cyc_Arg_current;
# 29 "cyclone/library/std/assert.h"
extern void*Cyc___assert_fail(struct _fat_ptr,struct _fat_ptr,unsigned);struct Cyc___cycFILE;
...
# 298
extern int isspace(int);struct Cyc_Buffer_t;
...
# 64
extern struct _fat_ptr Cyc_strconcat(struct _fat_ptr,struct _fat_ptr);char Cyc_Arg_Bad[4U]="Bad";char Cyc_Arg_Error[6U]="Error";struct Cyc_Arg_Unknown_Arg_error_struct{int tag;struct _fat_ptr f1;};struct Cyc_Arg_Missing_Arg_error_struct{int tag;struct _fat_ptr f1;};struct Cyc_Arg_Message_Arg_error_struct{int tag;struct _fat_ptr f1;};struct Cyc_Arg_Wrong_Arg_error_struct{int tag;struct _fat_ptr f1;struct _fat_ptr f2;struct _fat_ptr f3;};struct _tuple0{struct _fat_ptr f0;long f1;struct _fat_ptr f2;void*f3;struct _fat_ptr f4;};
# 64 "cyclone/library/std/arg.cyc"
static void*Cyc_Arg_lookup(struct Cyc_List_List*l,struct _fat_ptr x){struct Cyc_List_List*_T0;void*_T1;struct _tuple0*_T2;struct _tuple0 _T3;struct Cyc_List_List*_T4;void*_T5;struct _tuple0*_T6;struct _tuple0 _T7;long _T8;struct _fat_ptr _T9;struct Cyc_List_List*_TA;void*_TB;struct _tuple0*_TC;struct _tuple0 _TD;struct _fat_ptr _TE;unsigned long _TF;int _T10;struct Cyc_List_List*_T11;void*_T12;struct _tuple0*_T13;struct _tuple0 _T14;void*_T15;struct _fat_ptr _T16;struct Cyc_List_List*_T17;void*_T18;struct _tuple0*_T19;struct _tuple0 _T1A;struct _fat_ptr _T1B;int _T1C;struct Cyc_List_List*_T1D;void*_T1E;struct _tuple0*_T1F;struct _tuple0 _T20;void*_T21;struct Cyc_List_List*_T22;struct Cyc_Core_Not_found_exn_struct*_T23;void*_T24;
...
if(_T2!=0)goto _TL9;_T3= 
_tag_fat(0,0,0);return _T3;_TL9:
 if(howmuch >= 0)goto _TLB;
howmuch= 0;goto _TLC;_TLB: _TLC: {
unsigned long len=Cyc_strlen(s);_T4= len;_T5= s;_T6= 
_get_fat_size(_T5,sizeof(char));if(_T4 > _T6)goto _TLD;goto _TLE;_TLD: _T8= Cyc___assert_fail;{int(*_T44)(struct _fat_ptr,struct _fat_ptr,unsigned)=(int(*)(struct _fat_ptr,struct _fat_ptr,unsigned))_T8;_T7= _T44;}_T9= _tag_fat("len <= numelts(s)",sizeof(char),18U);_TA= _tag_fat("cyclone/library/std/arg.cyc",sizeof(char),28U);_T7(_T9,_TA,90U);_TLE: _TB= howmuch;_TC= (unsigned long)_TB;_TD= len;
...
# 115
if(_T39 >= _T3A)goto _TL26;_T3B= s;_T3C= _T3B.curr;_T3D= (const char*)_T3C;_T3E= i;_T3F= _T3D[_T3E];_T40= (int)_T3F;if(!_T40)goto _TL26;_T41= s;_T42= i;
whatsleft= _fat_ptr_plus(_T41,sizeof(char),_T42);goto _TL27;_TL26: _TL27: _T43= whatsleft;
return _T43;}}}}
# 125
...
if(_T2==0)goto _TL28;
Cyc_Buffer_add_string(b,item);goto _TL29;_TL28: _TL29: _T3= desc;_T4= _T3.curr;_T5= (char*)_T4;
if(_T5!=0)goto _TL2A;
return;_TL2A:
 if(indent >= 0)goto _TL2C;
indent= 0;goto _TL2D;_TL2C: _TL2D:
 if(margin >= 0)goto _TL2E;
margin= 0;goto _TL2F;_TL2E: _TL2F: _T7= indent + 2;_T8= (unsigned)_T7;{unsigned _T3D=_T8 + 1U;_TA= _check_times(_T3D,sizeof(char));{char*_T3E=_cycalloc_atomic(_TA);{unsigned _T3F=_T3D;unsigned i;i= 0;_TL33: if(i < _T3F)goto _TL31;else{goto _TL32;}_TL31: _TB= i;
# 136
...
unsigned i=0U;_TL47: _T25= i;_T26= indent;_T27= (unsigned long)_T26;_T28= itemlen;_T29= _T27 - _T28;if(_T25 < _T29)goto _TL45;else{goto _TL46;}
_TL45: _T2A= temp;_T2B= i;_T2C= (int)_T2B;{struct _fat_ptr _T3D=_fat_ptr_plus(_T2A,sizeof(char),_T2C);_T2D= _check_fat_subscript(_T3D,sizeof(char),0U);_T2E= (char*)_T2D;{char _T3E=*_T2E;char _T3F=' ';_T2F= _get_fat_size(_T3D,sizeof(char));if(_T2F!=1U)goto _TL48;if(_T3E!=0)goto _TL48;if(_T3F==0)goto _TL48;_throw_arraybounds();goto _TL49;_TL48: _TL49: _T30= _T3D.curr;_T31= (char*)_T30;*_T31= _T3F;}}
# 146
...
_TL50: _T4= b;_T5= speclist;_T6= _T5->hd;_T7= (struct _tuple0*)_T6;_T8= *_T7;_T9= _T8.f0;_TA= speclist;_TB= _TA->hd;_TC= (struct _tuple0*)_TB;_TD= *_TC;_TE= _TD.f2;_TF= Cyc_strconcat(_T9,_TE);_T10= speclist;_T11= _T10->hd;_T12= (struct _tuple0*)_T11;_T13= *_T12;_T14= _T13.f4;Cyc_Arg_Justify_justify_b(_T4,12,72,_TF,_T14);_T15= speclist;
# 172
speclist= _T15->tl;goto _TL4F;_TL51:{struct Cyc_String_pa_PrintArg_struct _T1A;_T1A.tag= 0;
# 174
({__typeof__(Cyc_Buffer_contents(b))_T1B=Cyc_Buffer_contents(b);_T1A.f1= _T1B;});_T16= _T1A;}{struct Cyc_String_pa_PrintArg_struct _T1A=_T16;void*_T1B[1];_T1B[0]= & _T1A;_T17= Cyc_stderr;_T18= _tag_fat("%s",sizeof(char),3U);_T19= _tag_fat(_T1B,sizeof(void*),1);Cyc_fprintf(_T17,_T18,_T19);}}}
# 177
...
# 237
f(s);goto _LL5;}case 3: _T2C= action;{struct Cyc_Arg_Set_spec_Arg_Spec_struct*_T80=(struct Cyc_Arg_Set_spec_Arg_Spec_struct*)_T2C;_T7D= _T80->f1;}{long*r=_T7D;_T2D= r;
# 240
*_T2D= 1;goto _LL5;}case 4: _T2E= action;{struct Cyc_Arg_Clear_spec_Arg_Spec_struct*_T80=(struct Cyc_Arg_Clear_spec_Arg_Spec_struct*)_T2E;_T7D= _T80->f1;}{long*r=_T7D;_T2F= r;
# 243
...
_T80->f1= s;_T80->f2= arg;({__typeof__(_tag_fat("an integer",sizeof(char),11U))_T81=_tag_fat("an integer",sizeof(char),11U);_T80->f3= _T81;});_T58= (struct Cyc_Arg_Wrong_Arg_error_struct*)_T80;}_T59= (void*)_T58;_T5A= speclist;_T5B= errmsg;Cyc_Arg_stop(_T57,_T59,_T5A,_T5B);_npop_handler(0);return;_TL72:
# 266
 f(n);
