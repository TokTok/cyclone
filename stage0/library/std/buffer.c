...
# 48 "cyclone/library/std/buffer.cyc"
...
_T6->buffer= s;_T6->position= 0U;_T6->length= n;({__typeof__(_tag_fat(0,0,0))_T7=_tag_fat(0,0,0);_T6->initial_buffer= _T7;});_T4= (struct Cyc_Buffer_t*)_T6;}return _T4;}
# 53
_TL0:{struct Cyc_Buffer_t*_T6=_cycalloc(sizeof(struct Cyc_Buffer_t));({__typeof__(_tag_fat(0,0,0))_T7=_tag_fat(0,0,0);_T6->buffer= _T7;});_T6->position= 0U;_T6->length= 0U;({__typeof__(_tag_fat(0,0,0))_T7=_tag_fat(0,0,0);_T6->initial_buffer= _T7;});_T5= (struct Cyc_Buffer_t*)_T6;}return _T5;}
# 57
...
return _TD;}
# 76
long Cyc_Buffer_restore(struct Cyc_Buffer_t*b,struct _fat_ptr buf){unsigned long _T0;struct Cyc_Buffer_t*_T1;struct Cyc_Buffer_t*_T2;struct _fat_ptr _T3;unsigned char*_T4;char*_T5;struct Cyc_Buffer_t*_T6;struct Cyc_Buffer_t*_T7;void(*_T8)(char*);void(*_T9)(void*);struct _fat_ptr _TA;unsigned _TB;unsigned char*_TC;char*_TD;struct Cyc_Buffer_t*_TE;struct Cyc_Buffer_t*_TF;int _T10;_T0= 
...
return 1;}}
# 89
unsigned long Cyc_Buffer_length(struct Cyc_Buffer_t*b){struct Cyc_Buffer_t*_T0;unsigned _T1;_T0= b;_T1= _T0->position;return _T1;}
# 91
void Cyc_Buffer_clear(struct Cyc_Buffer_t*b){struct Cyc_Buffer_t*_T0;_T0= b;_T0->position= 0U;}
# 93
...
_TL19:{struct Cyc_Core_Invalid_argument_exn_struct*_T23=_cycalloc(sizeof(struct Cyc_Core_Invalid_argument_exn_struct));_T23->tag= Cyc_Core_Invalid_argument;({__typeof__(_tag_fat("Buffer::add_substring",sizeof(char),22U))_T24=_tag_fat("Buffer::add_substring",sizeof(char),22U);_T23->f1= _T24;});_T4= (struct Cyc_Core_Invalid_argument_exn_struct*)_T23;}_T5= (void*)_T4;_throw(_T5);goto _TL18;_TL17: _TL18: _T6= b;_T7= _T6->position;_T8= len;_T9= (unsigned)_T8;_TA= _T7 + _T9;{
int new_position=(int)_TA;_TB= new_position;_TC= (unsigned)_TB;_TD= b;_TE= _TD->length;
if(_TC <= _TE)goto _TL1C;_TF= b;_T10= len;_T11= (unsigned)_T10;
Cyc_Buffer_resize(_TF,_T11);goto _TL1D;_TL1C: _TL1D: {
struct _fat_ptr buf=_tag_fat(0,0,0);{
...
if(_T7 <= _T9)goto _TL1E;_TA= b;_TB= len;_TC= (unsigned)_TB;
Cyc_Buffer_resize(_TA,_TC);goto _TL1F;_TL1E: _TL1F: {
struct _fat_ptr buf=_tag_fat(0,0,0);{
