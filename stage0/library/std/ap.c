...
# 28
static struct Cyc_AP_T*Cyc_mk(int size){long _T0;void*_T1;struct Cyc_AP_T*_T2;struct _fat_ptr _T3;void*_T4;int(*_T5)(struct _fat_ptr,struct _fat_ptr,unsigned);void*(*_T6)(struct _fat_ptr,struct _fat_ptr,unsigned);struct _fat_ptr _T7;struct _fat_ptr _T8;struct Cyc_AP_T*_T9;struct Cyc_AP_T*_TA;struct Cyc_AP_T*_TB;struct Cyc_AP_T*_TC;
struct Cyc_AP_T*z;_T0= Cyc_init;
if(_T0)goto _TL0;else{goto _TL2;}
_TL2: Cyc_AP_init();goto _TL1;_TL0: _TL1: _T1= _cycalloc(sizeof(struct Cyc_AP_T));
...
_T2->digits= _T3;
if(size <= 0)goto _TL3;goto _TL4;_TL3: _T6= Cyc___assert_fail;{int(*_TD)(struct _fat_ptr,struct _fat_ptr,unsigned)=(int(*)(struct _fat_ptr,struct _fat_ptr,unsigned))_T6;_T5= _TD;}_T7= _tag_fat("size > 0",sizeof(char),9U);_T8= _tag_fat("cyclone/library/std/ap.cyc",sizeof(char),27U);_T5(_T7,_T8,34U);_TL4: _T9= z;
_T9->sign= 1;_TA= z;
_TA->size= size;_TB= z;
_TB->ndigits= 1;_TC= z;
return _TC;}
...
_check_null(z);_T3= _T2->digits;({__typeof__(Cyc_XP_length(_T1,_T3))_T5=Cyc_XP_length(_T1,_T3);_T0->ndigits= _T5;});_T4= z;
return _T4;}
# 54
static struct Cyc_AP_T*Cyc_add(struct Cyc_AP_T*z,struct Cyc_AP_T*x,struct Cyc_AP_T*y){struct Cyc_AP_T*_T0;struct Cyc_AP_T*_T1;int _T2;int _T3;struct Cyc_AP_T*_T4;struct Cyc_AP_T*_T5;int _T6;int _T7;int _T8;struct Cyc_AP_T*_T9;struct _fat_ptr _TA;struct Cyc_AP_T*_TB;struct _fat_ptr _TC;struct Cyc_AP_T*_TD;struct _fat_ptr _TE;struct Cyc_AP_T*_TF;struct _fat_ptr _T10;struct Cyc_AP_T*_T11;int _T12;int _T13;unsigned char*_T14;unsigned char*_T15;struct Cyc_AP_T*_T16;int _T17;int _T18;int _T19;struct Cyc_AP_T*_T1A;struct _fat_ptr _T1B;int _T1C;struct _fat_ptr _T1D;struct Cyc_AP_T*_T1E;struct _fat_ptr _T1F;int _T20;struct _fat_ptr _T21;int _T22;int _T23;struct Cyc_AP_T*_T24;struct _fat_ptr _T25;int _T26;unsigned char*_T27;unsigned char*_T28;int _T29;struct Cyc_AP_T*_T2A;struct _fat_ptr _T2B;struct Cyc_AP_T*_T2C;struct _fat_ptr _T2D;struct Cyc_AP_T*_T2E;struct _fat_ptr _T2F;int _T30;struct Cyc_AP_T*_T31;struct Cyc_AP_T*_T32;int _T33;struct Cyc_AP_T*_T34;_T0= 
...
_fat_ptr_plus(_T1B,sizeof(unsigned char),_T1C);_T1E= x;_T1F= _T1E->digits;_T20= n;_T21= _fat_ptr_plus(_T1F,sizeof(unsigned char),_T20);_T22= carry;_T23= Cyc_XP_sum(_T19,_T1D,_T21,_T22);*_T15= (unsigned char)_T23;}goto _TLE;
# 62
...
_fat_ptr_plus(_T10,sizeof(unsigned char),_T11);_T13= x;_T14= _T13->digits;_T15= n;_T16= _fat_ptr_plus(_T14,sizeof(unsigned char),_T15);_T17= borrow;borrow= Cyc_XP_diff(_TE,_T12,_T16,_T17);goto _TL10;_TLF: _TL10:
 if(borrow!=0)goto _TL11;goto _TL12;_TL11: _T19= Cyc___assert_fail;{int(*_T20)(struct _fat_ptr,struct _fat_ptr,unsigned)=(int(*)(struct _fat_ptr,struct _fat_ptr,unsigned))_T19;_T18= _T20;}_T1A= _tag_fat("borrow == 0",sizeof(char),12U);_T1B= _tag_fat("cyclone/library/std/ap.cyc",sizeof(char),27U);_T18(_T1A,_T1B,70U);_TL12: _T1C= z;_T1D= z;_T1E= _T1D->size;_T1F= 
...
# 84
struct Cyc_AP_T*Cyc_AP_new(long n){int _T0;struct Cyc_AP_T*_T1;long _T2;struct Cyc_AP_T*_T3;_T0= (int)sizeof(long);_T1= Cyc_mk(_T0);_T2= n;_T3= Cyc_set(_T1,_T2);return _T3;}
struct Cyc_AP_T*Cyc_AP_neg(struct Cyc_AP_T*x){struct Cyc_AP_T*_T0;unsigned _T1;int(*_T2)(struct _fat_ptr,struct _fat_ptr,unsigned);void*(*_T3)(struct _fat_ptr,struct _fat_ptr,unsigned);struct _fat_ptr _T4;struct _fat_ptr _T5;struct Cyc_AP_T*_T6;int _T7;struct Cyc_AP_T*_T8;struct _fat_ptr _T9;struct Cyc_AP_T*_TA;struct _fat_ptr _TB;struct Cyc_AP_T*_TC;int _TD;unsigned _TE;unsigned _TF;unsigned _T10;int _T11;struct Cyc_AP_T*_T12;int _T13;unsigned _T14;unsigned _T15;unsigned _T16;unsigned _T17;unsigned _T18;unsigned _T19;struct Cyc_AP_T*_T1A;struct Cyc_AP_T*_T1B;struct Cyc_AP_T*_T1C;int _T1D;struct Cyc_AP_T*_T1E;int _T1F;struct Cyc_AP_T*_T20;struct _fat_ptr _T21;unsigned char*_T22;unsigned char*_T23;unsigned char _T24;int _T25;struct Cyc_AP_T*_T26;int _T27;struct Cyc_AP_T*_T28;
struct Cyc_AP_T*z;_T0= x;_T1= (unsigned)_T0;
if(!_T1)goto _TL15;goto _TL16;_TL15: _T3= Cyc___assert_fail;{int(*_T29)(struct _fat_ptr,struct _fat_ptr,unsigned)=(int(*)(struct _fat_ptr,struct _fat_ptr,unsigned))_T3;_T2= _T29;}_T4= _tag_fat("x",sizeof(char),2U);_T5= _tag_fat("cyclone/library/std/ap.cyc",sizeof(char),27U);_T2(_T4,_T5,87U);_TL16: _T6= x;_T7= _T6->ndigits;
...
struct Cyc_AP_T*z;_T0= x;_T1= (unsigned)_T0;
if(!_T1)goto _TL1B;goto _TL1C;_TL1B: _T3= Cyc___assert_fail;{int(*_T1E)(struct _fat_ptr,struct _fat_ptr,unsigned)=(int(*)(struct _fat_ptr,struct _fat_ptr,unsigned))_T3;_T2= _T1E;}_T4= _tag_fat("x",sizeof(char),2U);_T5= _tag_fat("cyclone/library/std/ap.cyc",sizeof(char),27U);_T2(_T4,_T5,96U);_TL1C: _T6= x;_T7= _T6->ndigits;
z= Cyc_mk(_T7);_T8= z;_T9= _T8->digits;_TA= x;_TB= _TA->digits;_TC= x;_TD= _TC->ndigits;_TE= (unsigned)_TD;_TF= sizeof(*((unsigned char*)x->digits.curr));_T10= _TE / _TF;_T12= x;_T13= _T12->ndigits;_T14= (unsigned)_T13;_T15= sizeof(*((unsigned char*)x->digits.curr));_T16= _T14 % _T15;
...
return _T2D;}
# 113
struct Cyc_AP_T*Cyc_AP_add(struct Cyc_AP_T*x,struct Cyc_AP_T*y){struct Cyc_AP_T*_T0;unsigned _T1;int(*_T2)(struct _fat_ptr,struct _fat_ptr,unsigned);void*(*_T3)(struct _fat_ptr,struct _fat_ptr,unsigned);struct _fat_ptr _T4;struct _fat_ptr _T5;struct Cyc_AP_T*_T6;unsigned _T7;int(*_T8)(struct _fat_ptr,struct _fat_ptr,unsigned);void*(*_T9)(struct _fat_ptr,struct _fat_ptr,unsigned);struct _fat_ptr _TA;struct _fat_ptr _TB;struct Cyc_AP_T*_TC;int _TD;struct Cyc_AP_T*_TE;int _TF;int _T10;int _T11;struct Cyc_AP_T*_T12;int _T13;struct Cyc_AP_T*_T14;int _T15;struct Cyc_AP_T*_T16;struct Cyc_AP_T*_T17;int _T18;struct Cyc_AP_T*_T19;struct Cyc_AP_T*_T1A;struct Cyc_AP_T*_T1B;struct Cyc_AP_T*_T1C;int _T1D;struct Cyc_AP_T*_T1E;int _T1F;struct Cyc_AP_T*_T20;struct _fat_ptr _T21;unsigned char*_T22;unsigned char*_T23;unsigned char _T24;int _T25;struct Cyc_AP_T*_T26;int _T27;struct Cyc_AP_T*_T28;int _T29;struct Cyc_AP_T*_T2A;struct Cyc_AP_T*_T2B;struct Cyc_AP_T*_T2C;struct Cyc_AP_T*_T2D;int _T2E;struct Cyc_AP_T*_T2F;int _T30;struct Cyc_AP_T*_T31;struct _fat_ptr _T32;unsigned char*_T33;unsigned char*_T34;unsigned char _T35;int _T36;struct Cyc_AP_T*_T37;struct Cyc_AP_T*_T38;int _T39;struct Cyc_AP_T*_T3A;struct Cyc_AP_T*_T3B;struct Cyc_AP_T*_T3C;struct Cyc_AP_T*_T3D;int _T3E;struct Cyc_AP_T*_T3F;int _T40;struct Cyc_AP_T*_T41;struct _fat_ptr _T42;unsigned char*_T43;unsigned char*_T44;unsigned char _T45;int _T46;struct Cyc_AP_T*_T47;int _T48;struct Cyc_AP_T*_T49;
struct Cyc_AP_T*z;_T0= x;_T1= (unsigned)_T0;
if(!_T1)goto _TL28;goto _TL29;_TL28: _T3= Cyc___assert_fail;{int(*_T4A)(struct _fat_ptr,struct _fat_ptr,unsigned)=(int(*)(struct _fat_ptr,struct _fat_ptr,unsigned))_T3;_T2= _T4A;}_T4= _tag_fat("x",sizeof(char),2U);_T5= _tag_fat("cyclone/library/std/ap.cyc",sizeof(char),27U);_T2(_T4,_T5,115U);_TL29: _T6= y;_T7= (unsigned)_T6;
if(!_T7)goto _TL2A;goto _TL2B;_TL2A: _T9= Cyc___assert_fail;{int(*_T4A)(struct _fat_ptr,struct _fat_ptr,unsigned)=(int(*)(struct _fat_ptr,struct _fat_ptr,unsigned))_T9;_T8= _T4A;}_TA= _tag_fat("y",sizeof(char),2U);_TB= _tag_fat("cyclone/library/std/ap.cyc",sizeof(char),27U);_T8(_TA,_TB,116U);_TL2B: _TC= x;_TD= _TC->sign;_TE= y;_TF= _TE->sign;_T10= _TD ^ _TF;
...
struct Cyc_AP_T*z;_T0= x;_T1= (unsigned)_T0;
if(!_T1)goto _TL38;goto _TL39;_TL38: _T3= Cyc___assert_fail;{int(*_T4A)(struct _fat_ptr,struct _fat_ptr,unsigned)=(int(*)(struct _fat_ptr,struct _fat_ptr,unsigned))_T3;_T2= _T4A;}_T4= _tag_fat("x",sizeof(char),2U);_T5= _tag_fat("cyclone/library/std/ap.cyc",sizeof(char),27U);_T2(_T4,_T5,131U);_TL39: _T6= y;_T7= (unsigned)_T6;
if(!_T7)goto _TL3A;goto _TL3B;_TL3A: _T9= Cyc___assert_fail;{int(*_T4A)(struct _fat_ptr,struct _fat_ptr,unsigned)=(int(*)(struct _fat_ptr,struct _fat_ptr,unsigned))_T9;_T8= _T4A;}_TA= _tag_fat("y",sizeof(char),2U);_TB= _tag_fat("cyclone/library/std/ap.cyc",sizeof(char),27U);_T8(_TA,_TB,132U);_TL3B: _TC= x;_TD= _TC->sign;_TE= y;_TF= _TE->sign;_T10= _TD ^ _TF;
...
return _T49;}
# 145
struct Cyc_AP_T*Cyc_AP_div(struct Cyc_AP_T*x,struct Cyc_AP_T*y){struct Cyc_AP_T*_T0;unsigned _T1;int(*_T2)(struct _fat_ptr,struct _fat_ptr,unsigned);void*(*_T3)(struct _fat_ptr,struct _fat_ptr,unsigned);struct _fat_ptr _T4;struct _fat_ptr _T5;struct Cyc_AP_T*_T6;unsigned _T7;int(*_T8)(struct _fat_ptr,struct _fat_ptr,unsigned);void*(*_T9)(struct _fat_ptr,struct _fat_ptr,unsigned);struct _fat_ptr _TA;struct _fat_ptr _TB;struct Cyc_AP_T*_TC;int _TD;struct Cyc_AP_T*_TE;struct _fat_ptr _TF;unsigned char*_T10;unsigned char*_T11;unsigned char _T12;int _T13;int(*_T14)(struct _fat_ptr,struct _fat_ptr,unsigned);void*(*_T15)(struct _fat_ptr,struct _fat_ptr,unsigned);struct _fat_ptr _T16;struct _fat_ptr _T17;struct Cyc_AP_T*_T18;int _T19;struct Cyc_AP_T*_T1A;int _T1B;struct _fat_ptr _T1C;struct Cyc_AP_T*_T1D;int _T1E;struct Cyc_AP_T*_T1F;int _T20;int _T21;int _T22;unsigned _T23;void*_T24;struct Cyc_AP_T*_T25;int _T26;struct Cyc_AP_T*_T27;struct _fat_ptr _T28;struct Cyc_AP_T*_T29;struct _fat_ptr _T2A;struct Cyc_AP_T*_T2B;int _T2C;struct Cyc_AP_T*_T2D;struct _fat_ptr _T2E;struct Cyc_AP_T*_T2F;struct _fat_ptr _T30;struct _fat_ptr _T31;struct Cyc_AP_T*_T32;struct Cyc_AP_T*_T33;int _T34;struct Cyc_AP_T*_T35;struct Cyc_AP_T*_T36;int _T37;struct Cyc_AP_T*_T38;int _T39;struct Cyc_AP_T*_T3A;int _T3B;struct Cyc_AP_T*_T3C;struct _fat_ptr _T3D;unsigned char*_T3E;unsigned char*_T3F;unsigned char _T40;int _T41;struct Cyc_AP_T*_T42;int _T43;struct Cyc_AP_T*_T44;int _T45;int _T46;struct Cyc_AP_T*_T47;
struct Cyc_AP_T*q;struct Cyc_AP_T*r;_T0= x;_T1= (unsigned)_T0;
if(!_T1)goto _TL49;goto _TL4A;_TL49: _T3= Cyc___assert_fail;{int(*_T48)(struct _fat_ptr,struct _fat_ptr,unsigned)=(int(*)(struct _fat_ptr,struct _fat_ptr,unsigned))_T3;_T2= _T48;}_T4= _tag_fat("x",sizeof(char),2U);_T5= _tag_fat("cyclone/library/std/ap.cyc",sizeof(char),27U);_T2(_T4,_T5,147U);_TL4A: _T6= y;_T7= (unsigned)_T6;
if(!_T7)goto _TL4B;goto _TL4C;_TL4B: _T9= Cyc___assert_fail;{int(*_T48)(struct _fat_ptr,struct _fat_ptr,unsigned)=(int(*)(struct _fat_ptr,struct _fat_ptr,unsigned))_T9;_T8= _T48;}_TA= _tag_fat("y",sizeof(char),2U);_TB= _tag_fat("cyclone/library/std/ap.cyc",sizeof(char),27U);_T8(_TA,_TB,148U);_TL4C: _TC= y;_TD= _TC->ndigits;
if(_TD==1)goto _TL50;else{goto _TL4F;}_TL50: _TE= y;_TF= _TE->digits;_T10= _check_fat_subscript(_TF,sizeof(unsigned char),0);_T11= (unsigned char*)_T10;_T12= *_T11;_T13= (int)_T12;if(_T13==0)goto _TL4D;else{goto _TL4F;}_TL4F: goto _TL4E;_TL4D: _T15= Cyc___assert_fail;{int(*_T48)(struct _fat_ptr,struct _fat_ptr,unsigned)=(int(*)(struct _fat_ptr,struct _fat_ptr,unsigned))_T15;_T14= _T48;}_T16= _tag_fat("!((y)->ndigits == 1 && (y)->digits[0] == 0)",sizeof(char),44U);_T17= _tag_fat("cyclone/library/std/ap.cyc",sizeof(char),27U);_T14(_T16,_T17,149U);_TL4E: _T18= x;_T19= _T18->ndigits;
...
return _T47;}
# 161
struct Cyc_AP_T*Cyc_AP_mod(struct Cyc_AP_T*x,struct Cyc_AP_T*y){struct Cyc_AP_T*_T0;unsigned _T1;int(*_T2)(struct _fat_ptr,struct _fat_ptr,unsigned);void*(*_T3)(struct _fat_ptr,struct _fat_ptr,unsigned);struct _fat_ptr _T4;struct _fat_ptr _T5;struct Cyc_AP_T*_T6;unsigned _T7;int(*_T8)(struct _fat_ptr,struct _fat_ptr,unsigned);void*(*_T9)(struct _fat_ptr,struct _fat_ptr,unsigned);struct _fat_ptr _TA;struct _fat_ptr _TB;struct Cyc_AP_T*_TC;int _TD;struct Cyc_AP_T*_TE;struct _fat_ptr _TF;unsigned char*_T10;unsigned char*_T11;unsigned char _T12;int _T13;int(*_T14)(struct _fat_ptr,struct _fat_ptr,unsigned);void*(*_T15)(struct _fat_ptr,struct _fat_ptr,unsigned);struct _fat_ptr _T16;struct _fat_ptr _T17;struct Cyc_AP_T*_T18;int _T19;struct Cyc_AP_T*_T1A;int _T1B;struct _fat_ptr _T1C;struct Cyc_AP_T*_T1D;int _T1E;struct Cyc_AP_T*_T1F;int _T20;int _T21;int _T22;unsigned _T23;void*_T24;struct Cyc_AP_T*_T25;int _T26;struct Cyc_AP_T*_T27;struct _fat_ptr _T28;struct Cyc_AP_T*_T29;struct _fat_ptr _T2A;struct Cyc_AP_T*_T2B;int _T2C;struct Cyc_AP_T*_T2D;struct _fat_ptr _T2E;struct Cyc_AP_T*_T2F;struct _fat_ptr _T30;struct _fat_ptr _T31;struct Cyc_AP_T*_T32;struct Cyc_AP_T*_T33;int _T34;struct Cyc_AP_T*_T35;struct Cyc_AP_T*_T36;int _T37;struct Cyc_AP_T*_T38;int _T39;struct Cyc_AP_T*_T3A;int _T3B;struct Cyc_AP_T*_T3C;struct _fat_ptr _T3D;unsigned char*_T3E;unsigned char*_T3F;unsigned char _T40;int _T41;struct Cyc_AP_T*_T42;struct Cyc_AP_T*_T43;
struct Cyc_AP_T*q;struct Cyc_AP_T*r;_T0= x;_T1= (unsigned)_T0;
if(!_T1)goto _TL56;goto _TL57;_TL56: _T3= Cyc___assert_fail;{int(*_T44)(struct _fat_ptr,struct _fat_ptr,unsigned)=(int(*)(struct _fat_ptr,struct _fat_ptr,unsigned))_T3;_T2= _T44;}_T4= _tag_fat("x",sizeof(char),2U);_T5= _tag_fat("cyclone/library/std/ap.cyc",sizeof(char),27U);_T2(_T4,_T5,163U);_TL57: _T6= y;_T7= (unsigned)_T6;
if(!_T7)goto _TL58;goto _TL59;_TL58: _T9= Cyc___assert_fail;{int(*_T44)(struct _fat_ptr,struct _fat_ptr,unsigned)=(int(*)(struct _fat_ptr,struct _fat_ptr,unsigned))_T9;_T8= _T44;}_TA= _tag_fat("y",sizeof(char),2U);_TB= _tag_fat("cyclone/library/std/ap.cyc",sizeof(char),27U);_T8(_TA,_TB,164U);_TL59: _TC= y;_TD= _TC->ndigits;
if(_TD==1)goto _TL5D;else{goto _TL5C;}_TL5D: _TE= y;_TF= _TE->digits;_T10= _check_fat_subscript(_TF,sizeof(unsigned char),0);_T11= (unsigned char*)_T10;_T12= *_T11;_T13= (int)_T12;if(_T13==0)goto _TL5A;else{goto _TL5C;}_TL5C: goto _TL5B;_TL5A: _T15= Cyc___assert_fail;{int(*_T44)(struct _fat_ptr,struct _fat_ptr,unsigned)=(int(*)(struct _fat_ptr,struct _fat_ptr,unsigned))_T15;_T14= _T44;}_T16= _tag_fat("!((y)->ndigits == 1 && (y)->digits[0] == 0)",sizeof(char),44U);_T17= _tag_fat("cyclone/library/std/ap.cyc",sizeof(char),27U);_T14(_T16,_T17,165U);_TL5B: _T18= x;_T19= _T18->ndigits;
q= Cyc_mk(_T19);_T1A= y;_T1B= _T1A->ndigits;
...
return _T43;}
# 177
struct Cyc_AP_T*Cyc_AP_pow(struct Cyc_AP_T*x,struct Cyc_AP_T*y,struct Cyc_AP_T*p){struct Cyc_AP_T*_T0;unsigned _T1;int(*_T2)(struct _fat_ptr,struct _fat_ptr,unsigned);void*(*_T3)(struct _fat_ptr,struct _fat_ptr,unsigned);struct _fat_ptr _T4;struct _fat_ptr _T5;struct Cyc_AP_T*_T6;unsigned _T7;int(*_T8)(struct _fat_ptr,struct _fat_ptr,unsigned);void*(*_T9)(struct _fat_ptr,struct _fat_ptr,unsigned);struct _fat_ptr _TA;struct _fat_ptr _TB;struct Cyc_AP_T*_TC;int _TD;int(*_TE)(struct _fat_ptr,struct _fat_ptr,unsigned);void*(*_TF)(struct _fat_ptr,struct _fat_ptr,unsigned);struct _fat_ptr _T10;struct _fat_ptr _T11;struct Cyc_AP_T*_T12;unsigned _T13;struct Cyc_AP_T*_T14;int _T15;struct Cyc_AP_T*_T16;int _T17;struct Cyc_AP_T*_T18;struct _fat_ptr _T19;unsigned char*_T1A;unsigned char*_T1B;unsigned char _T1C;int _T1D;struct Cyc_AP_T*_T1E;int _T1F;struct Cyc_AP_T*_T20;struct _fat_ptr _T21;unsigned char*_T22;unsigned char*_T23;unsigned char _T24;int _T25;int(*_T26)(struct _fat_ptr,struct _fat_ptr,unsigned);void*(*_T27)(struct _fat_ptr,struct _fat_ptr,unsigned);struct _fat_ptr _T28;struct _fat_ptr _T29;struct Cyc_AP_T*_T2A;int _T2B;struct Cyc_AP_T*_T2C;struct _fat_ptr _T2D;unsigned char*_T2E;unsigned char*_T2F;unsigned char _T30;int _T31;struct Cyc_AP_T*_T32;struct Cyc_AP_T*_T33;int _T34;struct Cyc_AP_T*_T35;struct _fat_ptr _T36;unsigned char*_T37;unsigned char*_T38;unsigned char _T39;int _T3A;struct Cyc_AP_T*_T3B;struct Cyc_AP_T*_T3C;int _T3D;struct Cyc_AP_T*_T3E;struct _fat_ptr _T3F;unsigned char*_T40;unsigned char*_T41;unsigned char _T42;int _T43;int _T44;struct Cyc_AP_T*_T45;struct _fat_ptr _T46;unsigned char*_T47;unsigned char*_T48;unsigned char _T49;int _T4A;int _T4B;struct Cyc_AP_T*_T4C;struct Cyc_AP_T*_T4D;struct Cyc_AP_T*_T4E;unsigned _T4F;struct Cyc_AP_T*_T50;int _T51;struct Cyc_AP_T*_T52;struct _fat_ptr _T53;unsigned char*_T54;unsigned char*_T55;unsigned char _T56;int _T57;struct Cyc_AP_T*_T58;struct _fat_ptr _T59;unsigned char*_T5A;unsigned char*_T5B;unsigned char _T5C;int _T5D;int _T5E;struct Cyc_AP_T*_T5F;struct Cyc_AP_T*_T60;struct Cyc_AP_T*_T61;struct Cyc_AP_T*_T62;int _T63;struct Cyc_AP_T*_T64;struct _fat_ptr _T65;unsigned char*_T66;unsigned char*_T67;unsigned char _T68;int _T69;struct Cyc_AP_T*_T6A;struct _fat_ptr _T6B;unsigned char*_T6C;unsigned char*_T6D;unsigned char _T6E;int _T6F;int _T70;struct Cyc_AP_T*_T71;struct Cyc_AP_T*_T72;struct Cyc_AP_T*_T73;
struct Cyc_AP_T*z;_T0= x;_T1= (unsigned)_T0;
if(!_T1)goto _TL60;goto _TL61;_TL60: _T3= Cyc___assert_fail;{int(*_T74)(struct _fat_ptr,struct _fat_ptr,unsigned)=(int(*)(struct _fat_ptr,struct _fat_ptr,unsigned))_T3;_T2= _T74;}_T4= _tag_fat("x",sizeof(char),2U);_T5= _tag_fat("cyclone/library/std/ap.cyc",sizeof(char),27U);_T2(_T4,_T5,179U);_TL61: _T6= y;_T7= (unsigned)_T6;
if(!_T7)goto _TL62;goto _TL63;_TL62: _T9= Cyc___assert_fail;{int(*_T74)(struct _fat_ptr,struct _fat_ptr,unsigned)=(int(*)(struct _fat_ptr,struct _fat_ptr,unsigned))_T9;_T8= _T74;}_TA= _tag_fat("y",sizeof(char),2U);_TB= _tag_fat("cyclone/library/std/ap.cyc",sizeof(char),27U);_T8(_TA,_TB,180U);_TL63: _TC= y;_TD= _TC->sign;
if(_TD!=1)goto _TL64;goto _TL65;_TL64: _TF= Cyc___assert_fail;{int(*_T74)(struct _fat_ptr,struct _fat_ptr,unsigned)=(int(*)(struct _fat_ptr,struct _fat_ptr,unsigned))_TF;_TE= _T74;}_T10= _tag_fat("y->sign == 1",sizeof(char),13U);_T11= _tag_fat("cyclone/library/std/ap.cyc",sizeof(char),27U);_TE(_T10,_T11,181U);_TL65: _T12= p;_T13= (unsigned)_T12;
if(_T13)goto _TL69;else{goto _TL68;}_TL69: _T14= p;_T15= _T14->sign;if(_T15==1)goto _TL6B;else{goto _TL66;}_TL6B: _T16= p;_T17= _T16->ndigits;if(_T17==1)goto _TL6C;else{goto _TL6A;}_TL6C: _T18= p;_T19= _T18->digits;_T1A= _check_fat_subscript(_T19,sizeof(unsigned char),0);_T1B= (unsigned char*)_T1A;_T1C= *_T1B;_T1D= (int)_T1C;if(_T1D==0)goto _TL66;else{goto _TL6A;}_TL6A: _T1E= p;_T1F= _T1E->ndigits;if(_T1F==1)goto _TL6D;else{goto _TL68;}_TL6D: _T20= p;_T21= _T20->digits;_T22= _T21.curr;_T23= (unsigned char*)_T22;_T24= _T23[0];_T25= (int)_T24;if(_T25==1)goto _TL66;else{goto _TL68;}_TL68: goto _TL67;_TL66: _T27= Cyc___assert_fail;{int(*_T74)(struct _fat_ptr,struct _fat_ptr,unsigned)=(int(*)(struct _fat_ptr,struct _fat_ptr,unsigned))_T27;_T26= _T74;}_T28= _tag_fat("!p || p->sign == 1 && !((p)->ndigits == 1 && (p)->digits[0] == 0) && !((p)->ndigits == 1 && (p)->digits[0] == 1)",sizeof(char),113U);_T29= _tag_fat("cyclone/library/std/ap.cyc",sizeof(char),27U);_T26(_T28,_T29,182U);_TL67: _T2A= x;_T2B= _T2A->ndigits;
...
if(!_T1)goto _TL82;goto _TL83;_TL82: _T3= Cyc___assert_fail;{int(*_T17)(struct _fat_ptr,struct _fat_ptr,unsigned)=(int(*)(struct _fat_ptr,struct _fat_ptr,unsigned))_T3;_T2= _T17;}_T4= _tag_fat("x",sizeof(char),2U);_T5= _tag_fat("cyclone/library/std/ap.cyc",sizeof(char),27U);_T2(_T4,_T5,211U);_TL83: _T6= y;_T7= (unsigned)_T6;
if(!_T7)goto _TL84;goto _TL85;_TL84: _T9= Cyc___assert_fail;{int(*_T17)(struct _fat_ptr,struct _fat_ptr,unsigned)=(int(*)(struct _fat_ptr,struct _fat_ptr,unsigned))_T9;_T8= _T17;}_TA= _tag_fat("y",sizeof(char),2U);_TB= _tag_fat("cyclone/library/std/ap.cyc",sizeof(char),27U);_T8(_TA,_TB,212U);_TL85: _TC= x;_TD= _TC->sign;_TE= y;_TF= _TE->sign;_T10= _TD ^ _TF;
...
struct Cyc_AP_T*z;_T0= x;_T1= (unsigned)_T0;
if(!_T1)goto _TL8B;goto _TL8C;_TL8B: _T3= Cyc___assert_fail;{int(*_T20)(struct _fat_ptr,struct _fat_ptr,unsigned)=(int(*)(struct _fat_ptr,struct _fat_ptr,unsigned))_T3;_T2= _T20;}_T4= _tag_fat("x",sizeof(char),2U);_T5= _tag_fat("cyclone/library/std/ap.cyc",sizeof(char),27U);_T2(_T4,_T5,250U);_TL8C:
 if(s < 0)goto _TL8D;goto _TL8E;_TL8D: _T7= Cyc___assert_fail;{int(*_T20)(struct _fat_ptr,struct _fat_ptr,unsigned)=(int(*)(struct _fat_ptr,struct _fat_ptr,unsigned))_T7;_T6= _T20;}_T8= _tag_fat("s >= 0",sizeof(char),7U);_T9= _tag_fat("cyclone/library/std/ap.cyc",sizeof(char),27U);_T6(_T8,_T9,251U);_TL8E: _TA= x;_TB= _TA->ndigits;_TC= s + 7;_TD= ~ 7;_TE= _TC & _TD;_TF= _TE / 8;_T10= _TB + _TF;
...
Cyc_normalize(_T1C,_T1E);return _T1F;}
# 257
struct Cyc_AP_T*Cyc_AP_rshift(struct Cyc_AP_T*x,int s){struct Cyc_AP_T*_T0;unsigned _T1;int(*_T2)(struct _fat_ptr,struct _fat_ptr,unsigned);void*(*_T3)(struct _fat_ptr,struct _fat_ptr,unsigned);struct _fat_ptr _T4;struct _fat_ptr _T5;int(*_T6)(struct _fat_ptr,struct _fat_ptr,unsigned);void*(*_T7)(struct _fat_ptr,struct _fat_ptr,unsigned);struct _fat_ptr _T8;struct _fat_ptr _T9;int _TA;struct Cyc_AP_T*_TB;int _TC;int _TD;struct Cyc_AP_T*_TE;struct Cyc_AP_T*_TF;int _T10;int _T11;int _T12;struct Cyc_AP_T*_T13;int _T14;struct Cyc_AP_T*_T15;struct _fat_ptr _T16;struct Cyc_AP_T*_T17;int _T18;struct Cyc_AP_T*_T19;struct _fat_ptr _T1A;int _T1B;struct Cyc_AP_T*_T1C;struct Cyc_AP_T*_T1D;int _T1E;struct Cyc_AP_T*_T1F;int _T20;struct Cyc_AP_T*_T21;int _T22;struct Cyc_AP_T*_T23;struct _fat_ptr _T24;unsigned char*_T25;unsigned char*_T26;unsigned char _T27;int _T28;struct Cyc_AP_T*_T29;struct Cyc_AP_T*_T2A;_T0= x;_T1= (unsigned)_T0;
if(!_T1)goto _TL8F;goto _TL90;_TL8F: _T3= Cyc___assert_fail;{int(*_T2B)(struct _fat_ptr,struct _fat_ptr,unsigned)=(int(*)(struct _fat_ptr,struct _fat_ptr,unsigned))_T3;_T2= _T2B;}_T4= _tag_fat("x",sizeof(char),2U);_T5= _tag_fat("cyclone/library/std/ap.cyc",sizeof(char),27U);_T2(_T4,_T5,258U);_TL90:
 if(s < 0)goto _TL91;goto _TL92;_TL91: _T7= Cyc___assert_fail;{int(*_T2B)(struct _fat_ptr,struct _fat_ptr,unsigned)=(int(*)(struct _fat_ptr,struct _fat_ptr,unsigned))_T7;_T6= _T2B;}_T8= _tag_fat("s >= 0",sizeof(char),7U);_T9= _tag_fat("cyclone/library/std/ap.cyc",sizeof(char),27U);_T6(_T8,_T9,259U);_TL92: _TA= s;_TB= x;_TC= _TB->ndigits;_TD= 8 * _TC;
...
if(!_T1)goto _TLA5;goto _TLA6;_TLA5: _T3= Cyc___assert_fail;{int(*_T16)(struct _fat_ptr,struct _fat_ptr,unsigned)=(int(*)(struct _fat_ptr,struct _fat_ptr,unsigned))_T3;_T2= _T16;}_T4= _tag_fat("x",sizeof(char),2U);_T5= _tag_fat("cyclone/library/std/ap.cyc",sizeof(char),27U);_T2(_T4,_T5,311U);_TLA6: _T6= x;_T7= _T6->ndigits;_T8= x;_T9= _T8->digits;_TA= 
...
# 318
struct Cyc_AP_T*Cyc_AP_fromstr(const char*str,int base){struct _fat_ptr _T0;void*_T1;void*_T2;unsigned _T3;struct _fat_ptr _T4;unsigned char*_T5;unsigned _T6;int(*_T7)(struct _fat_ptr,struct _fat_ptr,unsigned);void*(*_T8)(struct _fat_ptr,struct _fat_ptr,unsigned);struct _fat_ptr _T9;struct _fat_ptr _TA;int(*_TB)(struct _fat_ptr,struct _fat_ptr,unsigned);void*(*_TC)(struct _fat_ptr,struct _fat_ptr,unsigned);struct _fat_ptr _TD;struct _fat_ptr _TE;struct _fat_ptr _TF;unsigned char*_T10;const char*_T11;char _T12;int _T13;struct _fat_ptr _T14;unsigned char*_T15;const char*_T16;char _T17;int _T18;int _T19;struct _fat_ptr*_T1A;struct _fat_ptr _T1B;unsigned char*_T1C;const char*_T1D;char _T1E;int _T1F;struct _fat_ptr _T20;unsigned char*_T21;const char*_T22;char _T23;int _T24;struct _fat_ptr*_T25;struct _fat_ptr _T26;unsigned char*_T27;const char*_T28;struct _fat_ptr _T29;unsigned char*_T2A;const char*_T2B;char _T2C;int _T2D;struct _fat_ptr _T2E;unsigned char*_T2F;const char*_T30;char _T31;int _T32;struct _fat_ptr*_T33;struct _fat_ptr _T34;unsigned char*_T35;struct _fat_ptr _T36;unsigned char*_T37;const char*_T38;char _T39;int _T3A;struct _fat_ptr _T3B;unsigned char*_T3C;const char*_T3D;char _T3E;int _T3F;struct _fat_ptr _T40;unsigned char*_T41;const char*_T42;char _T43;int _T44;int _T45;struct _fat_ptr _T46;unsigned char*_T47;const char*_T48;char _T49;int _T4A;struct _fat_ptr _T4B;unsigned char*_T4C;const char*_T4D;char _T4E;int _T4F;struct _fat_ptr _T50;unsigned char*_T51;const char*_T52;char _T53;int _T54;int _T55;int _T56;struct _fat_ptr _T57;unsigned char*_T58;const char*_T59;char _T5A;int _T5B;struct _fat_ptr _T5C;unsigned char*_T5D;const char*_T5E;char _T5F;int _T60;struct _fat_ptr _T61;unsigned char*_T62;const char*_T63;char _T64;int _T65;int _T66;int _T67;struct _fat_ptr*_T68;unsigned _T69;int _T6A;unsigned _T6B;int _T6C;int _T6D;int _T6E;int _T6F;int _T70;struct _fat_ptr _T71;void*_T72;void*_T73;unsigned _T74;struct Cyc_AP_T*_T75;int _T76;struct Cyc_AP_T*_T77;struct _fat_ptr _T78;struct _fat_ptr _T79;unsigned char*_T7A;const char*_T7B;int _T7C;int(*_T7D)(struct _fat_ptr,struct _fat_ptr,unsigned);void*(*_T7E)(struct _fat_ptr,struct _fat_ptr,unsigned);struct _fat_ptr _T7F;struct _fat_ptr _T80;struct Cyc_AP_T*_T81;struct Cyc_AP_T*_T82;int _T83;struct Cyc_AP_T*_T84;int _T85;struct Cyc_AP_T*_T86;int _T87;struct Cyc_AP_T*_T88;struct _fat_ptr _T89;unsigned char*_T8A;unsigned char*_T8B;unsigned char _T8C;int _T8D;char _T8E;int _T8F;struct Cyc_AP_T*_T90;
struct Cyc_AP_T*z;{const char*_T91=str;_T1= (void*)_T91;_T2= (void*)_T91;_T3= _get_zero_arr_size_char(_T2,1U);_T0= _tag_fat(_T1,sizeof(char),_T3);}{
struct _fat_ptr p=_T0;
char sign='\000';
int carry;_T4= p;_T5= _T4.curr;_T6= (unsigned)_T5;
if(!_T6)goto _TLA9;goto _TLAA;_TLA9: _T8= Cyc___assert_fail;{int(*_T91)(struct _fat_ptr,struct _fat_ptr,unsigned)=(int(*)(struct _fat_ptr,struct _fat_ptr,unsigned))_T8;_T7= _T91;}_T9= _tag_fat("p",sizeof(char),2U);_TA= _tag_fat("cyclone/library/std/ap.cyc",sizeof(char),27U);_T7(_T9,_TA,323U);_TLAA:
 if(base < 2)goto _TLAB;if(base > 36)goto _TLAB;goto _TLAC;_TLAB: _TC= Cyc___assert_fail;{int(*_T91)(struct _fat_ptr,struct _fat_ptr,unsigned)=(int(*)(struct _fat_ptr,struct _fat_ptr,unsigned))_TC;_TB= _T91;}_TD= _tag_fat("base >= 2 && base <= 36",sizeof(char),24U);_TE= _tag_fat("cyclone/library/std/ap.cyc",sizeof(char),27U);_TB(_TD,_TE,324U);_TLAC:
...
# 340
 k= 1;_TLC9: _T69= 1U << k;_T6A= base;_T6B= (unsigned)_T6A;if(_T69 < _T6B)goto _TLC7;else{goto _TLC8;}
_TLC7:
# 340
 k= k + 1;goto _TLC9;_TLC8: _T6C= k * n;_T6D= _T6C + 7;_T6E= ~ 7;_T6F= _T6D & _T6E;_T70= _T6F / 8;
# 342
z= Cyc_mk(_T70);{const char*_T91=start;_T72= (void*)_T91;_T73= (void*)_T91;_T74= _get_zero_arr_size_char(_T73,1U);_T71= _tag_fat(_T72,sizeof(char),_T74);}
p= _T71;}_T75= z;_T76= _T75->size;_T77= z;_T78= _T77->digits;_T79= p;_T7A= _untag_fat_ptr(_T79,sizeof(char),1U);_T7B= (const char*)_T7A;_T7C= base;
# 345
carry= Cyc_XP_fromstr(_T76,_T78,_T7B,_T7C);
if(carry!=0)goto _TLCA;goto _TLCB;_TLCA: _T7E= Cyc___assert_fail;{int(*_T91)(struct _fat_ptr,struct _fat_ptr,unsigned)=(int(*)(struct _fat_ptr,struct _fat_ptr,unsigned))_T7E;_T7D= _T91;}_T7F= _tag_fat("carry == 0",sizeof(char),11U);_T80= _tag_fat("cyclone/library/std/ap.cyc",sizeof(char),27U);_T7D(_T7F,_T80,346U);_TLCB: _T81= z;_T82= z;_T83= _T82->size;
Cyc_normalize(_T81,_T83);_T84= z;_T86= z;_T87= _T86->ndigits;
if(_T87==1)goto _TLD0;else{goto _TLCF;}_TLD0: _T88= z;_T89= _T88->digits;_T8A= _check_fat_subscript(_T89,sizeof(unsigned char),0);_T8B= (unsigned char*)_T8A;_T8C= *_T8B;_T8D= (int)_T8C;if(_T8D==0)goto _TLCE;else{goto _TLCF;}_TLCF: _T8E= sign;_T8F= (int)_T8E;if(_T8F!=45)goto _TLCE;else{goto _TLCC;}_TLCE: _T85= 1;goto _TLCD;_TLCC: _T85= - 1;_TLCD: _T84->sign= _T85;_T90= z;
return _T90;}}
# 351
char*Cyc_AP_tostr(struct Cyc_AP_T*x,int base){struct Cyc_AP_T*_T0;unsigned _T1;int(*_T2)(struct _fat_ptr,struct _fat_ptr,unsigned);void*(*_T3)(struct _fat_ptr,struct _fat_ptr,unsigned);struct _fat_ptr _T4;struct _fat_ptr _T5;int(*_T6)(struct _fat_ptr,struct _fat_ptr,unsigned);void*(*_T7)(struct _fat_ptr,struct _fat_ptr,unsigned);struct _fat_ptr _T8;struct _fat_ptr _T9;unsigned _TA;int _TB;unsigned _TC;struct Cyc_AP_T*_TD;int _TE;int _TF;int _T10;int _T11;int _T12;struct Cyc_AP_T*_T13;int _T14;int _T15;struct _fat_ptr _T16;void*_T17;struct _fat_ptr _T18;struct Cyc_AP_T*_T19;int _T1A;unsigned _T1B;void*_T1C;struct _fat_ptr _T1D;struct Cyc_AP_T*_T1E;struct _fat_ptr _T1F;struct Cyc_AP_T*_T20;int _T21;unsigned _T22;unsigned _T23;unsigned _T24;int _T25;struct Cyc_AP_T*_T26;int _T27;unsigned _T28;unsigned _T29;unsigned _T2A;unsigned _T2B;unsigned _T2C;unsigned _T2D;struct Cyc_AP_T*_T2E;int _T2F;int _T30;struct _fat_ptr _T31;unsigned char*_T32;char*_T33;unsigned _T34;unsigned char*_T35;char*_T36;struct _fat_ptr _T37;struct _fat_ptr _T38;int _T39;int _T3A;struct Cyc_AP_T*_T3B;int _T3C;struct _fat_ptr _T3D;struct _fat_ptr _T3E;int _T3F;int _T40;struct Cyc_AP_T*_T41;int _T42;struct _fat_ptr _T43;struct _fat_ptr _T44;unsigned char*_T45;char*_T46;
struct _fat_ptr q;
struct _fat_ptr str;
int size;int k;_T0= x;_T1= (unsigned)_T0;
if(!_T1)goto _TLD1;goto _TLD2;_TLD1: _T3= Cyc___assert_fail;{int(*_T47)(struct _fat_ptr,struct _fat_ptr,unsigned)=(int(*)(struct _fat_ptr,struct _fat_ptr,unsigned))_T3;_T2= _T47;}_T4= _tag_fat("x",sizeof(char),2U);_T5= _tag_fat("cyclone/library/std/ap.cyc",sizeof(char),27U);_T2(_T4,_T5,355U);_TLD2:
 if(base < 2)goto _TLD3;if(base > 36)goto _TLD3;goto _TLD4;_TLD3: _T7= Cyc___assert_fail;{int(*_T47)(struct _fat_ptr,struct _fat_ptr,unsigned)=(int(*)(struct _fat_ptr,struct _fat_ptr,unsigned))_T7;_T6= _T47;}_T8= _tag_fat("base >= 2 && base <= 36",sizeof(char),24U);_T9= _tag_fat("cyclone/library/std/ap.cyc",sizeof(char),27U);_T6(_T8,_T9,356U);_TLD4:
 k= 5;_TLD8: _TA= 1U << k;_TB= base;_TC= (unsigned)_TB;if(_TA > _TC)goto _TLD6;else{goto _TLD7;}
_TLD6:
# 357
 k= k + -1;goto _TLD8;_TLD7: _TD= x;_TE= _TD->ndigits;_TF= 8 * _TE;_T10= k;_T11= _TF / _T10;_T12= _T11 + 1;
# 359
size= _T12 + 1;_T13= x;_T14= _T13->sign;_T15= - 1;
if(_T14!=_T15)goto _TLD9;
size= size + 1;goto _TLDA;_TLD9: _TLDA:{unsigned _T47=size;_T17= _cyccalloc_atomic(sizeof(char),_T47);_T16= _tag_fat(_T17,sizeof(char),_T47);}
str= _T16;_T19= x;_T1A= _T19->ndigits;_T1B= (unsigned)_T1A;{unsigned _T47=_T1B * sizeof(unsigned char);_T1C= _cycalloc_atomic(_T47);_T18= _tag_fat(_T1C,1U,_T47);}
q= _T18;_T1D= q;_T1E= x;_T1F= _T1E->digits;_T20= x;_T21= _T20->ndigits;_T22= (unsigned)_T21;_T23= sizeof(*((unsigned char*)x->digits.curr));_T24= _T22 / _T23;_T26= x;_T27= _T26->ndigits;_T28= (unsigned)_T27;_T29= sizeof(*((unsigned char*)x->digits.curr));_T2A= _T28 % _T29;
if(_T2A!=0U)goto _TLDB;_T25= 0;goto _TLDC;_TLDB: _T25= 1;_TLDC: _T2B= (unsigned)_T25;_T2C= _T24 + _T2B;_T2D= sizeof(*((unsigned char*)x->digits.curr));Cyc__memcpy(_T1D,_T1F,_T2C,_T2D);_T2E= x;_T2F= _T2E->sign;_T30= - 1;
if(_T2F!=_T30)goto _TLDD;_T31= str;{struct _fat_ptr _T47=_fat_ptr_plus(_T31,sizeof(char),0);_T32= _check_fat_subscript(_T47,sizeof(char),0U);_T33= (char*)_T32;{char _T48=*_T33;char _T49='-';_T34= _get_fat_size(_T47,sizeof(char));if(_T34!=1U)goto _TLDF;if(_T48!=0)goto _TLDF;if(_T49==0)goto _TLDF;_throw_arraybounds();goto _TLE0;_TLDF: _TLE0: _T35= _T47.curr;_T36= (char*)_T35;*_T36= _T49;}}_T37= str;_T38= 
# 367
_fat_ptr_plus(_T37,sizeof(char),1);_T39= size - 1;_T3A= base;_T3B= x;_T3C= _T3B->ndigits;_T3D= q;Cyc_XP_tostr(_T38,_T39,_T3A,_T3C,_T3D);goto _TLDE;
# 369
_TLDD: _T3E= str;_T3F= size;_T40= base;_T41= x;_T42= _T41->ndigits;_T43= q;Cyc_XP_tostr(_T3E,_T3F,_T40,_T42,_T43);_TLDE: _T44= str;_T45= _untag_fat_ptr_check_bound(_T44,sizeof(char),1U);_T46= (char*)_T45;
return _T46;}
# 372
struct Cyc_AP_T*Cyc_AP_gcd(struct Cyc_AP_T*x,struct Cyc_AP_T*y){struct Cyc_AP_T*_T0;unsigned _T1;int(*_T2)(struct _fat_ptr,struct _fat_ptr,unsigned);void*(*_T3)(struct _fat_ptr,struct _fat_ptr,unsigned);struct _fat_ptr _T4;struct _fat_ptr _T5;struct Cyc_AP_T*_T6;unsigned _T7;int(*_T8)(struct _fat_ptr,struct _fat_ptr,unsigned);void*(*_T9)(struct _fat_ptr,struct _fat_ptr,unsigned);struct _fat_ptr _TA;struct _fat_ptr _TB;struct Cyc_AP_T*_TC;int _TD;struct Cyc_AP_T*_TE;struct _fat_ptr _TF;unsigned char*_T10;unsigned char*_T11;unsigned char _T12;int _T13;struct Cyc_AP_T*_T14;int _T15;struct Cyc_AP_T*_T16;struct _fat_ptr _T17;struct Cyc_AP_T*_T18;struct _fat_ptr _T19;struct Cyc_AP_T*_T1A;int _T1B;unsigned _T1C;unsigned _T1D;unsigned _T1E;int _T1F;struct Cyc_AP_T*_T20;int _T21;unsigned _T22;unsigned _T23;unsigned _T24;unsigned _T25;unsigned _T26;unsigned _T27;struct Cyc_AP_T*_T28;struct Cyc_AP_T*_T29;struct Cyc_AP_T*_T2A;struct Cyc_AP_T*_T2B;struct Cyc_AP_T*_T2C;
struct Cyc_AP_T*z;struct Cyc_AP_T*tmp;_T0= x;_T1= (unsigned)_T0;
if(!_T1)goto _TLE1;goto _TLE2;_TLE1: _T3= Cyc___assert_fail;{int(*_T2D)(struct _fat_ptr,struct _fat_ptr,unsigned)=(int(*)(struct _fat_ptr,struct _fat_ptr,unsigned))_T3;_T2= _T2D;}_T4= _tag_fat("x",sizeof(char),2U);_T5= _tag_fat("cyclone/library/std/ap.cyc",sizeof(char),27U);_T2(_T4,_T5,374U);_TLE2: _T6= y;_T7= (unsigned)_T6;
if(!_T7)goto _TLE3;goto _TLE4;_TLE3: _T9= Cyc___assert_fail;{int(*_T2D)(struct _fat_ptr,struct _fat_ptr,unsigned)=(int(*)(struct _fat_ptr,struct _fat_ptr,unsigned))_T9;_T8= _T2D;}_TA= _tag_fat("y",sizeof(char),2U);_TB= _tag_fat("cyclone/library/std/ap.cyc",sizeof(char),27U);_T8(_TA,_TB,375U);_TLE4:
...
return _T2C;}
# 387
struct Cyc_AP_T*Cyc_AP_lcm(struct Cyc_AP_T*x,struct Cyc_AP_T*y){struct Cyc_AP_T*_T0;struct Cyc_AP_T*_T1;struct Cyc_AP_T*_T2;struct Cyc_AP_T*_T3;struct Cyc_AP_T*_T4;_T0= x;_T1= y;_T2= Cyc_AP_gcd(x,y);_T3= Cyc_AP_div(_T1,_T2);_T4= Cyc_AP_mul(_T0,_T3);return _T4;}
