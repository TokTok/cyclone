...
# 52 "cyclone/library/std/cycboot.h"
...
# 126 "cyclone/library/std/scanf.cyc"
...
# 146
({__typeof__(_tag_fat("scan expects short pointer",sizeof(char),27U))_TD=_tag_fat("scan expects short pointer",sizeof(char),27U);_TC->f1= _TD;});_T8= (struct Cyc_Core_Invalid_argument_exn_struct*)_TC;}_T9= (void*)_T8;_throw(_T9);};}
# 150
...
return _T7;}default:{struct Cyc_Core_Invalid_argument_exn_struct*_TC=_cycalloc(sizeof(struct Cyc_Core_Invalid_argument_exn_struct));_TC->tag= Cyc_Core_Invalid_argument;
# 157
({__typeof__(_tag_fat("scan expects int pointer",sizeof(char),25U))_TD=_tag_fat("scan expects int pointer",sizeof(char),25U);_TC->f1= _TD;});_T8= (struct Cyc_Core_Invalid_argument_exn_struct*)_TC;}_T9= (void*)_T8;_throw(_T9);};}
# 161
...
# 167
({__typeof__(_tag_fat("scan expects char pointer",sizeof(char),26U))_TC=_tag_fat("scan expects char pointer",sizeof(char),26U);_TB->f1= _TC;});_T8= (struct Cyc_Core_Invalid_argument_exn_struct*)_TB;}_T9= (void*)_T8;_throw(_T9);};}
# 171
...
# 176
({__typeof__(_tag_fat("scan expects double pointer",sizeof(char),28U))_T9=_tag_fat("scan expects double pointer",sizeof(char),28U);_T8->f1= _T9;});_T5= (struct Cyc_Core_Invalid_argument_exn_struct*)_T8;}_T6= (void*)_T5;_throw(_T6);;}
# 180
...
# 185
({__typeof__(_tag_fat("scan expects float pointer",sizeof(char),27U))_T9=_tag_fat("scan expects float pointer",sizeof(char),27U);_T8->f1= _T9;});_T5= (struct Cyc_Core_Invalid_argument_exn_struct*)_T8;}_T6= (void*)_T5;_throw(_T6);;}
# 189
...
# 263
again: _TC= & fmt;_TD= 
_fat_ptr_inplace_plus_post(_TC,sizeof(char),1);_TE= _check_fat_subscript(_TD,sizeof(char),0U);_TF= (const char*)_TE;_T10= *_TF;c= (int)_T10;_T11= c;_T12= (int)_T11;switch(_T12){case 37:
# 267
 literal:
...
struct _fat_ptr z=Cyc_va_arg_char_ptr(_T49);_T4A= & ap;
...
# 512
_TL56: _T60= ap;_T61= _check_fat_subscript(_T60,sizeof(void*),0U);_T62= (void**)_T61;_T63= *_T62;_T64= Cyc_va_arg_string_ptr(_T63);{struct _fat_ptr p4=_T64;_T65= & ap;
_fat_ptr_inplace_plus(_T65,sizeof(void*),1);{
...
# 561
_TL74: _T93= ap;_T94= _check_fat_subscript(_T93,sizeof(void*),0U);_T95= (void**)_T94;_T96= *_T95;{struct _fat_ptr p2=Cyc_va_arg_string_ptr(_T96);_T97= & ap;
_fat_ptr_inplace_plus(_T97,sizeof(void*),1);{
...
# 836
({__typeof__(_tag_fat("scanf3",sizeof(char),7U))_T180=_tag_fat("scanf3",sizeof(char),7U);_T17F->f1= _T180;});_T175= (struct Cyc_Core_Impossible_exn_struct*)_T17F;}_T176= (void*)_T175;_throw(_T176);}_LL47: _TLC: goto _TLF;_TLE:
# 840
 eof_failure:
 seen_eof= seen_eof + 1;
# 843
...
if(_T3==0)goto _TLF2;else{goto _TLF4;}_TLF4: _T4= s;_T5= _get_fat_size(_T4,sizeof(char));if(_T5==0U)goto _TLF2;else{goto _TLF3;}_TLF3: _T6= s;_T7= _T6.curr;_T8= (const char*)_T7;c= _T8[0];_T9= c;_TA= (int)_T9;if(_TA==0)goto _TLF2;else{goto _TLF0;}
_TLF2: _TB= - 1;return _TB;_TLF0: _TC= sptr;_TD= s;
({__typeof__(_fat_ptr_plus(_TD,sizeof(char),1))_T10=_fat_ptr_plus(_TD,sizeof(char),1);*_TC= _T10;});_TE= c;_TF= (int)_TE;
return _TF;}}
# 961
...
({__typeof__(_fat_ptr_plus(_T2,sizeof(char),_T3))_T4=_fat_ptr_plus(_T2,sizeof(char),_T3);*_T0= _T4;});
# 964
return 0;}
# 967
...
char c;_T0= sptr;{
struct _fat_ptr s=*_T0;_T1= s;_T2= _T1.curr;_T3= (char*)_T2;
if(_T3==0)goto _TLF7;else{goto _TLF9;}_TLF9: _T4= s;_T5= _get_fat_size(_T4,sizeof(char));if(_T5==0U)goto _TLF7;else{goto _TLF8;}_TLF8: _T6= s;_T7= _T6.curr;_T8= (const char*)_T7;c= _T8[0];_T9= c;_TA= (int)_T9;if(_TA==0)goto _TLF7;else{goto _TLF5;}
_TLF7: _TB= - 1;return _TB;_TLF5: _TC= c;_TD= (int)_TC;
return _TD;}}
# 975
