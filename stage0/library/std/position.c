...
struct _fat_ptr Cyc_Core_new_string(unsigned);struct Cyc_List_List{void*hd;struct Cyc_List_List*tl;};struct Cyc_Lineno_Pos{struct _fat_ptr logical_file;struct _fat_ptr line;int line_no;int col;};
# 31 "cyclone/library/std/lineno.h"
...
extern long Cyc_Position_use_gcc_style_location;struct _tuple0{struct _fat_ptr f0;unsigned f1;};
# 26 "cyclone/library/std/position.cyc"
static struct _tuple0 Cyc_Position_seg_to_loc(unsigned);
# 31
long Cyc_Position_use_gcc_style_location=0;static char _TmpG0[1U]="";
# 34
...
if(s1!=0U)goto _TL0;_T0= s2;
return _T0;_TL0:
 if(s2!=0U)goto _TL2;_T1= s1;
return _T1;_TL2: _T2= s1;
return _T2;}
# 43
long Cyc_Position_segment_equals(unsigned s1,unsigned s2){int _T0;_T0= s1==s2;return _T0;}
# 45
struct _fat_ptr Cyc_Position_string_of_loc(unsigned seg){struct _fat_ptr _T0;unsigned _T1;int _T2;long _T3;struct _fat_ptr _T4;struct Cyc_String_pa_PrintArg_struct _T5;struct Cyc_Lineno_Pos*_T6;struct Cyc_Int_pa_PrintArg_struct _T7;struct Cyc_Lineno_Pos*_T8;int _T9;struct _fat_ptr _TA;struct _fat_ptr _TB;struct _fat_ptr _TC;struct Cyc_String_pa_PrintArg_struct _TD;struct Cyc_Lineno_Pos*_TE;struct Cyc_Int_pa_PrintArg_struct _TF;struct Cyc_Lineno_Pos*_T10;int _T11;struct Cyc_Int_pa_PrintArg_struct _T12;struct Cyc_Lineno_Pos*_T13;int _T14;struct _fat_ptr _T15;struct _fat_ptr _T16;
...
_T14.f1= _TB->logical_file;_TA= _T14;}{struct Cyc_String_pa_PrintArg_struct _T14=_TA;{struct Cyc_Int_pa_PrintArg_struct _T15;_T15.tag= 1;_TD= pos;_TE= _TD->line_no;_T15.f1= (unsigned long)_TE;_TC= _T15;}{struct Cyc_Int_pa_PrintArg_struct _T15=_TC;{struct Cyc_Int_pa_PrintArg_struct _T16;_T16.tag= 1;_T10= pos;_T11= _T10->col;_T16.f1= (unsigned long)_T11;_TF= _T16;}{struct Cyc_Int_pa_PrintArg_struct _T16=_TF;void*_T17[3];_T17[0]= & _T14;_T17[1]= & _T15;_T17[2]= & _T16;_T12= _tag_fat("%s:%d:%d",sizeof(char),9U);_T13= _tag_fat(_T17,sizeof(void*),3);_T9= Cyc_aprintf(_T12,_T13);}}}return _T9;}
# 59
struct _fat_ptr Cyc_Position_string_of_segment(unsigned s){struct _fat_ptr _T0;_T0= Cyc_Position_string_of_loc(s);return _T0;}
# 61
static struct Cyc_Lineno_Pos*Cyc_Position_new_pos (void){struct Cyc_Lineno_Pos*_T0;{struct Cyc_Lineno_Pos*_T1=_cycalloc(sizeof(struct Cyc_Lineno_Pos));({__typeof__(_tag_fat("",sizeof(char),1U))_T2=_tag_fat("",sizeof(char),1U);_T1->logical_file= _T2;});({__typeof__(Cyc_Core_new_string(0U))_T2=Cyc_Core_new_string(0U);_T1->line= _T2;});_T1->line_no= 0;_T1->col= 0;_T0= (struct Cyc_Lineno_Pos*)_T1;}return _T0;}
# 63
...
_TL9:{struct Cyc_List_List*_T7=_cycalloc(sizeof(struct Cyc_List_List));{struct _fat_ptr*_T8=_cycalloc(sizeof(struct _fat_ptr));_T2= segs;_T3= _T2->hd;_T4= (unsigned)_T3;({__typeof__(Cyc_Position_string_of_segment(_T4))_T9=Cyc_Position_string_of_segment(_T4);*_T8= _T9;});_T1= (struct _fat_ptr*)_T8;}_T7->hd= _T1;_T7->tl= ans;_T0= (struct Cyc_List_List*)_T7;}ans= _T0;_T5= segs;
# 66
...
# 95
unsigned Cyc_Position_get_seg(struct Cyc_Position_Error*e){struct Cyc_Position_Error*_T0;unsigned _T1;_T0= e;_T1= _T0->seg;return _T1;}
struct _fat_ptr Cyc_Position_get_desc(struct Cyc_Position_Error*e){struct Cyc_Position_Error*_T0;struct _fat_ptr _T1;_T0= e;_T1= _T0->desc;return _T1;}
# 99
...
# 113
unsigned Cyc_Position_loc_to_seg(unsigned loc){unsigned _T0;_T0= loc;return _T0;}
# 115
static struct _tuple0 Cyc_Position_seg_to_loc(unsigned seg){struct _tuple0 _T0;{struct _tuple0 _T1;_T1.f0= Cyc_Position_source;_T1.f1= seg;_T0= _T1;}return _T0;}
