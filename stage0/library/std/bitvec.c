...
extern int Cyc_printf(struct _fat_ptr,struct _fat_ptr);struct Cyc_List_List{void*hd;struct Cyc_List_List*tl;};struct Cyc_Dict_T;struct Cyc_Dict_Dict{int(*rel)(void*,void*);struct _RegionHandle*r;const struct Cyc_Dict_T*t;};
# 108 "cyclone/library/std/dict.h"
extern void*Cyc_Dict_lookup(struct Cyc_Dict_Dict,void*);
# 41 "cyclone/library/std/bitvec.cyc"
long Cyc_Bitvec_get(struct _fat_ptr bvec,int pos){struct _fat_ptr _T0;int _T1;unsigned char*_T2;int*_T3;int _T4;int _T5;int _T6;int _T7;int _T8;
int word=pos >> 5;
...
return _T8;}
# 47
void Cyc_Bitvec_set(struct _fat_ptr bvec,int pos){struct _fat_ptr _T0;unsigned char*_T1;int*_T2;int _T3;struct _fat_ptr _T4;int _T5;unsigned char*_T6;int*_T7;int _T8;unsigned _T9;unsigned _TA;unsigned _TB;
int word=pos >> 5;
int offset=pos & 31;_T0= bvec;_T1= _T0.curr;_T2= (int*)_T1;_T3= word;_T4= bvec;_T5= word;_T6= _check_fat_subscript(_T4,sizeof(int),_T5);_T7= (int*)_T6;_T8= *_T7;_T9= (unsigned)_T8;_TA= 1U << offset;_TB= _T9 | _TA;
_T2[_T3]= (int)_TB;}
# 53
void Cyc_Bitvec_clear(struct _fat_ptr bvec,int pos){struct _fat_ptr _T0;unsigned char*_T1;int*_T2;int _T3;struct _fat_ptr _T4;int _T5;unsigned char*_T6;int*_T7;int _T8;unsigned _T9;unsigned _TA;unsigned _TB;unsigned _TC;
int word=pos >> 5;
int offset=pos & 31;_T0= bvec;_T1= _T0.curr;_T2= (int*)_T1;_T3= word;_T4= bvec;_T5= word;_T6= _check_fat_subscript(_T4,sizeof(int),_T5);_T7= (int*)_T6;_T8= *_T7;_T9= (unsigned)_T8;_TA= 1U << offset;_TB= ~ _TA;_TC= _T9 & _TB;
_T2[_T3]= (int)_TC;}
# 59
long Cyc_Bitvec_get_and_set(struct _fat_ptr bvec,int pos){struct _fat_ptr _T0;int _T1;unsigned char*_T2;int*_T3;int _T4;int _T5;long _T6;struct _fat_ptr _T7;unsigned char*_T8;int*_T9;int _TA;int _TB;unsigned _TC;unsigned _TD;unsigned _TE;long _TF;
int word=pos >> 5;
...
long ans=_T5==1;_T6= ans;
if(_T6)goto _TL0;else{goto _TL2;}
_TL2: _T7= bvec;_T8= _T7.curr;_T9= (int*)_T8;_TA= word;_TB= slot;_TC= (unsigned)_TB;_TD= 1U << offset;_TE= _TC | _TD;_T9[_TA]= (int)_TE;goto _TL1;_TL0: _TL1: _TF= ans;
return _TF;}}}
# 69
...
_get_fat_size(_T2,sizeof(int));if(_T1 > _T3)goto _TL3;_T4= len;_T5= src2;_T6= _get_fat_size(_T5,sizeof(int));if(_T4 > _T6)goto _TL3;goto _TL4;_TL3: _T8= Cyc___assert_fail;{int(*_T1F)(struct _fat_ptr,struct _fat_ptr,unsigned)=(int(*)(struct _fat_ptr,struct _fat_ptr,unsigned))_T8;_T7= _T1F;}_T9= _tag_fat("len <= numelts(src1) && len <= numelts(src2)",sizeof(char),45U);_TA= _tag_fat("cyclone/library/std/bitvec.cyc",sizeof(char),31U);_T7(_T9,_TA,71U);_TL4: {
...
unsigned len=_get_fat_size(_T0,sizeof(int));_T1= len;_T2= src1;_T3= 
_get_fat_size(_T2,sizeof(int));if(_T1 > _T3)goto _TL9;_T4= len;_T5= src2;_T6= _get_fat_size(_T5,sizeof(int));if(_T4 > _T6)goto _TL9;goto _TLA;_TL9: _T8= Cyc___assert_fail;{int(*_T1F)(struct _fat_ptr,struct _fat_ptr,unsigned)=(int(*)(struct _fat_ptr,struct _fat_ptr,unsigned))_T8;_T7= _T1F;}_T9= _tag_fat("len <= numelts(src1) && len <= numelts(src2)",sizeof(char),45U);_TA= _tag_fat("cyclone/library/std/bitvec.cyc",sizeof(char),31U);_T7(_T9,_TA,78U);_TLA: {
...
unsigned len=_get_fat_size(_T0,sizeof(int));_T1= len;_T2= src1;_T3= 
_get_fat_size(_T2,sizeof(int));if(_T1 > _T3)goto _TLF;_T4= len;_T5= src2;_T6= _get_fat_size(_T5,sizeof(int));if(_T4 > _T6)goto _TLF;goto _TL10;_TLF: _T8= Cyc___assert_fail;{int(*_T20)(struct _fat_ptr,struct _fat_ptr,unsigned)=(int(*)(struct _fat_ptr,struct _fat_ptr,unsigned))_T8;_T7= _T20;}_T9= _tag_fat("len <= numelts(src1) && len <= numelts(src2)",sizeof(char),45U);_TA= _tag_fat("cyclone/library/std/bitvec.cyc",sizeof(char),31U);_T7(_T9,_TA,85U);_TL10: {
...
# 146
long Cyc_Bitvec_all_set(struct _fat_ptr bvec,int sz){int _T0;unsigned _T1;struct _fat_ptr _T2;unsigned _T3;int(*_T4)(struct _fat_ptr,struct _fat_ptr,unsigned);void*(*_T5)(struct _fat_ptr,struct _fat_ptr,unsigned);struct _fat_ptr _T6;struct _fat_ptr _T7;struct _fat_ptr _T8;unsigned char*_T9;int*_TA;int*_TB;int _TC;int _TD;long _TE;
int words=sz >> 5;_T0= words;_T1= (unsigned)_T0;_T2= bvec;_T3= 
_get_fat_size(_T2,sizeof(int));if(_T1 >= _T3)goto _TL3F;goto _TL40;_TL3F: _T5= Cyc___assert_fail;{int(*_TF)(struct _fat_ptr,struct _fat_ptr,unsigned)=(int(*)(struct _fat_ptr,struct _fat_ptr,unsigned))_T5;_T4= _TF;}_T6= _tag_fat("words < numelts(bvec)",sizeof(char),22U);_T7= _tag_fat("cyclone/library/std/bitvec.cyc",sizeof(char),31U);_T4(_T6,_T7,148U);_TL40:{
...
return 1;}
# 159
void Cyc_Bitvec_print_bvec(struct _fat_ptr bvec){int _T0;unsigned _T1;struct _fat_ptr _T2;unsigned _T3;unsigned _T4;struct Cyc_Int_pa_PrintArg_struct _T5;int _T6;long _T7;struct _fat_ptr _T8;struct _fat_ptr _T9;struct _fat_ptr _TA;struct _fat_ptr _TB;{
