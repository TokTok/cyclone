...
struct _fat_ptr Cyc_Core_mkfat(void*,unsigned,unsigned);
# 308 "cyclone/library/std/cycboot.h"
extern int toupper(int);struct Cyc_List_List{void*hd;struct Cyc_List_List*tl;};
# 64 "cyclone/library/std/list.h"
extern int Cyc_List_length(struct Cyc_List_List*);
# 74 "cyclone/library/std/string.h"
...
# 37 "cyclone/library/std/string.cyc"
...
# 48
if(i >= j)goto _TL7;_T0= i;
return _T0;
# 51
_TL7: _T1= j;return _T1;}
# 53
inline static unsigned Cyc_umax(unsigned i,unsigned j){unsigned _T0;unsigned _T1;
# 55
if(i <= j)goto _TL9;_T0= i;
return _T0;
# 58
_TL9: _T1= j;return _T1;}
# 64
...
if(_T1B!=0)goto _TL16;
return 1;_TL16: _T1C= c1;_T1D= (int)_T1C;_T1E= c2;_T1F= (int)_T1E;{
int diff=_T1D - _T1F;
if(diff==0)goto _TL18;_T20= diff;
return _T20;_TL18:;}}}
# 72
i= i + 1;goto _TL10;_TLF:
# 83
 if(sz1!=sz2)goto _TL1A;
return 0;_TL1A:
 if(sz1 >= sz2)goto _TL1C;_T22= s2;_T23= _T22.curr;_T24= (const char*)_T23;_T25= 
_check_null(_T24);_T26= i;_T27= _T25[_T26];_T28= (int)_T27;if(_T28!=0)goto _TL1E;_T21= 0;goto _TL1F;_TL1E: _T21= - 1;_TL1F: return _T21;_TL1C: _T2A= s1;_T2B= _T2A.curr;_T2C= (const char*)_T2B;_T2D= 
# 88
...
# 91
int Cyc_strptrcmp(struct _fat_ptr*s1,struct _fat_ptr*s2){struct _fat_ptr*_T0;struct _fat_ptr _T1;struct _fat_ptr*_T2;struct _fat_ptr _T3;int _T4;_T0= s1;_T1= *_T0;_T2= s2;_T3= *_T2;_T4= Cyc_strcmp(_T1,_T3);return _T4;}
# 93
...
return 0;_TL43: _T4= a;_T5= *_T4;_T6= b;_T7= *_T6;_T8= 
...
# 194
_TL45:{struct Cyc_Core_Invalid_argument_exn_struct*_T22=_cycalloc(sizeof(struct Cyc_Core_Invalid_argument_exn_struct));_T22->tag= Cyc_Core_Invalid_argument;({__typeof__(_tag_fat("strcat",sizeof(char),7U))_T23=_tag_fat("strcat",sizeof(char),7U);_T22->f1= _T23;});_T1F= (struct Cyc_Core_Invalid_argument_exn_struct*)_T22;}_T20= (void*)_T1F;_throw(_T20);_TL46: _T21= dest;
return _T21;}}
# 200
struct _fat_ptr Cyc_strcat(struct _fat_ptr dest,struct _fat_ptr src){struct _fat_ptr _T0;_T0= Cyc_int_strcato(dest,src);return _T0;}
# 203
...
_get_fat_size(_T7,sizeof(char));if(_T6 <= _T8)goto _TL51;{struct Cyc_Core_Impossible_exn_struct*_T2F=_cycalloc(sizeof(struct Cyc_Core_Impossible_exn_struct));_T2F->tag= Cyc_Core_Impossible;
({__typeof__(_tag_fat("rstrconcat 1",sizeof(char),13U))_T30=_tag_fat("rstrconcat 1",sizeof(char),13U);_T2F->f1= _T30;});_T9= (struct Cyc_Core_Impossible_exn_struct*)_T2F;}_TA= (void*)_T9;_throw(_TA);goto _TL52;_TL51: _TL52:
...
# 213
_get_fat_size(_T1B,sizeof(char));if(_T1A <= _T1C)goto _TL59;{struct Cyc_Core_Impossible_exn_struct*_T2F=_cycalloc(sizeof(struct Cyc_Core_Impossible_exn_struct));_T2F->tag= Cyc_Core_Impossible;
({__typeof__(_tag_fat("rstrconcat 1",sizeof(char),13U))_T30=_tag_fat("rstrconcat 1",sizeof(char),13U);_T2F->f1= _T30;});_T1D= (struct Cyc_Core_Impossible_exn_struct*)_T2F;}_T1E= (void*)_T1D;_throw(_T1E);goto _TL5A;_TL59: _TL5A:
...
return _T2E;}}}
# 220
struct _fat_ptr Cyc_strconcat(struct _fat_ptr a,struct _fat_ptr b){struct _fat_ptr _T0;_T0= Cyc_rstrconcat(Cyc_Core_heap_region,a,b);return _T0;}
# 223
...
# 229
struct Cyc_List_List*lens;_T0= temp;lens= _region_malloc(_T0,0U,sizeof(struct Cyc_List_List));_T1= lens;_T1->hd= (void*)0U;_T2= lens;
_T2->tl= 0;{
...
# 254
struct _fat_ptr Cyc_strconcat_l(struct Cyc_List_List*strs){struct _fat_ptr _T0;_T0= Cyc_rstrconcat_l(Cyc_Core_heap_region,strs);return _T0;}
# 258
...
if(strs!=0)goto _TL68;_T0= 
Cyc_Core_rnew_string(r,0U);return _T0;_TL68: _T1= strs;_T2= _T1->tl;
if(_T2!=0)goto _TL6A;_T3= r;_T4= strs;_T5= _T4->hd;_T6= (struct _fat_ptr*)_T5;_T7= *_T6;_T8= 
Cyc_rstrdup(_T3,_T7);return _T8;_TL6A: {
...
_TL75:{struct Cyc_Core_Invalid_argument_exn_struct*_T1D=_cycalloc(sizeof(struct Cyc_Core_Invalid_argument_exn_struct));_T1D->tag= Cyc_Core_Invalid_argument;({__typeof__(_tag_fat("strncpy",sizeof(char),8U))_T1E=_tag_fat("strncpy",sizeof(char),8U);_T1D->f1= _T1E;});_T6= (struct Cyc_Core_Invalid_argument_exn_struct*)_T1D;}_T7= (void*)_T6;_throw(_T7);goto _TL74;_TL73: _TL74:
...
_TL83:{struct Cyc_Core_Invalid_argument_exn_struct*_T15=_cycalloc(sizeof(struct Cyc_Core_Invalid_argument_exn_struct));_T15->tag= Cyc_Core_Invalid_argument;({__typeof__(_tag_fat("zstrncpy",sizeof(char),9U))_T16=_tag_fat("zstrncpy",sizeof(char),9U);_T15->f1= _T16;});_T6= (struct Cyc_Core_Invalid_argument_exn_struct*)_T15;}_T7= (void*)_T6;_throw(_T7);goto _TL82;_TL81: _TL82: {
unsigned i;
...
return _T4;}}
# 378
struct _fat_ptr Cyc_strdup(struct _fat_ptr src){struct _fat_ptr _T0;_T0= Cyc_rstrdup(Cyc_Core_heap_region,src);return _T0;}
# 380
...
return _T10;}
# 419
struct _fat_ptr Cyc_expand(struct _fat_ptr s,unsigned long sz){struct _fat_ptr _T0;_T0= Cyc_rexpand(Cyc_Core_heap_region,s,sz);return _T0;}
# 421
...
_TLAB:{struct Cyc_Core_Invalid_argument_exn_struct*_T25=_cycalloc(sizeof(struct Cyc_Core_Invalid_argument_exn_struct));_T25->tag= Cyc_Core_Invalid_argument;({__typeof__(_tag_fat("rsubstring",sizeof(char),11U))_T26=_tag_fat("rsubstring",sizeof(char),11U);_T25->f1= _T26;});_TA= (struct Cyc_Core_Invalid_argument_exn_struct*)_T25;}_TB= (void*)_TA;_throw(_TB);goto _TLAA;_TLA9: _TLAA:{
...
_TLD4: _TD= c2;_TE= (int)_TD;_TF= c;_T10= (int)_TF;if(_TE!=_T10)goto _TLD8;_T11= s;_T12= i;_T13= (int)_T12;_T14= 
_fat_ptr_plus(_T11,sizeof(char),_T13);return _T14;_TLD8:
# 527
...
_TLDB: _TD= c2;_TE= (int)_TD;_TF= c;_T10= (int)_TF;if(_TE!=_T10)goto _TLDF;_T11= s;_T12= i;_T13= (int)_T12;_T14= 
_fat_ptr_plus(_T11,sizeof(char),_T13);return _T14;_TLDF:
# 539
...
if(_T2)goto _TLF0;else{goto _TLEF;}_TLF0: _T3= needle;_T4= _T3.curr;_T5= (unsigned)_T4;if(_T5)goto _TLED;else{goto _TLEF;}
_TLEF:{struct Cyc_Core_Invalid_argument_exn_struct*_T24=_cycalloc(sizeof(struct Cyc_Core_Invalid_argument_exn_struct));_T24->tag= Cyc_Core_Invalid_argument;({__typeof__(_tag_fat("strstr",sizeof(char),7U))_T25=_tag_fat("strstr",sizeof(char),7U);_T24->f1= _T25;});_T6= (struct Cyc_Core_Invalid_argument_exn_struct*)_T24;}_T7= (void*)_T6;_throw(_T7);goto _TLEE;_TLED: _TLEE: _T8= needle;_T9= _check_fat_subscript(_T8,sizeof(char),0U);_TA= (const char*)_T9;_TB= *_TA;_TC= (int)_TB;
if(_TC!=0)goto _TLF1;_TD= haystack;
return _TD;_TLF1: _TE= 
# 582
Cyc_strlen(needle);{int len=(int)_TE;{
struct _fat_ptr start=haystack;_TLF6: _TF= start;_T10= needle;_T11= _T10.curr;_T12= (const char*)_T11;_T13= *_T12;start= Cyc_strchr(_TF,_T13);_T14= start;_T15= _T14.curr;_T16= (char*)_T15;if(_T16!=0)goto _TLF4;else{goto _TLF5;}
# 585
...
if(_T2)goto _TLFC;else{goto _TLFB;}_TLFC: _T3= needle;_T4= _T3.curr;_T5= (unsigned)_T4;if(_T5)goto _TLF9;else{goto _TLFB;}
_TLFB:{struct Cyc_Core_Invalid_argument_exn_struct*_T24=_cycalloc(sizeof(struct Cyc_Core_Invalid_argument_exn_struct));_T24->tag= Cyc_Core_Invalid_argument;({__typeof__(_tag_fat("mstrstr",sizeof(char),8U))_T25=_tag_fat("mstrstr",sizeof(char),8U);_T24->f1= _T25;});_T6= (struct Cyc_Core_Invalid_argument_exn_struct*)_T24;}_T7= (void*)_T6;_throw(_T7);goto _TLFA;_TLF9: _TLFA: _T8= needle;_T9= _check_fat_subscript(_T8,sizeof(char),0U);_TA= (const char*)_T9;_TB= *_TA;_TC= (int)_TB;
if(_TC!=0)goto _TLFD;_TD= haystack;
return _TD;_TLFD: _TE= 
# 597
Cyc_strlen(needle);{int len=(int)_TE;{
struct _fat_ptr start=haystack;_TL102: _TF= start;_T10= needle;_T11= _T10.curr;_T12= (const char*)_T11;_T13= *_T12;start= Cyc_mstrchr(_TF,_T13);_T14= start;_T15= _T14.curr;_T16= (char*)_T15;if(_T16!=0)goto _TL100;else{goto _TL101;}
# 600
...
_TL116: _T5= b;_T6= _T5.curr;_T7= (const char*)_T6;_T8= _check_null(_T7);_T9= i;_TA= (int)_T9;_TB= _T8[_TA];_TC= (int)_TB;_TD= accept;_TE= _TD.curr;_TF= (const char*)_TE;_T10= _check_null(_TF);_T11= j;_T12= _T10[_T11];_T13= (int)_T12;if(_TC!=_T13)goto _TL119;_T14= i;
return _T14;_TL119:
# 637
...
return _T9;}
# 688
struct Cyc_List_List*Cyc_explode(struct _fat_ptr s){struct Cyc_List_List*_T0;_T0= Cyc_rexplode(Cyc_Core_heap_region,s);return _T0;}
# 690
struct _fat_ptr Cyc_implode(struct Cyc_List_List*chars){int _T0;int _T1;unsigned _T2;struct _fat_ptr _T3;unsigned long _T4;unsigned long _T5;int _T6;unsigned char*_T7;char*_T8;struct Cyc_List_List*_T9;void*_TA;long _TB;unsigned _TC;unsigned char*_TD;char*_TE;struct Cyc_List_List*_TF;struct _fat_ptr _T10;_T0= 
...
_TL12C: _T3= s;_T4= i;i= _T4 + 1;_T5= _T4;_T6= (int)_T5;{struct _fat_ptr _T11=_fat_ptr_plus(_T3,sizeof(char),_T6);_T7= _check_fat_subscript(_T11,sizeof(char),0U);_T8= (char*)_T7;{char _T12=*_T8;_T9= chars;_TA= _T9->hd;_TB= (long)_TA;{char _T13=(char)_TB;_TC= _get_fat_size(_T11,sizeof(char));if(_TC!=1U)goto _TL12E;if(_T12!=0)goto _TL12E;if(_T13==0)goto _TL12E;_throw_arraybounds();goto _TL12F;_TL12E: _TL12F: _TD= _T11.curr;_TE= (char*)_TD;*_TE= _T13;}}}_TF= chars;
...
_TL145:{struct Cyc_Core_Invalid_argument_exn_struct*_T16=_cycalloc(sizeof(struct Cyc_Core_Invalid_argument_exn_struct));_T16->tag= Cyc_Core_Invalid_argument;({__typeof__(_tag_fat("memcpy",sizeof(char),7U))_T17=_tag_fat("memcpy",sizeof(char),7U);_T16->f1= _T17;});_TC= (struct Cyc_Core_Invalid_argument_exn_struct*)_T16;}_TD= (void*)_TC;_throw(_TD);goto _TL144;_TL143: _TL144: _TE= d;_TF= _untag_fat_ptr_check_bound(_TE,sizeof(void),1U);_T10= (void*)_TF;_T11= s;_T12= _untag_fat_ptr_check_bound(_T11,sizeof(void),1U);_T13= (const void*)_T12;_T14= n * sz;
...
_TL14B:{struct Cyc_Core_Invalid_argument_exn_struct*_T16=_cycalloc(sizeof(struct Cyc_Core_Invalid_argument_exn_struct));_T16->tag= Cyc_Core_Invalid_argument;({__typeof__(_tag_fat("memove",sizeof(char),7U))_T17=_tag_fat("memove",sizeof(char),7U);_T16->f1= _T17;});_TC= (struct Cyc_Core_Invalid_argument_exn_struct*)_T16;}_TD= (void*)_TC;_throw(_TD);goto _TL14A;_TL149: _TL14A: _TE= d;_TF= _untag_fat_ptr_check_bound(_TE,sizeof(void),1U);_T10= (void*)_TF;_T11= s;_T12= _untag_fat_ptr_check_bound(_T11,sizeof(void),1U);_T13= (const void*)_T12;_T14= n * sz;
...
_TL151:{struct Cyc_Core_Invalid_argument_exn_struct*_T16=_cycalloc(sizeof(struct Cyc_Core_Invalid_argument_exn_struct));_T16->tag= Cyc_Core_Invalid_argument;({__typeof__(_tag_fat("memcmp",sizeof(char),7U))_T17=_tag_fat("memcmp",sizeof(char),7U);_T16->f1= _T17;});_TC= (struct Cyc_Core_Invalid_argument_exn_struct*)_T16;}_TD= (void*)_TC;_throw(_TD);goto _TL150;_TL14F: _TL150: _TE= s1;_TF= _untag_fat_ptr_check_bound(_TE,sizeof(char),1U);_T10= (const void*)_TF;_T11= s2;_T12= _untag_fat_ptr_check_bound(_T11,sizeof(char),1U);_T13= (const void*)_T12;_T14= n;_T15= 
memcmp(_T10,_T13,_T14);return _T15;}
# 794
struct _fat_ptr Cyc_memchr(struct _fat_ptr s,char c,unsigned long n){struct _fat_ptr _T0;struct _fat_ptr _T1;unsigned char*_T2;char*_T3;struct Cyc_Core_Invalid_argument_exn_struct*_T4;void*_T5;struct _fat_ptr _T6;unsigned char*_T7;const char*_T8;char _T9;int _TA;unsigned long _TB;struct _fat_ptr _TC;struct _fat_ptr _TD;unsigned char*_TE;const char*_TF;char*_T10;const char*_T11;struct _fat_ptr _T12;unsigned _T13;int _T14;struct _fat_ptr _T15;_T0= s;{
...
_TL157:{struct Cyc_Core_Invalid_argument_exn_struct*_T16=_cycalloc(sizeof(struct Cyc_Core_Invalid_argument_exn_struct));_T16->tag= Cyc_Core_Invalid_argument;({__typeof__(_tag_fat("memchr",sizeof(char),7U))_T17=_tag_fat("memchr",sizeof(char),7U);_T16->f1= _T17;});_T4= (struct Cyc_Core_Invalid_argument_exn_struct*)_T16;}_T5= (void*)_T4;_throw(_T5);goto _TL156;_TL155: _TL156: _T6= s;_T7= _untag_fat_ptr_check_bound(_T6,sizeof(char),1U);_T8= (const char*)_T7;_T9= c;_TA= (int)_T9;_TB= n;{
char*p=memchr(_T8,_TA,_TB);
if(p!=0)goto _TL159;_TC= 
_tag_fat(0,0,0);return _TC;_TL159: _TD= s;_TE= _untag_fat_ptr(_TD,sizeof(char),1U);_TF= (const char*)_TE;{
unsigned sval=(unsigned)_TF;_T10= p;_T11= (const char*)_T10;{
unsigned pval=(unsigned)_T11;
unsigned delta=pval - sval;_T12= s;_T13= delta;_T14= (int)_T13;_T15= 
_fat_ptr_plus(_T12,sizeof(char),_T14);return _T15;}}}}}
# 807
struct _fat_ptr Cyc_mmemchr(struct _fat_ptr s,char c,unsigned long n){struct _fat_ptr _T0;struct _fat_ptr _T1;unsigned char*_T2;char*_T3;struct Cyc_Core_Invalid_argument_exn_struct*_T4;void*_T5;struct _fat_ptr _T6;unsigned char*_T7;const char*_T8;char _T9;int _TA;unsigned long _TB;struct _fat_ptr _TC;struct _fat_ptr _TD;unsigned char*_TE;const char*_TF;char*_T10;struct _fat_ptr _T11;unsigned _T12;int _T13;struct _fat_ptr _T14;_T0= s;{
unsigned sz=_get_fat_size(_T0,sizeof(char));_T1= s;_T2= _T1.curr;_T3= (char*)_T2;
if(_T3==0)goto _TL15D;else{goto _TL15E;}_TL15E: if(n > sz)goto _TL15D;else{goto _TL15B;}
_TL15D:{struct Cyc_Core_Invalid_argument_exn_struct*_T15=_cycalloc(sizeof(struct Cyc_Core_Invalid_argument_exn_struct));_T15->tag= Cyc_Core_Invalid_argument;({__typeof__(_tag_fat("mmemchr",sizeof(char),8U))_T16=_tag_fat("mmemchr",sizeof(char),8U);_T15->f1= _T16;});_T4= (struct Cyc_Core_Invalid_argument_exn_struct*)_T15;}_T5= (void*)_T4;_throw(_T5);goto _TL15C;_TL15B: _TL15C: _T6= s;_T7= _untag_fat_ptr_check_bound(_T6,sizeof(char),1U);_T8= (const char*)_T7;_T9= c;_TA= (int)_T9;_TB= n;{
char*p=memchr(_T8,_TA,_TB);
if(p!=0)goto _TL15F;_TC= 
_tag_fat(0,0,0);return _TC;_TL15F: _TD= s;_TE= _untag_fat_ptr(_TD,sizeof(char),1U);_TF= (const char*)_TE;{
unsigned sval=(unsigned)_TF;_T10= p;{
...
_TL163:{struct Cyc_Core_Invalid_argument_exn_struct*_T10=_cycalloc(sizeof(struct Cyc_Core_Invalid_argument_exn_struct));_T10->tag= Cyc_Core_Invalid_argument;({__typeof__(_tag_fat("memset",sizeof(char),7U))_T11=_tag_fat("memset",sizeof(char),7U);_T10->f1= _T11;});_T6= (struct Cyc_Core_Invalid_argument_exn_struct*)_T10;}_T7= (void*)_T6;_throw(_T7);goto _TL162;_TL161: _TL162: _T8= s;_T9= _untag_fat_ptr_check_bound(_T8,sizeof(char),1U);_TA= (char*)_T9;_TB= (void*)_TA;_TC= c;_TD= (int)_TC;_TE= n;
...
_TL167:{struct Cyc_Core_Invalid_argument_exn_struct*_TE=_cycalloc(sizeof(struct Cyc_Core_Invalid_argument_exn_struct));_TE->tag= Cyc_Core_Invalid_argument;({__typeof__(_tag_fat("bzero",sizeof(char),6U))_TF=_tag_fat("bzero",sizeof(char),6U);_TE->f1= _TF;});_T6= (struct Cyc_Core_Invalid_argument_exn_struct*)_TE;}_T7= (void*)_T6;_throw(_T7);goto _TL166;_TL165: _TL166: _T9= bzero;{
...
_TL16B:{struct Cyc_Core_Invalid_argument_exn_struct*_T15=_cycalloc(sizeof(struct Cyc_Core_Invalid_argument_exn_struct));_T15->tag= Cyc_Core_Invalid_argument;({__typeof__(_tag_fat("bcopy",sizeof(char),6U))_T16=_tag_fat("bcopy",sizeof(char),6U);_T15->f1= _T16;});_TC= (struct Cyc_Core_Invalid_argument_exn_struct*)_T15;}_TD= (void*)_TC;_throw(_TD);goto _TL16A;_TL169: _TL16A: _TE= src;_TF= _untag_fat_ptr_check_bound(_TE,sizeof(void),1U);_T10= (const void*)_TF;_T11= dst;_T12= _untag_fat_ptr_check_bound(_T11,sizeof(void),1U);_T13= (void*)_T12;_T14= n * sz;
