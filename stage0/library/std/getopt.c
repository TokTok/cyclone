...
# 161 "bazel-out/k8-fastbuild/bin/cyclone/library/std/libc/stdlib.h"
extern char*getenv(const char*);
# 31 "./cyclone/library/std/getopt.h"
...
# 67 "cyclone/library/std/getopt.cyc"
...
# 417
_fat_ptr_plus(_T49,sizeof(char),1);_T4C= longopts;_T4D= _T4C.curr;_T4E= (struct Cyc_option*)_T4D;if(_T4E==0)goto _TL42;_T4F= argv;_T50= _T4F.curr;_T51= (struct _fat_ptr*)_T50;_T52= Cyc_optind;_T53= _T51[_T52];_T54= _T53.curr;_T55= (char*)_T54;_T56= _T55[1];_T57= (int)_T56;_T4B= _T57==45;goto _TL43;_TL42: _T4B= 0;_TL43: Cyc_nextchar= _fat_ptr_plus(_T4A,sizeof(char),_T4B);goto _TL1F;_TL1E: _TL1F: _T58= longopts;_T59= _T58.curr;_T5A= (struct Cyc_option*)_T59;
# 435
...
_TL50: _T8B= p;_T8C= _T8B.curr;_T8D= (const struct Cyc_option*)_T8C;_T8E= _T8D->name;_T8F= Cyc_nextchar;_T90= nameend;_T91= _T90.curr;_T92= Cyc_nextchar;_T93= _T92.curr;_T94= _T91 - _T93;_T95= _T94 / sizeof(char);_T96= (unsigned long)_T95;_T97= Cyc_strncmp(_T8E,_T8F,_T96);if(_T97)goto _TL53;else{goto _TL55;}
_TL55: _T98= nameend;_T99= _T98.curr;_T9A= Cyc_nextchar;_T9B= _T9A.curr;_T9C= _T99 - _T9B;_T9D= _T9C / sizeof(char);_T9E= (unsigned)_T9D;_T9F= p;_TA0= _T9F.curr;_TA1= (const struct Cyc_option*)_TA0;_TA2= _TA1->name;_TA3= Cyc_strlen(_TA2);if(_T9E!=_TA3)goto _TL56;
# 455
pfound= p;
...
_T291.f1= _TC7[0];_TC4= _T291;}{struct Cyc_String_pa_PrintArg_struct _T291=_TC4;{struct Cyc_String_pa_PrintArg_struct _T292;_T292.tag= 0;_TC9= argv;_TCA= Cyc_optind;_TCB= _check_fat_subscript(_TC9,sizeof(struct _fat_ptr),_TCA);_TCC= (struct _fat_ptr*)_TCB;_T292.f1= *_TCC;_TC8= _T292;}{struct Cyc_String_pa_PrintArg_struct _T292=_TC8;void*_T293[2];_T293[0]= & _T291;_T293[1]= & _T292;_TCD= Cyc_stderr;_TCE= _tag_fat("%s: option `%s' is ambiguous\n",sizeof(char),30U);_TCF= _tag_fat(_T293,sizeof(void*),2);Cyc_fprintf(_TCD,_TCE,_TCF);}}goto _TL64;_TL63: _TL64: _TD0= & Cyc_nextchar;_TD1= 
...
# 490
_T291.f1= _TED[0];_TEA= _T291;}{struct Cyc_String_pa_PrintArg_struct _T291=_TEA;{struct Cyc_String_pa_PrintArg_struct _T292;_T292.tag= 0;_TEF= pfound;_TF0= _TEF.curr;_TF1= (const struct Cyc_option*)_TF0;
_T292.f1= _TF1->name;_TEE= _T292;}{struct Cyc_String_pa_PrintArg_struct _T292=_TEE;void*_T293[2];_T293[0]= & _T291;_T293[1]= & _T292;_TF2= Cyc_stderr;_TF3= 
# 490
...
# 494
_TL6D:{struct Cyc_String_pa_PrintArg_struct _T291;_T291.tag= 0;_TF6= argv;_TF7= _TF6.curr;_TF8= (struct _fat_ptr*)_TF7;_T291.f1= _TF8[0];_TF5= _T291;}{struct Cyc_String_pa_PrintArg_struct _T291=_TF5;{struct Cyc_Int_pa_PrintArg_struct _T292;_T292.tag= 1;_TFA= argv;_TFB= _TFA.curr;_TFC= (struct _fat_ptr*)_TFB;_TFD= Cyc_optind - 1;_TFE= _TFC[_TFD];_TFF= _TFE.curr;_T100= (char*)_TFF;_T101= _T100[0];_T102= (int)_T101;
...
_T291.f1= _T11D[0];_T11A= _T291;}{struct Cyc_String_pa_PrintArg_struct _T291=_T11A;{struct Cyc_String_pa_PrintArg_struct _T292;_T292.tag= 0;_T11F= argv;_T120= Cyc_optind - 1;_T121= _check_fat_subscript(_T11F,sizeof(struct _fat_ptr),_T120);_T122= (struct _fat_ptr*)_T121;_T292.f1= *_T122;_T11E= _T292;}{struct Cyc_String_pa_PrintArg_struct _T292=_T11E;void*_T293[2];_T293[0]= & _T291;_T293[1]= & _T292;_T123= Cyc_stderr;_T124= _tag_fat("%s: option `%s' requires an argument\n",sizeof(char),38U);_T125= _tag_fat(_T293,sizeof(void*),2);Cyc_fprintf(_T123,_T124,_T125);}}goto _TL74;_TL73: _TL74: _T126= & Cyc_nextchar;_T127= 
...
# 528
if(_T147)goto _TL7F;else{goto _TL7D;}_TL7F: _T148= argv;_T149= Cyc_optind;_T14A= _check_fat_subscript(_T148,sizeof(struct _fat_ptr),_T149);_T14B= (struct _fat_ptr*)_T14A;_T14C= *_T14B;_T14D= _check_fat_subscript(_T14C,sizeof(char),1);_T14E= (char*)_T14D;_T14F= *_T14E;_T150= (int)_T14F;if(_T150==45)goto _TL7D;else{goto _TL7E;}_TL7E: _T151= optstring;_T152= Cyc_nextchar;_T153= _check_fat_subscript(_T152,sizeof(char),0U);_T154= (char*)_T153;_T155= *_T154;_T156= Cyc_strchr(_T151,_T155);_T157= _T156.curr;_T158= (char*)_T157;if(_T158==0)goto _TL7D;else{goto _TL7B;}
...
# 532
_T291.f1= _T166[0];_T163= _T291;}{struct Cyc_String_pa_PrintArg_struct _T291=_T163;{struct Cyc_String_pa_PrintArg_struct _T292;_T292.tag= 0;_T292.f1= Cyc_nextchar;_T167= _T292;}{struct Cyc_String_pa_PrintArg_struct _T292=_T167;void*_T293[2];_T293[0]= & _T291;_T293[1]= & _T292;_T168= Cyc_stderr;_T169= _tag_fat("%s: unrecognized option `--%s'\n",sizeof(char),32U);_T16A= _tag_fat(_T293,sizeof(void*),2);Cyc_fprintf(_T168,_T169,_T16A);}}goto _TL83;
# 535
_TL82:{struct Cyc_String_pa_PrintArg_struct _T291;_T291.tag= 0;_T16C= argv;_T16D= _T16C.curr;_T16E= (struct _fat_ptr*)_T16D;_T291.f1= _T16E[0];_T16B= _T291;}{struct Cyc_String_pa_PrintArg_struct _T291=_T16B;{struct Cyc_Int_pa_PrintArg_struct _T292;_T292.tag= 1;_T170= argv;_T171= _T170.curr;_T172= (struct _fat_ptr*)_T171;_T173= Cyc_optind;_T174= _T172[_T173];_T175= _T174.curr;_T176= (char*)_T175;_T177= _T176[0];_T178= (int)_T177;_T292.f1= (unsigned long)_T178;_T16F= _T292;}{struct Cyc_Int_pa_PrintArg_struct _T292=_T16F;{struct Cyc_String_pa_PrintArg_struct _T293;_T293.tag= 0;
_T293.f1= Cyc_nextchar;_T179= _T293;}{struct Cyc_String_pa_PrintArg_struct _T293=_T179;void*_T294[3];_T294[0]= & _T291;_T294[1]= & _T292;_T294[2]= & _T293;_T17A= Cyc_stderr;_T17B= 
# 535
...
# 559
_T291.f1= *_T196;_T193= _T291;}{struct Cyc_String_pa_PrintArg_struct _T291=_T193;{struct Cyc_Int_pa_PrintArg_struct _T292;_T292.tag= 1;_T198= c;_T199= (int)_T198;_T292.f1= (unsigned long)_T199;_T197= _T292;}{struct Cyc_Int_pa_PrintArg_struct _T292=_T197;void*_T293[2];_T293[0]= & _T291;_T293[1]= & _T292;_T19A= Cyc_stderr;_T19B= _tag_fat("%s: illegal option -- %c\n",sizeof(char),26U);_T19C= _tag_fat(_T293,sizeof(void*),2);Cyc_fprintf(_T19A,_T19B,_T19C);}}goto _TL91;
# 561
_TL90:{struct Cyc_String_pa_PrintArg_struct _T291;_T291.tag= 0;_T19E= argv;_T19F= _check_fat_subscript(_T19E,sizeof(struct _fat_ptr),0);_T1A0= (struct _fat_ptr*)_T19F;_T291.f1= *_T1A0;_T19D= _T291;}{struct Cyc_String_pa_PrintArg_struct _T291=_T19D;{struct Cyc_Int_pa_PrintArg_struct _T292;_T292.tag= 1;_T1A2= c;_T1A3= (int)_T1A2;_T292.f1= (unsigned long)_T1A3;_T1A1= _T292;}{struct Cyc_Int_pa_PrintArg_struct _T292=_T1A1;void*_T293[2];_T293[0]= & _T291;_T293[1]= & _T292;_T1A4= Cyc_stderr;_T1A5= _tag_fat("%s: invalid option -- %c\n",sizeof(char),26U);_T1A6= _tag_fat(_T293,sizeof(void*),2);Cyc_fprintf(_T1A4,_T1A5,_T1A6);}}_TL91: goto _TL8F;_TL8E: _TL8F: _T1A7= c;
# 563
...
_TLA2: _T1E0= p;_T1E1= _T1E0.curr;_T1E2= (const struct Cyc_option*)_T1E1;_T1E3= _T1E2->name;_T1E4= Cyc_nextchar;_T1E5= nameend;_T1E6= _T1E5.curr;_T1E7= Cyc_nextchar;_T1E8= _T1E7.curr;_T1E9= _T1E6 - _T1E8;_T1EA= _T1E9 / sizeof(char);_T1EB= (unsigned long)_T1EA;_T1EC= Cyc_strncmp(_T1E3,_T1E4,_T1EB);if(_T1EC)goto _TLA5;else{goto _TLA7;}
...
_T291.f1= *_T209;_T206= _T291;}{struct Cyc_String_pa_PrintArg_struct _T291=_T206;{struct Cyc_String_pa_PrintArg_struct _T292;_T292.tag= 0;_T20B= argv;_T20C= Cyc_optind;_T20D= _check_fat_subscript(_T20B,sizeof(struct _fat_ptr),_T20C);_T20E= (struct _fat_ptr*)_T20D;_T292.f1= *_T20E;_T20A= _T292;}{struct Cyc_String_pa_PrintArg_struct _T292=_T20A;void*_T293[2];_T293[0]= & _T291;_T293[1]= & _T292;_T20F= Cyc_stderr;_T210= _tag_fat("%s: option `-W %s' is ambiguous\n",sizeof(char),33U);_T211= _tag_fat(_T293,sizeof(void*),2);Cyc_fprintf(_T20F,_T210,_T211);}}goto _TLB0;_TLAF: _TLB0: _T212= & Cyc_nextchar;_T213= 
...
_T291.f1= *_T23E;_T23B= _T291;}{struct Cyc_String_pa_PrintArg_struct _T291=_T23B;{struct Cyc_String_pa_PrintArg_struct _T292;_T292.tag= 0;_T240= argv;_T241= Cyc_optind - 1;_T242= _check_fat_subscript(_T240,sizeof(struct _fat_ptr),_T241);_T243= (struct _fat_ptr*)_T242;
_T292.f1= *_T243;_T23F= _T292;}{struct Cyc_String_pa_PrintArg_struct _T292=_T23F;void*_T293[2];_T293[0]= & _T291;_T293[1]= & _T292;_T244= Cyc_stderr;_T245= 
# 650
