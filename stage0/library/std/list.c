...
# 147 "cyclone/library/std/core.h"
...
# 243 "cyclone/library/std/list.h"
...
# 30 "cyclone/library/std/list.cyc"
...
return _T1;}
# 38
void*Cyc_List_hd(struct Cyc_List_List*x){struct Cyc_List_List*_T0;void*_T1;_T0= x;_T1= _T0->hd;return _T1;}
# 41
struct Cyc_List_List*Cyc_List_tl(struct Cyc_List_List*x){struct Cyc_List_List*_T0;struct Cyc_List_List*_T1;_T0= x;_T1= _T0->tl;return _T1;}
# 45
struct Cyc_List_List*Cyc_List_rlist(struct _RegionHandle*r,struct _fat_ptr argv){struct Cyc_List_List*_T0;_T0= Cyc_List_rfrom_array(r,argv);return _T0;}
# 47
struct Cyc_List_List*Cyc_List_list(struct _fat_ptr argv){struct Cyc_List_List*_T0;_T0= Cyc_List_from_array(argv);return _T0;}
# 50
...
# 53
if(x!=0)goto _TL4;
return 0;_TL4: _T1= r;{struct Cyc_List_List*_TB=_region_malloc(_T1,0U,sizeof(struct Cyc_List_List));_T2= x;
...
return _TA;}
# 65
struct Cyc_List_List*Cyc_List_copy(struct Cyc_List_List*x){struct Cyc_List_List*_T0;_T0= Cyc_List_rcopy(Cyc_Core_heap_region,x);return _T0;}
# 68
...
# 71
if(x!=0)goto _TLA;
return 0;_TLA: _T1= r;{struct Cyc_List_List*_TD=_region_malloc(_T1,0U,sizeof(struct Cyc_List_List));_T2= x;_T3= _T2->hd;
({__typeof__(f(_T3))_TE=f(_T3);_TD->hd= _TE;});_TD->tl= 0;_T0= (struct Cyc_List_List*)_TD;}result= _T0;
prev= result;_T4= x;
x= _T4->tl;_TLF: if(x!=0)goto _TLD;else{goto _TLE;}
_TLD:{struct Cyc_List_List*temp;_T5= r;temp= _region_malloc(_T5,0U,sizeof(struct Cyc_List_List));_T6= temp;_T7= x;_T8= _T7->hd;({__typeof__(f(_T8))_TD=f(_T8);_T6->hd= _TD;});_T9= temp;_T9->tl= 0;_TA= prev;
_TA->tl= temp;
prev= temp;}_TB= x;
# 75
...
return _TC;}
# 83
struct Cyc_List_List*Cyc_List_map(void*(*f)(void*),struct Cyc_List_List*x){struct _RegionHandle*_T0;void*(*_T1)(void*);struct Cyc_List_List*_T2;struct Cyc_List_List*_T3;_T0= Cyc_Core_heap_region;_T1= f;_T2= x;_T3= Cyc_List_rmap(_T0,_T1,_T2);return _T3;}
# 86
...
# 89
if(x!=0)goto _TL10;
return 0;_TL10: _T1= r;{struct Cyc_List_List*_TF=_region_malloc(_T1,0U,sizeof(struct Cyc_List_List));_T2= env;_T3= x;_T4= _T3->hd;
({__typeof__(f(_T2,_T4))_T10=f(_T2,_T4);_TF->hd= _T10;});_TF->tl= 0;_T0= (struct Cyc_List_List*)_TF;}result= _T0;
prev= result;_T5= x;
x= _T5->tl;_TL15: if(x!=0)goto _TL13;else{goto _TL14;}
_TL13:{struct Cyc_List_List*e;_T6= r;e= _region_malloc(_T6,0U,sizeof(struct Cyc_List_List));_T7= e;_T8= env;_T9= x;_TA= _T9->hd;({__typeof__(f(_T8,_TA))_TF=f(_T8,_TA);_T7->hd= _TF;});_TB= e;_TB->tl= 0;_TC= prev;
_TC->tl= e;
prev= e;}_TD= x;
# 93
...
return _TE;}
# 101
struct Cyc_List_List*Cyc_List_map_c(void*(*f)(void*,void*),void*env,struct Cyc_List_List*x){struct _RegionHandle*_T0;void*(*_T1)(void*,void*);void*_T2;struct Cyc_List_List*_T3;struct Cyc_List_List*_T4;_T0= Cyc_Core_heap_region;_T1= f;_T2= env;_T3= x;_T4= Cyc_List_rmap_c(_T0,_T1,_T2,_T3);return _T4;}char Cyc_List_List_mismatch[14U]="List_mismatch";
# 105
...
struct Cyc_List_List*result;struct Cyc_List_List*prev;
# 113
if(x!=0)goto _TL16;if(y!=0)goto _TL16;
return 0;_TL16:
 if(x==0)goto _TL1A;else{goto _TL1B;}_TL1B: if(y==0)goto _TL1A;else{goto _TL18;}
_TL1A: _T0= & Cyc_List_List_mismatch_val;_T1= (struct Cyc_List_List_mismatch_exn_struct*)_T0;_throw(_T1);goto _TL19;_TL18: _TL19: _T3= r;{struct Cyc_List_List*_T17=_region_malloc(_T3,0U,sizeof(struct Cyc_List_List));_T4= x;_T5= _T4->hd;_T6= y;_T7= _T6->hd;
# 118
({__typeof__(f(_T5,_T7))_T18=f(_T5,_T7);_T17->hd= _T18;});_T17->tl= 0;_T2= (struct Cyc_List_List*)_T17;}result= _T2;
prev= result;_T8= x;
x= _T8->tl;_T9= y;
y= _T9->tl;
# 123
_TL1C: if(x!=0)goto _TL1F;else{goto _TL1E;}_TL1F: if(y!=0)goto _TL1D;else{goto _TL1E;}
_TL1D:{struct Cyc_List_List*temp;_TA= r;temp= _region_malloc(_TA,0U,sizeof(struct Cyc_List_List));_TB= temp;_TC= x;_TD= _TC->hd;_TE= y;_TF= _TE->hd;({__typeof__(f(_TD,_TF))_T17=f(_TD,_TF);_TB->hd= _T17;});_T10= temp;_T10->tl= 0;_T11= prev;
_T11->tl= temp;
prev= temp;_T12= x;
x= _T12->tl;_T13= y;
y= _T13->tl;}goto _TL1C;_TL1E:
# 130
 if(x!=0)goto _TL22;else{goto _TL23;}_TL23: if(y!=0)goto _TL22;else{goto _TL20;}
_TL22: _T14= & Cyc_List_List_mismatch_val;_T15= (struct Cyc_List_List_mismatch_exn_struct*)_T14;_throw(_T15);goto _TL21;_TL20: _TL21: _T16= result;
return _T16;}
# 135
struct Cyc_List_List*Cyc_List_map2(void*(*f)(void*,void*),struct Cyc_List_List*x,struct Cyc_List_List*y){struct _RegionHandle*_T0;void*(*_T1)(void*,void*);struct Cyc_List_List*_T2;struct Cyc_List_List*_T3;struct Cyc_List_List*_T4;_T0= Cyc_Core_heap_region;_T1= f;_T2= x;_T3= y;_T4= Cyc_List_rmap2(_T0,_T1,_T2,_T3);return _T4;}
# 138
...
struct Cyc_List_List*result;struct Cyc_List_List*prev;
# 141
if(x!=0)goto _TL24;if(y!=0)goto _TL24;if(z!=0)goto _TL24;
return 0;_TL24:
 if(x==0)goto _TL28;else{goto _TL2A;}_TL2A: if(y==0)goto _TL28;else{goto _TL29;}_TL29: if(z==0)goto _TL28;else{goto _TL26;}
_TL28: _T0= & Cyc_List_List_mismatch_val;_T1= (struct Cyc_List_List_mismatch_exn_struct*)_T0;_throw(_T1);goto _TL27;_TL26: _TL27: _T3= r;{struct Cyc_List_List*_T1D=_region_malloc(_T3,0U,sizeof(struct Cyc_List_List));_T4= x;_T5= _T4->hd;_T6= y;_T7= _T6->hd;_T8= z;_T9= _T8->hd;
# 146
({__typeof__(f(_T5,_T7,_T9))_T1E=f(_T5,_T7,_T9);_T1D->hd= _T1E;});_T1D->tl= 0;_T2= (struct Cyc_List_List*)_T1D;}result= _T2;
prev= result;_TA= x;
# 149
x= _TA->tl;_TB= y;
y= _TB->tl;_TC= z;
...
_TL2C:{struct Cyc_List_List*temp;_TD= r;temp= _region_malloc(_TD,0U,sizeof(struct Cyc_List_List));_TE= temp;_TF= x;_T10= _TF->hd;_T11= y;_T12= _T11->hd;_T13= z;_T14= _T13->hd;({__typeof__(f(_T10,_T12,_T14))_T1D=f(_T10,_T12,_T14);_TE->hd= _T1D;});_T15= temp;_T15->tl= 0;_T16= prev;
_T16->tl= temp;
prev= temp;_T17= x;
x= _T17->tl;_T18= y;
y= _T18->tl;_T19= z;
...
# 161
 if(x!=0)goto _TL32;else{goto _TL34;}_TL34: if(y!=0)goto _TL32;else{goto _TL33;}_TL33: if(z!=0)goto _TL32;else{goto _TL30;}
_TL32: _T1A= & Cyc_List_List_mismatch_val;_T1B= (struct Cyc_List_List_mismatch_exn_struct*)_T1A;_throw(_T1B);goto _TL31;_TL30: _TL31: _T1C= result;
return _T1C;}
# 166
...
# 201
 if(x!=0)goto _TL4C;else{goto _TL4D;}_TL4D: if(y!=0)goto _TL4C;else{goto _TL4A;}
_TL4C: _T6= & Cyc_List_List_mismatch_val;_T7= (struct Cyc_List_List_mismatch_exn_struct*)_T6;_throw(_T7);goto _TL4B;_TL4A: _TL4B:;}
# 205
...
# 208
 if(x!=0)goto _TL55;else{goto _TL56;}_TL56: if(y!=0)goto _TL55;else{goto _TL53;}
_TL55: _T7= & Cyc_List_List_mismatch_val;_T8= (struct Cyc_List_List_mismatch_exn_struct*)_T7;_throw(_T8);goto _TL54;_TL53: _TL54:;}
# 214
...
# 217
 if(x!=0)goto _TL5E;else{goto _TL5F;}_TL5F: if(y!=0)goto _TL5E;else{goto _TL5C;}
_TL5E: _T6= & Cyc_List_List_mismatch_val;_T7= (struct Cyc_List_List_mismatch_exn_struct*)_T6;_throw(_T7);goto _TL5D;_TL5C: _TL5D:;}
# 220
...
# 223
 if(x!=0)goto _TL67;else{goto _TL68;}_TL68: if(y!=0)goto _TL67;else{goto _TL65;}
_TL67: _T7= & Cyc_List_List_mismatch_val;_T8= (struct Cyc_List_List_mismatch_exn_struct*)_T7;_throw(_T8);goto _TL66;_TL65: _TL66:;}
# 230
...
if(x!=0)goto _TL71;_T0= accum;
return _T0;_TL71: _T1= x;_T2= _T1->hd;_T3= f;_T4= x;_T5= _T4->tl;_T6= accum;_T7= 
...
if(x!=0)goto _TL73;_T0= accum;
return _T0;_TL73: _T1= env;_T2= x;_T3= _T2->hd;_T4= f;_T5= env;_T6= x;_T7= _T6->tl;_T8= accum;_T9= 
...
return _T4;}
# 264
struct Cyc_List_List*Cyc_List_revappend(struct Cyc_List_List*x,struct Cyc_List_List*y){struct Cyc_List_List*_T0;_T0= Cyc_List_rrevappend(Cyc_Core_heap_region,x,y);return _T0;}
# 267
...
# 271
struct Cyc_List_List*Cyc_List_rev(struct Cyc_List_List*x){struct Cyc_List_List*_T0;_T0= Cyc_List_rrev(Cyc_Core_heap_region,x);return _T0;}
# 274
...
struct Cyc_List_List*result;struct Cyc_List_List*prev;
# 293
if(x!=0)goto _TL80;_T0= y;
return _T0;_TL80:
 if(y!=0)goto _TL82;_T1= 
Cyc_List_rcopy(r2,x);return _T1;_TL82: _T3= r2;{struct Cyc_List_List*_TE=_region_malloc(_T3,0U,sizeof(struct Cyc_List_List));_T4= x;
...
return _TD;}
# 308
struct Cyc_List_List*Cyc_List_append(struct Cyc_List_List*x,struct Cyc_List_List*y){struct Cyc_List_List*_T0;_T0= Cyc_List_rappend(Cyc_Core_heap_region,x,y);return _T0;}
# 312
...
# 315
if(x!=0)goto _TL88;_T0= y;
return _T0;_TL88:
 if(y!=0)goto _TL8A;_T1= x;
return _T1;_TL8A:
...
# 330
struct Cyc_List_List*Cyc_List_flatten(struct Cyc_List_List*x){struct Cyc_List_List*_T0;_T0= Cyc_List_rflatten(Cyc_Core_heap_region,x);return _T0;}
# 333
...
# 336
if(a!=0)goto _TL91;_T0= b;
return _T0;_TL91:
 if(b!=0)goto _TL93;_T1= a;
return _T1;_TL93: _T2= a;_T3= _T2->hd;_T4= b;_T5= _T4->hd;_T6= 
# 345
...
if(x!=0)goto _TL9F;_T0= x;
return _T0;_TL9F: _T1= x;{
struct Cyc_List_List*temp=_T1->tl;
if(temp!=0)goto _TLA1;_T2= x;
return _T2;_TLA1: {
# 380
...
Cyc_List_rimp_merge_sort(_TB,_TC);_TE= less_eq;_TF= b;_T10= Cyc_List_rimp_merge_sort(_TE,_TF);_T11= Cyc_List_imp_merge(_TA,_TD,_T10);return _T11;}}}
# 402
...
struct Cyc_List_List*c;struct Cyc_List_List*d;
# 410
if(a!=0)goto _TLA8;_T0= 
Cyc_List_rcopy(r,b);return _T0;_TLA8:
 if(b!=0)goto _TLAA;_T1= 
Cyc_List_rcopy(r,a);return _T1;_TLAA: _T2= a;_T3= _T2->hd;_T4= b;_T5= _T4->hd;_T6= 
# 419
...
# 463
void*Cyc_List_nth(struct Cyc_List_List*x,int i){struct Cyc_List_List*_T0;struct Cyc_List_List*_T1;void*_T2;_T0= Cyc_List_nth_tail(x,i);_T1= _check_null(_T0);_T2= _T1->hd;return _T2;}
# 467
...
return _T5;}
# 478
long Cyc_List_forall(long(*pred)(void*),struct Cyc_List_List*x){struct Cyc_List_List*_T0;void*_T1;long _T2;struct Cyc_List_List*_T3;
...
# 482
 return 1;}
# 484
long Cyc_List_forall_c(long(*pred)(void*,void*),void*env,struct Cyc_List_List*x){void*_T0;struct Cyc_List_List*_T1;void*_T2;long _T3;struct Cyc_List_List*_T4;
...
# 488
 return 1;}
# 493
long Cyc_List_exists(long(*pred)(void*),struct Cyc_List_List*x){struct Cyc_List_List*_T0;void*_T1;long _T2;struct Cyc_List_List*_T3;
...
# 497
 return 0;}
# 499
long Cyc_List_exists_c(long(*pred)(void*,void*),void*env,struct Cyc_List_List*x){void*_T0;struct Cyc_List_List*_T1;void*_T2;long _T3;struct Cyc_List_List*_T4;
...
if(!_T4)goto _TLDC;_T5= v;
return _T5;_TLDC:;}_T6= x;
# 507
...
# 520
if(x!=0)goto _TLDE;if(y!=0)goto _TLDE;
return 0;_TLDE:
 if(x==0)goto _TLE2;else{goto _TLE3;}_TLE3: if(y==0)goto _TLE2;else{goto _TLE0;}
_TLE2: _T0= & Cyc_List_List_mismatch_val;_T1= (struct Cyc_List_List_mismatch_exn_struct*)_T0;_throw(_T1);goto _TLE1;_TLE0: _TLE1: _T3= r3;{struct Cyc_List_List*_T16=_region_malloc(_T3,0U,sizeof(struct Cyc_List_List));_T5= r4;{struct _tuple2*_T17=_region_malloc(_T5,0U,sizeof(struct _tuple2));_T6= x;
# 525
...
# 538
 if(x!=0)goto _TLEA;else{goto _TLEB;}_TLEB: if(y!=0)goto _TLEA;else{goto _TLE8;}
_TLEA: _T13= & Cyc_List_List_mismatch_val;_T14= (struct Cyc_List_List_mismatch_exn_struct*)_T13;_throw(_T14);goto _TLE9;_TLE8: _TLE9: _T15= result;
return _T15;}
# 543
...
struct Cyc_List_List*result;struct Cyc_List_List*prev;struct Cyc_List_List*temp;
# 551
if(x!=0)goto _TLEC;if(y!=0)goto _TLEC;if(z!=0)goto _TLEC;
return 0;_TLEC:
 if(x==0)goto _TLF0;else{goto _TLF2;}_TLF2: if(y==0)goto _TLF0;else{goto _TLF1;}_TLF1: if(z==0)goto _TLF0;else{goto _TLEE;}
_TLF0: _T0= & Cyc_List_List_mismatch_val;_T1= (struct Cyc_List_List_mismatch_exn_struct*)_T0;_throw(_T1);goto _TLEF;_TLEE: _TLEF: _T3= r3;{struct Cyc_List_List*_T1A=_region_malloc(_T3,0U,sizeof(struct Cyc_List_List));_T5= r4;{struct _tuple3*_T1B=_region_malloc(_T5,0U,sizeof(struct _tuple3));_T6= x;
# 556
...
# 571
 if(x!=0)goto _TLFA;else{goto _TLFC;}_TLFC: if(y!=0)goto _TLFA;else{goto _TLFB;}_TLFB: if(z!=0)goto _TLFA;else{goto _TLF8;}
_TLFA: _T17= & Cyc_List_List_mismatch_val;_T18= (struct Cyc_List_List_mismatch_exn_struct*)_T17;_throw(_T18);goto _TLF9;_TLF8: _TLF9: _T19= result;
return _T19;}
# 576
...
# 586
if(x!=0)goto _TLFD;{struct _tuple0 _T1E;
_T1E.f0= 0;_T1E.f1= 0;_T0= _T1E;}return _T0;_TLFD: _T2= r3;{struct Cyc_List_List*_T1E=_region_malloc(_T2,0U,sizeof(struct Cyc_List_List));_T3= x;_T4= _T3->hd;_T5= (struct _tuple2*)_T4;_T6= _T5[0];
# 589
...
# 615
if(x!=0)goto _TL103;{struct _tuple1 _T2B;
_T2B.f0= 0;_T2B.f1= 0;_T2B.f2= 0;_T0= _T2B;}return _T0;_TL103: _T2= r3;{struct Cyc_List_List*_T2B=_region_malloc(_T2,0U,sizeof(struct Cyc_List_List));_T3= x;_T4= _T3->hd;_T5= (struct _tuple3*)_T4;_T6= _T5[0];
# 618
...
# 642
long Cyc_List_memq(struct Cyc_List_List*l,void*x){struct Cyc_List_List*_T0;void*_T1;void*_T2;struct Cyc_List_List*_T3;
...
# 646
 return 0;}
# 649
long Cyc_List_mem(int(*cmp)(void*,void*),struct Cyc_List_List*l,void*x){struct Cyc_List_List*_T0;void*_T1;void*_T2;int _T3;struct Cyc_List_List*_T4;
...
# 693
static int Cyc_List_ptrequal(void*x,void*y){int _T0;int _T1;_T0= x==y;_T1= !_T0;return _T1;}
# 698
struct Cyc_List_List*Cyc_List_delete(struct Cyc_List_List*l,void*x){struct Cyc_List_List*_T0;void*_T1;struct Cyc_List_List*_T2;_T0= l;_T1= x;_T2= Cyc_List_delete_cmp(Cyc_List_ptrequal,_T0,_T1);return _T2;}
# 702
long Cyc_List_mem_assoc(struct Cyc_List_List*l,void*x){struct Cyc_List_List*_T0;void*_T1;struct _tuple2*_T2;struct _tuple2 _T3;void*_T4;void*_T5;struct Cyc_List_List*_T6;
...
# 706
 return 0;}
# 711
long Cyc_List_mem_assoc_cmp(int(*cmp)(void*,void*),struct Cyc_List_List*l,void*x){struct Cyc_List_List*_T0;void*_T1;struct _tuple2*_T2;struct _tuple2 _T3;void*_T4;void*_T5;int _T6;struct Cyc_List_List*_T7;
...
# 735
_check_null(x);{void*v=_T7->hd;_T8= x;
x= _T8->tl;_T6= v;}
# 734
_TA[_T5]= _T6;i= i + 1;goto _TL13C;_TL13B:;}_T2= (void**)_TA;}_T0= 
# 733
_tag_fat(_T2,sizeof(void*),_T9);}return _T0;}
# 742
struct _fat_ptr Cyc_List_to_array(struct Cyc_List_List*x){struct _fat_ptr _T0;_T0= Cyc_List_rto_array(Cyc_Core_heap_region,x);return _T0;}
# 745
...
_TL142: _T1= r;{struct Cyc_List_List*_T3=_region_malloc(_T1,0U,sizeof(struct Cyc_List_List));({__typeof__(f(i))_T4=f(i);_T3->hd= _T4;});_T3->tl= res;_T0= (struct Cyc_List_List*)_T3;}res= _T0;
# 759
i= i + 1;goto _TL144;_TL143:;}_T2= 
# 761
Cyc_List_imp_rev(res);return _T2;}
# 764
struct Cyc_List_List*Cyc_List_tabulate(int n,void*(*f)(int)){struct _RegionHandle*_T0;int _T1;void*(*_T2)(int);struct Cyc_List_List*_T3;_T0= Cyc_Core_heap_region;_T1= n;_T2= f;_T3= Cyc_List_rtabulate(_T0,_T1,_T2);return _T3;}
# 766
...
_TL146: _T1= r;{struct Cyc_List_List*_T3=_region_malloc(_T1,0U,sizeof(struct Cyc_List_List));({__typeof__(f(env,i))_T4=f(env,i);_T3->hd= _T4;});_T3->tl= res;_T0= (struct Cyc_List_List*)_T3;}res= _T0;
# 768
i= i + 1;goto _TL148;_TL147:;}_T2= 
# 770
Cyc_List_imp_rev(res);return _T2;}
# 773
struct Cyc_List_List*Cyc_List_tabulate_c(int n,void*(*f)(void*,int),void*env){struct _RegionHandle*_T0;int _T1;void*(*_T2)(void*,int);void*_T3;struct Cyc_List_List*_T4;_T0= Cyc_Core_heap_region;_T1= n;_T2= f;_T3= env;_T4= Cyc_List_rtabulate_c(_T0,_T1,_T2,_T3);return _T4;}
# 775
...
return _TB;_TL154:
 return 0;}
# 792
long Cyc_List_list_prefix(int(*cmp)(void*,void*),struct Cyc_List_List*l1,struct Cyc_List_List*l2){struct Cyc_List_List*_T0;unsigned _T1;struct Cyc_List_List*_T2;unsigned _T3;struct Cyc_List_List*_T4;void*_T5;struct Cyc_List_List*_T6;void*_T7;int _T8;struct Cyc_List_List*_T9;struct Cyc_List_List*_TA;int _TB;
...
return _TB;}
# 803
struct Cyc_List_List*Cyc_List_rfilter_c(struct _RegionHandle*r,long(*f)(void*,void*),void*env,struct Cyc_List_List*l){struct _RegionHandle*_T0;struct Cyc_List_List*_T1;struct Cyc_List_List*_T2;struct Cyc_List_List*_T3;void*_T4;struct Cyc_List_List*_T5;void*_T6;long _T7;struct Cyc_List_List*_T8;struct _RegionHandle*_T9;struct Cyc_List_List*_TA;struct Cyc_List_List*_TB;struct Cyc_List_List*_TC;struct Cyc_List_List*_TD;struct Cyc_List_List*_TE;
if(l!=0)goto _TL15F;
return 0;_TL15F: {
# 807
...
return _TE;}}}
# 819
struct Cyc_List_List*Cyc_List_filter_c(long(*f)(void*,void*),void*env,struct Cyc_List_List*l){struct _RegionHandle*_T0;long(*_T1)(void*,void*);void*_T2;struct Cyc_List_List*_T3;struct Cyc_List_List*_T4;_T0= Cyc_Core_heap_region;_T1= f;_T2= env;_T3= l;_T4= 
Cyc_List_rfilter_c(_T0,_T1,_T2,_T3);return _T4;}
# 823
struct Cyc_List_List*Cyc_List_rfilter(struct _RegionHandle*r,long(*f)(void*),struct Cyc_List_List*l){struct _RegionHandle*_T0;struct Cyc_List_List*_T1;struct Cyc_List_List*_T2;struct Cyc_List_List*_T3;struct Cyc_List_List*_T4;void*_T5;long _T6;struct Cyc_List_List*_T7;struct _RegionHandle*_T8;struct Cyc_List_List*_T9;struct Cyc_List_List*_TA;struct Cyc_List_List*_TB;struct Cyc_List_List*_TC;struct Cyc_List_List*_TD;
if(l!=0)goto _TL167;
return 0;_TL167: {
# 827
struct Cyc_List_List*result;_T0= r;result= _region_malloc(_T0,0U,sizeof(struct Cyc_List_List));_T1= result;_T2= l;_T1->hd= _T2->hd;_T3= result;_T3->tl= 0;{
...
return _TD;}}}
# 839
struct Cyc_List_List*Cyc_List_filter(long(*f)(void*),struct Cyc_List_List*l){struct _RegionHandle*_T0;long(*_T1)(void*);struct Cyc_List_List*_T2;struct Cyc_List_List*_T3;_T0= Cyc_Core_heap_region;_T1= f;_T2= l;_T3= Cyc_List_rfilter(_T0,_T1,_T2);return _T3;}
