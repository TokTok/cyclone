...
# 13 "cyclone/library/std/apq.cyc"
...
({__typeof__(Cyc_AP_neg(_T6))_T1B=Cyc_AP_neg(_T6);_T4->d= _T1B;});_T7= q;_T8= q;_T9= _T8->n;
({__typeof__(Cyc_AP_neg(_T9))_T1B=Cyc_AP_neg(_T9);_T7->n= _T1B;});goto _TL1;_TL0: _TL1: _TA= q;_TB= _TA->n;_TC= 
# 18
...
({__typeof__(Cyc_AP_div(_T14,_T15))_T1B=Cyc_AP_div(_T14,_T15);_T12->n= _T1B;});_T16= newq;_T17= q;_T18= _T17->d;_T19= gcd;
({__typeof__(Cyc_AP_div(_T18,_T19))_T1B=Cyc_AP_div(_T18,_T19);_T16->d= _T1B;});_T1A= newq;
return _T1A;}}}
# 27
...
({__typeof__(Cyc_AP_fromint(i))_T4=Cyc_AP_fromint(i);_T1->n= _T4;});_T2= q;
...
Cyc_AP_cmp(d,Cyc_AP_zero);if(_T0!=0)goto _TL4;{struct Cyc_Invalid_argument_exn_struct*_T7=_cycalloc(sizeof(struct Cyc_Invalid_argument_exn_struct));_T7->tag= Cyc_Invalid_argument;
({__typeof__(_tag_fat("APQ_fromAP: divide by zero",sizeof(char),27U))_T8=_tag_fat("APQ_fromAP: divide by zero",sizeof(char),27U);_T7->f1= _T8;});_T1= (struct Cyc_Invalid_argument_exn_struct*)_T7;}_T2= (void*)_T1;_throw(_T2);goto _TL5;_TL4: _TL5: _T3= _cycalloc(sizeof(struct Cyc_APQ_T));{
...
_TL6: _T1= s;_T2= _check_fat_subscript(_T1,sizeof(char),0U);_T3= (const char*)_T2;_T4= *_T3;_T5= (int)_T4;if(_T5)goto _TL9;else{goto _TL8;}_TL9: _T6= s;_T7= _T6.curr;_T8= (const char*)_T7;_T9= *_T8;_TA= (int)_T9;if(_TA!=47)goto _TL7;else{goto _TL8;}
_TL7: _TB= & s;_fat_ptr_inplace_plus(_TB,sizeof(char),1);goto _TL6;_TL8: _TC= q;_TD= str;_TE= _untag_fat_ptr_check_bound(_TD,sizeof(char),1U);_TF= (const char*)_TE;_T10= base;
({__typeof__(Cyc_AP_fromstr(_TF,_T10))_T21=Cyc_AP_fromstr(_TF,_T10);_TC->n= _T21;});_T11= s;_T12= _T11.curr;_T13= (const char*)_T12;_T14= *_T13;_T15= (int)_T14;
...
_T1C->d= d;goto _TLD;
# 54
_TLC:{struct Cyc_Invalid_argument_exn_struct*_T21=_cycalloc(sizeof(struct Cyc_Invalid_argument_exn_struct));_T21->tag= Cyc_Invalid_argument;({__typeof__(_tag_fat("APQ_fromstr: malformed string",sizeof(char),30U))_T22=_tag_fat("APQ_fromstr: malformed string",sizeof(char),30U);_T21->f1= _T22;});_T1D= (struct Cyc_Invalid_argument_exn_struct*)_T21;}_T1E= (void*)_T1D;_throw(_T1E);_TLD:;}goto _TLB;
# 56
...
# 66
struct Cyc_APQ_T*Cyc_APQ_neg(struct Cyc_APQ_T*q){struct Cyc_APQ_T*_T0;struct Cyc_AP_T*_T1;struct Cyc_AP_T*_T2;struct Cyc_APQ_T*_T3;struct Cyc_AP_T*_T4;struct Cyc_APQ_T*_T5;_T0= _check_null(q);_T1= _T0->n;_T2= Cyc_AP_neg(_T1);_T3= q;_T4= _T3->d;_T5= Cyc_APQ_fromAP(_T2,_T4);return _T5;}
# 68
struct Cyc_APQ_T*Cyc_APQ_abs(struct Cyc_APQ_T*q){struct Cyc_APQ_T*_T0;struct Cyc_AP_T*_T1;struct Cyc_AP_T*_T2;struct Cyc_APQ_T*_T3;struct Cyc_AP_T*_T4;struct Cyc_APQ_T*_T5;_T0= _check_null(q);_T1= _T0->n;_T2= Cyc_AP_abs(_T1);_T3= q;_T4= _T3->d;_T5= Cyc_APQ_fromAP(_T2,_T4);return _T5;}
# 70
...
_check_null(q);_T1= _T0->n;_T2= Cyc_AP_zero;_T3= Cyc_AP_cmp(_T1,_T2);if(_T3!=0)goto _TL10;{struct Cyc_Invalid_argument_exn_struct*_T11=_cycalloc(sizeof(struct Cyc_Invalid_argument_exn_struct));_T11->tag= Cyc_Invalid_argument;
({__typeof__(_tag_fat("APQ_div: divide by zero",sizeof(char),24U))_T12=_tag_fat("APQ_div: divide by zero",sizeof(char),24U);_T11->f1= _T12;});_T4= (struct Cyc_Invalid_argument_exn_struct*)_T11;}_T5= (void*)_T4;_throw(_T5);goto _TL11;_TL10: _TL11: _T6= 
