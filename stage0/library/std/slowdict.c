...
# 49
long Cyc_SlowDict_is_empty(struct Cyc_SlowDict_Dict*d){struct Cyc_SlowDict_Dict*_T0;int*_T1;int _T2;_T0= d;{
...
_T2F->key= _T1C->key;_T1D= n;_T2F->data= _T1D->data;_T2F->left= leaf;_T1E= n;_T2F->right= _T1E->right;_T1B= (struct Cyc_Splay_node*)_T2F;}_T2E->v= _T1B;_T1A= (struct Cyc_Splay_noderef*)_T2E;}_T2D->f1= _T1A;_T19= (struct Cyc_Splay_Node_Splay_tree_struct*)_T2D;}newright= (void*)_T19;goto _TL9;
# 81
_TL8:{struct Cyc_Splay_Node_Splay_tree_struct*_T2D=_cycalloc(sizeof(struct Cyc_Splay_Node_Splay_tree_struct));_T2D->tag= 1;{struct Cyc_Splay_noderef*_T2E=_cycalloc(sizeof(struct Cyc_Splay_noderef));{struct Cyc_Splay_node*_T2F=_cycalloc(sizeof(struct Cyc_Splay_node));_T22= n;_T2F->key= _T22->key;_T23= n;_T2F->data= _T23->data;_T24= n;_T2F->left= _T24->left;_T2F->right= leaf;_T21= (struct Cyc_Splay_node*)_T2F;}_T2E->v= _T21;_T20= (struct Cyc_Splay_noderef*)_T2E;}_T2D->f1= _T20;_T1F= (struct Cyc_Splay_Node_Splay_tree_struct*)_T2D;}newleft= (void*)_T1F;_T25= n;
...
# 89
_T2B->reln= _T27->reln;{struct Cyc_Splay_Node_Splay_tree_struct*_T2C=_cycalloc(sizeof(struct Cyc_Splay_Node_Splay_tree_struct));_T2C->tag= 1;{struct Cyc_Splay_noderef*_T2D=_cycalloc(sizeof(struct Cyc_Splay_noderef));{struct Cyc_Splay_node*_T2E=_cycalloc(sizeof(struct Cyc_Splay_node));_T2E->key= key;_T2E->data= data;_T2E->left= newleft;_T2E->right= newright;_T2A= (struct Cyc_Splay_node*)_T2E;}_T2D->v= _T2A;_T29= (struct Cyc_Splay_noderef*)_T2D;}_T2C->f1= _T29;_T28= (struct Cyc_Splay_Node_Splay_tree_struct*)_T2C;}_T2B->tree= (void*)_T28;_T26= (struct Cyc_SlowDict_Dict*)_T2B;}return _T26;}}
# 92
struct Cyc_SlowDict_Dict*Cyc_SlowDict_insert_new(struct Cyc_SlowDict_Dict*d,void*key,void*data){struct Cyc_SlowDict_Dict*_T0;int(*_T1)(void*,void*);void*_T2;struct Cyc_SlowDict_Dict*_T3;void*_T4;long _T5;struct Cyc_SlowDict_Present_exn_struct*_T6;struct Cyc_SlowDict_Present_exn_struct*_T7;struct Cyc_SlowDict_Dict*_T8;_T0= d;_T1= _T0->reln;_T2= key;_T3= d;_T4= _T3->tree;_T5= 
# 94
...
# 116
({__typeof__(_tag_fat("Dict::lookup",sizeof(char),13U))_T13=_tag_fat("Dict::lookup",sizeof(char),13U);_T12->f1= _T13;});_TC= (struct Cyc_Core_Impossible_exn_struct*)_T12;}_TD= (void*)_TC;_throw(_TD);;}goto _TL11;_TL10: _TL11: _TE= & Cyc_SlowDict_Absent_val;_TF= (struct Cyc_SlowDict_Absent_exn_struct*)_TE;_throw(_TF);}
# 121
...
# 127
({__typeof__(_tag_fat("Dict::lookup",sizeof(char),13U))_T11=_tag_fat("Dict::lookup",sizeof(char),13U);_T10->f1= _T11;});_TC= (struct Cyc_Core_Impossible_exn_struct*)_T10;}_TD= (void*)_TC;_throw(_TD);;}goto _TL15;_TL14: _TL15:
# 129
 return 0;}
# 132
...
# 138
({__typeof__(_tag_fat("Dict::lookup",sizeof(char),13U))_T29=_tag_fat("Dict::lookup",sizeof(char),13U);_T28->f1= _T29;});_T9= (struct Cyc_Core_Impossible_exn_struct*)_T28;}_TA= (void*)_T9;_throw(_TA);goto _TL1B;_TL1A:{struct Cyc_Splay_Node_Splay_tree_struct*_T28=(struct Cyc_Splay_Node_Splay_tree_struct*)_T26;_T27= _T28->f1;}{struct Cyc_Splay_noderef*nr=_T27;_TB= nr;{
# 140
...
_T2C->reln= _T1D->reln;{struct Cyc_Splay_Node_Splay_tree_struct*_T2D=_cycalloc(sizeof(struct Cyc_Splay_Node_Splay_tree_struct));_T2D->tag= 1;{struct Cyc_Splay_noderef*_T2E=_cycalloc(sizeof(struct Cyc_Splay_noderef));{struct Cyc_Splay_node*_T2F=_cycalloc(sizeof(struct Cyc_Splay_node));_T21= newtop;_T2F->key= _T21->key;_T22= newtop;_T2F->data= _T22->data;_T23= newtop;
_T2F->left= _T23->left;_T24= n;_T2F->right= _T24->right;_T20= (struct Cyc_Splay_node*)_T2F;}
# 151
_T2E->v= _T20;_T1F= (struct Cyc_Splay_noderef*)_T2E;}_T2D->f1= _T1F;_T1E= (struct Cyc_Splay_Node_Splay_tree_struct*)_T2D;}_T2C->tree= (void*)_T1E;_T1C= (struct Cyc_SlowDict_Dict*)_T2C;}return _T1C;}};}};}}}_TL1B:;}goto _TL19;
# 157
...
Cyc_SlowDict_fold_tree(_TD,_TF,_T10);_T12= Cyc_SlowDict_fold_tree(_TA,_TC,_T11);_T13= f(_T7,_T9,_T12);return _T13;}};}
# 176
void*Cyc_SlowDict_fold(void*(*f)(void*,void*,void*),struct Cyc_SlowDict_Dict*d,void*accum){void*(*_T0)(void*,void*,void*);struct Cyc_SlowDict_Dict*_T1;void*_T2;void*_T3;void*_T4;_T0= f;_T1= d;_T2= _T1->tree;_T3= accum;_T4= Cyc_SlowDict_fold_tree(_T0,_T2,_T3);return _T4;}
# 178
...
# 204
void Cyc_SlowDict_app(void*(*f)(void*,void*),struct Cyc_SlowDict_Dict*d){void*(*_T0)(void*,void*);struct Cyc_SlowDict_Dict*_T1;void*_T2;_T0= f;_T1= d;_T2= _T1->tree;Cyc_SlowDict_app_tree(_T0,_T2);}
# 206
...
# 218
void Cyc_SlowDict_iter(void(*f)(void*,void*),struct Cyc_SlowDict_Dict*d){void(*_T0)(void*,void*);struct Cyc_SlowDict_Dict*_T1;void*_T2;_T0= f;_T1= d;_T2= _T1->tree;Cyc_SlowDict_iter_tree(_T0,_T2);}
# 220
...
# 232
void Cyc_SlowDict_app_c(void*(*f)(void*,void*,void*),void*env,struct Cyc_SlowDict_Dict*d){void*(*_T0)(void*,void*,void*);void*_T1;struct Cyc_SlowDict_Dict*_T2;void*_T3;_T0= f;_T1= env;_T2= d;_T3= _T2->tree;Cyc_SlowDict_app_tree_c(_T0,_T1,_T3);}
# 234
...
# 246
void Cyc_SlowDict_iter_c(void(*f)(void*,void*,void*),void*env,struct Cyc_SlowDict_Dict*d){void(*_T0)(void*,void*,void*);void*_T1;struct Cyc_SlowDict_Dict*_T2;void*_T3;_T0= f;_T1= env;_T2= d;_T3= _T2->tree;Cyc_SlowDict_iter_tree_c(_T0,_T1,_T3);}
# 248
...
# 255
_T17->key= _TA->key;_TB= n;_TC= _TB->data;({__typeof__(f(_TC))_T18=f(_TC);_T17->data= _T18;});_TD= f;_TE= n;_TF= _TE->left;({__typeof__(Cyc_SlowDict_map_tree(_TD,_TF))_T18=Cyc_SlowDict_map_tree(_TD,_TF);_T17->left= _T18;});_T10= f;_T11= n;_T12= _T11->right;({__typeof__(Cyc_SlowDict_map_tree(_T10,_T12))_T18=Cyc_SlowDict_map_tree(_T10,_T12);_T17->right= _T18;});_T9= (struct Cyc_Splay_node*)_T17;}_T16->v= _T9;_T8= (struct Cyc_Splay_noderef*)_T16;}_T15->f1= _T8;_T7= (struct Cyc_Splay_Node_Splay_tree_struct*)_T15;}_T13= (void*)_T7;
# 254
return _T13;}};}
# 258
struct Cyc_SlowDict_Dict*Cyc_SlowDict_map(void*(*f)(void*),struct Cyc_SlowDict_Dict*d){struct Cyc_SlowDict_Dict*_T0;struct Cyc_SlowDict_Dict*_T1;void*(*_T2)(void*);struct Cyc_SlowDict_Dict*_T3;void*_T4;{struct Cyc_SlowDict_Dict*_T5=_cycalloc(sizeof(struct Cyc_SlowDict_Dict));_T1= d;_T5->reln= _T1->reln;_T2= f;_T3= d;_T4= _T3->tree;({__typeof__(Cyc_SlowDict_map_tree(_T2,_T4))_T6=Cyc_SlowDict_map_tree(_T2,_T4);_T5->tree= _T6;});_T0= (struct Cyc_SlowDict_Dict*)_T5;}return _T0;}
# 260
...
_T1A->key= _TA->key;_TB= env;_TC= n;_TD= _TC->data;({__typeof__(f(_TB,_TD))_T1B=f(_TB,_TD);_T1A->data= _T1B;});_TE= f;_TF= env;_T10= n;_T11= _T10->left;({__typeof__(Cyc_SlowDict_map_tree_c(_TE,_TF,_T11))_T1B=Cyc_SlowDict_map_tree_c(_TE,_TF,_T11);_T1A->left= _T1B;});_T12= f;_T13= env;_T14= n;_T15= _T14->right;
({__typeof__(Cyc_SlowDict_map_tree_c(_T12,_T13,_T15))_T1B=Cyc_SlowDict_map_tree_c(_T12,_T13,_T15);_T1A->right= _T1B;});_T9= (struct Cyc_Splay_node*)_T1A;}
# 266
...
_T6->reln= _T1->reln;_T2= f;_T3= env;_T4= d;_T5= _T4->tree;({__typeof__(Cyc_SlowDict_map_tree_c(_T2,_T3,_T5))_T7=Cyc_SlowDict_map_tree_c(_T2,_T3,_T5);_T6->tree= _T7;});_T0= (struct Cyc_SlowDict_Dict*)_T6;}return _T0;}
# 274
...
# 287
struct Cyc_List_List*Cyc_SlowDict_to_list(struct Cyc_SlowDict_Dict*d){struct Cyc_List_List*(*_T0)(struct Cyc_List_List*(*)(void*,void*,struct Cyc_List_List*),struct Cyc_SlowDict_Dict*,struct Cyc_List_List*);struct Cyc_SlowDict_Dict*_T1;struct Cyc_List_List*_T2;{struct Cyc_List_List*(*_T3)(struct Cyc_List_List*(*)(void*,void*,struct Cyc_List_List*),struct Cyc_SlowDict_Dict*,struct Cyc_List_List*)=(struct Cyc_List_List*(*)(struct Cyc_List_List*(*)(void*,void*,struct Cyc_List_List*),struct Cyc_SlowDict_Dict*,struct Cyc_List_List*))Cyc_SlowDict_fold;_T0= _T3;}_T1= d;_T2= _T0(Cyc_SlowDict_to_list_f,_T1,0);return _T2;}
