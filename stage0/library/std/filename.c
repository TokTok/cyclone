...
# 34 "cyclone/library/std/filename.cyc"
...
# 38
struct _fat_ptr Cyc_Filename_chop_extension(struct _fat_ptr filename){struct _fat_ptr _T0;unsigned _T1;unsigned _T2;struct _fat_ptr _T3;unsigned char*_T4;const char*_T5;const char*_T6;int _T7;char _T8;int _T9;struct Cyc_Core_Invalid_argument_exn_struct*_TA;void*_TB;struct _fat_ptr _TC;int _TD;unsigned long _TE;struct _fat_ptr _TF;_T0= filename;_T1= 
_get_fat_size(_T0,sizeof(char));_T2= _T1 - 1U;{int i=(int)_T2;
_TL0: if(i >= 0)goto _TL3;else{goto _TL2;}_TL3: _T3= filename;_T4= _T3.curr;_T5= (const char*)_T4;_T6= _check_null(_T5);_T7= i;_T8= _T6[_T7];_T9= (int)_T8;if(_T9!=46)goto _TL1;else{goto _TL2;}
_TL1: i= i + -1;goto _TL0;_TL2:
 if(i >= 0)goto _TL4;{struct Cyc_Core_Invalid_argument_exn_struct*_T10=_cycalloc(sizeof(struct Cyc_Core_Invalid_argument_exn_struct));_T10->tag= Cyc_Core_Invalid_argument;
({__typeof__(_tag_fat("chop_extension",sizeof(char),15U))_T11=_tag_fat("chop_extension",sizeof(char),15U);_T10->f1= _T11;});_TA= (struct Cyc_Core_Invalid_argument_exn_struct*)_T10;}_TB= (void*)_TA;_throw(_TB);goto _TL5;_TL4: _TL5: _TC= filename;_TD= i;_TE= (unsigned long)_TD;_TF= 
Cyc_substring(_TC,0,_TE);return _TF;}}
# 49
struct _fat_ptr Cyc_Filename_dirname(struct _fat_ptr filename){struct _fat_ptr _T0;unsigned _T1;unsigned _T2;struct _fat_ptr _T3;unsigned char*_T4;const char*_T5;const char*_T6;int _T7;char _T8;int _T9;struct _fat_ptr _TA;struct _fat_ptr _TB;int _TC;unsigned long _TD;struct _fat_ptr _TE;_T0= filename;_T1= 
_get_fat_size(_T0,sizeof(char));_T2= _T1 - 1U;{int i=(int)_T2;
_TL6: if(i >= 0)goto _TL9;else{goto _TL8;}_TL9: _T3= filename;_T4= _T3.curr;_T5= (const char*)_T4;_T6= _check_null(_T5);_T7= i;_T8= _T6[_T7];_T9= (int)_T8;if(_T9!=47)goto _TL7;else{goto _TL8;}
_TL7: i= i + -1;goto _TL6;_TL8:
 if(i >= 0)goto _TLA;_TA= 
Cyc_Core_new_string(0U);return _TA;_TLA: _TB= filename;_TC= i;_TD= (unsigned long)_TC;_TE= 
# 56
Cyc_substring(_TB,0,_TD);return _TE;}}
# 60
struct _fat_ptr Cyc_Filename_basename(struct _fat_ptr filename){struct _fat_ptr _T0;unsigned _T1;unsigned _T2;struct _fat_ptr _T3;unsigned char*_T4;const char*_T5;const char*_T6;int _T7;char _T8;int _T9;struct _fat_ptr _TA;int _TB;struct _fat_ptr _TC;unsigned _TD;int _TE;unsigned _TF;unsigned _T10;struct _fat_ptr _T11;_T0= filename;_T1= 
_get_fat_size(_T0,sizeof(char));_T2= _T1 - 1U;{int i=(int)_T2;
_TLC: if(i >= 0)goto _TLF;else{goto _TLE;}_TLF: _T3= filename;_T4= _T3.curr;_T5= (const char*)_T4;_T6= _check_null(_T5);_T7= i;_T8= _T6[_T7];_T9= (int)_T8;if(_T9!=47)goto _TLD;else{goto _TLE;}
_TLD: i= i + -1;goto _TLC;_TLE: _TA= filename;_TB= i + 1;_TC= filename;_TD= 
_get_fat_size(_TC,sizeof(char));_TE= i + 1;_TF= (unsigned)_TE;_T10= _TD - _TF;_T11= Cyc_substring(_TA,_TB,_T10);return _T11;}}
# 67
long Cyc_Filename_check_suffix(struct _fat_ptr filename,struct _fat_ptr suffix){struct _fat_ptr _T0;unsigned _T1;unsigned _T2;struct _fat_ptr _T3;unsigned _T4;unsigned _T5;struct _fat_ptr _T6;unsigned char*_T7;const char*_T8;const char*_T9;int _TA;int _TB;char _TC;int _TD;struct _fat_ptr _TE;unsigned char*_TF;const char*_T10;const char*_T11;int _T12;int _T13;char _T14;int _T15;_T0= filename;_T1= 
...
_TL11: _T6= filename;_T7= _T6.curr;_T8= (const char*)_T7;_T9= _check_null(_T8);_TA= i;i= _TA + -1;_TB= _TA;_TC= _T9[_TB];_TD= (int)_TC;_TE= suffix;_TF= _TE.curr;_T10= (const char*)_TF;_T11= _check_null(_T10);_T12= j;j= _T12 + -1;_T13= _T12;_T14= _T11[_T13];_T15= (int)_T14;if(_TD==_T15)goto _TL14;
return 0;_TL14: goto _TL10;_TL12:
 if(j < 0)goto _TL16;
return 0;_TL16:
 return 1;}}}
# 78
struct _fat_ptr Cyc_Filename_gnuify(struct _fat_ptr filename){int _T0;struct _fat_ptr _T1;unsigned _T2;struct _fat_ptr _T3;unsigned char*_T4;const char*_T5;const char*_T6;char _T7;int _T8;long _T9;struct _fat_ptr _TA;unsigned _TB;unsigned _TC;struct _fat_ptr _TD;int _TE;unsigned _TF;char*_T10;unsigned _T11;unsigned _T12;struct _fat_ptr _T13;unsigned char*_T14;char*_T15;char _T16;struct _fat_ptr _T17;unsigned char*_T18;char*_T19;unsigned _T1A;unsigned char*_T1B;char*_T1C;unsigned _T1D;unsigned char*_T1E;char*_T1F;struct _fat_ptr _T20;unsigned char*_T21;char*_T22;struct _fat_ptr _T23;unsigned char*_T24;const char*_T25;const char*_T26;unsigned _T27;unsigned char*_T28;char*_T29;struct _fat_ptr _T2A;unsigned _T2B;struct _fat_ptr _T2C;int _T2D;unsigned _T2E;char*_T2F;unsigned _T30;unsigned _T31;struct _fat_ptr _T32;int _T33;int _T34;unsigned char*_T35;const char*_T36;struct _fat_ptr _T37;int _T38;int _T39;unsigned char*_T3A;char*_T3B;char _T3C;char _T3D;int _T3E;unsigned _T3F;unsigned char*_T40;char*_T41;struct _fat_ptr _T42;_T1= filename;_T2= 
_get_fat_size(_T1,sizeof(char));if(_T2 <= 1U)goto _TL18;_T3= filename;_T4= _T3.curr;_T5= (const char*)_T4;_T6= _check_null(_T5);_T7= _T6[1];_T8= (int)_T7;_T0= _T8==58;goto _TL19;_TL18: _T0= 0;_TL19: {long has_drive_name=_T0;
int i;int j;
struct _fat_ptr ans;
