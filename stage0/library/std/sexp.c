...
# 179
extern struct Cyc_List_List*Cyc_List_imp_rev(struct Cyc_List_List*);struct Cyc_Hashtable_Table;
...
# 107 "cyclone/library/std/sexp.h"
...
# 51
extern int Cyc_strcmp(struct _fat_ptr,struct _fat_ptr);struct Cyc_Xarray_Xarray{struct _fat_ptr elmts;int num_elmts;};
# 54 "cyclone/library/std/xarray.h"
extern struct Cyc_Xarray_Xarray*Cyc_Xarray_create_empty (void);
# 66
extern void Cyc_Xarray_add(struct Cyc_Xarray_Xarray*,void*);
# 104
extern void Cyc_Xarray_iter_c(void(*)(void*,void*),void*,struct Cyc_Xarray_Xarray*);
# 55 "cyclone/library/std/sexp.cyc"
...
# 77
if(_T3!=_T5)goto _TL0;
return 0;_TL0: _T6= xself;_T7= _T6->vtable;_T8= (int)_T7;_T9= yself;_TA= _T9->vtable;_TB= (int)_TA;{
# 80
int diff=_T8 - _TB;
if(diff==0)goto _TL2;_TC= diff;
return _TC;_TL2: _TD= xself;_TE= _TD->vtable;_TF= y;{
# 84
...
if(fopt!=0)goto _TL4;{struct Cyc_String_pa_PrintArg_struct _TA;_TA.tag= 0;{const char*_TB=filename;_T2= (void*)_TB;_T3= (void*)_TB;_T4= _get_zero_arr_size_char(_T3,1U);_T1= _tag_fat(_T2,sizeof(char),_T4);}
_TA.f1= _T1;_T0= _TA;}{struct Cyc_String_pa_PrintArg_struct _TA=_T0;void*_TB[1];_TB[0]= & _TA;_T5= Cyc_stderr;_T6= _tag_fat("unable to open file %s\n",sizeof(char),24U);_T7= _tag_fat(_TB,sizeof(void*),1);Cyc_fprintf(_T5,_T6,_T7);}goto _TL5;_TL4: _TL5: _T8= 
...
_TL9: _T0= s;_T1= *_T0;_T2= (int)_T1;if(_T2!=0)goto _TL7;else{goto _TL8;}
_TL7: _T3= c;_T4= c;_T5= *_T4;*_T3= _T5 + 1;{const char**_T8=& s;_T6= *_T8;_T7= *_T6;if(_T7==0)goto _TLA;*_T8= *_T8 + 1;goto _TLB;_TLA: _throw_arraybounds();_TLB:;}goto _TL9;_TL8:;}
# 134
...
({__typeof__(_fat_ptr_plus(_TC,sizeof(char),1))_TF=_fat_ptr_plus(_TC,sizeof(char),1);*_TA= _TF;});{const char**_TF=& s;_TD= *_TF;_TE= *_TD;if(_TE==0)goto _TL12;*_TF= *_TF + 1;goto _TL13;_TL12: _throw_arraybounds();_TL13:;}goto _TLF;_TLE:;}
# 142
...
return _T4;}}
# 177
static void Cyc_Sexp_pungetc(struct Cyc_Sexp_Parser*p,int ch){struct Cyc_Sexp_Parser*_T0;int(*_T1)(int,void*);int _T2;struct Cyc_Sexp_Parser*_T3;void*_T4;_T0= p;_T1= _T0->ungetc;_T2= ch;_T3= p;_T4= _T3->env;_T1(_T2,_T4);}
# 180
...
_T1(_T3,_T4,_T5);}
# 186
static long Cyc_Sexp_whitespace(int ch){int _T0;if(ch==32)goto _TL16;else{goto _TL18;}_TL18: if(ch==9)goto _TL16;else{goto _TL17;}_TL17: if(ch==10)goto _TL16;else{goto _TL14;}_TL16: _T0= 1;goto _TL15;_TL14: _T0= ch==13;_TL15: return _T0;}
# 189
static void Cyc_Sexp_expectws(struct Cyc_Sexp_Parser*p,int expected_ch){long _T0;struct Cyc_Sexp_Parser*_T1;int _T2;struct _fat_ptr _T3;struct Cyc_Int_pa_PrintArg_struct _T4;int _T5;struct _fat_ptr _T6;struct _fat_ptr _T7;
int ch=Cyc_Sexp_pgetc(p);
_TL19: _T0= Cyc_Sexp_whitespace(ch);if(_T0)goto _TL1A;else{goto _TL1B;}
_TL1A: ch= Cyc_Sexp_pgetc(p);goto _TL19;_TL1B:
 if(ch==expected_ch)goto _TL1C;_T1= p;_T2= ch;{struct Cyc_Int_pa_PrintArg_struct _T8;_T8.tag= 1;_T5= expected_ch;
_T8.f1= (unsigned long)_T5;_T4= _T8;}{struct Cyc_Int_pa_PrintArg_struct _T8=_T4;void*_T9[1];_T9[0]= & _T8;_T6= _tag_fat("expected '%c'",sizeof(char),14U);_T7= _tag_fat(_T9,sizeof(void*),1);_T3= Cyc_aprintf(_T6,_T7);}Cyc_Sexp_perror(_T1,_T2,_T3);goto _TL1D;_TL1C: _TL1D:;}
# 198
...
int ch=Cyc_Sexp_pgetc(p);
if(ch==expected_ch)goto _TL1E;_T0= p;_T1= ch;{struct Cyc_Int_pa_PrintArg_struct _T7;_T7.tag= 1;_T4= expected_ch;
_T7.f1= (unsigned long)_T4;_T3= _T7;}{struct Cyc_Int_pa_PrintArg_struct _T7=_T3;void*_T8[1];_T8[0]= & _T7;_T5= _tag_fat("expected '%c'",sizeof(char),14U);_T6= _tag_fat(_T8,sizeof(void*),1);_T2= Cyc_aprintf(_T5,_T6);}Cyc_Sexp_perror(_T0,_T1,_T2);goto _TL1F;_TL1E: _TL1F:;}
# 207
struct Cyc_Sexp_Object Cyc_Sexp_parse(struct Cyc_Sexp_Parser*p){long _T0;struct Cyc_List_List*_T1;void*_T2;int _T3;struct Cyc_Sexp_Class*_T4;char _T5;int _T6;struct Cyc_Sexp_Class*_T7;struct Cyc_Sexp_Obj*(*_T8)(struct Cyc_Sexp_Parser*);struct Cyc_Sexp_Object _T9;struct Cyc_List_List*_TA;struct Cyc_Sexp_Parser*_TB;void(*_TC)(void*,int,struct _fat_ptr);struct Cyc_Sexp_Parser*_TD;void*_TE;int _TF;struct _fat_ptr _T10;
int ch=Cyc_Sexp_pgetc(p);
_TL20: _T0= Cyc_Sexp_whitespace(ch);if(_T0)goto _TL21;else{goto _TL22;}
_TL21: ch= Cyc_Sexp_pgetc(p);goto _TL20;_TL22:{
...
({__typeof__(_tag_fat("Sexp::file2object error",sizeof(char),24U))_T9=_tag_fat("Sexp::file2object error",sizeof(char),24U);_T8->f1= _T9;});_T6= (struct Cyc_Core_Failure_exn_struct*)_T8;}_T7= (void*)_T6;_throw(_T7);}
# 233
...
# 235
_T6.env= f;_T6.getc= Cyc_getc;_T6.ungetc= Cyc_ungetc;_T6.error= Cyc_Sexp_file_error;_T0= _T6;}{
# 234
...
if(fopt!=0)goto _TL2E;{struct Cyc_Core_Failure_exn_struct*_T3=_cycalloc(sizeof(struct Cyc_Core_Failure_exn_struct));_T3->tag= Cyc_Core_Failure;
({__typeof__(_tag_fat("file not found",sizeof(char),15U))_T4=_tag_fat("file not found",sizeof(char),15U);_T3->f1= _T4;});_T0= (struct Cyc_Core_Failure_exn_struct*)_T3;}_T1= (void*)_T0;_throw(_T1);goto _TL2F;_TL2E: _TL2F: {
...
if(_T1 < _T3)goto _TL30;_T4= - 1;
return _T4;_TL30: _T5= env;_T6= _T5->str;_T7= env;_T8= _T7->offset;_T9= (int)_T8;_TA= _check_fat_subscript(_T6,sizeof(char),_T9);_TB= (const char*)_TA;_TC= *_TB;{
...
if(_T0!=_T1)goto _TL32;_T2= - 1;
return _T2;_TL32: _T3= env;
...
({__typeof__(_tag_fat("Sexp::string2object error",sizeof(char),26U))_T9=_tag_fat("Sexp::string2object error",sizeof(char),26U);_T8->f1= _T9;});_T6= (struct Cyc_Core_Failure_exn_struct*)_T8;}_T7= (void*)_T6;_throw(_T7);}
# 290
...
# 292
_T6.str= str;({__typeof__(Cyc_strlen(str))_T7=Cyc_strlen(str);_T6.length= _T7;});_T6.offset= 0U;_T0= _T6;}{
# 291
struct Cyc_Sexp_StringEnv env=_T0;{struct Cyc_Sexp_Parser _T6;_T2= & env;
# 295
...
if(_T1 <= _T3)goto _TL5C;
return 1;
_TL5C: _T4= x;_T5= _T4->v;_T6= y;_T7= _T6->v;if(_T5 >= _T7)goto _TL5E;_T8= - 1;
return _T8;
# 392
_TL5E: return 0;}
# 395
...
if(_T1 <= _T3)goto _TL60;
return 1;
_TL60: _T4= x;_T5= _T4->v;_T6= y;_T7= _T6->v;if(_T5 >= _T7)goto _TL62;_T8= - 1;
return _T8;
# 401
_TL62: return 0;}
# 405
...
# 420
static struct _tuple4*Cyc_Sexp_parse_uint(struct Cyc_Sexp_Parser*p){unsigned _T0;struct _tuple4*_T1;_T0= Cyc_Sexp_parse_int(p);_T1= Cyc_Sexp_mk_uint(_T0);return _T1;}
# 422
...
# 427
static struct _tuple5*Cyc_Sexp_parse_sint(struct Cyc_Sexp_Parser*p){unsigned _T0;int _T1;struct _tuple5*_T2;_T0= Cyc_Sexp_parse_int(p);_T1= (int)_T0;_T2= Cyc_Sexp_mk_sint(_T1);return _T2;}
# 430
...
({__typeof__(Cyc_Sexp_nibble(3U,_T8))_T15=Cyc_Sexp_nibble(3U,_T8);_T14.f1= _T15;});_T6= _T14;}{struct Cyc_Int_pa_PrintArg_struct _T14=_T6;{struct Cyc_Int_pa_PrintArg_struct _T15;_T15.tag= 1;_TA= x;_TB= (unsigned)_TA;({__typeof__(Cyc_Sexp_nibble(2U,_TB))_T16=Cyc_Sexp_nibble(2U,_TB);_T15.f1= _T16;});_T9= _T15;}{struct Cyc_Int_pa_PrintArg_struct _T15=_T9;{struct Cyc_Int_pa_PrintArg_struct _T16;_T16.tag= 1;_TD= x;_TE= (unsigned)_TD;({__typeof__(Cyc_Sexp_nibble(1U,_TE))_T17=Cyc_Sexp_nibble(1U,_TE);_T16.f1= _T17;});_TC= _T16;}{struct Cyc_Int_pa_PrintArg_struct _T16=_TC;{struct Cyc_Int_pa_PrintArg_struct _T17;_T17.tag= 1;_T10= x;_T11= (unsigned)_T10;({__typeof__(Cyc_Sexp_nibble(0U,_T11))_T18=Cyc_Sexp_nibble(0U,_T11);_T17.f1= _T18;});_TF= _T17;}{struct Cyc_Int_pa_PrintArg_struct _T17=_TF;void*_T18[4];_T18[0]= & _T14;_T18[1]= & _T15;_T18[2]= & _T16;_T18[3]= & _T17;_T12= _tag_fat("%x%x%x%x",sizeof(char),9U);_T13= _tag_fat(_T18,sizeof(void*),4);_T5= Cyc_aprintf(_T12,_T13);}}}}_T2(_T4,_T5);}}
# 446
static struct _tuple2*Cyc_Sexp_parse_ushort(struct Cyc_Sexp_Parser*p){unsigned short _T0;struct _tuple2*_T1;_T0= Cyc_Sexp_parse_short(p);_T1= Cyc_Sexp_mk_ushort(_T0);return _T1;}
# 448
...
({__typeof__(Cyc_Sexp_nibble(3U,_T8))_T15=Cyc_Sexp_nibble(3U,_T8);_T14.f1= _T15;});_T6= _T14;}{struct Cyc_Int_pa_PrintArg_struct _T14=_T6;{struct Cyc_Int_pa_PrintArg_struct _T15;_T15.tag= 1;_TA= x;_TB= (unsigned)_TA;({__typeof__(Cyc_Sexp_nibble(2U,_TB))_T16=Cyc_Sexp_nibble(2U,_TB);_T15.f1= _T16;});_T9= _T15;}{struct Cyc_Int_pa_PrintArg_struct _T15=_T9;{struct Cyc_Int_pa_PrintArg_struct _T16;_T16.tag= 1;_TD= x;_TE= (unsigned)_TD;({__typeof__(Cyc_Sexp_nibble(1U,_TE))_T17=Cyc_Sexp_nibble(1U,_TE);_T16.f1= _T17;});_TC= _T16;}{struct Cyc_Int_pa_PrintArg_struct _T16=_TC;{struct Cyc_Int_pa_PrintArg_struct _T17;_T17.tag= 1;_T10= x;_T11= (unsigned)_T10;({__typeof__(Cyc_Sexp_nibble(0U,_T11))_T18=Cyc_Sexp_nibble(0U,_T11);_T17.f1= _T18;});_TF= _T17;}{struct Cyc_Int_pa_PrintArg_struct _T17=_TF;void*_T18[4];_T18[0]= & _T14;_T18[1]= & _T15;_T18[2]= & _T16;_T18[3]= & _T17;_T12= _tag_fat("%x%x%x%x",sizeof(char),9U);_T13= _tag_fat(_T18,sizeof(void*),4);_T5= Cyc_aprintf(_T12,_T13);}}}}_T2(_T4,_T5);}}
# 453
static struct _tuple3*Cyc_Sexp_parse_sshort(struct Cyc_Sexp_Parser*p){unsigned short _T0;short _T1;struct _tuple3*_T2;_T0= Cyc_Sexp_parse_short(p);_T1= (short)_T0;_T2= Cyc_Sexp_mk_sshort(_T1);return _T2;}
# 456
...
({__typeof__(Cyc_Sexp_nibble(1U,_T8))_TF=Cyc_Sexp_nibble(1U,_T8);_TE.f1= _TF;});_T6= _TE;}{struct Cyc_Int_pa_PrintArg_struct _TE=_T6;{struct Cyc_Int_pa_PrintArg_struct _TF;_TF.tag= 1;_TA= x;_TB= (unsigned)_TA;({__typeof__(Cyc_Sexp_nibble(0U,_TB))_T10=Cyc_Sexp_nibble(0U,_TB);_TF.f1= _T10;});_T9= _TF;}{struct Cyc_Int_pa_PrintArg_struct _TF=_T9;void*_T10[2];_T10[0]= & _TE;_T10[1]= & _TF;_TC= _tag_fat("%x%x",sizeof(char),5U);_TD= _tag_fat(_T10,sizeof(void*),2);_T5= Cyc_aprintf(_TC,_TD);}}_T2(_T4,_T5);}}
# 471
static struct _tuple0*Cyc_Sexp_parse_uchar(struct Cyc_Sexp_Parser*p){unsigned char _T0;struct _tuple0*_T1;_T0= Cyc_Sexp_parse_char(p);_T1= Cyc_Sexp_mk_uchar(_T0);return _T1;}
# 473
...
({__typeof__(Cyc_Sexp_nibble(1U,_T8))_TF=Cyc_Sexp_nibble(1U,_T8);_TE.f1= _TF;});_T6= _TE;}{struct Cyc_Int_pa_PrintArg_struct _TE=_T6;{struct Cyc_Int_pa_PrintArg_struct _TF;_TF.tag= 1;_TA= x;_TB= (unsigned)_TA;({__typeof__(Cyc_Sexp_nibble(0U,_TB))_T10=Cyc_Sexp_nibble(0U,_TB);_TF.f1= _T10;});_T9= _TF;}{struct Cyc_Int_pa_PrintArg_struct _TF=_T9;void*_T10[2];_T10[0]= & _TE;_T10[1]= & _TF;_TC= _tag_fat("%x%x",sizeof(char),5U);_TD= _tag_fat(_T10,sizeof(void*),2);_T5= Cyc_aprintf(_TC,_TD);}}_T2(_T4,_T5);}}
# 478
static struct _tuple1*Cyc_Sexp_parse_schar(struct Cyc_Sexp_Parser*p){unsigned char _T0;signed char _T1;struct _tuple1*_T2;_T0= Cyc_Sexp_parse_char(p);_T1= (signed char)_T0;_T2= Cyc_Sexp_mk_schar(_T1);return _T2;}union Cyc_Sexp_IntFloat{unsigned i;float f;};
# 486
...
_T3.i= i;_T0= _T3;}{union Cyc_Sexp_IntFloat u=_T0;_T1= u;_T2= _T1.f;
return _T2;}}
# 490
...
_T3.f= f;_T0= _T3;}{union Cyc_Sexp_IntFloat u=_T0;_T1= u;_T2= _T1.i;
return _T2;}}union Cyc_Sexp_DoubleLongLong{unsigned long long x;double d;};
# 498
...
_T3.x= x;_T0= _T3;}{union Cyc_Sexp_DoubleLongLong u=_T0;_T1= u;_T2= _T1.d;
return _T2;}}
# 502
...
_T3.d= d;_T0= _T3;}{union Cyc_Sexp_DoubleLongLong u=_T0;_T1= u;_T2= _T1.x;
return _T2;}}
# 508
...
({__typeof__(Cyc_Sexp_float2int(x))_TA=Cyc_Sexp_float2int(x);_T9.f1= _TA;});_T6= _T9;}{struct Cyc_Int_pa_PrintArg_struct _T9=_T6;void*_TA[1];_TA[0]= & _T9;_T7= _tag_fat("%08x",sizeof(char),5U);_T8= _tag_fat(_TA,sizeof(void*),1);_T5= Cyc_aprintf(_T7,_T8);}_T2(_T4,_T5);}}
# 515
static struct _tuple8*Cyc_Sexp_parse_float(struct Cyc_Sexp_Parser*p){unsigned _T0;float _T1;struct _tuple8*_T2;_T0= Cyc_Sexp_parse_int(p);_T1= Cyc_Sexp_int2float(_T0);_T2= Cyc_Sexp_mk_float(_T1);return _T2;}
# 517
...
if(_T5 >= 0.0)goto _TL70;_T6= - 1;
return _T6;
_TL70: _T7= diff;_T8= (double)_T7;if(_T8 <= 0.0)goto _TL72;
return 1;
# 524
_TL72: return 0;}}
# 528
static int Cyc_Sexp_hash_double(struct _tuple9*self){struct _tuple9*_T0;double _T1;unsigned long long _T2;unsigned _T3;int _T4;_T0= self;_T1= _T0->v;_T2= Cyc_Sexp_double2longlong(_T1);_T3= (unsigned)_T2;_T4= (int)_T3;return _T4;}
# 530
...
double diff=_T1 - _T3;
if(diff >= 0.0)goto _TL74;_T4= - 1;
return _T4;
_TL74: if(diff <= 0.0)goto _TL76;
return 1;
# 548
_TL76: return 0;}}
# 552
static int Cyc_Sexp_hash_str(struct _tuple10*self){struct _tuple10*_T0;struct _fat_ptr _T1;int _T2;_T0= self;_T1= _T0->v;_T2= Cyc_Hashtable_hash_string(_T1);return _T2;}
# 554
static int Cyc_Sexp_hash_symbol(struct _tuple10*self){struct _tuple10*_T0;struct _fat_ptr _T1;int _T2;_T0= self;_T1= _T0->v;_T2= Cyc_Hashtable_hash_string(_T1);return _T2;}
# 556
...
_T1(_T3,_T5);}
# 562
static struct _tuple10*Cyc_Sexp_parse_symbol(struct Cyc_Sexp_Parser*p){long _T0;int _T1;int _T2;struct Cyc_Sexp_Parser*_T3;int _T4;struct _fat_ptr _T5;long _T6;struct Cyc_List_List*_T7;int _T8;struct _fat_ptr _T9;int _TA;void*_TB;struct _fat_ptr _TC;unsigned _TD;int _TE;unsigned char*_TF;char*_T10;struct Cyc_List_List*_T11;void*_T12;int _T13;unsigned _T14;unsigned char*_T15;char*_T16;struct Cyc_List_List*_T17;struct _tuple10*_T18;
struct Cyc_List_List*chars=0;
int ch=Cyc_Sexp_pgetc(p);
_TL78: _T0= Cyc_Sexp_whitespace(ch);if(_T0)goto _TL79;else{goto _TL7A;}
_TL79: ch= Cyc_Sexp_pgetc(p);goto _TL78;_TL7A:
 _TL7B: if(1)goto _TL7C;else{goto _TL7D;}
_TL7C: _T1= ch;_T2= - 1;if(_T1!=_T2)goto _TL7E;_T3= p;_T4= ch;_T5= 
_tag_fat("unexpected end of file",sizeof(char),23U);Cyc_Sexp_perror(_T3,_T4,_T5);goto _TL7F;_TL7E: _TL7F: _T6= 
...
# 585
static struct _fat_ptr Cyc_Sexp_escape(struct _fat_ptr s){struct _fat_ptr _T0;unsigned char*_T1;const char*_T2;const char*_T3;unsigned _T4;int _T5;char _T6;int _T7;struct _fat_ptr _T8;unsigned char*_T9;const char*_TA;unsigned _TB;int _TC;char _TD;int _TE;struct _fat_ptr _TF;struct _fat_ptr _T10;unsigned _T11;int _T12;unsigned _T13;unsigned _T14;unsigned _T15;char*_T16;unsigned _T17;unsigned _T18;struct _fat_ptr _T19;unsigned char*_T1A;const char*_T1B;const char*_T1C;unsigned _T1D;int _T1E;struct _fat_ptr _T1F;unsigned char*_T20;const char*_T21;unsigned _T22;int _T23;char _T24;int _T25;struct _fat_ptr _T26;unsigned char*_T27;const char*_T28;unsigned _T29;int _T2A;char _T2B;int _T2C;struct _fat_ptr _T2D;unsigned _T2E;int _T2F;unsigned char*_T30;char*_T31;unsigned _T32;unsigned char*_T33;char*_T34;struct _fat_ptr _T35;unsigned _T36;int _T37;unsigned char*_T38;char*_T39;unsigned _T3A;unsigned char*_T3B;char*_T3C;struct _fat_ptr _T3D;
unsigned n=Cyc_strlen(s);
int escapes=0;{
unsigned i=0U;_TL8D: if(i < n)goto _TL8B;else{goto _TL8C;}
_TL8B: _T0= s;_T1= _T0.curr;_T2= (const char*)_T1;_T3= _check_null(_T2);_T4= i;_T5= (int)_T4;_T6= _T3[_T5];_T7= (int)_T6;if(_T7==34)goto _TL90;else{goto _TL91;}_TL91: _T8= s;_T9= _T8.curr;_TA= (const char*)_T9;_TB= i;_TC= (int)_TB;_TD= _TA[_TC];_TE= (int)_TD;if(_TE==92)goto _TL90;else{goto _TL8E;}
_TL90: escapes= escapes + 1;goto _TL8F;_TL8E: _TL8F:
# 588
 i= i + 1;goto _TL8D;_TL8C:;}
# 592
if(escapes!=0)goto _TL92;_TF= s;
return _TF;_TL92: _T11= n;_T12= escapes;_T13= (unsigned)_T12;_T14= _T11 + _T13;_T15= _T14 + 1U;{unsigned _T3E=_T15 + 1U;_T17= _check_times(_T3E,sizeof(char));{char*_T3F=_cycalloc_atomic(_T17);{unsigned _T40=_T3E;unsigned i;i= 0;_TL97: if(i < _T40)goto _TL95;else{goto _TL96;}_TL95: _T18= i;
# 595
_T3F[_T18]= '\000';i= i + 1;goto _TL97;_TL96: _T3F[_T40]= 0;}_T16= (char*)_T3F;}_T10= 
# 594
_tag_fat(_T16,sizeof(char),_T3E);}{struct _fat_ptr news=_T10;
# 597
unsigned pos=0U;{
unsigned i=0U;_TL9B: if(i < n)goto _TL99;else{goto _TL9A;}
_TL99: _T19= s;_T1A= _T19.curr;_T1B= (const char*)_T1A;_T1C= _check_null(_T1B);_T1D= i;_T1E= (int)_T1D;{char ch=_T1C[_T1E];_T1F= s;_T20= _T1F.curr;_T21= (const char*)_T20;_T22= i;_T23= (int)_T22;_T24= _T21[_T23];_T25= (int)_T24;
if(_T25==34)goto _TL9E;else{goto _TL9F;}_TL9F: _T26= s;_T27= _T26.curr;_T28= (const char*)_T27;_T29= i;_T2A= (int)_T29;_T2B= _T28[_T2A];_T2C= (int)_T2B;if(_T2C==92)goto _TL9E;else{goto _TL9C;}
_TL9E: _T2D= news;_T2E= pos;_T2F= (int)_T2E;{struct _fat_ptr _T3E=_fat_ptr_plus(_T2D,sizeof(char),_T2F);_T30= _check_fat_subscript(_T3E,sizeof(char),0U);_T31= (char*)_T30;{char _T3F=*_T31;char _T40='\\';_T32= _get_fat_size(_T3E,sizeof(char));if(_T32!=1U)goto _TLA0;if(_T3F!=0)goto _TLA0;if(_T40==0)goto _TLA0;_throw_arraybounds();goto _TLA1;_TLA0: _TLA1: _T33= _T3E.curr;_T34= (char*)_T33;*_T34= _T40;}}
pos= pos + 1;goto _TL9D;_TL9C: _TL9D: _T35= news;_T36= pos;_T37= (int)_T36;{struct _fat_ptr _T3E=_fat_ptr_plus(_T35,sizeof(char),_T37);_T38= _check_fat_subscript(_T3E,sizeof(char),0U);_T39= (char*)_T38;{char _T3F=*_T39;char _T40=ch;_T3A= _get_fat_size(_T3E,sizeof(char));if(_T3A!=1U)goto _TLA2;if(_T3F!=0)goto _TLA2;if(_T40==0)goto _TLA2;_throw_arraybounds();goto _TLA3;_TLA2: _TLA3: _T3B= _T3E.curr;_T3C= (char*)_T3B;*_T3C= _T40;}}
# 605
pos= pos + 1;}
# 598
i= i + 1;goto _TL9B;_TL9A:;}_T3D= news;
# 607
return _T3D;}}
# 611
...
# 618
static int Cyc_Sexp_cmp_str(struct _tuple10*x,struct _tuple10*y){struct _tuple10*_T0;struct _fat_ptr _T1;struct _tuple10*_T2;struct _fat_ptr _T3;int _T4;_T0= x;_T1= _T0->v;_T2= y;_T3= _T2->v;_T4= Cyc_strcmp(_T1,_T3);return _T4;}
# 620
static int Cyc_Sexp_cmp_symbol(struct _tuple10*x,struct _tuple10*y){struct _tuple10*_T0;struct _fat_ptr _T1;struct _tuple10*_T2;struct _fat_ptr _T3;int _T4;_T0= x;_T1= _T0->v;_T2= y;_T3= _T2->v;_T4= Cyc_strcmp(_T1,_T3);return _T4;}
# 625
...
if(_T0!=_T1)goto _TLA7;_T2= p;_T3= ch;_T4= 
_tag_fat("unexpected end of file",sizeof(char),23U);Cyc_Sexp_perror(_T2,_T3,_T4);goto _TLA8;_TLA7: _TLA8:
 if(ch!=34)goto _TLA9;goto _TLA6;_TLA9:
# 634
 if(ch!=92)goto _TLAB;
ch= Cyc_Sexp_pgetc(p);
if(ch==34)goto _TLAD;if(ch==92)goto _TLAD;_T5= p;_T6= ch;_T7= 
_tag_fat("expected '\"' or '\\'",sizeof(char),20U);Cyc_Sexp_perror(_T5,_T6,_T7);goto _TLAE;_TLAD: _TLAE: goto _TLAC;_TLAB: _TLAC:{struct Cyc_List_List*_T1A=_cycalloc(sizeof(struct Cyc_List_List));_T9= ch;
# 639
...
# 649
static void Cyc_Sexp_print_tuple(struct _tuple10*self,struct Cyc_Sexp_Printer*p){struct _tuple10*_T0;struct _fat_ptr _T1;struct Cyc_Sexp_Printer*_T2;struct _fat_ptr _T3;unsigned char*_T4;struct Cyc_Sexp_Object*_T5;struct Cyc_Sexp_Object*_T6;unsigned _T7;int _T8;struct Cyc_Sexp_Object _T9;_T0= self;{
# 651
...
_TLB6: _T2= p;_T3= vs;_T4= _T3.curr;_T5= (struct Cyc_Sexp_Object*)_T4;_T6= _check_null(_T5);_T7= i;_T8= (int)_T7;_T9= _T6[_T8];Cyc_Sexp_print(_T2,_T9);
# 653
i= i + 1;goto _TLB8;_TLB7:;}}}
# 660
static int Cyc_Sexp_hash_tuple(struct _tuple10*x){struct _tuple10*_T0;struct _fat_ptr _T1;struct _fat_ptr _T2;unsigned char*_T3;struct Cyc_Sexp_Object*_T4;struct Cyc_Sexp_Object*_T5;unsigned _T6;int _T7;unsigned _T8;struct Cyc_Sexp_Obj*_T9;unsigned _TA;unsigned _TB;unsigned _TC;int _TD;
unsigned res=0U;_T0= x;{
struct _fat_ptr vs=_T0->v;_T1= vs;{
unsigned n=_get_fat_size(_T1,sizeof(struct Cyc_Sexp_Object));{
unsigned i=0U;_TLBC: if(i < n)goto _TLBA;else{goto _TLBB;}
_TLBA: _T2= vs;_T3= _T2.curr;_T4= (struct Cyc_Sexp_Object*)_T3;_T5= _check_null(_T4);_T6= i;_T7= (int)_T6;{struct Cyc_Sexp_Object _TE=_T5[_T7];struct Cyc_Sexp_Obj*_TF;_TF= _TE.self;{struct Cyc_Sexp_Obj*v=_TF;_T8= res << 8;_T9= v;_TA= (unsigned)_T9;_TB= _TA & 255U;
res= _T8 | _TB;}}
# 664
i= i + 1;goto _TLBC;_TLBB:;}_TC= res;_TD= (int)_TC;
# 668
return _TD;}}}
# 672
static int Cyc_Sexp_cmp_tuple(struct _tuple10*x,struct _tuple10*y){struct _tuple10*_T0;struct _tuple10*_T1;struct _fat_ptr _T2;struct _fat_ptr _T3;int _T4;struct _fat_ptr _T5;unsigned char*_T6;struct Cyc_Sexp_Object*_T7;struct Cyc_Sexp_Object*_T8;unsigned _T9;int _TA;struct Cyc_Sexp_Object _TB;struct _fat_ptr _TC;unsigned char*_TD;struct Cyc_Sexp_Object*_TE;struct Cyc_Sexp_Object*_TF;unsigned _T10;int _T11;struct Cyc_Sexp_Object _T12;int _T13;
if(x!=y)goto _TLBD;
return 0;_TLBD: _T0= x;{
...
if(nx >= ny)goto _TLBF;_T4= - 1;
return _T4;_TLBF:
 if(nx <= ny)goto _TLC1;
return 1;_TLC1:{
unsigned i=0U;_TLC6: if(i < nx)goto _TLC4;else{goto _TLC5;}
_TLC4: _T5= xs;_T6= _T5.curr;_T7= (struct Cyc_Sexp_Object*)_T6;_T8= _check_null(_T7);_T9= i;_TA= (int)_T9;_TB= _T8[_TA];_TC= ys;_TD= _TC.curr;_TE= (struct Cyc_Sexp_Object*)_TD;_TF= _check_null(_TE);_T10= i;_T11= (int)_T10;_T12= _TF[_T11];{int c=Cyc_Sexp_cmp(_TB,_T12);
if(c==0)goto _TLC7;_T13= c;
return _T13;_TLC7:;}
# 683
...
return _T8;}}
# 699
static struct _tuple10*Cyc_Sexp_parse_tuple(struct Cyc_Sexp_Parser*p){long _T0;struct _fat_ptr _T1;int _T2;struct Cyc_Sexp_Object*_T3;unsigned _T4;unsigned _T5;struct Cyc_List_List**_T6;struct _tuple10*_T7;struct Cyc_List_List*_T8;void*_T9;int _TA;struct Cyc_Sexp_Class*_TB;char _TC;int _TD;struct Cyc_Sexp_Class*_TE;struct Cyc_Sexp_Obj*(*_TF)(struct Cyc_Sexp_Parser*);struct Cyc_List_List*_T10;struct Cyc_Sexp_Object*_T11;struct Cyc_List_List*_T12;struct Cyc_Sexp_Parser*_T13;void(*_T14)(void*,int,struct _fat_ptr);struct Cyc_Sexp_Parser*_T15;void*_T16;int _T17;struct _fat_ptr _T18;
struct Cyc_List_List*xs=0;
Next: {
int ch=Cyc_Sexp_pgetc(p);
_TLC9: _T0= Cyc_Sexp_whitespace(ch);if(_T0)goto _TLCA;else{goto _TLCB;}
_TLCA: ch= Cyc_Sexp_pgetc(p);goto _TLC9;_TLCB:
 if(ch!=41)goto _TLCC;
...
# 710
({__typeof__(Cyc_Sexp_next_list(_T6))_T1C=Cyc_Sexp_next_list(_T6);_T1A[_T5]= _T1C;});i= i + 1;goto _TLD1;_TLD0:;}_T3= (struct Cyc_Sexp_Object*)_T1A;}_T1= 
# 709
_tag_fat(_T3,sizeof(struct Cyc_Sexp_Object),_T19);}{struct _fat_ptr vs=_T1;_T7= 
# 712
...
({__typeof__(Cyc_Sexp_up(obj))_T1D=Cyc_Sexp_up(obj);*_T1C= _T1D;});_T11= (struct Cyc_Sexp_Object*)_T1C;}_T1B->hd= _T11;_T1B->tl= xs;_T10= (struct Cyc_List_List*)_T1B;}xs= _T10;goto Next;}_TLD6:;}}_T12= cs;
# 714
...
if(objopt==0)goto _TLDA;_T5= objopt;_T6= *_T5;
return _T6;_TLDA: {
