...
# 114 "cyclone/library/std/core.h"
 int Cyc_Core_intcmp(int,int);struct Cyc___cycFILE;
...
extern int Cyc_List_length(struct Cyc_List_List*);struct Cyc_Dict_T;struct Cyc_Dict_Dict{int(*rel)(void*,void*);struct _RegionHandle*r;const struct Cyc_Dict_T*t;};
...
# 257
extern struct Cyc_Dict_Dict Cyc_Dict_delete(struct Cyc_Dict_Dict,void*);struct Cyc_Set_Set;
...
# 27 "cyclone/library/std/graph.cyc"
struct Cyc_Dict_Dict Cyc_Graph_empty(int(*cmp)(void*,void*)){int(*_T0)(void*,void*);struct Cyc_Dict_Dict _T1;_T0= cmp;_T1= Cyc_Dict_empty(_T0);return _T1;}
# 32
...
# 88
static struct Cyc_List_List*Cyc_Graph_to_list(struct Cyc_Set_Set*ts){long _T0;struct Cyc_List_List*_T1;struct Cyc_List_List*_T2;
...
return _T2;}
# 101
int Cyc_Graph_is_edge(struct Cyc_Dict_Dict g,void*source,void*target){struct Cyc_Set_Set**(*_T0)(struct Cyc_Dict_Dict,void*);void**(*_T1)(struct Cyc_Dict_Dict,void*);long _T2;_T1= Cyc_Dict_lookup_opt;{
...
# 141
static struct Cyc_List_List*Cyc_Graph_sourcesOf(struct Cyc_Dict_Dict g,void*node){struct Cyc_List_List*_T0;unsigned _T1;struct Cyc_List_List*_T2;void*_T3;void*_T4;long _T5;struct Cyc_List_List*_T6;struct Cyc_List_List*_T7;struct Cyc_List_List*_T8;
struct Cyc_List_List*result=0;{
# 144
...
Cyc_Set_member(ts,node);if(!_T5)goto _TL17;{struct Cyc_List_List*_TC=_cycalloc(sizeof(struct Cyc_List_List));
_TC->hd= s;_TC->tl= result;_T6= (struct Cyc_List_List*)_TC;}result= _T6;goto _TL18;_TL17: _TL18:;}}_T7= edges;
# 144
...
# 161
({__typeof__(Cyc_Set_empty(_T4))_T9=Cyc_Set_empty(_T4);_T8.f0= _T9;});_T8.f1= g;_T2= _T8;}return _T2;_TL19:{struct Cyc_Set_Set*_T8=*_T6;_T7= _T8;}{struct Cyc_Set_Set*sourceTargets=_T7;{struct _tuple1 _T8;
# 163
_T8.f0= sourceTargets;({__typeof__(Cyc_Dict_delete(g,source))_T9=Cyc_Dict_delete(g,source);_T8.f1= _T9;});_T5= _T8;}return _T5;};}}
# 170
...
return _T11;}}
# 200
struct Cyc_Dict_Dict Cyc_Graph_tkernel(struct Cyc_Dict_Dict g){struct Cyc_Dict_Dict _T0;int(*_T1)(void*,void*);int(*_T2)(void*,void*);struct Cyc_List_List*_T3;unsigned _T4;struct Cyc_List_List*_T5;void*_T6;void*_T7;long _T8;int _T9;struct Cyc_List_List*_TA;struct Cyc_Dict_Dict _TB;_T0= g;{
...
struct Cyc_Dict_Dict(*_T90)(struct Cyc_Dict_Dict,void*,struct Cyc_Graph_nodestate*)=(struct Cyc_Dict_Dict(*)(struct Cyc_Dict_Dict,void*,struct Cyc_Graph_nodestate*))_TC;_TB= _T90;}_TD= ts;_TE= _TD->ns;_TF= v;_T10= nsv;({__typeof__(_TB(_TE,_TF,_T10))_T90=_TB(_TE,_TF,_T10);_TA->ns= _T90;});_T11= ts;{struct Cyc_List_List*_T90=_cycalloc(sizeof(struct Cyc_List_List));
...
struct Cyc_Graph_componentstate*csCnew;csCnew= _cycalloc(sizeof(struct Cyc_Graph_componentstate));_T49= csCnew;_T4B= Cyc_Set_empty;{struct Cyc_Set_Set*(*_T90)(int(*)(int,int))=(struct Cyc_Set_Set*(*)(int(*)(int,int)))_T4B;_T4A= _T90;}_T4C= Cyc_Core_intcmp;({__typeof__(_T4A(_T4C))_T90=_T4A(_T4C);_T49->Succ= _T90;});_T4D= csCnew;_T4E= cmp;({__typeof__(Cyc_Set_empty(_T4E))_T90=Cyc_Set_empty(_T4E);_T4D->nodes= _T90;});_T4F= ts;_T51= Cyc_Dict_insert;{
struct Cyc_Dict_Dict(*_T90)(struct Cyc_Dict_Dict,int,struct Cyc_Graph_componentstate*)=(struct Cyc_Dict_Dict(*)(struct Cyc_Dict_Dict,int,struct Cyc_Graph_componentstate*))_T51;_T50= _T90;}_T52= ts;_T53= _T52->cs;_T54= Cnew;_T55= csCnew;({__typeof__(_T50(_T53,_T54,_T55))_T90=_T50(_T53,_T54,_T55);_T4F->cs= _T90;});_T56= ts;{
...
# 285
cmp(top,v);if(_T58!=0)goto _TL48;else{goto _TL49;}_TL49: _T59= Cyc_Graph_is_edge(g,v,v);if(_T59)goto _TL48;else{goto _TL46;}
_TL48: _T5A= csCnew;_T5C= Cyc_Set_insert;{struct Cyc_Set_Set*(*_T92)(struct Cyc_Set_Set*,int)=(struct Cyc_Set_Set*(*)(struct Cyc_Set_Set*,int))_T5C;_T5B= _T92;}_T5D= csCnew;_T5E= _T5D->Succ;_T5F= Cnew;({__typeof__(_T5B(_T5E,_T5F))_T92=_T5B(_T5E,_T5F);_T5A->Succ= _T92;});goto _TL47;_TL46: _TL47: goto _LL0;}_LL0:;}_T60= ts;_T61= _T60->cstack;{
# 290
...
long(*_T90)(struct Cyc_Set_Set*,int)=(long(*)(struct Cyc_Set_Set*,int))_T6A;_T69= _T90;}_T6B= csCnew;_T6C= _T6B->Succ;_T6D= X;_T6E= _T69(_T6C,_T6D);if(_T6E)goto _TL4E;else{goto _TL50;}
...
Cyc_Set_member(_T13,_T14);if(_T15)goto _TL5A;else{goto _TL5C;}
_TL5C: Cyc_Graph_comp_tc(ts,g,source);goto _TL5B;_TL5A: _TL5B:;}}_T16= edges;
# 319
...
struct Cyc_Graph_componentstate*(*_T32)(struct Cyc_Dict_Dict,int)=(struct Cyc_Graph_componentstate*(*)(struct Cyc_Dict_Dict,int))_T29;_T28= _T32;}_T2A= ts;_T2B= _T2A->cs;_T2C= C2;_T2D= _T28(_T2B,_T2C);_T2E= _T2D->nodes;targets= Cyc_Set_union_two(_T27,_T2E);}goto _TL61;_TL63: _T2F= cs;{
# 335
...
struct Cyc_Dict_Dict(*_T57)(struct Cyc_Dict_Dict,void*,unsigned)=(struct Cyc_Dict_Dict(*)(struct Cyc_Dict_Dict,void*,unsigned))_T25;_T24= _T57;}_T26= N;_T27= *_T26;_T28= x;_T29= Ny;({__typeof__(_T24(_T27,_T28,_T29))_T57=_T24(_T27,_T28,_T29);*_T23= _T57;});goto _TL6E;_TL6D: _TL6E:;}}goto _TL6A;_TL69:;}_T2B= Cyc_Dict_lookup;{
# 369
...
struct Cyc_Dict_Dict(*_T57)(struct Cyc_Dict_Dict,void*,unsigned)=(struct Cyc_Dict_Dict(*)(struct Cyc_Dict_Dict,void*,unsigned))_T41;_T40= _T57;}_T42= N;_T43= *_T42;_T44= top;({__typeof__(_T40(_T43,_T44,4294967295U))_T57=_T40(_T43,_T44,4294967295U);*_T3F= _T57;});_T45= output;_T46= output;_T47= *_T46;_T48= top;
({__typeof__(Cyc_Graph_add_node(_T47,_T48))_T57=Cyc_Graph_add_node(_T47,_T48);*_T45= _T57;});_T49= output;_T4A= output;_T4B= *_T4A;_T4C= top;_T4D= component;
({__typeof__(Cyc_Graph_add_edges(_T4B,_T4C,_T4D))_T57=Cyc_Graph_add_edges(_T4B,_T4C,_T4D);*_T49= _T57;});_T4E= 
...
struct Cyc_Dict_Dict(*_T50)(struct Cyc_Dict_Dict,void*,unsigned)=(struct Cyc_Dict_Dict(*)(struct Cyc_Dict_Dict,void*,unsigned))_T25;_T24= _T50;}_T26= N;_T27= *_T26;_T28= x;_T29= Ny;({__typeof__(_T24(_T27,_T28,_T29))_T50=_T24(_T27,_T28,_T29);*_T23= _T50;});goto _TL8E;_TL8D: _TL8E:;}}goto _TL8A;_TL89:;}_T2B= Cyc_Dict_lookup;{
# 423
...
struct Cyc_Dict_Dict(*_T50)(struct Cyc_Dict_Dict,void*,unsigned)=(struct Cyc_Dict_Dict(*)(struct Cyc_Dict_Dict,void*,unsigned))_T40;_T3F= _T50;}_T41= N;_T42= *_T41;_T43= top;({__typeof__(_T3F(_T42,_T43,4294967295U))_T50=_T3F(_T42,_T43,4294967295U);*_T3E= _T50;});_T44= output;{struct Cyc_List_List*_T50=_cycalloc(sizeof(struct Cyc_List_List));
