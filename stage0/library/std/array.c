...
# 359 "cyclone/library/std/list.h"
...
# 63 "cyclone/library/std/array.cyc"
...
_TL2:{struct Cyc_Core_Invalid_argument_exn_struct*_TE6=_cycalloc(sizeof(struct Cyc_Core_Invalid_argument_exn_struct));_TE6->tag= Cyc_Core_Invalid_argument;({__typeof__(_tag_fat("Array::qsort",sizeof(char),13U))_TE7=_tag_fat("Array::qsort",sizeof(char),13U);_TE6->f1= _TE7;});_T4= (struct Cyc_Core_Invalid_argument_exn_struct*)_TE6;}_T5= (void*)_T4;_throw(_T5);goto _TL1;_TL0: _TL1:
# 77
...
_TL2B:{struct Cyc_Core_Invalid_argument_exn_struct*_T59=_cycalloc(sizeof(struct Cyc_Core_Invalid_argument_exn_struct));_T59->tag= Cyc_Core_Invalid_argument;({__typeof__(_tag_fat("Array::msort",sizeof(char),13U))_T5A=_tag_fat("Array::msort",sizeof(char),13U);_T59->f1= _T5A;});_T4= (struct Cyc_Core_Invalid_argument_exn_struct*)_T59;}_T5= (void*)_T4;_throw(_T5);goto _TL2A;_TL29: _TL2A: _T7= len;{unsigned _T59=(unsigned)_T7;_T9= _check_times(_T59,sizeof(void*));{void**_T5A=_cycalloc(_T9);{unsigned _T5B=_T59;unsigned i;i= 0;_TL30: if(i < _T5B)goto _TL2E;else{goto _TL2F;}_TL2E: _TA= i;_TB= arr;_TC= _TB.curr;_TD= (void**)_TC;_TE= 
# 145
...
# 192
if(!_T50)goto _TL49;{
int i=0;_TL4E: if(i < len)goto _TL4C;else{goto _TL4D;}
_TL4C: _T51= from;_T52= _T51.curr;_T53= (void**)_T52;_T54= i;_T55= to;_T56= _T55.curr;_T57= (void**)_T56;_T58= i;_T53[_T54]= _T57[_T58];
# 193
i= i + 1;goto _TL4E;_TL4D:;}goto _TL4A;_TL49: _TL4A:;}}
# 199
struct _fat_ptr Cyc_Array_from_list(struct Cyc_List_List*x){struct _fat_ptr _T0;_T0= Cyc_List_to_array(x);return _T0;}
# 201
...
_check_null(_T9);_TB= i;_TC= (int)_TB;_TD= _TA[_TC];({__typeof__(f(_TD))_T11=f(_TD);_TF[_T6]= _T11;});i= i + 1;goto _TL56;_TL55:;}_T4= (void**)_TF;}_T2= _tag_fat(_T4,sizeof(void*),_TE);}return _T2;}}
# 218
...
_check_null(_TA);_TC= i;_TD= (int)_TC;_TE= _TB[_TD];({__typeof__(f(_T7,_TE))_T12=f(_T7,_TE);_T10[_T6]= _T12;});i= i + 1;goto _TL5A;_TL59:;}_T4= (void**)_T10;}_T2= _tag_fat(_T4,sizeof(void*),_TF);}return _T2;}}
# 225
void Cyc_Array_imp_map(void*(*f)(void*),struct _fat_ptr x){struct _fat_ptr _T0;unsigned _T1;struct _fat_ptr _T2;unsigned char*_T3;void**_T4;int _T5;struct _fat_ptr _T6;unsigned char*_T7;void**_T8;void**_T9;int _TA;void*_TB;_T0= x;_T1= 
_get_fat_size(_T0,sizeof(void*));{int sx=(int)_T1;
int i=0;_TL5E: if(i < sx)goto _TL5C;else{goto _TL5D;}
_TL5C: _T2= x;_T3= _T2.curr;_T4= (void**)_T3;_T5= i;_T6= x;_T7= _T6.curr;_T8= (void**)_T7;_T9= _check_null(_T8);_TA= i;_TB= _T9[_TA];({__typeof__(f(_TB))_TC=f(_TB);_T4[_T5]= _TC;});
# 227
i= i + 1;goto _TL5E;_TL5D:;}}
# 230
void Cyc_Array_imp_map_c(void*(*f)(void*,void*),void*env,struct _fat_ptr x){struct _fat_ptr _T0;unsigned _T1;struct _fat_ptr _T2;unsigned char*_T3;void**_T4;int _T5;void*_T6;struct _fat_ptr _T7;unsigned char*_T8;void**_T9;void**_TA;int _TB;void*_TC;_T0= x;_T1= 
_get_fat_size(_T0,sizeof(void*));{int sx=(int)_T1;
int i=0;_TL62: if(i < sx)goto _TL60;else{goto _TL61;}
_TL60: _T2= x;_T3= _T2.curr;_T4= (void**)_T3;_T5= i;_T6= env;_T7= x;_T8= _T7.curr;_T9= (void**)_T8;_TA= _check_null(_T9);_TB= i;_TC= _TA[_TB];({__typeof__(f(_T6,_TC))_TD=f(_T6,_TC);_T4[_T5]= _TD;});
# 232
i= i + 1;goto _TL62;_TL61:;}}char Cyc_Array_Array_mismatch[15U]="Array_mismatch";
# 238
...
# 247
_check_null(_TF);_T11= i;_T12= (int)_T11;_T13= _T10[_T12];_T14= y;_T15= _T14.curr;_T16= (void**)_T15;_T17= _check_null(_T16);_T18= i;_T19= (int)_T18;_T1A= _T17[_T19];({__typeof__(f(_T13,_T1A))_T1E=f(_T13,_T1A);_T1C[_TC]= _T1E;});i= i + 1;goto _TL68;_TL67:;}_TA= (void**)_T1C;}_T8= _tag_fat(_TA,sizeof(void*),_T1B);}return _T8;}}
# 253
void Cyc_Array_app(void*(*f)(void*),struct _fat_ptr x){struct _fat_ptr _T0;unsigned _T1;struct _fat_ptr _T2;unsigned char*_T3;void**_T4;void**_T5;int _T6;void*_T7;_T0= x;_T1= 
_get_fat_size(_T0,sizeof(void*));{int sx=(int)_T1;
int i=0;_TL6C: if(i < sx)goto _TL6A;else{goto _TL6B;}
_TL6A: _T2= x;_T3= _T2.curr;_T4= (void**)_T3;_T5= _check_null(_T4);_T6= i;_T7= _T5[_T6];f(_T7);
# 255
i= i + 1;goto _TL6C;_TL6B:;}}
# 258
void Cyc_Array_app_c(void*(*f)(void*,void*),void*env,struct _fat_ptr x){struct _fat_ptr _T0;unsigned _T1;void*_T2;struct _fat_ptr _T3;unsigned char*_T4;void**_T5;void**_T6;int _T7;void*_T8;_T0= x;_T1= 
_get_fat_size(_T0,sizeof(void*));{int sx=(int)_T1;
int i=0;_TL70: if(i < sx)goto _TL6E;else{goto _TL6F;}
_TL6E: _T2= env;_T3= x;_T4= _T3.curr;_T5= (void**)_T4;_T6= _check_null(_T5);_T7= i;_T8= _T6[_T7];f(_T2,_T8);
# 260
i= i + 1;goto _TL70;_TL6F:;}}
# 267
void Cyc_Array_iter(void(*f)(void*),struct _fat_ptr x){struct _fat_ptr _T0;unsigned _T1;struct _fat_ptr _T2;unsigned char*_T3;void**_T4;void**_T5;int _T6;void*_T7;_T0= x;_T1= 
_get_fat_size(_T0,sizeof(void*));{int sx=(int)_T1;
int i=0;_TL74: if(i < sx)goto _TL72;else{goto _TL73;}
_TL72: _T2= x;_T3= _T2.curr;_T4= (void**)_T3;_T5= _check_null(_T4);_T6= i;_T7= _T5[_T6];f(_T7);
# 269
i= i + 1;goto _TL74;_TL73:;}}
# 274
void Cyc_Array_iter_c(void(*f)(void*,void*),void*env,struct _fat_ptr x){struct _fat_ptr _T0;unsigned _T1;void*_T2;struct _fat_ptr _T3;unsigned char*_T4;void**_T5;void**_T6;int _T7;void*_T8;_T0= x;_T1= 
_get_fat_size(_T0,sizeof(void*));{int sx=(int)_T1;
int i=0;_TL78: if(i < sx)goto _TL76;else{goto _TL77;}
_TL76: _T2= env;_T3= x;_T4= _T3.curr;_T5= (void**)_T4;_T6= _check_null(_T5);_T7= i;_T8= _T6[_T7];f(_T2,_T8);
# 276
i= i + 1;goto _TL78;_TL77:;}}
# 282
...
# 286
int i=0;_TL7E: if(i < sx)goto _TL7C;else{goto _TL7D;}
_TL7C: _T8= x;_T9= _T8.curr;_TA= (void**)_T9;_TB= _check_null(_TA);_TC= i;_TD= _TB[_TC];_TE= y;_TF= _TE.curr;_T10= (void**)_TF;_T11= _check_null(_T10);_T12= i;_T13= _T11[_T12];f(_TD,_T13);
# 286
i= i + 1;goto _TL7E;_TL7D:;}}}
# 290
void Cyc_Array_app2_c(void*(*f)(void*,void*,void*),void*env,struct _fat_ptr x,struct _fat_ptr y){struct _fat_ptr _T0;unsigned _T1;int _T2;unsigned _T3;struct _fat_ptr _T4;unsigned _T5;struct Cyc_Array_Array_mismatch_exn_struct*_T6;struct Cyc_Array_Array_mismatch_exn_struct*_T7;void*_T8;struct _fat_ptr _T9;unsigned char*_TA;void**_TB;void**_TC;int _TD;void*_TE;struct _fat_ptr _TF;unsigned char*_T10;void**_T11;void**_T12;int _T13;void*_T14;_T0= x;_T1= 
_get_fat_size(_T0,sizeof(void*));{int sx=(int)_T1;_T2= sx;_T3= (unsigned)_T2;_T4= y;_T5= 
...
# 294
int i=0;_TL84: if(i < sx)goto _TL82;else{goto _TL83;}
_TL82: _T8= env;_T9= x;_TA= _T9.curr;_TB= (void**)_TA;_TC= _check_null(_TB);_TD= i;_TE= _TC[_TD];_TF= y;_T10= _TF.curr;_T11= (void**)_T10;_T12= _check_null(_T11);_T13= i;_T14= _T12[_T13];f(_T8,_TE,_T14);
# 294
...
# 304
int i=0;_TL8A: if(i < sx)goto _TL88;else{goto _TL89;}
_TL88: _T8= x;_T9= _T8.curr;_TA= (void**)_T9;_TB= _check_null(_TA);_TC= i;_TD= _TB[_TC];_TE= y;_TF= _TE.curr;_T10= (void**)_TF;_T11= _check_null(_T10);_T12= i;_T13= _T11[_T12];f(_TD,_T13);
# 304
...
# 312
int i=0;_TL90: if(i < sx)goto _TL8E;else{goto _TL8F;}
_TL8E: _T8= env;_T9= x;_TA= _T9.curr;_TB= (void**)_TA;_TC= _check_null(_TB);_TD= i;_TE= _TC[_TD];_TF= y;_T10= _TF.curr;_T11= (void**)_T10;_T12= _check_null(_T11);_T13= i;_T14= _T12[_T13];f(_T8,_TE,_T14);
# 312
i= i + 1;goto _TL90;_TL8F:;}}}
# 319
void*Cyc_Array_fold_left(void*(*f)(void*,void*),void*accum,struct _fat_ptr x){struct _fat_ptr _T0;unsigned _T1;void*_T2;struct _fat_ptr _T3;unsigned char*_T4;void**_T5;void**_T6;int _T7;void*_T8;void*_T9;_T0= x;_T1= 
_get_fat_size(_T0,sizeof(void*));{int sx=(int)_T1;{
int i=0;_TL94: if(i < sx)goto _TL92;else{goto _TL93;}
_TL92: _T2= accum;_T3= x;_T4= _T3.curr;_T5= (void**)_T4;_T6= _check_null(_T5);_T7= i;_T8= _T6[_T7];accum= f(_T2,_T8);
# 321
i= i + 1;goto _TL94;_TL93:;}_T9= accum;
# 324
return _T9;}}
# 327
void*Cyc_Array_fold_left_c(void*(*f)(void*,void*,void*),void*env,void*accum,struct _fat_ptr x){struct _fat_ptr _T0;unsigned _T1;void*_T2;void*_T3;struct _fat_ptr _T4;unsigned char*_T5;void**_T6;void**_T7;int _T8;void*_T9;void*_TA;_T0= x;_T1= 
_get_fat_size(_T0,sizeof(void*));{int sx=(int)_T1;{
int i=0;_TL98: if(i < sx)goto _TL96;else{goto _TL97;}
_TL96: _T2= env;_T3= accum;_T4= x;_T5= _T4.curr;_T6= (void**)_T5;_T7= _check_null(_T6);_T8= i;_T9= _T7[_T8];accum= f(_T2,_T3,_T9);
# 329
i= i + 1;goto _TL98;_TL97:;}_TA= accum;
# 332
return _TA;}}
# 338
void*Cyc_Array_fold_right(void*(*f)(void*,void*),struct _fat_ptr x,void*accum){struct _fat_ptr _T0;unsigned _T1;unsigned _T2;struct _fat_ptr _T3;unsigned char*_T4;void**_T5;void**_T6;int _T7;void*_T8;void*_T9;void*_TA;_T0= x;_T1= 
_get_fat_size(_T0,sizeof(void*));_T2= _T1 - 1U;{int i=(int)_T2;_TL9C: if(i >= 0)goto _TL9A;else{goto _TL9B;}
_TL9A: _T3= x;_T4= _T3.curr;_T5= (void**)_T4;_T6= _check_null(_T5);_T7= i;_T8= _T6[_T7];_T9= accum;accum= f(_T8,_T9);
# 339
i= i + -1;goto _TL9C;_TL9B:;}_TA= accum;
# 342
return _TA;}
# 344
void*Cyc_Array_fold_right_c(void*(*f)(void*,void*,void*),void*env,struct _fat_ptr x,void*accum){struct _fat_ptr _T0;unsigned _T1;unsigned _T2;void*_T3;struct _fat_ptr _T4;unsigned char*_T5;void**_T6;void**_T7;int _T8;void*_T9;void*_TA;void*_TB;_T0= x;_T1= 
_get_fat_size(_T0,sizeof(void*));_T2= _T1 - 1U;{int i=(int)_T2;_TLA0: if(i >= 0)goto _TL9E;else{goto _TL9F;}
_TL9E: _T3= env;_T4= x;_T5= _T4.curr;_T6= (void**)_T5;_T7= _check_null(_T6);_T8= i;_T9= _T7[_T8];_TA= accum;accum= f(_T3,_T9,_TA);
# 345
i= i + -1;goto _TLA0;_TL9F:;}_TB= accum;
# 348
return _TB;}
# 352
...
# 374
long Cyc_Array_forall(long(*pred)(void*),struct _fat_ptr x){struct _fat_ptr _T0;unsigned _T1;struct _fat_ptr _T2;unsigned char*_T3;void**_T4;void**_T5;int _T6;void*_T7;long _T8;_T0= x;_T1= 
_get_fat_size(_T0,sizeof(void*));{int sx=(int)_T1;{
int i=0;_TLAB: if(i < sx)goto _TLA9;else{goto _TLAA;}
_TLA9: _T2= x;_T3= _T2.curr;_T4= (void**)_T3;_T5= _check_null(_T4);_T6= i;_T7= _T5[_T6];_T8= pred(_T7);if(_T8)goto _TLAC;else{goto _TLAE;}
_TLAE: return 0;_TLAC:
# 376
 i= i + 1;goto _TLAB;_TLAA:;}
# 380
return 1;}}
# 382
long Cyc_Array_forall_c(long(*pred)(void*,void*),void*env,struct _fat_ptr x){struct _fat_ptr _T0;unsigned _T1;void*_T2;struct _fat_ptr _T3;unsigned char*_T4;void**_T5;void**_T6;int _T7;void*_T8;long _T9;_T0= x;_T1= 
_get_fat_size(_T0,sizeof(void*));{int sx=(int)_T1;{
int i=0;_TLB2: if(i < sx)goto _TLB0;else{goto _TLB1;}
_TLB0: _T2= env;_T3= x;_T4= _T3.curr;_T5= (void**)_T4;_T6= _check_null(_T5);_T7= i;_T8= _T6[_T7];_T9= pred(_T2,_T8);if(_T9)goto _TLB3;else{goto _TLB5;}
_TLB5: return 0;_TLB3:
# 384
 i= i + 1;goto _TLB2;_TLB1:;}
# 388
return 1;}}
# 393
long Cyc_Array_exists(long(*pred)(void*),struct _fat_ptr x){struct _fat_ptr _T0;unsigned _T1;struct _fat_ptr _T2;unsigned char*_T3;void**_T4;void**_T5;int _T6;void*_T7;long _T8;_T0= x;_T1= 
_get_fat_size(_T0,sizeof(void*));{int sx=(int)_T1;{
int i=0;_TLB9: if(i < sx)goto _TLB7;else{goto _TLB8;}
_TLB7: _T2= x;_T3= _T2.curr;_T4= (void**)_T3;_T5= _check_null(_T4);_T6= i;_T7= _T5[_T6];_T8= pred(_T7);if(!_T8)goto _TLBA;
return 1;_TLBA:
# 395
...
return 0;}}
# 401
long Cyc_Array_exists_c(long(*pred)(void*,void*),void*env,struct _fat_ptr x){struct _fat_ptr _T0;unsigned _T1;void*_T2;struct _fat_ptr _T3;unsigned char*_T4;void**_T5;void**_T6;int _T7;void*_T8;long _T9;_T0= x;_T1= 
_get_fat_size(_T0,sizeof(void*));{int sx=(int)_T1;{
int i=0;_TLBF: if(i < sx)goto _TLBD;else{goto _TLBE;}
_TLBD: _T2= env;_T3= x;_T4= _T3.curr;_T5= (void**)_T4;_T6= _check_null(_T5);_T7= i;_T8= _T6[_T7];_T9= pred(_T2,_T8);if(!_T9)goto _TLC0;
return 1;_TLC0:
# 403
...
return _T2;}}
# 430
long Cyc_Array_memq(struct _fat_ptr l,void*x){struct _fat_ptr _T0;unsigned _T1;struct _fat_ptr _T2;unsigned char*_T3;void**_T4;void**_T5;int _T6;void*_T7;void*_T8;_T0= l;_T1= 
_get_fat_size(_T0,sizeof(void*));{int s=(int)_T1;{
int i=0;_TLD3: if(i < s)goto _TLD1;else{goto _TLD2;}
_TLD1: _T2= l;_T3= _T2.curr;_T4= (void**)_T3;_T5= _check_null(_T4);_T6= i;_T7= _T5[_T6];_T8= x;if(_T7!=_T8)goto _TLD4;
return 1;_TLD4:
# 432
...
return 0;}}
# 439
long Cyc_Array_mem(int(*compare)(void*,void*),struct _fat_ptr l,void*x){struct _fat_ptr _T0;unsigned _T1;struct _fat_ptr _T2;unsigned char*_T3;void**_T4;void**_T5;int _T6;void*_T7;void*_T8;int _T9;_T0= l;_T1= 
_get_fat_size(_T0,sizeof(void*));{int s=(int)_T1;{
int i=0;_TLD9: if(i < s)goto _TLD7;else{goto _TLD8;}
_TLD7: _T2= l;_T3= _T2.curr;_T4= (void**)_T3;_T5= _check_null(_T4);_T6= i;_T7= _T5[_T6];_T8= x;_T9= compare(_T7,_T8);if(0!=_T9)goto _TLDA;
return 1;_TLDA:
# 441
...
_TLE0:{struct Cyc_Core_Invalid_argument_exn_struct*_T17=_cycalloc(sizeof(struct Cyc_Core_Invalid_argument_exn_struct));_T17->tag= Cyc_Core_Invalid_argument;({__typeof__(_tag_fat("Array::extract",sizeof(char),15U))_T18=_tag_fat("Array::extract",sizeof(char),15U);_T17->f1= _T18;});_T8= (struct Cyc_Core_Invalid_argument_exn_struct*)_T17;}_T9= (void*)_T8;_throw(_T9);goto _TLDF;_TLDE: _TLDF: _TB= n;{unsigned _T17=(unsigned)_TB;_TD= _check_times(_T17,sizeof(void*));{void**_T18=_cycalloc(_TD);{unsigned _T19=_T17;unsigned i;i= 0;_TLE8: if(i < _T19)goto _TLE6;else{goto _TLE7;}_TLE6: _TE= i;_TF= x;_T10= start;_T11= (unsigned)_T10;_T12= i;_T13= _T11 + _T12;_T14= (int)_T13;_T15= _check_fat_subscript(_TF,sizeof(void*),_T14);_T16= (void**)_T15;
# 458
