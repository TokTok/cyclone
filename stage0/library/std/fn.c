...
# 36
static void*Cyc_Fn_fp_apply(void*(*f)(void*),void*x){void*_T0;_T0= f(x);return _T0;}
# 39
...
_TL1:{struct Cyc_List_List*_T6=_cycalloc(sizeof(struct Cyc_List_List));_T1= f;_T2= x;_T3= _T2->hd;({__typeof__(Cyc_Fn_apply(_T1,_T3))_T7=Cyc_Fn_apply(_T1,_T3);_T6->hd= _T7;});_T6->tl= res;_T0= (struct Cyc_List_List*)_T6;}res= _T0;_T4= x;
# 90
