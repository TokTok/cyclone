...
# 274 "cyclone/library/std/cycboot.h"
extern int Cyc_file_string_read(struct Cyc___cycFILE*,struct _fat_ptr,int,int);struct Cyc_Lexing_lexbuf{void(*refill_buff)(struct Cyc_Lexing_lexbuf*);void*refill_state;struct _fat_ptr lex_buffer;int lex_buffer_len;int lex_abs_pos;int lex_start_pos;int lex_curr_pos;int lex_last_pos;int lex_last_action;long lex_eof_reached;};struct Cyc_Lexing_function_lexbuf_state{int(*read_fun)(struct _fat_ptr,int,void*);void*read_fun_state;};
# 75 "cyclone/library/std/string.h"
...
# 73 "cyclone/library/std/lexing.cyc"
...
_get_fat_size(_T0,sizeof(char));if(_T1!=1U)goto _TL0;
Cyc_Lexing_aux_buffer= Cyc_Core_new_string(4097U);goto _TL1;_TL0: _TL1: _T2= lexbuf;_T3= _T2->refill_state;_T4= (struct Cyc_Lexing_function_lexbuf_state*)_T3;_T5= _T4->read_fun;_T6= Cyc_Lexing_aux_buffer;_T7= Cyc_Lexing_aux_buffer;_T8= 
_get_fat_size(_T7,sizeof(char));_T9= _T8 - 1U;_TA= (int)_T9;_TB= lexbuf;_TC= _TB->refill_state;_TD= (struct Cyc_Lexing_function_lexbuf_state*)_TC;_TE= _TD->read_fun_state;{int read=_T5(_T6,_TA,_TE);
# 81
...
({__typeof__(Cyc_Core_new_string(8193U))_T3=Cyc_Core_new_string(8193U);_T2->lex_buffer= _T3;});_T2->lex_buffer_len= 8192;_T2->lex_abs_pos= - 8192;_T2->lex_start_pos= 8192;
_T2->lex_curr_pos= 8192;_T2->lex_last_pos= 8192;_T2->lex_last_action= 0;_T2->lex_eof_reached= 0;_T0= (struct Cyc_Lexing_lexbuf*)_T2;}
# 108
return _T0;}
# 114
static int Cyc_Lexing_read_from_file(struct _fat_ptr aux,int n,struct Cyc___cycFILE*f){int _T0;_T0= Cyc_file_string_read(f,aux,0,n);return _T0;}
# 117
...
# 121
static void Cyc_Lexing_set_eof(struct Cyc_Lexing_lexbuf*lbuf){struct Cyc_Lexing_lexbuf*_T0;_T0= lbuf;_T0->lex_eof_reached= 1;}
# 123
...
({__typeof__(Cyc_strdup(s))_T4=Cyc_strdup(s);_T3->lex_buffer= _T4;});_T1= s;_T2= 
_get_fat_size(_T1,sizeof(char));_T3->lex_buffer_len= (int)_T2;_T3->lex_abs_pos= 0;_T3->lex_start_pos= 0;_T3->lex_curr_pos= 0;_T3->lex_last_pos= 0;_T3->lex_last_action= 0;_T3->lex_eof_reached= 1;_T0= (struct Cyc_Lexing_lexbuf*)_T3;}
# 124
return _T0;}
# 130
...
return _T17;}}}
# 138
struct _fat_ptr Cyc_Lexing_lexeme(struct Cyc_Lexing_lexbuf*lbuf){struct _fat_ptr _T0;_T0= Cyc_Lexing_rlexeme(Cyc_Core_heap_region,lbuf);return _T0;}
...
int Cyc_Lexing_lexeme_start(struct Cyc_Lexing_lexbuf*lbuf){struct Cyc_Lexing_lexbuf*_T0;int _T1;struct Cyc_Lexing_lexbuf*_T2;int _T3;int _T4;_T0= lbuf;_T1= _T0->lex_abs_pos;_T2= lbuf;_T3= _T2->lex_start_pos;_T4= _T1 + _T3;return _T4;}
int Cyc_Lexing_lexeme_end(struct Cyc_Lexing_lexbuf*lbuf){struct Cyc_Lexing_lexbuf*_T0;int _T1;struct Cyc_Lexing_lexbuf*_T2;int _T3;int _T4;_T0= lbuf;_T1= _T0->lex_abs_pos;_T2= lbuf;_T3= _T2->lex_curr_pos;_T4= _T1 + _T3;return _T4;}
