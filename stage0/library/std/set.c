...
# 211
extern struct Cyc_List_List*Cyc_List_merge_sort(int(*)(void*,void*),struct Cyc_List_List*);struct Cyc_Iter_Iter{void*env;long(*next)(void*,void*);};struct Cyc_Set_Set;extern char Cyc_Set_Absent[7U];struct Cyc_Set_Absent_exn_struct{char*tag;};struct Cyc_Set_Set{int(*cmp)(void*,void*);int cardinality;struct Cyc_List_List*nodes;};
# 37 "cyclone/library/std/set.cyc"
struct Cyc_Set_Set*Cyc_Set_empty(int(*comp)(void*,void*)){struct Cyc_Set_Set*_T0;{struct Cyc_Set_Set*_T1=_cycalloc(sizeof(struct Cyc_Set_Set));_T1->cmp= comp;_T1->cardinality= 0;_T1->nodes= 0;_T0= (struct Cyc_Set_Set*)_T1;}return _T0;}
...
# 42
struct Cyc_Set_Set*Cyc_Set_singleton(int(*comp)(void*,void*),void*x){struct Cyc_Set_Set*_T0;struct Cyc_List_List*_T1;{struct Cyc_Set_Set*_T2=_cycalloc(sizeof(struct Cyc_Set_Set));_T2->cmp= comp;_T2->cardinality= 1;{struct Cyc_List_List*_T3=_cycalloc(sizeof(struct Cyc_List_List));_T3->hd= x;_T3->tl= 0;_T1= (struct Cyc_List_List*)_T3;}_T2->nodes= _T1;_T0= (struct Cyc_Set_Set*)_T2;}return _T0;}
# 44
int Cyc_Set_cardinality(struct Cyc_Set_Set*s){struct Cyc_Set_Set*_T0;int _T1;_T0= s;_T1= _T0->cardinality;return _T1;}
# 47
long Cyc_Set_is_empty(struct Cyc_Set_Set*s){struct Cyc_Set_Set*_T0;int _T1;int _T2;_T0= s;_T1= _T0->cardinality;_T2= _T1==0;return _T2;}
# 50
static long Cyc_Set_member_b(int(*cmp)(void*,void*),struct Cyc_List_List*n,void*elt){void*_T0;struct Cyc_List_List*_T1;void*_T2;struct Cyc_List_List*_T3;
...
# 58
 return 0;}
# 61
long Cyc_Set_member(struct Cyc_Set_Set*s,void*elt){struct Cyc_Set_Set*_T0;int(*_T1)(void*,void*);struct Cyc_Set_Set*_T2;struct Cyc_List_List*_T3;void*_T4;long _T5;_T0= s;_T1= _T0->cmp;_T2= s;_T3= _T2->nodes;_T4= elt;_T5= Cyc_Set_member_b(_T1,_T3,_T4);return _T5;}
# 66
...
return _T19;}}}}
# 85
struct Cyc_Set_Set*Cyc_Set_insert(struct Cyc_Set_Set*s,void*elt){long _T0;struct Cyc_Set_Set*_T1;struct Cyc_Set_Set*_T2;struct Cyc_Set_Set*_T3;struct Cyc_Set_Set*_T4;int _T5;struct _RegionHandle*_T6;struct Cyc_Set_Set*_T7;int(*_T8)(void*,void*);struct Cyc_Set_Set*_T9;struct Cyc_List_List*_TA;void*_TB;_T0= 
Cyc_Set_member(s,elt);if(!_T0)goto _TL10;_T1= s;
return _T1;_TL10:{struct Cyc_Set_Set*_TC=_cycalloc(sizeof(struct Cyc_Set_Set));_T3= s;
_TC->cmp= _T3->cmp;_T4= s;_T5= _T4->cardinality;_TC->cardinality= _T5 + 1;_T6= Cyc_Core_heap_region;_T7= s;_T8= _T7->cmp;_T9= s;_TA= _T9->nodes;_TB= elt;({__typeof__(Cyc_Set_insert_b(_T6,_T8,_TA,_TB))_TD=Cyc_Set_insert_b(_T6,_T8,_TA,_TB);_TC->nodes= _TD;});_T2= (struct Cyc_Set_Set*)_TC;}return _T2;}
# 90
struct Cyc_Set_Set*Cyc_Set_rinsert(struct _RegionHandle*rgn,struct Cyc_Set_Set*s,void*elt){long _T0;struct Cyc_Set_Set*_T1;struct Cyc_Set_Set*_T2;struct _RegionHandle*_T3;struct Cyc_Set_Set*_T4;struct Cyc_Set_Set*_T5;int _T6;struct _RegionHandle*_T7;struct Cyc_Set_Set*_T8;int(*_T9)(void*,void*);struct Cyc_Set_Set*_TA;struct Cyc_List_List*_TB;void*_TC;_T0= 
Cyc_Set_member(s,elt);if(!_T0)goto _TL12;_T1= s;
return _T1;_TL12: _T3= rgn;{struct Cyc_Set_Set*_TD=_region_malloc(_T3,0U,sizeof(struct Cyc_Set_Set));_T4= s;
_TD->cmp= _T4->cmp;_T5= s;_T6= _T5->cardinality;_TD->cardinality= _T6 + 1;_T7= rgn;_T8= s;_T9= _T8->cmp;_TA= s;_TB= _TA->nodes;_TC= elt;({__typeof__(Cyc_Set_insert_b(_T7,_T9,_TB,_TC))_TE=Cyc_Set_insert_b(_T7,_T9,_TB,_TC);_TD->nodes= _TE;});_T2= (struct Cyc_Set_Set*)_TD;}return _T2;}
# 98
...
return _T11;}}}
# 115
void Cyc_Set_imp_insert(struct Cyc_Set_Set*s,void*elt){long _T0;struct Cyc_Set_Set*_T1;struct _RegionHandle*_T2;struct Cyc_Set_Set*_T3;int(*_T4)(void*,void*);struct Cyc_Set_Set*_T5;struct Cyc_List_List*_T6;void*_T7;struct Cyc_Set_Set*_T8;_T0= 
Cyc_Set_member(s,elt);if(_T0)goto _TL1C;else{goto _TL1E;}
_TL1E: _T1= s;_T2= Cyc_Core_heap_region;_T3= s;_T4= _T3->cmp;_T5= s;_T6= _T5->nodes;_T7= elt;({__typeof__(Cyc_Set_imp_insert_b(_T2,_T4,_T6,_T7))_T9=Cyc_Set_imp_insert_b(_T2,_T4,_T6,_T7);_T1->nodes= _T9;});_T8= s;
_T8->cardinality= _T8->cardinality + 1;goto _TL1D;_TL1C: _TL1D:;}
# 121
void Cyc_Set_imp_rinsert(struct _RegionHandle*rgn,struct Cyc_Set_Set*s,void*elt){long _T0;struct Cyc_Set_Set*_T1;struct _RegionHandle*_T2;struct Cyc_Set_Set*_T3;int(*_T4)(void*,void*);struct Cyc_Set_Set*_T5;struct Cyc_List_List*_T6;void*_T7;struct Cyc_Set_Set*_T8;_T0= 
Cyc_Set_member(s,elt);if(_T0)goto _TL1F;else{goto _TL21;}
_TL21: _T1= s;_T2= rgn;_T3= s;_T4= _T3->cmp;_T5= s;_T6= _T5->nodes;_T7= elt;({__typeof__(Cyc_Set_imp_insert_b(_T2,_T4,_T6,_T7))_T9=Cyc_Set_imp_insert_b(_T2,_T4,_T6,_T7);_T1->nodes= _T9;});_T8= s;
...
_check_null(n);_T1= _T0->hd;_T2= elt;_T3= cmp(_T1,_T2);if(_T3!=0)goto _TL3C;_T4= n;_T5= _T4->tl;
return _T5;_TL3C: {
# 198
...
return _T15;}}}
# 211
struct Cyc_Set_Set*Cyc_Set_delete(struct Cyc_Set_Set*s,void*elt){long _T0;struct Cyc_Set_Set*_T1;struct Cyc_Set_Set*_T2;struct Cyc_Set_Set*_T3;int _T4;struct Cyc_Set_Set*_T5;int(*_T6)(void*,void*);struct Cyc_Set_Set*_T7;struct Cyc_List_List*_T8;void*_T9;struct Cyc_Set_Set*_TA;_T0= 
Cyc_Set_member(s,elt);if(!_T0)goto _TL42;{struct Cyc_Set_Set*_TB=_cycalloc(sizeof(struct Cyc_Set_Set));_T2= s;
_TB->cmp= _T2->cmp;_T3= s;_T4= _T3->cardinality;_TB->cardinality= _T4 - 1;_T5= s;_T6= _T5->cmp;_T7= s;_T8= _T7->nodes;_T9= elt;({__typeof__(Cyc_Set_delete_b(_T6,_T8,_T9))_TC=Cyc_Set_delete_b(_T6,_T8,_T9);_TB->nodes= _TC;});_T1= (struct Cyc_Set_Set*)_TB;}return _T1;_TL42: _TA= s;
return _TA;}
# 220
...
_check_null(n);_T1= _T0->hd;_T2= elt;_T3= cmp(_T1,_T2);if(_T3!=0)goto _TL44;_T4= n;_T5= _T4->tl;
return _T5;_TL44: {
# 224
...
return _T11;}}
# 236
void*Cyc_Set_imp_delete(struct Cyc_Set_Set*s,void*elt){long _T0;struct Cyc_Set_Set*_T1;struct Cyc_Set_Set*_T2;int(*_T3)(void*,void*);struct Cyc_Set_Set*_T4;struct Cyc_List_List*_T5;void*_T6;void**_T7;struct Cyc_Set_Set*_T8;void*_T9;
void*ret=elt;_T0= 
Cyc_Set_member(s,elt);if(!_T0)goto _TL4A;_T1= s;_T2= s;_T3= _T2->cmp;_T4= s;_T5= _T4->nodes;_T6= elt;_T7= & ret;
({__typeof__(Cyc_Set_imp_delete_b(_T3,_T5,_T6,_T7))_TA=Cyc_Set_imp_delete_b(_T3,_T5,_T6,_T7);_T1->nodes= _TA;});_T8= s;
...
return _T6;}
# 258
void Cyc_Set_app(void*(*f)(void*),struct Cyc_Set_Set*s){void*(*_T0)(void*);struct Cyc_Set_Set*_T1;struct Cyc_List_List*_T2;_T0= f;_T1= s;_T2= _T1->nodes;Cyc_List_app(_T0,_T2);}
void Cyc_Set_iter(void(*f)(void*),struct Cyc_Set_Set*s){void(*_T0)(void*);struct Cyc_Set_Set*_T1;struct Cyc_List_List*_T2;_T0= f;_T1= s;_T2= _T1->nodes;Cyc_List_iter(_T0,_T2);}
void Cyc_Set_iter_c(void(*f)(void*,void*),void*env,struct Cyc_Set_Set*s){void(*_T0)(void*,void*);void*_T1;struct Cyc_Set_Set*_T2;struct Cyc_List_List*_T3;_T0= f;_T1= env;_T2= s;_T3= _T2->nodes;Cyc_List_iter_c(_T0,_T1,_T3);}
# 264
...
# 305
_T10->cmp= comp;({__typeof__(Cyc_List_length(z))_T11=Cyc_List_length(z);_T10->cardinality= _T11;});_T10->nodes= z;_TF= (struct Cyc_Set_Set*)_T10;}return _TF;}}
# 308
struct Cyc_List_List*Cyc_Set_to_list(struct Cyc_Set_Set*s){struct Cyc_Set_Set*_T0;struct Cyc_List_List*_T1;_T0= s;_T1= _T0->nodes;return _T1;}
# 310
long Cyc_Set_subset(struct Cyc_Set_Set*s1,struct Cyc_Set_Set*s2){struct Cyc_Set_Set*_T0;struct Cyc_Set_Set*_T1;struct Cyc_Set_Set*_T2;struct Cyc_List_List*_T3;void*_T4;struct Cyc_List_List*_T5;void*_T6;struct Cyc_List_List*_T7;struct Cyc_List_List*_T8;_T0= s1;{
...
return 1;_TL6D:
 if(x2!=0)goto _TL6F;
return 0;_TL6F: _T3= x1;_T4= _T3->hd;_T5= x2;_T6= _T5->hd;{
int i=comp(_T4,_T6);
if(i >= 0)goto _TL71;
return 0;_TL71:
...
# 327
 return 1;}}}}
# 330
struct Cyc_Set_Set*Cyc_Set_diff(struct Cyc_Set_Set*s1,struct Cyc_Set_Set*s2){struct Cyc_Set_Set*_T0;struct Cyc_Set_Set*_T1;struct Cyc_Set_Set*_T2;struct Cyc_Set_Set*_T3;struct Cyc_Set_Set*_T4;struct Cyc_List_List*_T5;int(*_T6)(void*,void*);struct Cyc_List_List*_T7;void*_T8;long _T9;int(*_TA)(void*,void*);struct Cyc_List_List*_TB;void*_TC;struct Cyc_List_List*_TD;struct Cyc_Set_Set*_TE;_T0= s1;{
int(*comp)(void*,void*)=_T0->cmp;_T1= s1;{
struct Cyc_List_List*x1=_T1->nodes;_T2= s2;{
struct Cyc_List_List*x2=_T2->nodes;_T3= s1;{
int card=_T3->cardinality;
# 336
if(x2!=0)goto _TL75;_T4= s1;
return _T4;_TL75:
# 339
...
if(diff==0)goto _TL84;_T14= diff;
return _T14;_TL84: _T15= x1;
x1= _T15->tl;_T16= x2;
x2= _T16->tl;}goto _TL81;_TL83:
# 365
 return 0;}}}}
# 368
long Cyc_Set_equals(struct Cyc_Set_Set*s1,struct Cyc_Set_Set*s2){int _T0;int _T1;_T0= Cyc_Set_setcmp(s1,s2);_T1= _T0==0;return _T1;}char Cyc_Set_Absent[7U]="Absent";
# 371
...
return _T6;}
# 381
long Cyc_Set_iter_f(struct Cyc_List_List**elts_left,void**dest){struct Cyc_List_List**_T0;struct Cyc_List_List*_T1;unsigned _T2;void**_T3;struct Cyc_List_List**_T4;struct Cyc_List_List*_T5;struct Cyc_List_List**_T6;struct Cyc_List_List**_T7;struct Cyc_List_List*_T8;struct Cyc_List_List*_T9;_T0= elts_left;_T1= *_T0;_T2= (unsigned)_T1;
...
*_T5= _T3->nodes;_T1= (struct Cyc_List_List**)_T5;}_T4.env= _T1;_T4.next= Cyc_Set_iter_f;_T0= _T4;}return _T0;}
