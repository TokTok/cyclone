...
# 42
_check_null(l);_T9= _T8->hd;{struct Cyc_Rope_Rope_node*r=(struct Cyc_Rope_Rope_node*)_T9;_TA= l;
l= _TA->tl;_T7= r;}
# 41
_TE[_T6]= _T7;i= i + 1;goto _TL3;_TL2:;}_T4= (struct Cyc_Rope_Rope_node**)_TE;}_T2= 
# 39
...
return _T4;}}
# 83
int Cyc_Rope_cmp(struct Cyc_Rope_Rope_node*r1,struct Cyc_Rope_Rope_node*r2){struct _fat_ptr _T0;struct _fat_ptr _T1;int _T2;_T0= Cyc_Rope_to_string(r1);_T1= Cyc_Rope_to_string(r2);_T2= Cyc_strcmp(_T0,_T1);return _T2;}
